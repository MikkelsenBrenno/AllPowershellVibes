<#
.SYNOPSIS
    Detects Printer Queue state.

.DESCRIPTION
    Detects Printer Queue state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Printer Queue is compliant
    Exit 1:      Printer Queue is noncompliant
