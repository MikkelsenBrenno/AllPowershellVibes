<#
.SYNOPSIS
    Remediates Printer Queue state.

.DESCRIPTION
    Writes configurable state evidence for Printer Queue remediation.
...
.INTUNE
    ...
    Exit 0:      Printer Queue remediation completed
    Exit 1:      Printer Queue remediation did not complete
...
$ScriptPackageName = 'Repair-Printer-Queue-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Printer Queue'
...
$MarkerFileName = 'repair-printer-queue-readiness.state'
$EvidenceFileName = 'repair-printer-queue-readiness.json'
