<#
.SYNOPSIS
    Detects Printer Mapping state.

.DESCRIPTION
    Detects Printer Mapping state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Printer Mapping is compliant
    Exit 1:      Printer Mapping is noncompliant
