<#
.SYNOPSIS
    Detects Print Processor state.

.DESCRIPTION
    Detects Print Processor state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Print Processor is compliant
    Exit 1:      Print Processor is noncompliant
