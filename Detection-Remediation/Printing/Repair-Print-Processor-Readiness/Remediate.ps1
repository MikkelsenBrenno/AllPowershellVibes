<#
.SYNOPSIS
    Remediates Print Processor state.

.DESCRIPTION
    Writes configurable state evidence for Print Processor remediation.
...
.INTUNE
    ...
    Exit 0:      Print Processor remediation completed
    Exit 1:      Print Processor remediation did not complete
...
$ScriptPackageName = 'Repair-Print-Processor-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Print Processor'
...
$MarkerFileName = 'repair-print-processor-readiness.state'
$EvidenceFileName = 'repair-print-processor-readiness.json'
