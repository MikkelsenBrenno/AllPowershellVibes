<#
.SYNOPSIS
    Remediates Print Port state.

.DESCRIPTION
    Writes configurable state evidence for Print Port remediation.
...
.INTUNE
    ...
    Exit 0:      Print Port remediation completed
    Exit 1:      Print Port remediation did not complete
...
$ScriptPackageName = 'Refresh-Print-Port-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Print Port'
...
$MarkerFileName = 'refresh-print-port-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-print-port-snapshot-when-stale.json'
