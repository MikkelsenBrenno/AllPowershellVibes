<#
.SYNOPSIS
    Detects Default Printer state.

.DESCRIPTION
    Detects Default Printer state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Default Printer is compliant
    Exit 1:      Default Printer is noncompliant
