<#
.SYNOPSIS
    Remediates Default Printer state.

.DESCRIPTION
    Writes configurable state evidence for Default Printer remediation.
...
.INTUNE
    ...
    Exit 0:      Default Printer remediation completed
    Exit 1:      Default Printer remediation did not complete
...
$ScriptPackageName = 'Refresh-Default-Printer-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Default Printer'
...
$MarkerFileName = 'refresh-default-printer-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-default-printer-snapshot-when-stale.json'
