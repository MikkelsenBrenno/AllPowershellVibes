<#
.SYNOPSIS
    Remediates Cloud Printer state.

.DESCRIPTION
    Writes configurable state evidence for Cloud Printer remediation.
...
.INTUNE
    ...
    Exit 0:      Cloud Printer remediation completed
    Exit 1:      Cloud Printer remediation did not complete
...
$ScriptPackageName = 'Ensure-Cloud-Printer-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Cloud Printer'
...
$MarkerFileName = 'ensure-cloud-printer-state.state'
$EvidenceFileName = 'ensure-cloud-printer-state.json'
