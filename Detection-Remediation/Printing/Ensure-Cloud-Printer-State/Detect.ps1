<#
.SYNOPSIS
    Detects Cloud Printer state.

.DESCRIPTION
    Detects Cloud Printer state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Cloud Printer is compliant
    Exit 1:      Cloud Printer is noncompliant
