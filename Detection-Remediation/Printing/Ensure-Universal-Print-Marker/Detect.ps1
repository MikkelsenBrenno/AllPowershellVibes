<#
.SYNOPSIS
    Detects Universal Print state.

.DESCRIPTION
    Detects Universal Print state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Universal Print is compliant
    Exit 1:      Universal Print is noncompliant
