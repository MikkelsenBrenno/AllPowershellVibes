<#
.SYNOPSIS
    Remediates Universal Print state.

.DESCRIPTION
    Writes configurable state evidence for Universal Print remediation.
...
.INTUNE
    ...
    Exit 0:      Universal Print remediation completed
    Exit 1:      Universal Print remediation did not complete
...
$ScriptPackageName = 'Ensure-Universal-Print-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Universal Print'
...
$MarkerFileName = 'ensure-universal-print-marker.state'
$EvidenceFileName = 'ensure-universal-print-marker.json'
