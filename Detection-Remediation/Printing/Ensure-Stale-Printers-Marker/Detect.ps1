<#
.SYNOPSIS
    Detects Stale Printers state.

.DESCRIPTION
    Detects Stale Printers state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Stale Printers is compliant
    Exit 1:      Stale Printers is noncompliant
