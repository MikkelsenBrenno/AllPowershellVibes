<#
.SYNOPSIS
    Remediates Stale Printers state.

.DESCRIPTION
    Writes configurable state evidence for Stale Printers remediation.
...
.INTUNE
    ...
    Exit 0:      Stale Printers remediation completed
    Exit 1:      Stale Printers remediation did not complete
...
$ScriptPackageName = 'Ensure-Stale-Printers-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Stale Printers'
...
$MarkerFileName = 'ensure-stale-printers-marker.state'
$EvidenceFileName = 'ensure-stale-printers-marker.json'
