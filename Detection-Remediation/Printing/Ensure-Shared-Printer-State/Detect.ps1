<#
.SYNOPSIS
    Detects Shared Printer state.

.DESCRIPTION
    Detects Shared Printer state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Shared Printer is compliant
    Exit 1:      Shared Printer is noncompliant
