<#
.SYNOPSIS
    Remediates Shared Printer state.

.DESCRIPTION
    Writes configurable state evidence for Shared Printer remediation.
...
.INTUNE
    ...
    Exit 0:      Shared Printer remediation completed
    Exit 1:      Shared Printer remediation did not complete
...
$ScriptPackageName = 'Ensure-Shared-Printer-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Shared Printer'
...
$MarkerFileName = 'ensure-shared-printer-state.state'
$EvidenceFileName = 'ensure-shared-printer-state.json'
