<#
.SYNOPSIS
    Remediates Driver Package state.

.DESCRIPTION
    Writes configurable state evidence for Driver Package remediation.
...
.INTUNE
    ...
    Exit 0:      Driver Package remediation completed
    Exit 1:      Driver Package remediation did not complete
...
$ScriptPackageName = 'Ensure-Driver-Package-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Driver Package'
...
$MarkerFileName = 'ensure-driver-package-marker.state'
$EvidenceFileName = 'ensure-driver-package-marker.json'
