<#
.SYNOPSIS
    Detects Driver Package state.

.DESCRIPTION
    Detects Driver Package state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Driver Package is compliant
    Exit 1:      Driver Package is noncompliant
