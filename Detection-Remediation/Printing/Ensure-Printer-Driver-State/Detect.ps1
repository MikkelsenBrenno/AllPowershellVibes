<#
.SYNOPSIS
    Detects Printer Driver state.

.DESCRIPTION
    Detects Printer Driver state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Printer Driver is compliant
    Exit 1:      Printer Driver is noncompliant
