<#
.SYNOPSIS
    Remediates Printer Driver state.

.DESCRIPTION
    Writes configurable state evidence for Printer Driver remediation.
...
.INTUNE
    ...
    Exit 0:      Printer Driver remediation completed
    Exit 1:      Printer Driver remediation did not complete
...
$ScriptPackageName = 'Ensure-Printer-Driver-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Printer Driver'
...
$MarkerFileName = 'ensure-printer-driver-state.state'
$EvidenceFileName = 'ensure-printer-driver-state.json'
