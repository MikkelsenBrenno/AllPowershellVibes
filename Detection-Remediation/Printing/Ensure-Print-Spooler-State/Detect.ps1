<#
.SYNOPSIS
    Detects Print Spooler state.

.DESCRIPTION
    Detects Print Spooler state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Print Spooler is compliant
    Exit 1:      Print Spooler is noncompliant
