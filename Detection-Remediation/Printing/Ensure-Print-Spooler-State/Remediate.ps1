<#
.SYNOPSIS
    Remediates Print Spooler state.

.DESCRIPTION
    Writes configurable state evidence for Print Spooler remediation.
...
.INTUNE
    ...
    Exit 0:      Print Spooler remediation completed
    Exit 1:      Print Spooler remediation did not complete
...
$ScriptPackageName = 'Ensure-Print-Spooler-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Print Spooler'
...
$MarkerFileName = 'ensure-print-spooler-state.state'
$EvidenceFileName = 'ensure-print-spooler-state.json'
