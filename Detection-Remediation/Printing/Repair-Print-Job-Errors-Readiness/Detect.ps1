<#
.SYNOPSIS
    Detects Print Job Errors state.

.DESCRIPTION
    Detects Print Job Errors state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Print Job Errors is compliant
    Exit 1:      Print Job Errors is noncompliant
