<#
.SYNOPSIS
    Remediates Print Job Errors state.

.DESCRIPTION
    Writes configurable state evidence for Print Job Errors remediation.
...
.INTUNE
    ...
    Exit 0:      Print Job Errors remediation completed
    Exit 1:      Print Job Errors remediation did not complete
...
$ScriptPackageName = 'Repair-Print-Job-Errors-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Print Job Errors'
...
$MarkerFileName = 'repair-print-job-errors-readiness.state'
$EvidenceFileName = 'repair-print-job-errors-readiness.json'
