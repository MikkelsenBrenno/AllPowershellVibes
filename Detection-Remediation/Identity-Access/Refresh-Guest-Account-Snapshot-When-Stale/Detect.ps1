<#
.SYNOPSIS
    Detects Guest Account state.

.DESCRIPTION
    Detects Guest Account state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Guest Account is compliant
    Exit 1:      Guest Account is noncompliant
