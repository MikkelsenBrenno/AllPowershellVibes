<#
.SYNOPSIS
    Remediates Guest Account state.

.DESCRIPTION
    Writes configurable state evidence for Guest Account remediation.
...
.INTUNE
    ...
    Exit 0:      Guest Account remediation completed
    Exit 1:      Guest Account remediation did not complete
...
$ScriptPackageName = 'Refresh-Guest-Account-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Guest Account'
...
$MarkerFileName = 'refresh-guest-account-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-guest-account-snapshot-when-stale.json'
