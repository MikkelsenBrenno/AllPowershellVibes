<#
.SYNOPSIS
    Remediates SignIn Logs state.

.DESCRIPTION
    Writes configurable state evidence for SignIn Logs remediation.
...
.INTUNE
    ...
    Exit 0:      SignIn Logs remediation completed
    Exit 1:      SignIn Logs remediation did not complete
...
$ScriptPackageName = 'Ensure-SignIn-Logs-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'SignIn Logs'
...
$MarkerFileName = 'ensure-signin-logs-state.state'
$EvidenceFileName = 'ensure-signin-logs-state.json'
