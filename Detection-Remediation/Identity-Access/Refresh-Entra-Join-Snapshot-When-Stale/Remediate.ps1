<#
.SYNOPSIS
    Remediates Entra Join state.

.DESCRIPTION
    Writes configurable state evidence for Entra Join remediation.
...
.INTUNE
    ...
    Exit 0:      Entra Join remediation completed
    Exit 1:      Entra Join remediation did not complete
...
$ScriptPackageName = 'Refresh-Entra-Join-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Entra Join'
...
$MarkerFileName = 'refresh-entra-join-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-entra-join-snapshot-when-stale.json'
