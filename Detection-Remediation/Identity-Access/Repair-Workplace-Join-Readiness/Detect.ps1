<#
.SYNOPSIS
    Detects Workplace Join state.

.DESCRIPTION
    Detects Workplace Join state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Workplace Join is compliant
    Exit 1:      Workplace Join is noncompliant
