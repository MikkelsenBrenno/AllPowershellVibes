<#
.SYNOPSIS
    Remediates Workplace Join state.

.DESCRIPTION
    Writes configurable state evidence for Workplace Join remediation.
...
.INTUNE
    ...
    Exit 0:      Workplace Join remediation completed
    Exit 1:      Workplace Join remediation did not complete
...
$ScriptPackageName = 'Repair-Workplace-Join-Readiness'
...
$MarkerFileName = 'repair-workplace-join-readiness.state'
$EvidenceFileName = 'repair-workplace-join-readiness.json'
