<#
.SYNOPSIS
    Remediates Primary Refresh Token state.

.DESCRIPTION
    Writes configurable state evidence for Primary Refresh Token remediation.
...
.INTUNE
    ...
    Exit 0:      Primary Refresh Token remediation completed
    Exit 1:      Primary Refresh Token remediation did not complete
...
$ScriptPackageName = 'Ensure-Primary-Refresh-Token-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Primary Refresh Token'
...
$MarkerFileName = 'ensure-primary-refresh-token-marker.state'
$EvidenceFileName = 'ensure-primary-refresh-token-marker.json'
