<#
.SYNOPSIS
    Detects Primary Refresh Token state.

.DESCRIPTION
    Detects Primary Refresh Token state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Primary Refresh Token is compliant
    Exit 1:      Primary Refresh Token is noncompliant
