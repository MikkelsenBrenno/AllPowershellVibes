<#
.SYNOPSIS
    Detects Credential Guard Readiness state.

.DESCRIPTION
    Detects Credential Guard Readiness state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Credential Guard Readiness is compliant
    Exit 1:      Credential Guard Readiness is noncompliant
