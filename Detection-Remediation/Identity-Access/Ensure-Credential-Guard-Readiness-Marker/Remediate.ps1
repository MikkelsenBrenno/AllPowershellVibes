<#
.SYNOPSIS
    Remediates Credential Guard Readiness state.

.DESCRIPTION
    Writes configurable state evidence for Credential Guard Readiness remediation.
...
.INTUNE
    ...
    Exit 0:      Credential Guard Readiness remediation completed
    Exit 1:      Credential Guard Readiness remediation did not complete
...
$ScriptPackageName = 'Ensure-Credential-Guard-Readiness-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Credential Guard Readiness'
...
$MarkerFileName = 'ensure-credential-guard-readiness-marker.state'
$EvidenceFileName = 'ensure-credential-guard-readiness-marker.json'
