<#
.SYNOPSIS
    Remediates Windows Hello state.

.DESCRIPTION
    Writes configurable state evidence for Windows Hello remediation.
...
.INTUNE
    ...
    Exit 0:      Windows Hello remediation completed
    Exit 1:      Windows Hello remediation did not complete
...
$ScriptPackageName = 'Ensure-Windows-Hello-Marker'
...
$MarkerFileName = 'ensure-windows-hello-marker.state'
$EvidenceFileName = 'ensure-windows-hello-marker.json'
