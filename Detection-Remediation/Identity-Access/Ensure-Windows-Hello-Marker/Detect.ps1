<#
.SYNOPSIS
    Detects Windows Hello state.

.DESCRIPTION
    Detects Windows Hello state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Windows Hello is compliant
    Exit 1:      Windows Hello is noncompliant
