<#
.SYNOPSIS
    Remediates Cached Logons state.

.DESCRIPTION
    Writes configurable state evidence for Cached Logons remediation.
...
.INTUNE
    ...
    Exit 0:      Cached Logons remediation completed
    Exit 1:      Cached Logons remediation did not complete
...
$ScriptPackageName = 'Ensure-Cached-Logons-State'
...
$MarkerFileName = 'ensure-cached-logons-state.state'
$EvidenceFileName = 'ensure-cached-logons-state.json'
