<#
.SYNOPSIS
    Detects Cached Logons state.

.DESCRIPTION
    Detects Cached Logons state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Cached Logons is compliant
    Exit 1:      Cached Logons is noncompliant
