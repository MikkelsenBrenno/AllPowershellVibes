<#
.SYNOPSIS
    Remediates Admin Role Membership state.

.DESCRIPTION
    Writes configurable state evidence for Admin Role Membership remediation.
...
.INTUNE
    ...
    Exit 0:      Admin Role Membership remediation completed
    Exit 1:      Admin Role Membership remediation did not complete
...
$ScriptPackageName = 'Repair-Admin-Role-Membership-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Admin Role Membership'
...
$MarkerFileName = 'repair-admin-role-membership-readiness.state'
$EvidenceFileName = 'repair-admin-role-membership-readiness.json'
