<#
.SYNOPSIS
    Detects Admin Role Membership state.

.DESCRIPTION
    Detects Admin Role Membership state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Admin Role Membership is compliant
    Exit 1:      Admin Role Membership is noncompliant
