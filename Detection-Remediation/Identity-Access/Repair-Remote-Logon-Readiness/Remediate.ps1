<#
.SYNOPSIS
    Remediates Remote Logon state.

.DESCRIPTION
    Writes configurable state evidence for Remote Logon remediation.
...
.INTUNE
    ...
    Exit 0:      Remote Logon remediation completed
    Exit 1:      Remote Logon remediation did not complete
...
$ScriptPackageName = 'Repair-Remote-Logon-Readiness'
...
$MarkerFileName = 'repair-remote-logon-readiness.state'
$EvidenceFileName = 'repair-remote-logon-readiness.json'
