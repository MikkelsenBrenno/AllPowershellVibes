<#
.SYNOPSIS
    Detects Remote Logon state.

.DESCRIPTION
    Detects Remote Logon state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Remote Logon is compliant
    Exit 1:      Remote Logon is noncompliant
