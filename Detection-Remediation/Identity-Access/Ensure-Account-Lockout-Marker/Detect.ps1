<#
.SYNOPSIS
    Detects Account Lockout state.

.DESCRIPTION
    Detects Account Lockout state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Account Lockout is compliant
    Exit 1:      Account Lockout is noncompliant
