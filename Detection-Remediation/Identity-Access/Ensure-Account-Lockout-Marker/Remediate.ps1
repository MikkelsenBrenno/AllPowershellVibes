<#
.SYNOPSIS
    Remediates Account Lockout state.

.DESCRIPTION
    Writes configurable state evidence for Account Lockout remediation.
...
.INTUNE
    ...
    Exit 0:      Account Lockout remediation completed
    Exit 1:      Account Lockout remediation did not complete
...
$ScriptPackageName = 'Ensure-Account-Lockout-Marker'
...
$MarkerFileName = 'ensure-account-lockout-marker.state'
$EvidenceFileName = 'ensure-account-lockout-marker.json'
