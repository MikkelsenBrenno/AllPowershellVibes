<#
.SYNOPSIS
    Remediates Local Administrators state.

.DESCRIPTION
    Writes configurable state evidence for Local Administrators remediation.
...
.INTUNE
    ...
    Exit 0:      Local Administrators remediation completed
    Exit 1:      Local Administrators remediation did not complete
...
$ScriptPackageName = 'Ensure-Local-Administrators-State'
...
$MarkerFileName = 'ensure-local-administrators-state.state'
$EvidenceFileName = 'ensure-local-administrators-state.json'
