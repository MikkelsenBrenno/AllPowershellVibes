<#
.SYNOPSIS
    Detects Local Administrators state.

.DESCRIPTION
    Detects Local Administrators state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Local Administrators is compliant
    Exit 1:      Local Administrators is noncompliant
