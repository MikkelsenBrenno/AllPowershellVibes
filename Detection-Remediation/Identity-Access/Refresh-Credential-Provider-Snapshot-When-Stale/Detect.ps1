<#
.SYNOPSIS
    Detects Credential Provider state.

.DESCRIPTION
    Detects Credential Provider state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Credential Provider is compliant
    Exit 1:      Credential Provider is noncompliant
