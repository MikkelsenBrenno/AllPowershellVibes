<#
.SYNOPSIS
    Detects Password Policy state.

.DESCRIPTION
    Detects Password Policy state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Password Policy is compliant
    Exit 1:      Password Policy is noncompliant
