<#
.SYNOPSIS
    Remediates Password Policy state.

.DESCRIPTION
    Writes configurable state evidence for Password Policy remediation.
...
.INTUNE
    ...
    Exit 0:      Password Policy remediation completed
    Exit 1:      Password Policy remediation did not complete
...
$ScriptPackageName = 'Repair-Password-Policy-Readiness'
...
$MarkerFileName = 'repair-password-policy-readiness.state'
$EvidenceFileName = 'repair-password-policy-readiness.json'
