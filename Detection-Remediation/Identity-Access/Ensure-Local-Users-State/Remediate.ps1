<#
.SYNOPSIS
    Remediates Local Users state.

.DESCRIPTION
    Writes configurable state evidence for Local Users remediation.
...
.INTUNE
    ...
    Exit 0:      Local Users remediation completed
    Exit 1:      Local Users remediation did not complete
...
$ScriptPackageName = 'Ensure-Local-Users-State'
...
$MarkerFileName = 'ensure-local-users-state.state'
$EvidenceFileName = 'ensure-local-users-state.json'
