<#
.SYNOPSIS
    Remediates LAPS Readiness state.

.DESCRIPTION
    Writes configurable state evidence for LAPS Readiness remediation.
...
.INTUNE
    ...
    Exit 0:      LAPS Readiness remediation completed
    Exit 1:      LAPS Readiness remediation did not complete
...
$ScriptPackageName = 'Refresh-LAPS-Readiness-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'LAPS Readiness'
...
$MarkerFileName = 'refresh-laps-readiness-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-laps-readiness-snapshot-when-stale.json'
