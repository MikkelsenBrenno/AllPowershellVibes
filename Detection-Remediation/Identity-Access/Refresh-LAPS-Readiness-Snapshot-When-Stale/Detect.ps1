<#
.SYNOPSIS
    Detects LAPS Readiness state.

.DESCRIPTION
    Detects LAPS Readiness state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      LAPS Readiness is compliant
    Exit 1:      LAPS Readiness is noncompliant
