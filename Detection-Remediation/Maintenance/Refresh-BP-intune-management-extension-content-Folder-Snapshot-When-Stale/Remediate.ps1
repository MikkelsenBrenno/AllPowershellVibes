<#
.SYNOPSIS
    Refreshes the Intune Management Extension Content Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-intune-management-extension-content-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPintunemanagementextensioncontentFolderSnapshot.json'
