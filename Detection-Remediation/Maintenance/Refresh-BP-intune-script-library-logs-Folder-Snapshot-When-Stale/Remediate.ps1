<#
.SYNOPSIS
    Refreshes the Intune Script Library Logs Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-intune-script-library-logs-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPintunescriptlibrarylogsFolderSnapshot.json'
