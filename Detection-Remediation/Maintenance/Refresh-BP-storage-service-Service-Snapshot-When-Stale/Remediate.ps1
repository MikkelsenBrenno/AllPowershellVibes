<#
.SYNOPSIS
    Refreshes the Storage Service Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-storage-service-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPstorageserviceServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Storage Service service state snapshot for technician troubleshooting.'

$ServiceNames = @('StorSvc')
