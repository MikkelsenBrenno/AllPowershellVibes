# Ensure Task Scheduler Service Running

## Summary

Detects and remediates devices where Task Scheduler is stopped, which can break scheduled maintenance, update, and app tasks.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Task-Scheduler-Service-Running`.
