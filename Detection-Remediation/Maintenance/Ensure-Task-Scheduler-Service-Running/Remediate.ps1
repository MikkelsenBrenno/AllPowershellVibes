...
.INTUNE
    ...
    Exit 0:      Task Scheduler Service remediation succeeded
    Exit 1:      Task Scheduler Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Task Scheduler Service.'
    exit 1
}
