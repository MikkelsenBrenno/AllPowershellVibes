<#
.SYNOPSIS
    Refreshes the ProgramData Temp Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-programdata-temp-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPprogramdatatempFolderSnapshot.json'
