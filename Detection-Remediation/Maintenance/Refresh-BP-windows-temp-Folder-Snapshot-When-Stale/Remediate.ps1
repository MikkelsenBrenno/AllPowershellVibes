<#
.SYNOPSIS
    Refreshes the Windows Temp Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-temp-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwindowstempFolderSnapshot.json'
