<#
.SYNOPSIS
    Remediates Ensure Group Policy Background Refresh Enabled.
...
$ScriptPackageName = 'Ensure-Group-Policy-Background-Refresh-Enabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System'; Name = 'DisableBkGndGroupPolicy'; Type = 'DWord'; Value = 0; Description = 'Enable background Group Policy refresh' }
)
