<#
.SYNOPSIS
    Refreshes the Restart Manager Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-restart-manager-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPrestartmanagereventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Restart Manager Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-RestartManager/Operational'
$RecentEventCount = 80
$EventIdsToHighlight = @(10000, 10001, 10002)
