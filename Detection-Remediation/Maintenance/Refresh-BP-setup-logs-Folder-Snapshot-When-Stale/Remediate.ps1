<#
.SYNOPSIS
    Refreshes the Setup Logs Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-setup-logs-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsetuplogsFolderSnapshot.json'
