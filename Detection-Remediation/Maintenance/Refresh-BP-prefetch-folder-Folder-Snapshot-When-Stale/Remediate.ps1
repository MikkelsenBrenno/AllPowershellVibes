<#
.SYNOPSIS
    Refreshes the Prefetch Folder Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-prefetch-folder-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPprefetchfolderFolderSnapshot.json'
