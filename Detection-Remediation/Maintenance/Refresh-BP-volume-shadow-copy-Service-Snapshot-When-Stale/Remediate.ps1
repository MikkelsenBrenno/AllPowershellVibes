<#
.SYNOPSIS
    Refreshes the Volume Shadow Copy Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-volume-shadow-copy-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPvolumeshadowcopyServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Volume Shadow Copy service state snapshot for technician troubleshooting.'
