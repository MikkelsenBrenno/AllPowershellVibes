<#
.SYNOPSIS
    Refreshes the Windows Search Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-search-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwindowssearchServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Search service state snapshot for technician troubleshooting.'
