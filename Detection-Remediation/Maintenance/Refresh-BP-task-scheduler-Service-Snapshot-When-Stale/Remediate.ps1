<#
.SYNOPSIS
    Refreshes the Task Scheduler Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-task-scheduler-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPtaskschedulerServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Task Scheduler service state snapshot for technician troubleshooting.'

$ServiceNames = @('Schedule')
