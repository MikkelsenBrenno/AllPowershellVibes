<#
.SYNOPSIS
    Refreshes the Disk Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-disk-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdiskeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Disk Events event log snapshot for technician troubleshooting.'

$EventLogName = 'System'
$RecentEventCount = 80
$EventIdsToHighlight = @(7, 11, 15, 51, 153, 157)
