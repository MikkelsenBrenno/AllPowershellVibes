<#
.SYNOPSIS
    Refreshes the Component Based Servicing Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-cbs-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcbseventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Component Based Servicing Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Setup'
$RecentEventCount = 80
$EventIdsToHighlight = @(2, 3, 4)
