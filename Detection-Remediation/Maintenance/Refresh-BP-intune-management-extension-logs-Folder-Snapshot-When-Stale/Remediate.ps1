<#
.SYNOPSIS
    Refreshes the Intune Management Extension Logs Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-intune-management-extension-logs-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPintunemanagementextensionlogsFolderSnapshot.json'
