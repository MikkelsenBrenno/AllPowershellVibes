<#
.SYNOPSIS
    Refreshes the File History Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-file-history-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPfilehistoryServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'File History service state snapshot for technician troubleshooting.'
