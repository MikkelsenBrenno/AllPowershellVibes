<#
.SYNOPSIS
    Refreshes the Software Protection Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-software-protection-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsoftwareprotectionServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Software Protection service state snapshot for technician troubleshooting.'
