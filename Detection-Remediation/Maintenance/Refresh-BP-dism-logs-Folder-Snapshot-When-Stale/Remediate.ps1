<#
.SYNOPSIS
    Refreshes the DISM Logs Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-dism-logs-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdismlogsFolderSnapshot.json'
