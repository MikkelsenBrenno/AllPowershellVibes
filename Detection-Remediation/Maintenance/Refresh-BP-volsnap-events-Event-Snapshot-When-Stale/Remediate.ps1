<#
.SYNOPSIS
    Refreshes the Volume Shadow Copy Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-volsnap-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPvolsnapeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Volume Shadow Copy Events event log snapshot for technician troubleshooting.'

$EventLogName = 'System'
$RecentEventCount = 80
$EventIdsToHighlight = @(25, 33, 36)
