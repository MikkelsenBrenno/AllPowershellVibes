<#
.SYNOPSIS
    Refreshes the SysMain Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-sysmain-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsysmainServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'SysMain service state snapshot for technician troubleshooting.'

$ServiceNames = @('SysMain')
