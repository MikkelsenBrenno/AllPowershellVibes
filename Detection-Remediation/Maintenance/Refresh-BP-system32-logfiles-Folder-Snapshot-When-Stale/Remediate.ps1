<#
.SYNOPSIS
    Refreshes the System32 LogFiles Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-system32-logfiles-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsystem32logfilesFolderSnapshot.json'
