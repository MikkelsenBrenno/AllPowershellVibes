...
Detects and remediates Delivery Optimization policy so Windows Update content sharing is limited to LAN peers.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Delivery-Optimization-LAN-Mode`.
