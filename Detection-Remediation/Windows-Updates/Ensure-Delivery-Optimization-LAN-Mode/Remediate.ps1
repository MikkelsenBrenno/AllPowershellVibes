<#
.SYNOPSIS
    Remediates Ensure Delivery Optimization LAN Mode.
...
.INTUNE
    ...
    Exit 0:      Ensure Delivery Optimization LAN Mode remediation succeeded
    Exit 1:      Ensure Delivery Optimization LAN Mode remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Delivery Optimization LAN Mode.'
    exit 1
}
