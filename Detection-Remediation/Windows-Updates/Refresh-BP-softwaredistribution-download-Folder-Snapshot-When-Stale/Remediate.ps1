<#
.SYNOPSIS
    Refreshes the SoftwareDistribution Download Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-softwaredistribution-download-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsoftwaredistributiondownloadFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'SoftwareDistribution Download folder size snapshot for technician troubleshooting.'
