# Delivery Optimization Snapshot

## Summary

Refreshes a local Delivery Optimization service snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `DeliveryOptimizationSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Delivery-Optimization-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Delivery-Optimization-Snapshot-When-Stale`.
