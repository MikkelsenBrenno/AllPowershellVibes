<#
.SYNOPSIS
    Refreshes the Delivery Optimization Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-Delivery-Optimization-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'DeliveryOptimizationSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Delivery Optimization service snapshot.'
