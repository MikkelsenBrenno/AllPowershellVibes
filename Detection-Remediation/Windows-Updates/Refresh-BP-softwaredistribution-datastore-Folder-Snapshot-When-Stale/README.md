# SoftwareDistribution DataStore Folder

## Summary

Refreshes a local SoftwareDistribution DataStore folder usage troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPsoftwaredistributiondatastoreFolderSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-softwaredistribution-datastore-Folder-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-softwaredistribution-datastore-Folder-Snapshot-When-Stale`.
