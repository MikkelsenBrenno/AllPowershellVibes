<#
.SYNOPSIS
    Refreshes the SoftwareDistribution DataStore Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-softwaredistribution-datastore-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsoftwaredistributiondatastoreFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'SoftwareDistribution DataStore folder size snapshot for technician troubleshooting.'
