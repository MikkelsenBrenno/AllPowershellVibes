# Ensure Windows Update Drivers Excluded Template

## Summary

Template remediation that detects and excludes drivers from Windows quality updates where driver deployment is managed separately.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Windows-Update-Drivers-Excluded-Template`.
