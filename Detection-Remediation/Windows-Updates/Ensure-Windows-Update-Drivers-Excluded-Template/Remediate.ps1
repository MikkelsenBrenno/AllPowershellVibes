<#
.SYNOPSIS
    Remediates Ensure Windows Update Drivers Excluded Template.
...
.INTUNE
    ...
    Exit 0:      Ensure Windows Update Drivers Excluded Template remediation succeeded
    Exit 1:      Ensure Windows Update Drivers Excluded Template remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Windows Update Drivers Excluded Template.'
    exit 1
}
