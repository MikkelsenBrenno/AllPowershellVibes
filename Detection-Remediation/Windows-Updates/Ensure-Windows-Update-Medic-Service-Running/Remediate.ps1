<#
.SYNOPSIS
    Starts Windows Update Medic Service.
...
.INTUNE
    ...
    Exit 0:      Windows Update Medic Service remediation succeeded
    Exit 1:      Windows Update Medic Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Windows Update Medic Service.'
    exit 1
}
