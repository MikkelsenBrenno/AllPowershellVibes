<#
.SYNOPSIS
    Detects whether Windows Update Medic Service is running.
...
.INTUNE
    ...
    Exit 0:      Windows Update Medic Service is running
    Exit 1:      Windows Update Medic Service is missing or stopped
...
$ScriptPackageName = 'Ensure-Windows-Update-Medic-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. Windows Update Medic Service could not be validated.'
    exit 1
}
