# Ensure Windows Update Medic Service Running

## Summary

Detects and remediates devices where the Windows Update Medic service is stopped, supporting Windows Update for Business reliability.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Windows-Update-Medic-Service-Running`.
