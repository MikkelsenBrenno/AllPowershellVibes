<#
.SYNOPSIS
    Remediates Ensure Windows Update No Auto Reboot With Users.
...
.INTUNE
    ...
    Exit 0:      Ensure Windows Update No Auto Reboot With Users remediation succeeded
    Exit 1:      Ensure Windows Update No Auto Reboot With Users remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Windows Update No Auto Reboot With Users.'
    exit 1
}
