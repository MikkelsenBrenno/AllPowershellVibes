# Ensure Windows Update No Auto Reboot With Users

## Summary

Detects and remediates Windows Update policy so signed-in users are not automatically rebooted for scheduled update installation.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Windows-Update-No-Auto-Reboot-With-Users`.
