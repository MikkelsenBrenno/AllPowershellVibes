<#
.SYNOPSIS
    Refreshes the Update Stack Folder Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-update-stack-folder-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPupdatestackfolderFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Update Stack Folder folder size snapshot for technician troubleshooting.'
