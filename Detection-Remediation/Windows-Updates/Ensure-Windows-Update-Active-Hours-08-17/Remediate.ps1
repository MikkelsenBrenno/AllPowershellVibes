<#
.SYNOPSIS
    Remediates Ensure Windows Update Active Hours 08 To 17.
...
$ScriptPackageName = 'Ensure-Windows-Update-Active-Hours-08-17'
...
$RegistryValues = @(
    ...
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'; Name = 'ActiveHoursStart'; Type = 'DWord'; Value = 8; Description = 'Start active hours at 08:00 local time' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'; Name = 'ActiveHoursEnd'; Type = 'DWord'; Value = 17; Description = 'End active hours at 17:00 local time' }
)
