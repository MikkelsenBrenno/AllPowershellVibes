<#
.SYNOPSIS
    Refreshes the Update Orchestrator Tasks Task snapshot.
...
$ScriptPackageName = 'Refresh-BP-update-orchestrator-tasks-Task-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPupdateorchestratortasksTaskSnapshot.json'
$CollectionMode = 'Task'
$JsonDepth = 8
$RegistryItems = @()
$ServiceNames = @()
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Update Orchestrator Tasks scheduled task snapshot for technician troubleshooting.'
