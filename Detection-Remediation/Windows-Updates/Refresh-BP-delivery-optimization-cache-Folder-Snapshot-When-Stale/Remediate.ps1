<#
.SYNOPSIS
    Refreshes the Delivery Optimization Cache Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-delivery-optimization-cache-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdeliveryoptimizationcacheFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Delivery Optimization Cache folder size snapshot for technician troubleshooting.'
