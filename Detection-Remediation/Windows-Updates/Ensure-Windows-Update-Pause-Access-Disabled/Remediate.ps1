<#
.SYNOPSIS
    Remediates Ensure Windows Update Pause Access Disabled.
...
$ScriptPackageName = 'Ensure-Windows-Update-Pause-Access-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'; Name = 'SetDisablePauseUXAccess'; Type = 'DWord'; Value = 1; Description = 'Remove user access to pause updates' }
)
