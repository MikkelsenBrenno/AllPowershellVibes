<#
.SYNOPSIS
    Remediates Ensure Feature Update Safeguard Holds Allowed.
...
$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'; Name = 'DisableWUfBSafeguards'; Type = 'DWord'; Value = 0; Description = 'Keep feature-update safeguard holds enabled' }
)
