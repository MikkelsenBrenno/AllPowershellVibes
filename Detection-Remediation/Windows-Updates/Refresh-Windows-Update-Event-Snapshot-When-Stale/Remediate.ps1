<#
.SYNOPSIS
    Refreshes the Windows Update Event Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-Windows-Update-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'WindowsUpdateEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Update operational event snapshot.'
