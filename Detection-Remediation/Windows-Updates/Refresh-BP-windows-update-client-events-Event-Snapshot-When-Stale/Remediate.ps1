<#
.SYNOPSIS
    Refreshes the Windows Update Client Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-update-client-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwindowsupdateclienteventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Update Client Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-WindowsUpdateClient/Operational'
$RecentEventCount = 80
