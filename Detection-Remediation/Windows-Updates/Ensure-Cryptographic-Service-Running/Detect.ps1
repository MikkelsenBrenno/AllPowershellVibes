<#
.SYNOPSIS
    Detects whether Cryptographic Service is running.
...
.INTUNE
    ...
    Exit 0:      Cryptographic Service is running
    Exit 1:      Cryptographic Service is missing or stopped
...
$ScriptPackageName = 'Ensure-Cryptographic-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. Cryptographic Service could not be validated.'
    exit 1
}
