...
.INTUNE
    ...
    Exit 0:      Cryptographic Service remediation succeeded
    Exit 1:      Cryptographic Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Cryptographic Service.'
    exit 1
}
