<#
.SYNOPSIS
    Remediates Ensure Legacy Automatic Updates Does Not Reboot With Users.
...
$ScriptPackageName = 'Ensure-Legacy-AU-No-Auto-Reboot-With-Users'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'; Name = 'AUOptions'; Type = 'DWord'; Value = 4; Description = 'Use scheduled Automatic Updates installation' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'; Name = 'NoAutoRebootWithLoggedOnUsers'; Type = 'DWord'; Value = 1; Description = 'Do not automatically reboot while a user is signed in' }
)
