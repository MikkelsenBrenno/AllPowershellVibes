<#
.SYNOPSIS
    Refreshes the Windows Update Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-update-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwindowsupdateServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Update service state snapshot for technician troubleshooting.'

$ServiceNames = @('wuauserv')
