<#
.SYNOPSIS
    Refreshes the Delivery Optimization Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-delivery-optimization-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdeliveryoptimizationeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Delivery Optimization Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-DeliveryOptimization/Operational'
$RecentEventCount = 80
$EventIdsToHighlight = @(100, 101, 102, 200)
