# Ensure Windows Update Active Hours Template

## Summary

Template remediation that detects and sets Windows Update active hours policy for business devices.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Windows-Update-Active-Hours-Template`.
