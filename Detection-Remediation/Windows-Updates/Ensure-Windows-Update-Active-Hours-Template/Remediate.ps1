<#
.SYNOPSIS
    Remediates Ensure Windows Update Active Hours Template.
...
.INTUNE
    ...
    Exit 0:      Ensure Windows Update Active Hours Template remediation succeeded
    Exit 1:      Ensure Windows Update Active Hours Template remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Windows Update Active Hours Template.'
    exit 1
}
