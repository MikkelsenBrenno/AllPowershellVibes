<#
.SYNOPSIS
    Detects Ensure Windows Update Active Hours Template.
...
.INTUNE
    ...
    Exit 0:      Ensure Windows Update Active Hours Template is compliant
    Exit 1:      Ensure Windows Update Active Hours Template is missing or different
...
$ScriptPackageName = 'Ensure-Windows-Update-Active-Hours-Template'
$ScriptName = 'Detect'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'; Name = 'SetActiveHours'; Type = 'DWord'; Value = 1; Description = 'Enable active hours policy' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'; Name = 'ActiveHoursStart'; Type = 'DWord'; Value = 8; Description = 'Active hours start, customize before deployment' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate'; Name = 'ActiveHoursEnd'; Type = 'DWord'; Value = 17; Description = 'Active hours end, customize before deployment' }
)
...
try {
    ...
    Write-Output 'Not compliant. Ensure Windows Update Active Hours Template could not be validated.'
    exit 1
}
