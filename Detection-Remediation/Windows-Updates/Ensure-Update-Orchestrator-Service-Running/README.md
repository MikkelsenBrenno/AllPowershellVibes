# Ensure Update Orchestrator Service Running

## Summary

Detects and remediates devices where the Windows Update Orchestrator service is not running, which can affect Windows Update for Business processing.
