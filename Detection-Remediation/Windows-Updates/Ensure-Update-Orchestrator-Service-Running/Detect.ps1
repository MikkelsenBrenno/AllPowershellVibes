<#
.SYNOPSIS
    Detects whether the Update Orchestrator service is running.
...
.INTUNE
    ...
    Exit 0:      Update Orchestrator service is running
    Exit 1:      Update Orchestrator service is missing or stopped
...
$ScriptPackageName = 'Ensure-Update-Orchestrator-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. Update Orchestrator service could not be validated.'
    exit 1
}
