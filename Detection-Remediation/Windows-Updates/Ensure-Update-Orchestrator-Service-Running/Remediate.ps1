<#
.SYNOPSIS
    Starts the Update Orchestrator service.
...
.INTUNE
    ...
    Exit 0:      Update Orchestrator service remediated
    Exit 1:      Update Orchestrator service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Update Orchestrator service.'
    exit 1
}
