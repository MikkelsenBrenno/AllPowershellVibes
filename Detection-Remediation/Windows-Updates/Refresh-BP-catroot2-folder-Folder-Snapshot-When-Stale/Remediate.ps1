<#
.SYNOPSIS
    Refreshes the Catroot2 Folder Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-catroot2-folder-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcatroot2folderFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Catroot2 Folder folder size snapshot for technician troubleshooting.'
