<#
.SYNOPSIS
    Refreshes the Update Orchestrator Task Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-Update-Orchestrator-Task-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'UpdateOrchestratorTaskSnapshot.json'
$CollectionMode = 'Task'
$JsonDepth = 8
$RegistryItems = @()
$ServiceNames = @()
