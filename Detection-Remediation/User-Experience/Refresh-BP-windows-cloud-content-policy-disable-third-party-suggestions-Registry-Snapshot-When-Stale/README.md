# Windows Cloud Content Policy DisableThirdPartySuggestions Registry

## Summary

Refreshes a local Windows Cloud Content Policy DisableThirdPartySuggestions registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPcloudcontentdisablethirdpartysuggestionsRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-windows-cloud-content-policy-disable-third-party-suggestions-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-windows-cloud-content-policy-disable-third-party-suggestions-Registry-Snapshot-When-Stale`.
