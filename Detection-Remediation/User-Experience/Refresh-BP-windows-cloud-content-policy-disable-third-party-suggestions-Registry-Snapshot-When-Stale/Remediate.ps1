<#
.SYNOPSIS
    Refreshes the Windows Cloud Content Policy DisableThirdPartySuggestions Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-cloud-content-policy-disable-third-party-suggestions-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcloudcontentdisablethirdpartysuggestionsRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Cloud Content Policy DisableThirdPartySuggestions registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent'; Name = 'DisableThirdPartySuggestions'; Description = 'Third-party suggestion state' }
)
