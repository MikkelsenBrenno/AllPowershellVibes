<#
.SYNOPSIS
    Refreshes the Shell Core Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-shell-core-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPshellcoreeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Shell Core Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-Shell-Core/Operational'
$RecentEventCount = 80
$EventIdsToHighlight = @(9707, 9708, 9709)
