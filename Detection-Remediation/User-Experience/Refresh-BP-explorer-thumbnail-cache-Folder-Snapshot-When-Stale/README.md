# Explorer Thumbnail Cache Folder

## Summary

Refreshes a local Explorer Thumbnail Cache folder usage troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPexplorerthumbnailcacheFolderSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-explorer-thumbnail-cache-Folder-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-explorer-thumbnail-cache-Folder-Snapshot-When-Stale`.
