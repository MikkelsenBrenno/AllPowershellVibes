<#
.SYNOPSIS
    Refreshes the Explorer Thumbnail Cache Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-explorer-thumbnail-cache-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPexplorerthumbnailcacheFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Explorer Thumbnail Cache folder size snapshot for technician troubleshooting.'
