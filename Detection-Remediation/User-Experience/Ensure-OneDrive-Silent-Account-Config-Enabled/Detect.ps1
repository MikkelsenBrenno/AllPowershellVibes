<#
.SYNOPSIS
    Detects Ensure OneDrive Silent Account Config Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure OneDrive Silent Account Config Enabled is compliant
    Exit 1:      Ensure OneDrive Silent Account Config Enabled is missing or different
...
try {
    ...
    Write-Output 'Not compliant. Ensure OneDrive Silent Account Config Enabled could not be validated.'
    exit 1
}
