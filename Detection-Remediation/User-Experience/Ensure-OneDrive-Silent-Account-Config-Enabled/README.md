# Ensure OneDrive Silent Account Config Enabled

## Summary

Detects and remediates OneDrive policy that silently configures the sync client for signed-in Windows users.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-OneDrive-Silent-Account-Config-Enabled`.
