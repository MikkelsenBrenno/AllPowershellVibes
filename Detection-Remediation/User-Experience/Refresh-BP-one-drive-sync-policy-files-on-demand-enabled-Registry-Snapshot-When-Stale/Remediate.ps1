<#
.SYNOPSIS
    Refreshes the OneDrive Sync Policy FilesOnDemandEnabled Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-one-drive-sync-policy-files-on-demand-enabled-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPonedrivesyncfilesondemandenabledRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'OneDrive Sync Policy FilesOnDemandEnabled registry policy snapshot for technician troubleshooting.'
