<#
.SYNOPSIS
    Refreshes the Windows Cloud Content Policy DisableSoftLanding Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-cloud-content-policy-disable-soft-landing-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcloudcontentdisablesoftlandingRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Cloud Content Policy DisableSoftLanding registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent'; Name = 'DisableSoftLanding'; Description = 'Tips and soft landing state' }
)
