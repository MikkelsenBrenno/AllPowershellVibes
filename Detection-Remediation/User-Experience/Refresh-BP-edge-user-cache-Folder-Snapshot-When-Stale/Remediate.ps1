<#
.SYNOPSIS
    Refreshes the Microsoft Edge User Cache Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-edge-user-cache-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPedgeusercacheFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft Edge User Cache folder size snapshot for technician troubleshooting.'
