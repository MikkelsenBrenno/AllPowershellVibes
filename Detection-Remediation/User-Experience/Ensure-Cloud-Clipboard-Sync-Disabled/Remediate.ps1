<#
.SYNOPSIS
    Remediates Ensure Cloud Clipboard Sync Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Cloud Clipboard Sync Disabled remediation succeeded
    Exit 1:      Ensure Cloud Clipboard Sync Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Cloud Clipboard Sync Disabled.'
    exit 1
}
