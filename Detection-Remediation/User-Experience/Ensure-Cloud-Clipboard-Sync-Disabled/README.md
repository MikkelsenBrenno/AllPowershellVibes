...
Detects and remediates cross-device clipboard sync policy on managed Windows endpoints.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Cloud-Clipboard-Sync-Disabled`.
