<#
.SYNOPSIS
    Remediates Ensure Search Highlights Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Search Highlights Disabled remediation succeeded
    Exit 1:      Ensure Search Highlights Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Search Highlights Disabled.'
    exit 1
}
