...
Detects and remediates Windows Search dynamic content policy so search highlights are disabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Search-Highlights-Disabled`.
