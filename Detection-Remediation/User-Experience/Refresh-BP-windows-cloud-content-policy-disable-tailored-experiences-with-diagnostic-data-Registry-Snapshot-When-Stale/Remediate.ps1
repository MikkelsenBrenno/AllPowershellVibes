<#
.SYNOPSIS
    Refreshes the Windows Cloud Content Policy DisableTailoredExperiencesWithDiagnosticData Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-cloud-content-policy-disable-tailored-experiences-with-diagnostic-data-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcloudcontentdisabletailoredexperienceswithdiagnosticdataRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Cloud Content Policy DisableTailoredExperiencesWithDiagnosticData registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent'; Name = 'DisableTailoredExperiencesWithDiagnosticData'; Description = 'Tailored experience state' }
)
