# Windows Cloud Content Policy DisableTailoredExperiencesWithDiagnosticData Registry

## Summary

Refreshes a local Windows Cloud Content Policy DisableTailoredExperiencesWithDiagnosticData registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPcloudcontentdisabletailoredexperienceswithdiagnosticdataRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-windows-cloud-content-policy-disable-tailored-experiences-with-diagnostic-data-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-windows-cloud-content-policy-disable-tailored-experiences-with-diagnostic-data-Registry-Snapshot-When-Stale`.
