<#
.SYNOPSIS
    Refreshes the Windows Cloud Content Policy ConfigureWindowsSpotlight Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-cloud-content-policy-configure-windows-spotlight-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcloudcontentconfigurewindowsspotlightRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Cloud Content Policy ConfigureWindowsSpotlight registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent'; Name = 'ConfigureWindowsSpotlight'; Description = 'Spotlight configuration' }
)
