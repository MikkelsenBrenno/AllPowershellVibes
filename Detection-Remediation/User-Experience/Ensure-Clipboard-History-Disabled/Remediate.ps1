<#
.SYNOPSIS
    Remediates Ensure Clipboard History Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Clipboard History Disabled remediation succeeded
    Exit 1:      Ensure Clipboard History Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Clipboard History Disabled.'
    exit 1
}
