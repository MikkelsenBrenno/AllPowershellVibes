...
Detects and remediates Windows clipboard history policy on shared or privacy-sensitive business endpoints.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Clipboard-History-Disabled`.
