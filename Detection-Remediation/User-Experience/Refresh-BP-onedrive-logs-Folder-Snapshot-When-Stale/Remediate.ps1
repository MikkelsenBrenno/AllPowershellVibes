<#
.SYNOPSIS
    Refreshes the OneDrive Logs Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-onedrive-logs-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPonedrivelogsFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'OneDrive Logs folder size snapshot for technician troubleshooting.'
