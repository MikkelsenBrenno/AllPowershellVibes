<#
.SYNOPSIS
    Remediates Ensure Windows Consumer Features Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Windows Consumer Features Disabled remediation succeeded
    Exit 1:      Ensure Windows Consumer Features Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Windows Consumer Features Disabled.'
    exit 1
}
