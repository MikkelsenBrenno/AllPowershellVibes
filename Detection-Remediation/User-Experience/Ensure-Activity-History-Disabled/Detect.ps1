<#
.SYNOPSIS
    Detects Ensure Activity History Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Activity History Disabled is compliant
    Exit 1:      Ensure Activity History Disabled is missing or different
...
$ScriptPackageName = 'Ensure-Activity-History-Disabled'
$ScriptName = 'Detect'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\System'; Name = 'PublishUserActivities'; Type = 'DWord'; Value = 0; Description = 'Disable Activity History publishing' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\System'; Name = 'UploadUserActivities'; Type = 'DWord'; Value = 0; Description = 'Disable Activity History upload' }
)
...
try {
    ...
    Write-Output 'Not compliant. Ensure Activity History Disabled could not be validated.'
    exit 1
}
