...
Detects and remediates Activity History publishing and upload policies on managed business devices.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Activity-History-Disabled`.
