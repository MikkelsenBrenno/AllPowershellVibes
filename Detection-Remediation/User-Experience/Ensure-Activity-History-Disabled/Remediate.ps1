<#
.SYNOPSIS
    Remediates Ensure Activity History Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Activity History Disabled remediation succeeded
    Exit 1:      Ensure Activity History Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Activity History Disabled.'
    exit 1
}
