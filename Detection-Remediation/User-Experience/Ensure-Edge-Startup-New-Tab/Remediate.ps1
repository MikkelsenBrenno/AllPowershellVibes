<#
.SYNOPSIS
    Remediates Ensure Edge Opens A New Tab At Startup.
...
$ScriptPackageName = 'Ensure-Edge-Startup-New-Tab'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'RestoreOnStartup'; Type = 'DWord'; Value = 5; Description = 'Open a new tab when Edge starts' }
)
