...
Detects and remediates Windows soft landing and tips policy so managed devices show fewer consumer prompts.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Windows-Tips-Disabled`.
