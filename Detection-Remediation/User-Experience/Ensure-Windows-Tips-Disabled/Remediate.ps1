<#
.SYNOPSIS
    Remediates Ensure Windows Tips Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Windows Tips Disabled remediation succeeded
    Exit 1:      Ensure Windows Tips Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Windows Tips Disabled.'
    exit 1
}
