...
Detects and remediates GameDVR policy so capture features are disabled on managed business endpoints.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-GameDVR-Disabled`.
