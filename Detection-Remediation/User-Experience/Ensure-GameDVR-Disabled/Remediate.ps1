<#
.SYNOPSIS
    Remediates Ensure GameDVR Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure GameDVR Disabled remediation succeeded
    Exit 1:      Ensure GameDVR Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure GameDVR Disabled.'
    exit 1
}
