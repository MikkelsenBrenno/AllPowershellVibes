<#
.SYNOPSIS
    Remediates Ensure Start Menu Web Search Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Start Menu Web Search Disabled remediation succeeded
    Exit 1:      Ensure Start Menu Web Search Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Start Menu Web Search Disabled.'
    exit 1
}
