...
Detects and remediates Explorer policy that disables web search suggestions in the Windows search box.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Start-Menu-Web-Search-Disabled`.
