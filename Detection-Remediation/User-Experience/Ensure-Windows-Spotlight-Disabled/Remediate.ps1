<#
.SYNOPSIS
    Remediates Ensure Windows Spotlight Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Windows Spotlight Disabled remediation succeeded
    Exit 1:      Ensure Windows Spotlight Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Windows Spotlight Disabled.'
    exit 1
}
