...
Detects and remediates Windows Spotlight feature policy for a quieter managed endpoint experience.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Windows-Spotlight-Disabled`.
