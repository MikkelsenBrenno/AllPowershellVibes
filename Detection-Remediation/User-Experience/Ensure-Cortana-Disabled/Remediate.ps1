<#
.SYNOPSIS
    Remediates Ensure Cortana Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Cortana Disabled remediation succeeded
    Exit 1:      Ensure Cortana Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Cortana Disabled.'
    exit 1
}
