...
Detects and remediates Windows Search policy so Cortana is disabled on managed business endpoints.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Cortana-Disabled`.
