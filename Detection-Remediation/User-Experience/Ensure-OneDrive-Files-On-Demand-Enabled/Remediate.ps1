<#
.SYNOPSIS
    Remediates Ensure OneDrive Files On Demand Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure OneDrive Files On Demand Enabled remediation succeeded
    Exit 1:      Ensure OneDrive Files On Demand Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure OneDrive Files On Demand Enabled.'
    exit 1
}
