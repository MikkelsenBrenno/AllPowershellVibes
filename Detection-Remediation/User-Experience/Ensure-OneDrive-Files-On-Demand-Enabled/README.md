...
Detects and remediates OneDrive policy that enables Files On-Demand for managed Business Premium devices.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-OneDrive-Files-On-Demand-Enabled`.
