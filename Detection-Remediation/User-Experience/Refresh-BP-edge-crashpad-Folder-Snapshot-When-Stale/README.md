# Microsoft Edge Crashpad Folder

## Summary

Refreshes a local Microsoft Edge Crashpad folder usage troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPedgecrashpadFolderSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-edge-crashpad-Folder-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-edge-crashpad-Folder-Snapshot-When-Stale`.
