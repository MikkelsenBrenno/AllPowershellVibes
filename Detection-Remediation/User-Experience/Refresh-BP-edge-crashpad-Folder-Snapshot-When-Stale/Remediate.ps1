<#
.SYNOPSIS
    Refreshes the Microsoft Edge Crashpad Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-edge-crashpad-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPedgecrashpadFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft Edge Crashpad folder size snapshot for technician troubleshooting.'
