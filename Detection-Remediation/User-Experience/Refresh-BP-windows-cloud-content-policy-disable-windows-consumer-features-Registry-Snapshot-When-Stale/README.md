# Windows Cloud Content Policy DisableWindowsConsumerFeatures Registry

## Summary

Refreshes a local Windows Cloud Content Policy DisableWindowsConsumerFeatures registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPcloudcontentdisablewindowsconsumerfeaturesRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-windows-cloud-content-policy-disable-windows-consumer-features-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-windows-cloud-content-policy-disable-windows-consumer-features-Registry-Snapshot-When-Stale`.
