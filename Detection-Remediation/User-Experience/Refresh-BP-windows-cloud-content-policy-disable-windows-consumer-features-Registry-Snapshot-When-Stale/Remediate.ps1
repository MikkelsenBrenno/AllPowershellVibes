<#
.SYNOPSIS
    Refreshes the Windows Cloud Content Policy DisableWindowsConsumerFeatures Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-cloud-content-policy-disable-windows-consumer-features-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcloudcontentdisablewindowsconsumerfeaturesRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Cloud Content Policy DisableWindowsConsumerFeatures registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent'; Name = 'DisableWindowsConsumerFeatures'; Description = 'Consumer feature state' }
)
