<#
.SYNOPSIS
    Refreshes the User Profile Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-user-profile-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPuserprofileeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'User Profile Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Application'
$RecentEventCount = 80
$EventIdsToHighlight = @(1500, 1502, 1505, 1511, 1530)
