<#
.SYNOPSIS
    Refreshes the Windows Cloud Content Policy DisableWindowsSpotlightFeatures Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-cloud-content-policy-disable-windows-spotlight-features-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcloudcontentdisablewindowsspotlightfeaturesRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Cloud Content Policy DisableWindowsSpotlightFeatures registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\CloudContent'; Name = 'DisableWindowsSpotlightFeatures'; Description = 'Spotlight feature state' }
)
