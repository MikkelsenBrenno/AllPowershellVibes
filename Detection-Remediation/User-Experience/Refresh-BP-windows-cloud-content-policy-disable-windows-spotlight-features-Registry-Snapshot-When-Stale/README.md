# Windows Cloud Content Policy DisableWindowsSpotlightFeatures Registry

## Summary

Refreshes a local Windows Cloud Content Policy DisableWindowsSpotlightFeatures registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPcloudcontentdisablewindowsspotlightfeaturesRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-windows-cloud-content-policy-disable-windows-spotlight-features-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-windows-cloud-content-policy-disable-windows-spotlight-features-Registry-Snapshot-When-Stale`.
