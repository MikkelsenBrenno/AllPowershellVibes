# Ensure Windows Copilot Disabled Template

## Summary

Template remediation that detects and disables Windows Copilot policy where organizations have not approved Copilot use.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Windows-Copilot-Disabled-Template`.
