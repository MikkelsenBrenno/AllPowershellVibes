<#
.SYNOPSIS
    Remediates Ensure Windows Copilot Disabled Template.
...
.INTUNE
    ...
    Exit 0:      Ensure Windows Copilot Disabled Template remediation succeeded
    Exit 1:      Ensure Windows Copilot Disabled Template remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Windows Copilot Disabled Template.'
    exit 1
}
