<#
.SYNOPSIS
    Remediates Ensure Recall Snapshots Disabled.
...
$ScriptPackageName = 'Ensure-Recall-Snapshots-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsAI'; Name = 'DisableAIDataAnalysis'; Type = 'DWord'; Value = 1; Description = 'Disable saving snapshots for Recall' }
)
