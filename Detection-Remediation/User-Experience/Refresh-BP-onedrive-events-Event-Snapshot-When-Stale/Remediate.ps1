<#
.SYNOPSIS
    Refreshes the OneDrive Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-onedrive-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPonedriveeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'OneDrive Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Application'
$RecentEventCount = 80
$EventIdsToHighlight = @(1000, 1001, 1002)
