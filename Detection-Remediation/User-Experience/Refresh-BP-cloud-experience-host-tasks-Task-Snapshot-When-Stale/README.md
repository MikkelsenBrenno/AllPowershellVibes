# Cloud Experience Host Tasks Task

## Summary

Refreshes a local Cloud Experience Host Tasks scheduled task troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPcloudexperiencehosttasksTaskSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-cloud-experience-host-tasks-Task-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-cloud-experience-host-tasks-Task-Snapshot-When-Stale`.
