<#
.SYNOPSIS
    Refreshes the Themes Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-themes-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPthemesServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Themes service state snapshot for technician troubleshooting.'
