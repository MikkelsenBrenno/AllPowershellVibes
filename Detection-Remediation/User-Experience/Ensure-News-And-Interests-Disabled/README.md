...
Detects and remediates policy that disables News and Interests or Widgets surfaces on managed Windows endpoints.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-News-And-Interests-Disabled`.
