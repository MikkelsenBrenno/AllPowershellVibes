<#
.SYNOPSIS
    Remediates Ensure News And Interests Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure News And Interests Disabled remediation succeeded
    Exit 1:      Ensure News And Interests Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure News And Interests Disabled.'
    exit 1
}
