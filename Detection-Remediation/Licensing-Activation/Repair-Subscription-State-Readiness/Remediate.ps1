<#
.SYNOPSIS
    Remediates Subscription State state.

.DESCRIPTION
    Writes configurable state evidence for Subscription State remediation.
...
.INTUNE
    ...
    Exit 0:      Subscription State remediation completed
    Exit 1:      Subscription State remediation did not complete
...
$ScriptPackageName = 'Repair-Subscription-State-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Subscription State'
...
$MarkerFileName = 'repair-subscription-state-readiness.state'
$EvidenceFileName = 'repair-subscription-state-readiness.json'
