<#
.SYNOPSIS
    Detects Subscription State state.

.DESCRIPTION
    Detects Subscription State state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Subscription State is compliant
    Exit 1:      Subscription State is noncompliant
