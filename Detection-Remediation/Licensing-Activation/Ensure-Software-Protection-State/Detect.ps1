<#
.SYNOPSIS
    Detects Software Protection state.

.DESCRIPTION
    Detects Software Protection state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Software Protection is compliant
    Exit 1:      Software Protection is noncompliant
