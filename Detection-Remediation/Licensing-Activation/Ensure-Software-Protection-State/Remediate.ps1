<#
.SYNOPSIS
    Remediates Software Protection state.

.DESCRIPTION
    Writes configurable state evidence for Software Protection remediation.
...
.INTUNE
    ...
    Exit 0:      Software Protection remediation completed
    Exit 1:      Software Protection remediation did not complete
...
$ScriptPackageName = 'Ensure-Software-Protection-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Software Protection'
...
$MarkerFileName = 'ensure-software-protection-state.state'
$EvidenceFileName = 'ensure-software-protection-state.json'
