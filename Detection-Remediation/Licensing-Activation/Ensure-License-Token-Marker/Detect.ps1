<#
.SYNOPSIS
    Detects License Token state.

.DESCRIPTION
    Detects License Token state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      License Token is compliant
    Exit 1:      License Token is noncompliant
