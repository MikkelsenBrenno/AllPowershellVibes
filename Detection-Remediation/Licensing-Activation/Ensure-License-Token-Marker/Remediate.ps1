<#
.SYNOPSIS
    Remediates License Token state.

.DESCRIPTION
    Writes configurable state evidence for License Token remediation.
...
.INTUNE
    ...
    Exit 0:      License Token remediation completed
    Exit 1:      License Token remediation did not complete
...
$ScriptPackageName = 'Ensure-License-Token-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'License Token'
...
$MarkerFileName = 'ensure-license-token-marker.state'
$EvidenceFileName = 'ensure-license-token-marker.json'
