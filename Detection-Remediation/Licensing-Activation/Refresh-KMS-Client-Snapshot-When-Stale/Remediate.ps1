<#
.SYNOPSIS
    Remediates KMS Client state.

.DESCRIPTION
    Writes configurable state evidence for KMS Client remediation.
...
.INTUNE
    ...
    Exit 0:      KMS Client remediation completed
    Exit 1:      KMS Client remediation did not complete
...
$ScriptPackageName = 'Refresh-KMS-Client-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'KMS Client'
...
$MarkerFileName = 'refresh-kms-client-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-kms-client-snapshot-when-stale.json'
