<#
.SYNOPSIS
    Remediates Licensing Service state.

.DESCRIPTION
    Writes configurable state evidence for Licensing Service remediation.
...
.INTUNE
    ...
    Exit 0:      Licensing Service remediation completed
    Exit 1:      Licensing Service remediation did not complete
...
$ScriptPackageName = 'Ensure-Licensing-Service-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Licensing Service'
...
$MarkerFileName = 'ensure-licensing-service-marker.state'
$EvidenceFileName = 'ensure-licensing-service-marker.json'
