<#
.SYNOPSIS
    Detects Licensing Service state.

.DESCRIPTION
    Detects Licensing Service state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Licensing Service is compliant
    Exit 1:      Licensing Service is noncompliant
