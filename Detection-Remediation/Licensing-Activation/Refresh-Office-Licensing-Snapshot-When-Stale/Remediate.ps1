<#
.SYNOPSIS
    Remediates Office Licensing state.

.DESCRIPTION
    Writes configurable state evidence for Office Licensing remediation.
...
.INTUNE
    ...
    Exit 0:      Office Licensing remediation completed
    Exit 1:      Office Licensing remediation did not complete
...
$ScriptPackageName = 'Refresh-Office-Licensing-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Office Licensing'
$PurposeCategory = 'Licensing-Activation'
$ManagedStateRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Licensing-Activation'
$MarkerFileName = 'refresh-office-licensing-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-office-licensing-snapshot-when-stale.json'
