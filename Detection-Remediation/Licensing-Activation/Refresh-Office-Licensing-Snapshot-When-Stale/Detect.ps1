<#
.SYNOPSIS
    Detects Office Licensing state.

.DESCRIPTION
    Detects Office Licensing state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Office Licensing is compliant
    Exit 1:      Office Licensing is noncompliant
