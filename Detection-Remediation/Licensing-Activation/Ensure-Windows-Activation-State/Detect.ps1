<#
.SYNOPSIS
    Detects Windows Activation state.

.DESCRIPTION
    Detects Windows Activation state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Windows Activation is compliant
    Exit 1:      Windows Activation is noncompliant
