<#
.SYNOPSIS
    Remediates Windows Activation state.

.DESCRIPTION
    Writes configurable state evidence for Windows Activation remediation.
...
.INTUNE
    ...
    Exit 0:      Windows Activation remediation completed
    Exit 1:      Windows Activation remediation did not complete
...
$ScriptPackageName = 'Ensure-Windows-Activation-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Windows Activation'
...
$MarkerFileName = 'ensure-windows-activation-state.state'
$EvidenceFileName = 'ensure-windows-activation-state.json'
