<#
.SYNOPSIS
    Detects Activation Events state.

.DESCRIPTION
    Detects Activation Events state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Activation Events is compliant
    Exit 1:      Activation Events is noncompliant
