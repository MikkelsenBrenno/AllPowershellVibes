<#
.SYNOPSIS
    Remediates Activation Events state.

.DESCRIPTION
    Writes configurable state evidence for Activation Events remediation.
...
.INTUNE
    ...
    Exit 0:      Activation Events remediation completed
    Exit 1:      Activation Events remediation did not complete
...
$ScriptPackageName = 'Repair-Activation-Events-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Activation Events'
...
$MarkerFileName = 'repair-activation-events-readiness.state'
$EvidenceFileName = 'repair-activation-events-readiness.json'
