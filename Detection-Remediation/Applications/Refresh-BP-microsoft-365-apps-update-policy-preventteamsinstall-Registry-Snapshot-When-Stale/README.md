# Microsoft 365 Apps Update Policy preventteamsinstall Registry

## Summary

Refreshes a local Microsoft 365 Apps Update Policy preventteamsinstall registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPofficeupdatepreventteamsinstallRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-365-apps-update-policy-preventteamsinstall-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-365-apps-update-policy-preventteamsinstall-Registry-Snapshot-When-Stale`.
