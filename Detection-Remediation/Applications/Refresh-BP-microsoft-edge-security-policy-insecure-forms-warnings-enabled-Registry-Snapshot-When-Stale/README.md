# Microsoft Edge Security Policy InsecureFormsWarningsEnabled Registry

## Summary

Refreshes a local Microsoft Edge Security Policy InsecureFormsWarningsEnabled registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPedgesecurityinsecureformswarningsenabledRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-security-policy-insecure-forms-warnings-enabled-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-security-policy-insecure-forms-warnings-enabled-Registry-Snapshot-When-Stale`.
