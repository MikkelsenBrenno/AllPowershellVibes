<#
.SYNOPSIS
    Remediates Office Install State state.

.DESCRIPTION
    Detects and remediates Office Install State state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Office Install State remediation completed
    Exit 1:      Office Install State remediation failed
...
$ScriptPackageName = 'Ensure-Office-Install-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Office Install State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Applications'
$MarkerFileName = 'office-install-state.state'
