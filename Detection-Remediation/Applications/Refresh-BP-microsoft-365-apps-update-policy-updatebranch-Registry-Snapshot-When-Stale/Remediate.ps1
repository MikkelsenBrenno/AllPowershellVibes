<#
.SYNOPSIS
    Refreshes the Microsoft 365 Apps Update Policy updatebranch Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-microsoft-365-apps-update-policy-updatebranch-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficeupdateupdatebranchRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft 365 Apps Update Policy updatebranch registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\common\officeupdate'; Name = 'updatebranch'; Description = 'Update channel' }
)
