# Microsoft Edge Security Policy RendererAppContainerEnabled Registry

## Summary

Refreshes a local Microsoft Edge Security Policy RendererAppContainerEnabled registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPedgesecurityrendererappcontainerenabledRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-security-policy-renderer-app-container-enabled-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-security-policy-renderer-app-container-enabled-Registry-Snapshot-When-Stale`.
