<#
.SYNOPSIS
    Starts Microsoft Store Install Service.
...
.INTUNE
    ...
    Exit 0:      Microsoft Store Install Service remediation succeeded
    Exit 1:      Microsoft Store Install Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Microsoft Store Install Service.'
    exit 1
}
