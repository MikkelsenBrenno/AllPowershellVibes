# Ensure Microsoft Store Install Service Running

## Summary

Detects and remediates devices where the Microsoft Store Install Service is stopped, which can block Store and Company Portal app install flows.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Microsoft-Store-Install-Service-Running`.
