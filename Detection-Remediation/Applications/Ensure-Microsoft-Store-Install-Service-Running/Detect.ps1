<#
.SYNOPSIS
    Detects whether Microsoft Store Install Service is running.
...
.INTUNE
    ...
    Exit 0:      Microsoft Store Install Service is running
    Exit 1:      Microsoft Store Install Service is missing or stopped
...
$ScriptPackageName = 'Ensure-Microsoft-Store-Install-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. Microsoft Store Install Service could not be validated.'
    exit 1
}
