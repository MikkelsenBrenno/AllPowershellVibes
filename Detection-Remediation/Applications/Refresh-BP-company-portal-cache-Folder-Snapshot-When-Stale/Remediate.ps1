<#
.SYNOPSIS
    Refreshes the Company Portal Cache Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-company-portal-cache-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcompanyportalcacheFolderSnapshot.json'
