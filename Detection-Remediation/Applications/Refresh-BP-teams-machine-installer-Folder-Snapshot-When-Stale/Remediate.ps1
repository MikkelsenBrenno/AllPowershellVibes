<#
.SYNOPSIS
    Refreshes the Teams Machine Installer Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-teams-machine-installer-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPteamsmachineinstallerFolderSnapshot.json'
