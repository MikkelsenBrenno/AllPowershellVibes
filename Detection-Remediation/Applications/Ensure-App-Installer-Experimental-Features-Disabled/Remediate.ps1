<#
.SYNOPSIS
    Remediates Ensure App Installer Experimental Features Disabled.
...
$ScriptPackageName = 'Ensure-App-Installer-Experimental-Features-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppInstaller'; Name = 'EnableExperimentalFeatures'; Type = 'DWord'; Value = 0; Description = 'Disable App Installer experimental features' }
)
