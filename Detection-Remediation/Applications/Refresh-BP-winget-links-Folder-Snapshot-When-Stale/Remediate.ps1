<#
.SYNOPSIS
    Refreshes the WinGet Links Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-winget-links-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwingetlinksFolderSnapshot.json'
