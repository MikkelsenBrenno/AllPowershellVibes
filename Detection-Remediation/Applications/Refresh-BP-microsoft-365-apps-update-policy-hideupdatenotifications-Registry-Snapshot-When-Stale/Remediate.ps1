<#
.SYNOPSIS
    Refreshes the Microsoft 365 Apps Update Policy hideupdatenotifications Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-microsoft-365-apps-update-policy-hideupdatenotifications-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficeupdatehideupdatenotificationsRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft 365 Apps Update Policy hideupdatenotifications registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\common\officeupdate'; Name = 'hideupdatenotifications'; Description = 'Update notification visibility' }
)
