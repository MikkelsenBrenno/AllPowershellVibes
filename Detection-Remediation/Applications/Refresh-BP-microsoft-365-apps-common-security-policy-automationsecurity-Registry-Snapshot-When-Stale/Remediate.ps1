<#
.SYNOPSIS
    Refreshes the Microsoft 365 Apps Common Security Policy automationsecurity Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-microsoft-365-apps-common-security-policy-automationsecurity-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficecommonsecurityautomationsecurityRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft 365 Apps Common Security Policy automationsecurity registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\common\security'; Name = 'automationsecurity'; Description = 'Office automation security' }
)
