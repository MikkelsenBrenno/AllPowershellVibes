<#
.SYNOPSIS
    Refreshes the AppX Deployment Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-appx-deployment-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPappxdeploymenteventsEventSnapshot.json'
