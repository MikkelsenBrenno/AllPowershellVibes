<#
.SYNOPSIS
    Refreshes the Office Update Cache Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-office-update-cache-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficeupdatecacheFolderSnapshot.json'
