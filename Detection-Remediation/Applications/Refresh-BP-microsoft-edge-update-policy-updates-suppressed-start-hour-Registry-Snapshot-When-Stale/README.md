# Microsoft Edge Update Policy UpdatesSuppressedStartHour Registry

## Summary

Refreshes a local Microsoft Edge Update Policy UpdatesSuppressedStartHour registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPedgeupdateupdatessuppressedstarthourRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-update-policy-updates-suppressed-start-hour-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-update-policy-updates-suppressed-start-hour-Registry-Snapshot-When-Stale`.
