<#
.SYNOPSIS
    Refreshes the Application Information Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-application-information-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPapplicationinformationServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Application Information service state snapshot for technician troubleshooting.'

$ServiceNames = @('Appinfo')
