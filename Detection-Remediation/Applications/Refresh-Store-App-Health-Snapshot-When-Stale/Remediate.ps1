<#
.SYNOPSIS
    Refreshes the Store App Health Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-Store-App-Health-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'StoreAppHealthSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Store and AppX service snapshot.'
