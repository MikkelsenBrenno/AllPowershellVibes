# Store App Health Snapshot

## Summary

Refreshes a local Microsoft Store and AppX service snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `StoreAppHealthSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Store-App-Health-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Store-App-Health-Snapshot-When-Stale`.
