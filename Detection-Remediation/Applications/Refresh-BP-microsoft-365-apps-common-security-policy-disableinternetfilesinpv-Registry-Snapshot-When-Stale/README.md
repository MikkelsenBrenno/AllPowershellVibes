# Microsoft 365 Apps Common Security Policy disableinternetfilesinpv Registry

## Summary

Refreshes a local Microsoft 365 Apps Common Security Policy disableinternetfilesinpv registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPofficecommonsecuritydisableinternetfilesinpvRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-365-apps-common-security-policy-disableinternetfilesinpv-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-365-apps-common-security-policy-disableinternetfilesinpv-Registry-Snapshot-When-Stale`.
