<#
.SYNOPSIS
    Refreshes the Microsoft 365 Apps Common Security Policy disableinternetfilesinpv Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-microsoft-365-apps-common-security-policy-disableinternetfilesinpv-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficecommonsecuritydisableinternetfilesinpvRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft 365 Apps Common Security Policy disableinternetfilesinpv registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\common\security'; Name = 'disableinternetfilesinpv'; Description = 'Protected View internet file state' }
)
