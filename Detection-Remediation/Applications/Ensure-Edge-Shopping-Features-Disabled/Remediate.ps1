<#
.SYNOPSIS
    Remediates Ensure Edge Shopping Features Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Edge Shopping Features Disabled remediation succeeded
    Exit 1:      Ensure Edge Shopping Features Disabled remediation failed
...
$ScriptPackageName = 'Ensure-Edge-Shopping-Features-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'EdgeShoppingAssistantEnabled'; Type = 'DWord'; Value = 0; Description = 'Disable Microsoft Edge shopping assistant features' }
)
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Edge Shopping Features Disabled.'
    exit 1
}
