<#
.SYNOPSIS
    Detects Ensure Edge Shopping Features Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Edge Shopping Features Disabled is compliant
    Exit 1:      Ensure Edge Shopping Features Disabled is missing or different
