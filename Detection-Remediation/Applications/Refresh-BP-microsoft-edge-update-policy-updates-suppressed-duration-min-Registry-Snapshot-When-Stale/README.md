# Microsoft Edge Update Policy UpdatesSuppressedDurationMin Registry

## Summary

Refreshes a local Microsoft Edge Update Policy UpdatesSuppressedDurationMin registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPedgeupdateupdatessuppresseddurationminRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-update-policy-updates-suppressed-duration-min-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-update-policy-updates-suppressed-duration-min-Registry-Snapshot-When-Stale`.
