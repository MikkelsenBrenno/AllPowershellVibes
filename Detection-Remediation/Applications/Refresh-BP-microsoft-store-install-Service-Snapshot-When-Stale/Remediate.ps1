<#
.SYNOPSIS
    Refreshes the Microsoft Store Install Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-microsoft-store-install-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPmicrosoftstoreinstallServiceSnapshot.json'
