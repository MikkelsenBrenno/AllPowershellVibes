<#
.SYNOPSIS
    Refreshes the App Readiness Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-app-readiness-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPappreadinesseventsEventSnapshot.json'
