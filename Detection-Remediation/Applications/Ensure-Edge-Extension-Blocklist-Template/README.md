# Ensure Edge Extension Blocklist Template

## Summary

Template remediation that detects and applies an editable Microsoft Edge extension blocklist.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Edge-Extension-Blocklist-Template`.
