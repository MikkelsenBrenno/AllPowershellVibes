<#
.SYNOPSIS
    Detects Ensure Edge Extension Blocklist Template.
...
.INTUNE
    ...
    Exit 0:      Ensure Edge Extension Blocklist Template is compliant
    Exit 1:      Ensure Edge Extension Blocklist Template is missing or different
...
$ScriptPackageName = 'Ensure-Edge-Extension-Blocklist-Template'
$ScriptName = 'Detect'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge\ExtensionInstallBlocklist'; Name = '1'; Type = 'String'; Value = '*'; Description = 'Block all extensions until an allowlist is added' }
)
...
try {
    ...
    Write-Output 'Not compliant. Ensure Edge Extension Blocklist Template could not be validated.'
    exit 1
}
