<#
.SYNOPSIS
    Remediates Ensure Edge Extension Blocklist Template.
...
.INTUNE
    ...
    Exit 0:      Ensure Edge Extension Blocklist Template remediation succeeded
    Exit 1:      Ensure Edge Extension Blocklist Template remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Edge Extension Blocklist Template.'
    exit 1
}
