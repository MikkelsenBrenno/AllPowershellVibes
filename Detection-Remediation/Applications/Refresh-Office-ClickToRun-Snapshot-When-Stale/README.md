# Office ClickToRun Snapshot

## Summary

Refreshes a local Office Click-to-Run service snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `OfficeClickToRunSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Office-ClickToRun-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Office-ClickToRun-Snapshot-When-Stale`.
