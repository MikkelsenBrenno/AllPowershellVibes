<#
.SYNOPSIS
    Refreshes the Office ClickToRun Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-Office-ClickToRun-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'OfficeClickToRunSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Office Click-to-Run service snapshot.'
