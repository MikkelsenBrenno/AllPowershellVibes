<#
.SYNOPSIS
    Refreshes the Microsoft Store Cache Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-store-cache-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPstorecacheFolderSnapshot.json'
