<#
.SYNOPSIS
    Remediates Ensure App Installer Default Source Enabled.
...
$ScriptPackageName = 'Ensure-App-Installer-Default-Source-Enabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\AppInstaller'; Name = 'EnableDefaultSource'; Type = 'DWord'; Value = 1; Description = 'Enable the App Installer default Microsoft community source' }
)
