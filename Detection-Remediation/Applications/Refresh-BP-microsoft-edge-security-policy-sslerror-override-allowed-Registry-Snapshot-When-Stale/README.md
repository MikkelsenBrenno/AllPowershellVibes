# Microsoft Edge Security Policy SSLErrorOverrideAllowed Registry

## Summary

Refreshes a local Microsoft Edge Security Policy SSLErrorOverrideAllowed registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPedgesecuritysslerroroverrideallowedRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-security-policy-sslerror-override-allowed-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-security-policy-sslerror-override-allowed-Registry-Snapshot-When-Stale`.
