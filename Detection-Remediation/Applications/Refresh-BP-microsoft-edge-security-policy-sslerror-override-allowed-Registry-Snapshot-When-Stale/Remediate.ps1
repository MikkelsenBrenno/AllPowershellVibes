<#
.SYNOPSIS
    Refreshes the Microsoft Edge Security Policy SSLErrorOverrideAllowed Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-microsoft-edge-security-policy-sslerror-override-allowed-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPedgesecuritysslerroroverrideallowedRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft Edge Security Policy SSLErrorOverrideAllowed registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'SSLErrorOverrideAllowed'; Description = 'Certificate error override state' }
)
