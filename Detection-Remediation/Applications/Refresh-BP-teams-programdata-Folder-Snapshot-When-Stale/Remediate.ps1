<#
.SYNOPSIS
    Refreshes the Teams ProgramData Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-teams-programdata-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPteamsprogramdataFolderSnapshot.json'
