<#
.SYNOPSIS
    Refreshes the Microsoft 365 Apps Common Security Policy disableallactivex Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-microsoft-365-apps-common-security-policy-disableallactivex-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficecommonsecuritydisableallactivexRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft 365 Apps Common Security Policy disableallactivex registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\common\security'; Name = 'disableallactivex'; Description = 'ActiveX state' }
)
