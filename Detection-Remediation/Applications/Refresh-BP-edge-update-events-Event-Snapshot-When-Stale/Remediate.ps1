<#
.SYNOPSIS
    Refreshes the Edge Update Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-edge-update-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPedgeupdateeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Edge Update Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-WindowsUpdateClient/Operational'
$RecentEventCount = 80
$EventIdsToHighlight = @(19, 20, 25, 31, 43)
