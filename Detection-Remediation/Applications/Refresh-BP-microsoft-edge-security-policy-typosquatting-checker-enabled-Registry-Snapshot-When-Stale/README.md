# Microsoft Edge Security Policy TyposquattingCheckerEnabled Registry

## Summary

Refreshes a local Microsoft Edge Security Policy TyposquattingCheckerEnabled registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPedgesecuritytyposquattingcheckerenabledRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-security-policy-typosquatting-checker-enabled-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-security-policy-typosquatting-checker-enabled-Registry-Snapshot-When-Stale`.
