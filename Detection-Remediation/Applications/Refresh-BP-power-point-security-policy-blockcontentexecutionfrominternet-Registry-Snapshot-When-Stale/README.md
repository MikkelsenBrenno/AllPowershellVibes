# PowerPoint Security Policy blockcontentexecutionfrominternet Registry

## Summary

Refreshes a local PowerPoint Security Policy blockcontentexecutionfrominternet registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPofficepowerpointsecurityblockcontentexecutionfrominternetRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-power-point-security-policy-blockcontentexecutionfrominternet-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-power-point-security-policy-blockcontentexecutionfrominternet-Registry-Snapshot-When-Stale`.
