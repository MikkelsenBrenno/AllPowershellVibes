<#
.SYNOPSIS
    Refreshes the PowerPoint Security Policy blockcontentexecutionfrominternet Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-power-point-security-policy-blockcontentexecutionfrominternet-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficepowerpointsecurityblockcontentexecutionfrominternetRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'PowerPoint Security Policy blockcontentexecutionfrominternet registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\powerpoint\security'; Name = 'blockcontentexecutionfrominternet'; Description = 'Internet content execution block' }
)
