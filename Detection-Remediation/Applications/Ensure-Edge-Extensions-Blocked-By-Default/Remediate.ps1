<#
.SYNOPSIS
    Remediates Ensure Edge Extensions Blocked By Default.
...
$ScriptPackageName = 'Ensure-Edge-Extensions-Blocked-By-Default'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge\ExtensionInstallBlocklist'; Name = '1'; Type = 'String'; Value = '*'; Description = 'Block all Edge extensions by default' }
)
