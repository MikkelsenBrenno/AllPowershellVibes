<#
.SYNOPSIS
    Starts AppX Deployment Service.
...
.INTUNE
    ...
    Exit 0:      AppX Deployment Service remediation succeeded
    Exit 1:      AppX Deployment Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for AppX Deployment Service.'
    exit 1
}
