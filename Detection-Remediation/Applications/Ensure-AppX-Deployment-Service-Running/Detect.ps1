<#
.SYNOPSIS
    Detects whether AppX Deployment Service is running.
...
.INTUNE
    ...
    Exit 0:      AppX Deployment Service is running
    Exit 1:      AppX Deployment Service is missing or stopped
...
$ScriptPackageName = 'Ensure-AppX-Deployment-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. AppX Deployment Service could not be validated.'
    exit 1
}
