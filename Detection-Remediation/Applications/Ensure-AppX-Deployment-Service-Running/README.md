# Ensure AppX Deployment Service Running

## Summary

Detects and remediates devices where the AppX Deployment Service is stopped, helping Store, Company Portal, and packaged app troubleshooting.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-AppX-Deployment-Service-Running`.
