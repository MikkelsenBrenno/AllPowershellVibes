<#
.SYNOPSIS
    Refreshes the Office Click To Run Logs Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-office-click-to-run-logs-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficeclicktorunlogsFolderSnapshot.json'
