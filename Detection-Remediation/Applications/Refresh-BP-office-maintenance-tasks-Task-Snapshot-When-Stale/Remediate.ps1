<#
.SYNOPSIS
    Refreshes the Office Maintenance Tasks Task snapshot.
...
$ScriptPackageName = 'Refresh-BP-office-maintenance-tasks-Task-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficemaintenancetasksTaskSnapshot.json'
$CollectionMode = 'Task'
$JsonDepth = 8
$RegistryItems = @()
$ServiceNames = @()
