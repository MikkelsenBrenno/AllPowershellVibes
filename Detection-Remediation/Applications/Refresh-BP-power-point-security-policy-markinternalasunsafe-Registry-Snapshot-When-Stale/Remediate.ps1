<#
.SYNOPSIS
    Refreshes the PowerPoint Security Policy markinternalasunsafe Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-power-point-security-policy-markinternalasunsafe-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficepowerpointsecuritymarkinternalasunsafeRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'PowerPoint Security Policy markinternalasunsafe registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\powerpoint\security'; Name = 'markinternalasunsafe'; Description = 'Internal location trust state' }
)
