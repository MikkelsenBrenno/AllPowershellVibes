<#
.SYNOPSIS
    Remediates Ensure Microsoft 365 Apps Monthly Enterprise Channel.
...
$ScriptPackageName = 'Ensure-Microsoft-365-Apps-Monthly-Enterprise-Channel'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Office\16.0\Common\OfficeUpdate'; Name = 'UpdateBranch'; Type = 'String'; Value = 'MonthlyEnterprise'; Description = 'Assign Monthly Enterprise Channel' }
)
