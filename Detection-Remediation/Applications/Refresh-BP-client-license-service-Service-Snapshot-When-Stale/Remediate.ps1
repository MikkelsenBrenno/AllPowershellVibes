<#
.SYNOPSIS
    Refreshes the Client License Service Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-client-license-service-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPclientlicenseserviceServiceSnapshot.json'
