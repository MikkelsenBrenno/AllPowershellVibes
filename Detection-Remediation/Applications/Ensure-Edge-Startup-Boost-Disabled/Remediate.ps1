<#
.SYNOPSIS
    Remediates Ensure Edge Startup Boost Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Edge Startup Boost Disabled remediation succeeded
    Exit 1:      Ensure Edge Startup Boost Disabled remediation failed
...
$ScriptPackageName = 'Ensure-Edge-Startup-Boost-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'StartupBoostEnabled'; Type = 'DWord'; Value = 0; Description = 'Disable Microsoft Edge Startup Boost' }
)
