<#
.SYNOPSIS
    Detects Ensure Edge Startup Boost Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Edge Startup Boost Disabled is compliant
    Exit 1:      Ensure Edge Startup Boost Disabled is missing or different
