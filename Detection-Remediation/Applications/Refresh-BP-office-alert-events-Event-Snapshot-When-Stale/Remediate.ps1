<#
.SYNOPSIS
    Refreshes the Office Alert Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-office-alert-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficealerteventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Office Alert Events event log snapshot for technician troubleshooting.'

$EventLogName = 'OAlerts'
$RecentEventCount = 80
$EventIdsToHighlight = @(300, 301, 302)
