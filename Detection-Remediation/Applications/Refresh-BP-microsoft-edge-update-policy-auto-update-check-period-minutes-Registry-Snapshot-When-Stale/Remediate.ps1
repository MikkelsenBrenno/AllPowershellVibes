<#
.SYNOPSIS
    Refreshes the Microsoft Edge Update Policy AutoUpdateCheckPeriodMinutes Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-microsoft-edge-update-policy-auto-update-check-period-minutes-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPedgeupdateautoupdatecheckperiodminutesRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft Edge Update Policy AutoUpdateCheckPeriodMinutes registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\EdgeUpdate'; Name = 'AutoUpdateCheckPeriodMinutes'; Description = 'Update check interval' }
)
