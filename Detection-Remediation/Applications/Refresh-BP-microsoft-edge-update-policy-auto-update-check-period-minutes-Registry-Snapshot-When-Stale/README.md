# Microsoft Edge Update Policy AutoUpdateCheckPeriodMinutes Registry

## Summary

Refreshes a local Microsoft Edge Update Policy AutoUpdateCheckPeriodMinutes registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPedgeupdateautoupdatecheckperiodminutesRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-update-policy-auto-update-check-period-minutes-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-update-policy-auto-update-check-period-minutes-Registry-Snapshot-When-Stale`.
