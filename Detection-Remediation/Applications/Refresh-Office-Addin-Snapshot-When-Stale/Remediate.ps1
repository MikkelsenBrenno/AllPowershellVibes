<#
.SYNOPSIS
    Refreshes the Office Addin Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-Office-Addin-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'OfficeAddinSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Office add-in registry root snapshot.'

$RegistryItems = @(
    @{ Path = 'HKCU:\Software\Microsoft\Office\Word\Addins'; Name = ''; Description = 'Word add-ins root exists' },
    @{ Path = 'HKCU:\Software\Microsoft\Office\Excel\Addins'; Name = ''; Description = 'Excel add-ins root exists' },
    @{ Path = 'HKCU:\Software\Microsoft\Office\Outlook\Addins'; Name = ''; Description = 'Outlook add-ins root exists' }
)
