<#
.SYNOPSIS
    Refreshes the Microsoft Store Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-store-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPstoreeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft Store Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-Store/Operational'
$RecentEventCount = 80
$EventIdsToHighlight = @(8001, 8003, 8004)
