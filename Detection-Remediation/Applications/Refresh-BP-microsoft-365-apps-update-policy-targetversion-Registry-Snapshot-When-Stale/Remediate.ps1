<#
.SYNOPSIS
    Refreshes the Microsoft 365 Apps Update Policy targetversion Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-microsoft-365-apps-update-policy-targetversion-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficeupdatetargetversionRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft 365 Apps Update Policy targetversion registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\common\officeupdate'; Name = 'targetversion'; Description = 'Target version' }
)
