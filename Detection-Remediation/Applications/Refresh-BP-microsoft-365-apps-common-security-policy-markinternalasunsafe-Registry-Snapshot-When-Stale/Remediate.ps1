<#
.SYNOPSIS
    Refreshes the Microsoft 365 Apps Common Security Policy markinternalasunsafe Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-microsoft-365-apps-common-security-policy-markinternalasunsafe-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficecommonsecuritymarkinternalasunsafeRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft 365 Apps Common Security Policy markinternalasunsafe registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\common\security'; Name = 'markinternalasunsafe'; Description = 'Internal location trust state' }
)
