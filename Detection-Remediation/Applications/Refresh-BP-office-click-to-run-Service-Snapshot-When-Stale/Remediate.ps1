<#
.SYNOPSIS
    Refreshes the Office Click To Run Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-office-click-to-run-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficeclicktorunServiceSnapshot.json'
