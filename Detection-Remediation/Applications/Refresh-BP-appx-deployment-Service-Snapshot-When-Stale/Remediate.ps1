<#
.SYNOPSIS
    Refreshes the AppX Deployment Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-appx-deployment-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPappxdeploymentServiceSnapshot.json'
