<#
.SYNOPSIS
    Refreshes the PowerPoint Security Policy extensionhardening Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-power-point-security-policy-extensionhardening-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPofficepowerpointsecurityextensionhardeningRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'PowerPoint Security Policy extensionhardening registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\powerpoint\security'; Name = 'extensionhardening'; Description = 'Extension hardening state' }
)
