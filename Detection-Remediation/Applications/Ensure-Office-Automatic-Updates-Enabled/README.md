# Ensure Office Automatic Updates Enabled

## Summary

Detects and remediates Microsoft 365 Apps policy that keeps Office automatic updates enabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Office-Automatic-Updates-Enabled`.
