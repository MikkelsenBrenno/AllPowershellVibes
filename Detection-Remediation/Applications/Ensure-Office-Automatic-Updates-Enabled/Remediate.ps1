<#
.SYNOPSIS
    Remediates Ensure Office Automatic Updates Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Office Automatic Updates Enabled remediation succeeded
    Exit 1:      Ensure Office Automatic Updates Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Office Automatic Updates Enabled.'
    exit 1
}
