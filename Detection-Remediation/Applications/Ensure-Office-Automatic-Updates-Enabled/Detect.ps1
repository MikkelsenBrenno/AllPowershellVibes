<#
.SYNOPSIS
    Detects Ensure Office Automatic Updates Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Office Automatic Updates Enabled is compliant
    Exit 1:      Ensure Office Automatic Updates Enabled is missing or different
...
$ScriptPackageName = 'Ensure-Office-Automatic-Updates-Enabled'
$ScriptName = 'Detect'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\common\officeupdate'; Name = 'enableautomaticupdates'; Type = 'DWord'; Value = 1; Description = 'Enable Microsoft 365 Apps automatic updates' }
)
...
try {
    ...
    Write-Output 'Not compliant. Ensure Office Automatic Updates Enabled could not be validated.'
    exit 1
}
