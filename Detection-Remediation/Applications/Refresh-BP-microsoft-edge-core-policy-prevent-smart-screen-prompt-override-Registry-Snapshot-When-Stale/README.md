# Microsoft Edge Core Policy PreventSmartScreenPromptOverride Registry

## Summary

Refreshes a local Microsoft Edge Core Policy PreventSmartScreenPromptOverride registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPedgebrowsercorepreventsmartscreenpromptoverrideRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-core-policy-prevent-smart-screen-prompt-override-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-microsoft-edge-core-policy-prevent-smart-screen-prompt-override-Registry-Snapshot-When-Stale`.
