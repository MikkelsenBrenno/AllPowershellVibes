<#
.SYNOPSIS
    Refreshes the Windows Installer Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-installer-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwindowsinstallerServiceSnapshot.json'
