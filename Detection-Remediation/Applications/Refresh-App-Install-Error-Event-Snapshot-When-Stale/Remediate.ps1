<#
.SYNOPSIS
    Refreshes the App Install Error Event Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-App-Install-Error-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'AppInstallErrorEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'App install error event snapshot.'

$EventLogName = 'Microsoft-Windows-AppXDeploymentServer/Operational'
$RecentEventCount = 80
$EventIdsToHighlight = @(404, 465, 602, 603, 605)
