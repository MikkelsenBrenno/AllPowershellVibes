<#
.SYNOPSIS
    Detects Removable Storage state.

.DESCRIPTION
    Detects Removable Storage state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Removable Storage is compliant
    Exit 1:      Removable Storage is noncompliant
