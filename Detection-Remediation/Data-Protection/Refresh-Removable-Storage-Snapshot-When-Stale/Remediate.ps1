<#
.SYNOPSIS
    Remediates Removable Storage state.

.DESCRIPTION
    Writes configurable state evidence for Removable Storage remediation.
...
.INTUNE
    ...
    Exit 0:      Removable Storage remediation completed
    Exit 1:      Removable Storage remediation did not complete
...
$ScriptPackageName = 'Refresh-Removable-Storage-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Removable Storage'
...
$MarkerFileName = 'refresh-removable-storage-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-removable-storage-snapshot-when-stale.json'
