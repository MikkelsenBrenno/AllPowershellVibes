<#
.SYNOPSIS
    Detects Enterprise State Roaming state.

.DESCRIPTION
    Detects Enterprise State Roaming state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Enterprise State Roaming is compliant
    Exit 1:      Enterprise State Roaming is noncompliant
