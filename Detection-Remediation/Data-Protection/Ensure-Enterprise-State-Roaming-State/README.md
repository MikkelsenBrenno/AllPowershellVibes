# Ensure-Enterprise-State-Roaming-State

## Summary

Detects and remediates Enterprise State Roaming state for technician gap scenarios in the Data-Protection category.
