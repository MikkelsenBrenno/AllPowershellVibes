<#
.SYNOPSIS
    Remediates Enterprise State Roaming state.

.DESCRIPTION
    Writes configurable state evidence for Enterprise State Roaming remediation.
...
.INTUNE
    ...
    Exit 0:      Enterprise State Roaming remediation completed
    Exit 1:      Enterprise State Roaming remediation did not complete
...
$ScriptPackageName = 'Ensure-Enterprise-State-Roaming-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Enterprise State Roaming'
$PurposeCategory = 'Data-Protection'
$ManagedStateRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Data-Protection'
$MarkerFileName = 'ensure-enterprise-state-roaming-state.state'
$EvidenceFileName = 'ensure-enterprise-state-roaming-state.json'
