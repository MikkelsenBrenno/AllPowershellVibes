<#
.SYNOPSIS
    Remediates DLP Marker state.

.DESCRIPTION
    Writes configurable state evidence for DLP Marker remediation.
...
.INTUNE
    ...
    Exit 0:      DLP Marker remediation completed
    Exit 1:      DLP Marker remediation did not complete
...
$ScriptPackageName = 'Repair-DLP-Marker-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'DLP Marker'
...
$MarkerFileName = 'repair-dlp-marker-readiness.state'
$EvidenceFileName = 'repair-dlp-marker-readiness.json'
