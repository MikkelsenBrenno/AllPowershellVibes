<#
.SYNOPSIS
    Remediates Data Loss Event state.

.DESCRIPTION
    Writes configurable state evidence for Data Loss Event remediation.
...
.INTUNE
    ...
    Exit 0:      Data Loss Event remediation completed
    Exit 1:      Data Loss Event remediation did not complete
...
$ScriptPackageName = 'Refresh-Data-Loss-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Data Loss Event'
...
$MarkerFileName = 'refresh-data-loss-event-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-data-loss-event-snapshot-when-stale.json'
