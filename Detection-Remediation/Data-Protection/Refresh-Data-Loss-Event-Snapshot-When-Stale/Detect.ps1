<#
.SYNOPSIS
    Detects Data Loss Event state.

.DESCRIPTION
    Detects Data Loss Event state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Data Loss Event is compliant
    Exit 1:      Data Loss Event is noncompliant
