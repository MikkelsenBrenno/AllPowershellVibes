<#
.SYNOPSIS
    Remediates Sensitive Data Share state.

.DESCRIPTION
    Writes configurable state evidence for Sensitive Data Share remediation.
...
.INTUNE
    ...
    Exit 0:      Sensitive Data Share remediation completed
    Exit 1:      Sensitive Data Share remediation did not complete
...
$ScriptPackageName = 'Ensure-Sensitive-Data-Share-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Sensitive Data Share'
...
$MarkerFileName = 'ensure-sensitive-data-share-state.state'
$EvidenceFileName = 'ensure-sensitive-data-share-state.json'
