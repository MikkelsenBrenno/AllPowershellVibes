<#
.SYNOPSIS
    Detects Sensitive Data Share state.

.DESCRIPTION
    Detects Sensitive Data Share state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Sensitive Data Share is compliant
    Exit 1:      Sensitive Data Share is noncompliant
