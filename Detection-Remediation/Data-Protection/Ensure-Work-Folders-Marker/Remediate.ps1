<#
.SYNOPSIS
    Remediates Work Folders state.

.DESCRIPTION
    Writes configurable state evidence for Work Folders remediation.
...
.INTUNE
    ...
    Exit 0:      Work Folders remediation completed
    Exit 1:      Work Folders remediation did not complete
...
$ScriptPackageName = 'Ensure-Work-Folders-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Work Folders'
...
$MarkerFileName = 'ensure-work-folders-marker.state'
$EvidenceFileName = 'ensure-work-folders-marker.json'
