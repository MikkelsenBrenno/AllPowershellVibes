<#
.SYNOPSIS
    Detects Work Folders state.

.DESCRIPTION
    Detects Work Folders state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Work Folders is compliant
    Exit 1:      Work Folders is noncompliant
