<#
.SYNOPSIS
    Remediates User Profile Backup state.

.DESCRIPTION
    Writes configurable state evidence for User Profile Backup remediation.
...
.INTUNE
    ...
    Exit 0:      User Profile Backup remediation completed
    Exit 1:      User Profile Backup remediation did not complete
...
$ScriptPackageName = 'Ensure-User-Profile-Backup-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'User Profile Backup'
...
$MarkerFileName = 'ensure-user-profile-backup-marker.state'
$EvidenceFileName = 'ensure-user-profile-backup-marker.json'
