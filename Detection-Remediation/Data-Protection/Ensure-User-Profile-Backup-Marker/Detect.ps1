<#
.SYNOPSIS
    Detects User Profile Backup state.

.DESCRIPTION
    Detects User Profile Backup state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      User Profile Backup is compliant
    Exit 1:      User Profile Backup is noncompliant
