<#
.SYNOPSIS
    Detects Controlled Folder state.

.DESCRIPTION
    Detects Controlled Folder state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Controlled Folder is compliant
    Exit 1:      Controlled Folder is noncompliant
