<#
.SYNOPSIS
    Remediates Controlled Folder state.

.DESCRIPTION
    Writes configurable state evidence for Controlled Folder remediation.
...
.INTUNE
    ...
    Exit 0:      Controlled Folder remediation completed
    Exit 1:      Controlled Folder remediation did not complete
...
$ScriptPackageName = 'Repair-Controlled-Folder-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Controlled Folder'
...
$MarkerFileName = 'repair-controlled-folder-readiness.state'
$EvidenceFileName = 'repair-controlled-folder-readiness.json'
