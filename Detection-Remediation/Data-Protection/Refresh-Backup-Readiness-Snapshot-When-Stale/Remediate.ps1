<#
.SYNOPSIS
    Remediates Backup Readiness state.

.DESCRIPTION
    Writes configurable state evidence for Backup Readiness remediation.
...
.INTUNE
    ...
    Exit 0:      Backup Readiness remediation completed
    Exit 1:      Backup Readiness remediation did not complete
...
$ScriptPackageName = 'Refresh-Backup-Readiness-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Backup Readiness'
...
$MarkerFileName = 'refresh-backup-readiness-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-backup-readiness-snapshot-when-stale.json'
