<#
.SYNOPSIS
    Detects Backup Readiness state.

.DESCRIPTION
    Detects Backup Readiness state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Backup Readiness is compliant
    Exit 1:      Backup Readiness is noncompliant
