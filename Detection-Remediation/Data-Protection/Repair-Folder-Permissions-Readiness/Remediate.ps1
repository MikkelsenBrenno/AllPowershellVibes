<#
.SYNOPSIS
    Remediates Folder Permissions state.

.DESCRIPTION
    Writes configurable state evidence for Folder Permissions remediation.
...
.INTUNE
    ...
    Exit 0:      Folder Permissions remediation completed
    Exit 1:      Folder Permissions remediation did not complete
...
$ScriptPackageName = 'Repair-Folder-Permissions-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Folder Permissions'
...
$MarkerFileName = 'repair-folder-permissions-readiness.state'
$EvidenceFileName = 'repair-folder-permissions-readiness.json'
