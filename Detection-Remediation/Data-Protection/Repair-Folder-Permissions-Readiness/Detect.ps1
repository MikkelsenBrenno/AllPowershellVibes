<#
.SYNOPSIS
    Detects Folder Permissions state.

.DESCRIPTION
    Detects Folder Permissions state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Folder Permissions is compliant
    Exit 1:      Folder Permissions is noncompliant
