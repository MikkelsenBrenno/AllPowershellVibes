<#
.SYNOPSIS
    Remediates Clipboard Policy state.

.DESCRIPTION
    Writes configurable state evidence for Clipboard Policy remediation.
...
.INTUNE
    ...
    Exit 0:      Clipboard Policy remediation completed
    Exit 1:      Clipboard Policy remediation did not complete
...
$ScriptPackageName = 'Ensure-Clipboard-Policy-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Clipboard Policy'
...
$MarkerFileName = 'ensure-clipboard-policy-state.state'
$EvidenceFileName = 'ensure-clipboard-policy-state.json'
