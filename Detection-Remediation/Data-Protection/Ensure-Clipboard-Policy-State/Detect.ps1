<#
.SYNOPSIS
    Detects Clipboard Policy state.

.DESCRIPTION
    Detects Clipboard Policy state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Clipboard Policy is compliant
    Exit 1:      Clipboard Policy is noncompliant
