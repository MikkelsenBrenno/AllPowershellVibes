<#
.SYNOPSIS
    Remediates File Recovery state.

.DESCRIPTION
    Writes configurable state evidence for File Recovery remediation.
...
.INTUNE
    ...
    Exit 0:      File Recovery remediation completed
    Exit 1:      File Recovery remediation did not complete
...
$ScriptPackageName = 'Repair-File-Recovery-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'File Recovery'
...
$MarkerFileName = 'repair-file-recovery-readiness.state'
$EvidenceFileName = 'repair-file-recovery-readiness.json'
