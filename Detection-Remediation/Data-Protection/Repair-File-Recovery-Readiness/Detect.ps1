<#
.SYNOPSIS
    Detects File Recovery state.

.DESCRIPTION
    Detects File Recovery state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      File Recovery is compliant
    Exit 1:      File Recovery is noncompliant
