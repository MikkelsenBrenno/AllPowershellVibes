<#
.SYNOPSIS
    Detects OneDrive KFM state.

.DESCRIPTION
    Detects OneDrive KFM state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      OneDrive KFM is compliant
    Exit 1:      OneDrive KFM is noncompliant
