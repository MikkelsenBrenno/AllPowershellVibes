<#
.SYNOPSIS
    Remediates OneDrive KFM state.

.DESCRIPTION
    Writes configurable state evidence for OneDrive KFM remediation.
...
.INTUNE
    ...
    Exit 0:      OneDrive KFM remediation completed
    Exit 1:      OneDrive KFM remediation did not complete
...
$ScriptPackageName = 'Ensure-OneDrive-KFM-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'OneDrive KFM'
...
$MarkerFileName = 'ensure-onedrive-kfm-state.state'
$EvidenceFileName = 'ensure-onedrive-kfm-state.json'
