<#
.SYNOPSIS
    Detects Encryption Key state.

.DESCRIPTION
    Detects Encryption Key state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Encryption Key is compliant
    Exit 1:      Encryption Key is noncompliant
