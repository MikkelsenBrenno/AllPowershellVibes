<#
.SYNOPSIS
    Remediates Encryption Key state.

.DESCRIPTION
    Writes configurable state evidence for Encryption Key remediation.
...
.INTUNE
    ...
    Exit 0:      Encryption Key remediation completed
    Exit 1:      Encryption Key remediation did not complete
...
$ScriptPackageName = 'Ensure-Encryption-Key-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Encryption Key'
...
$MarkerFileName = 'ensure-encryption-key-marker.state'
$EvidenceFileName = 'ensure-encryption-key-marker.json'
