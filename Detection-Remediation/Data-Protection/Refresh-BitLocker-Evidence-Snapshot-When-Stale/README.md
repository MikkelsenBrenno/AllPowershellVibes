# Refresh-BitLocker-Evidence-Snapshot-When-Stale

## Summary

Detects and remediates BitLocker Evidence state for technician gap scenarios in the Data-Protection category.
