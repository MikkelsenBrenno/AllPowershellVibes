<#
.SYNOPSIS
    Remediates BitLocker Evidence state.

.DESCRIPTION
    Writes configurable state evidence for BitLocker Evidence remediation.
...
.INTUNE
    ...
    Exit 0:      BitLocker Evidence remediation completed
    Exit 1:      BitLocker Evidence remediation did not complete
...
$ScriptPackageName = 'Refresh-BitLocker-Evidence-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'BitLocker Evidence'
...
$MarkerFileName = 'refresh-bitlocker-evidence-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-bitlocker-evidence-snapshot-when-stale.json'
