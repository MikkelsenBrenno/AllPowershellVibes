<#
.SYNOPSIS
    Detects BitLocker Evidence state.

.DESCRIPTION
    Detects BitLocker Evidence state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      BitLocker Evidence is compliant
    Exit 1:      BitLocker Evidence is noncompliant
