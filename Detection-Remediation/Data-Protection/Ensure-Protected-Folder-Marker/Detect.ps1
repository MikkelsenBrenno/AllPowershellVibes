<#
.SYNOPSIS
    Detects Protected Folder state.

.DESCRIPTION
    Detects Protected Folder state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Protected Folder is compliant
    Exit 1:      Protected Folder is noncompliant
