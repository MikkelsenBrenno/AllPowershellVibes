<#
.SYNOPSIS
    Remediates Protected Folder state.

.DESCRIPTION
    Writes configurable state evidence for Protected Folder remediation.
...
.INTUNE
    ...
    Exit 0:      Protected Folder remediation completed
    Exit 1:      Protected Folder remediation did not complete
...
$ScriptPackageName = 'Ensure-Protected-Folder-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Protected Folder'
...
$MarkerFileName = 'ensure-protected-folder-marker.state'
$EvidenceFileName = 'ensure-protected-folder-marker.json'
