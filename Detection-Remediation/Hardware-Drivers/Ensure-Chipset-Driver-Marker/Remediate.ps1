<#
.SYNOPSIS
    Remediates Chipset Driver state.

.DESCRIPTION
    Writes configurable state evidence for Chipset Driver remediation.
...
.INTUNE
    ...
    Exit 0:      Chipset Driver remediation completed
    Exit 1:      Chipset Driver remediation did not complete
...
$ScriptPackageName = 'Ensure-Chipset-Driver-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Chipset Driver'
...
$MarkerFileName = 'ensure-chipset-driver-marker.state'
$EvidenceFileName = 'ensure-chipset-driver-marker.json'
