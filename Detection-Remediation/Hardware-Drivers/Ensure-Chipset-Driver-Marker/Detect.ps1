<#
.SYNOPSIS
    Detects Chipset Driver state.

.DESCRIPTION
    Detects Chipset Driver state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Chipset Driver is compliant
    Exit 1:      Chipset Driver is noncompliant
