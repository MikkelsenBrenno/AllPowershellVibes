<#
.SYNOPSIS
    Remediates TPM Device state.

.DESCRIPTION
    Writes configurable state evidence for TPM Device remediation.
...
.INTUNE
    ...
    Exit 0:      TPM Device remediation completed
    Exit 1:      TPM Device remediation did not complete
...
$ScriptPackageName = 'Ensure-TPM-Device-Marker'
...
$MarkerFileName = 'ensure-tpm-device-marker.state'
$EvidenceFileName = 'ensure-tpm-device-marker.json'
