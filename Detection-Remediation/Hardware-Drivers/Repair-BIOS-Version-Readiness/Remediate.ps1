<#
.SYNOPSIS
    Remediates BIOS Version state.

.DESCRIPTION
    Writes configurable state evidence for BIOS Version remediation.
...
.INTUNE
    ...
    Exit 0:      BIOS Version remediation completed
    Exit 1:      BIOS Version remediation did not complete
...
$ScriptPackageName = 'Repair-BIOS-Version-Readiness'
...
$MarkerFileName = 'repair-bios-version-readiness.state'
$EvidenceFileName = 'repair-bios-version-readiness.json'
