<#
.SYNOPSIS
    Detects BIOS Version state.

.DESCRIPTION
    Detects BIOS Version state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      BIOS Version is compliant
    Exit 1:      BIOS Version is noncompliant
