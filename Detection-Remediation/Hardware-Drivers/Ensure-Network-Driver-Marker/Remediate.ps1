<#
.SYNOPSIS
    Remediates Network Driver state.

.DESCRIPTION
    Writes configurable state evidence for Network Driver remediation.
...
.INTUNE
    ...
    Exit 0:      Network Driver remediation completed
    Exit 1:      Network Driver remediation did not complete
...
$ScriptPackageName = 'Ensure-Network-Driver-Marker'
...
$MarkerFileName = 'ensure-network-driver-marker.state'
$EvidenceFileName = 'ensure-network-driver-marker.json'
