<#
.SYNOPSIS
    Detects Network Driver state.

.DESCRIPTION
    Detects Network Driver state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Network Driver is compliant
    Exit 1:      Network Driver is noncompliant
