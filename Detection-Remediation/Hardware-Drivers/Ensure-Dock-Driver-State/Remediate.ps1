<#
.SYNOPSIS
    Remediates Dock Driver state.

.DESCRIPTION
    Writes configurable state evidence for Dock Driver remediation.
...
.INTUNE
    ...
    Exit 0:      Dock Driver remediation completed
    Exit 1:      Dock Driver remediation did not complete
...
$EvidenceFileName = 'ensure-dock-driver-state.json'
