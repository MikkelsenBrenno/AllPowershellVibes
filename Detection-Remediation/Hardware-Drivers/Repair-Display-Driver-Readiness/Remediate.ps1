<#
.SYNOPSIS
    Remediates Display Driver state.

.DESCRIPTION
    Writes configurable state evidence for Display Driver remediation.
...
.INTUNE
    ...
    Exit 0:      Display Driver remediation completed
    Exit 1:      Display Driver remediation did not complete
...
$ScriptPackageName = 'Repair-Display-Driver-Readiness'
...
$MarkerFileName = 'repair-display-driver-readiness.state'
$EvidenceFileName = 'repair-display-driver-readiness.json'
