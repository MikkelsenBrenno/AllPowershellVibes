<#
.SYNOPSIS
    Detects Display Driver state.

.DESCRIPTION
    Detects Display Driver state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Display Driver is compliant
    Exit 1:      Display Driver is noncompliant
