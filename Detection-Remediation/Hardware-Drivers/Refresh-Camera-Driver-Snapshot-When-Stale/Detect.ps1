<#
.SYNOPSIS
    Detects Camera Driver state.

.DESCRIPTION
    Detects Camera Driver state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Camera Driver is compliant
    Exit 1:      Camera Driver is noncompliant
