<#
.SYNOPSIS
    Remediates Camera Driver state.

.DESCRIPTION
    Writes configurable state evidence for Camera Driver remediation.
...
.INTUNE
    ...
    Exit 0:      Camera Driver remediation completed
    Exit 1:      Camera Driver remediation did not complete
...
$ScriptPackageName = 'Refresh-Camera-Driver-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Camera Driver'
...
$MarkerFileName = 'refresh-camera-driver-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-camera-driver-snapshot-when-stale.json'
