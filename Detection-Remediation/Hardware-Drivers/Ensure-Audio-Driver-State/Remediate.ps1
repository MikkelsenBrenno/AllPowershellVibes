<#
.SYNOPSIS
    Remediates Audio Driver state.

.DESCRIPTION
    Writes configurable state evidence for Audio Driver remediation.
...
.INTUNE
    ...
    Exit 0:      Audio Driver remediation completed
    Exit 1:      Audio Driver remediation did not complete
...
$ScriptPackageName = 'Ensure-Audio-Driver-State'
...
$MarkerFileName = 'ensure-audio-driver-state.state'
$EvidenceFileName = 'ensure-audio-driver-state.json'
