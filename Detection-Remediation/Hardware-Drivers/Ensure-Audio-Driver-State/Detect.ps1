<#
.SYNOPSIS
    Detects Audio Driver state.

.DESCRIPTION
    Detects Audio Driver state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Audio Driver is compliant
    Exit 1:      Audio Driver is noncompliant
