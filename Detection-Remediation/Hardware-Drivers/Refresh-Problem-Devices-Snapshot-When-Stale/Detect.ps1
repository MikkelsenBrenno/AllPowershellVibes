<#
.SYNOPSIS
    Detects Problem Devices state.

.DESCRIPTION
    Detects Problem Devices state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Problem Devices is compliant
    Exit 1:      Problem Devices is noncompliant
