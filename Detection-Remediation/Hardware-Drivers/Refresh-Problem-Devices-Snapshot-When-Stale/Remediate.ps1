<#
.SYNOPSIS
    Remediates Problem Devices state.

.DESCRIPTION
    Writes configurable state evidence for Problem Devices remediation.
...
.INTUNE
    ...
    Exit 0:      Problem Devices remediation completed
    Exit 1:      Problem Devices remediation did not complete
...
$ScriptPackageName = 'Refresh-Problem-Devices-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Problem Devices'
...
$MarkerFileName = 'refresh-problem-devices-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-problem-devices-snapshot-when-stale.json'
