<#
.SYNOPSIS
    Remediates Firmware Version state.

.DESCRIPTION
    Writes configurable state evidence for Firmware Version remediation.
...
.INTUNE
    ...
    Exit 0:      Firmware Version remediation completed
    Exit 1:      Firmware Version remediation did not complete
...
$ScriptPackageName = 'Refresh-Firmware-Version-Snapshot-When-Stale'
...
$MarkerFileName = 'refresh-firmware-version-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-firmware-version-snapshot-when-stale.json'
