<#
.SYNOPSIS
    Detects Firmware Version state.

.DESCRIPTION
    Detects Firmware Version state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Firmware Version is compliant
    Exit 1:      Firmware Version is noncompliant
