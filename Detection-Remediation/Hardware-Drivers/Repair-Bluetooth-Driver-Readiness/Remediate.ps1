<#
.SYNOPSIS
    Remediates Bluetooth Driver state.

.DESCRIPTION
    Writes configurable state evidence for Bluetooth Driver remediation.
...
.INTUNE
    ...
    Exit 0:      Bluetooth Driver remediation completed
    Exit 1:      Bluetooth Driver remediation did not complete
...
$ScriptPackageName = 'Repair-Bluetooth-Driver-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Bluetooth Driver'
...
$MarkerFileName = 'repair-bluetooth-driver-readiness.state'
$EvidenceFileName = 'repair-bluetooth-driver-readiness.json'
