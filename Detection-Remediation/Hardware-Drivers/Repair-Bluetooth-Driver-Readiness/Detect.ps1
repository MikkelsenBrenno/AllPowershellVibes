<#
.SYNOPSIS
    Detects Bluetooth Driver state.

.DESCRIPTION
    Detects Bluetooth Driver state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Bluetooth Driver is compliant
    Exit 1:      Bluetooth Driver is noncompliant
