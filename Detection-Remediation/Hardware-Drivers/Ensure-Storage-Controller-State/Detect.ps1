<#
.SYNOPSIS
    Detects Storage Controller state.

.DESCRIPTION
    Detects Storage Controller state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Storage Controller is compliant
    Exit 1:      Storage Controller is noncompliant
