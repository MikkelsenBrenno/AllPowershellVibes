<#
.SYNOPSIS
    Refreshes the LAPS Policy Snapshot snapshot.
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows LAPS policy registry snapshot.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Microsoft\Policies\LAPS'; Name = 'BackupDirectory'; Description = 'Backup directory' },
    @{ Path = 'HKLM:\SOFTWARE\Microsoft\Policies\LAPS'; Name = 'PasswordAgeDays'; Description = 'Password age in days' }
)
