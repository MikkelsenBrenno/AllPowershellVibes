<#
.SYNOPSIS
    Refreshes the IME Log Folder Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-IME-Log-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'IMELogFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Intune Management Extension log folder usage snapshot.'
