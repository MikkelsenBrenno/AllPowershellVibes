<#
.SYNOPSIS
    Refreshes the PowerShell Operational Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-powershell-operational-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPpowershelloperationaleventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'PowerShell Operational Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-PowerShell/Operational'
$RecentEventCount = 80
$EventIdsToHighlight = @(4103, 4104, 4105, 4106)
