<#
.SYNOPSIS
    Refreshes the Local Administrators Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-Local-Admins-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'LocalAdministratorsSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Local Administrators group membership snapshot.'
