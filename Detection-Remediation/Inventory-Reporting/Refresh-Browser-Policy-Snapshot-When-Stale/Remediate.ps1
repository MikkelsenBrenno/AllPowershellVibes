<#
.SYNOPSIS
    Remediates Browser Policy Snapshot state.

.DESCRIPTION
    Detects and remediates Browser Policy Snapshot state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Browser Policy Snapshot remediation completed
    Exit 1:      Browser Policy Snapshot remediation failed
...
$ScriptPackageName = 'Refresh-Browser-Policy-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotName = 'Browser Policy Snapshot'
$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Snapshots\Inventory-Reporting'
$SnapshotFileName = 'browser-policy-snapshot-snapshot.json'
