# Company Portal Snapshot

## Summary

Refreshes a local Company Portal app package snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `CompanyPortalSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Company-Portal-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Company-Portal-Snapshot-When-Stale`.
