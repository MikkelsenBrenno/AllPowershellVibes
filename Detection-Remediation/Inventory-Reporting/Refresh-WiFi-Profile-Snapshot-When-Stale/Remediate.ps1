<#
.SYNOPSIS
    Refreshes the WiFi Profile Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-WiFi-Profile-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'WiFiProfileSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Saved Wi-Fi profile name snapshot.'
