# WiFi Profile Snapshot

## Summary

Refreshes a local saved Wi-Fi profile snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `WiFiProfileSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-WiFi-Profile-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-WiFi-Profile-Snapshot-When-Stale`.
