<#
.SYNOPSIS
    Refreshes the Event Error Snapshot snapshot.
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Recent Application event error snapshot.'
