# Defender Preference Snapshot

## Summary

Refreshes a local Defender preference JSON snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `DefenderPreferenceSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Defender-Preference-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Defender-Preference-Snapshot-When-Stale`.
