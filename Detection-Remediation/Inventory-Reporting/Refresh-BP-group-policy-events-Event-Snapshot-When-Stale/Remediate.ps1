<#
.SYNOPSIS
    Refreshes the Group Policy Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-group-policy-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPgrouppolicyeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Group Policy Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-GroupPolicy/Operational'
$RecentEventCount = 80
$EventIdsToHighlight = @(4000, 5312, 5317, 7016, 8004)
