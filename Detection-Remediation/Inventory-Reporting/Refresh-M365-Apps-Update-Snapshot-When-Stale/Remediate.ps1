<#
.SYNOPSIS
    Refreshes the M365 Apps Update Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-M365-Apps-Update-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'M365AppsUpdateSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Microsoft 365 Apps update registry snapshot.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\common\officeupdate'; Name = 'enableautomaticupdates'; Description = 'Office automatic updates' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\office\16.0\common\officeupdate'; Name = 'updatebranch'; Description = 'Office update branch' },
    @{ Path = 'HKLM:\SOFTWARE\Microsoft\Office\ClickToRun\Configuration'; Name = 'VersionToReport'; Description = 'Click-to-Run version' }
)
