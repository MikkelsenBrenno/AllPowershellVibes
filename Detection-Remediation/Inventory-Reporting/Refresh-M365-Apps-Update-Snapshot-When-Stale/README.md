# M365 Apps Update Snapshot

## Summary

Refreshes a local Microsoft 365 Apps update policy and Click-to-Run snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `M365AppsUpdateSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-M365-Apps-Update-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-M365-Apps-Update-Snapshot-When-Stale`.
