<#
.SYNOPSIS
    Remediates Browser Version Snapshot state.

.DESCRIPTION
    Detects and remediates Browser Version Snapshot state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Browser Version Snapshot remediation completed
    Exit 1:      Browser Version Snapshot remediation failed
...
$ScriptPackageName = 'Refresh-Browser-Version-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotName = 'Browser Version Snapshot'
$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Snapshots\Inventory-Reporting'
$SnapshotFileName = 'browser-version-snapshot-snapshot.json'
