<#
.SYNOPSIS
    Refreshes the Certificate Services Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-certificate-services-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcertificateserviceseventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Certificate Services Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Application'
$RecentEventCount = 80
$EventIdsToHighlight = @(64, 65, 66, 67)
