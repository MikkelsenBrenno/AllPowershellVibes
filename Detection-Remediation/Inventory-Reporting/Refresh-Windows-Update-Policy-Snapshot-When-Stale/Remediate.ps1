<#
.SYNOPSIS
    Refreshes the Windows Update Policy Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-Windows-Update-Policy-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'WindowsUpdatePolicySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Update policy registry snapshot.'
...
$RegistryItems = @(
    ...
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU'; Name = 'NoAutoUpdate'; Description = 'Disable automatic updates' },
