<#
.SYNOPSIS
    Refreshes the OneDrive KFM Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-OneDrive-KFM-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'OneDriveKFMSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'OneDrive Known Folder Move policy snapshot.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\OneDrive'; Name = 'KFMSilentOptIn'; Description = 'KFM silent opt-in tenant ID' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\OneDrive'; Name = 'KFMBlockOptOut'; Description = 'Block KFM opt-out' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\OneDrive'; Name = 'FilesOnDemandEnabled'; Description = 'Files On-Demand' }
)
