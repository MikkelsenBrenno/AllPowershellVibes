# OneDrive KFM Snapshot

## Summary

Refreshes a local OneDrive Known Folder Move policy snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `OneDriveKFMSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-OneDrive-KFM-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-OneDrive-KFM-Snapshot-When-Stale`.
