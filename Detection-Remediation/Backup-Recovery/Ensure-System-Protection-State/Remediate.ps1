<#
.SYNOPSIS
    Remediates System Protection state.

.DESCRIPTION
    Writes configurable state evidence for System Protection remediation.
...
.INTUNE
    ...
    Exit 0:      System Protection remediation completed
    Exit 1:      System Protection remediation did not complete
...
$ScriptPackageName = 'Ensure-System-Protection-State'
...
$MarkerFileName = 'ensure-system-protection-state.state'
$EvidenceFileName = 'ensure-system-protection-state.json'
