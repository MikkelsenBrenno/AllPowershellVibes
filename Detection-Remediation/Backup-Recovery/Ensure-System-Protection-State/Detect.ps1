<#
.SYNOPSIS
    Detects System Protection state.

.DESCRIPTION
    Detects System Protection state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      System Protection is compliant
    Exit 1:      System Protection is noncompliant
