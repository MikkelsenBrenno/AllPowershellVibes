<#
.SYNOPSIS
    Detects Restore Point state.

.DESCRIPTION
    Detects Restore Point state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Restore Point is compliant
    Exit 1:      Restore Point is noncompliant
