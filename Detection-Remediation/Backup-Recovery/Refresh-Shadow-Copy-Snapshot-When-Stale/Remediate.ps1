<#
.SYNOPSIS
    Remediates Shadow Copy state.

.DESCRIPTION
    Writes configurable state evidence for Shadow Copy remediation.
...
.INTUNE
    ...
    Exit 0:      Shadow Copy remediation completed
    Exit 1:      Shadow Copy remediation did not complete
...
$ScriptPackageName = 'Refresh-Shadow-Copy-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Shadow Copy'
...
$MarkerFileName = 'refresh-shadow-copy-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-shadow-copy-snapshot-when-stale.json'
