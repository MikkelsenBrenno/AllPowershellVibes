<#
.SYNOPSIS
    Remediates Profile Backup state.

.DESCRIPTION
    Writes configurable state evidence for Profile Backup remediation.
...
.INTUNE
    ...
    Exit 0:      Profile Backup remediation completed
    Exit 1:      Profile Backup remediation did not complete
...
$ScriptPackageName = 'Repair-Profile-Backup-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Profile Backup'
...
$MarkerFileName = 'repair-profile-backup-readiness.state'
$EvidenceFileName = 'repair-profile-backup-readiness.json'
