<#
.SYNOPSIS
    Detects Profile Backup state.

.DESCRIPTION
    Detects Profile Backup state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Profile Backup is compliant
    Exit 1:      Profile Backup is noncompliant
