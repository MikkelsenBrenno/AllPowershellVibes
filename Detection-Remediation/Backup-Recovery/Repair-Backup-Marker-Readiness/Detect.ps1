<#
.SYNOPSIS
    Detects Backup Marker state.

.DESCRIPTION
    Detects Backup Marker state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Backup Marker is compliant
    Exit 1:      Backup Marker is noncompliant
