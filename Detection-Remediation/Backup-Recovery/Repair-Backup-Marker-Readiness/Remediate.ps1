<#
.SYNOPSIS
    Remediates Backup Marker state.

.DESCRIPTION
    Writes configurable state evidence for Backup Marker remediation.
...
.INTUNE
    ...
    Exit 0:      Backup Marker remediation completed
    Exit 1:      Backup Marker remediation did not complete
...
$ScriptPackageName = 'Repair-Backup-Marker-Readiness'
...
$MarkerFileName = 'repair-backup-marker-readiness.state'
$EvidenceFileName = 'repair-backup-marker-readiness.json'
