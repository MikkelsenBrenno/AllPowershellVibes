<#
.SYNOPSIS
    Remediates File History state.

.DESCRIPTION
    Writes configurable state evidence for File History remediation.
...
.INTUNE
    ...
    Exit 0:      File History remediation completed
    Exit 1:      File History remediation did not complete
...
$ScriptPackageName = 'Refresh-File-History-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'File History'
...
$MarkerFileName = 'refresh-file-history-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-file-history-snapshot-when-stale.json'
