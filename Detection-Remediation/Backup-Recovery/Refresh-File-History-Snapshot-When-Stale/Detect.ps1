<#
.SYNOPSIS
    Detects File History state.

.DESCRIPTION
    Detects File History state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      File History is compliant
    Exit 1:      File History is noncompliant
