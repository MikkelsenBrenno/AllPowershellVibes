<#
.SYNOPSIS
    Remediates Recovery Partition state.

.DESCRIPTION
    Writes configurable state evidence for Recovery Partition remediation.
...
.INTUNE
    ...
    Exit 0:      Recovery Partition remediation completed
    Exit 1:      Recovery Partition remediation did not complete
...
$ScriptPackageName = 'Repair-Recovery-Partition-Readiness'
...
$MarkerFileName = 'repair-recovery-partition-readiness.state'
$EvidenceFileName = 'repair-recovery-partition-readiness.json'
