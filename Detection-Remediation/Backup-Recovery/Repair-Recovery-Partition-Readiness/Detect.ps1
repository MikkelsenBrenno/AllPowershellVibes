<#
.SYNOPSIS
    Detects Recovery Partition state.

.DESCRIPTION
    Detects Recovery Partition state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Recovery Partition is compliant
    Exit 1:      Recovery Partition is noncompliant
