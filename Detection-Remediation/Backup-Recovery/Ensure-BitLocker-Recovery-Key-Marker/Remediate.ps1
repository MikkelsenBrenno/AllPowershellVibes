<#
.SYNOPSIS
    Remediates BitLocker Recovery Key state.

.DESCRIPTION
    Writes configurable state evidence for BitLocker Recovery Key remediation.
...
.INTUNE
    ...
    Exit 0:      BitLocker Recovery Key remediation completed
    Exit 1:      BitLocker Recovery Key remediation did not complete
...
$ScriptPackageName = 'Ensure-BitLocker-Recovery-Key-Marker'
...
$MarkerFileName = 'ensure-bitlocker-recovery-key-marker.state'
$EvidenceFileName = 'ensure-bitlocker-recovery-key-marker.json'
