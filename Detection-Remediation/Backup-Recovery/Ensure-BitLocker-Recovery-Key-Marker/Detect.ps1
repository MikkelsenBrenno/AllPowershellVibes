<#
.SYNOPSIS
    Detects BitLocker Recovery Key state.

.DESCRIPTION
    Detects BitLocker Recovery Key state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      BitLocker Recovery Key is compliant
    Exit 1:      BitLocker Recovery Key is noncompliant
