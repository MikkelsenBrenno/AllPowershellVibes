<#
.SYNOPSIS
    Detects Recovery Drive state.

.DESCRIPTION
    Detects Recovery Drive state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Recovery Drive is compliant
    Exit 1:      Recovery Drive is noncompliant
