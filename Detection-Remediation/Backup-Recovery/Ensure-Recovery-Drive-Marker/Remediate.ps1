<#
.SYNOPSIS
    Remediates Recovery Drive state.

.DESCRIPTION
    Writes configurable state evidence for Recovery Drive remediation.
...
.INTUNE
    ...
    Exit 0:      Recovery Drive remediation completed
    Exit 1:      Recovery Drive remediation did not complete
...
$ScriptPackageName = 'Ensure-Recovery-Drive-Marker'
...
$MarkerFileName = 'ensure-recovery-drive-marker.state'
$EvidenceFileName = 'ensure-recovery-drive-marker.json'
