<#
.SYNOPSIS
    Remediates BCD Health state.

.DESCRIPTION
    Writes configurable state evidence for BCD Health remediation.
...
.INTUNE
    ...
    Exit 0:      BCD Health remediation completed
    Exit 1:      BCD Health remediation did not complete
...
$ScriptPackageName = 'Ensure-BCD-Health-State'
...
$MarkerFileName = 'ensure-bcd-health-state.state'
$EvidenceFileName = 'ensure-bcd-health-state.json'
