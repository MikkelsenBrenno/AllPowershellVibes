<#
.SYNOPSIS
    Remediates Config Backup state.

.DESCRIPTION
    Writes configurable state evidence for Config Backup remediation.
...
.INTUNE
    ...
    Exit 0:      Config Backup remediation completed
    Exit 1:      Config Backup remediation did not complete
...
$ScriptPackageName = 'Ensure-Config-Backup-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Config Backup'
...
$MarkerFileName = 'ensure-config-backup-marker.state'
$EvidenceFileName = 'ensure-config-backup-marker.json'
