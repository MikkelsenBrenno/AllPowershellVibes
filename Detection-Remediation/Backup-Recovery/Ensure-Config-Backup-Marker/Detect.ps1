<#
.SYNOPSIS
    Detects Config Backup state.

.DESCRIPTION
    Detects Config Backup state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Config Backup is compliant
    Exit 1:      Config Backup is noncompliant
