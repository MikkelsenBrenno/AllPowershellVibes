<#
.SYNOPSIS
    Remediates Registry Backup state.

.DESCRIPTION
    Writes configurable state evidence for Registry Backup remediation.
...
.INTUNE
    ...
    Exit 0:      Registry Backup remediation completed
    Exit 1:      Registry Backup remediation did not complete
...
$ScriptPackageName = 'Ensure-Registry-Backup-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Registry Backup'
...
$MarkerFileName = 'ensure-registry-backup-state.state'
$EvidenceFileName = 'ensure-registry-backup-state.json'
