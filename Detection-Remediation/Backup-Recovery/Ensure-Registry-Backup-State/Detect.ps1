<#
.SYNOPSIS
    Detects Registry Backup state.

.DESCRIPTION
    Detects Registry Backup state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Registry Backup is compliant
    Exit 1:      Registry Backup is noncompliant
