<#
.SYNOPSIS
    Refreshes the Windows System Privacy Policy AllowClipboardHistory Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-system-privacy-policy-allow-clipboard-history-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsystemprivacyallowclipboardhistoryRegistrySnapshot.json'
