<#
.SYNOPSIS
    Remediates Power Configuration File state.

.DESCRIPTION
    Detects and remediates Power Configuration File state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Power Configuration File remediation completed
    Exit 1:      Power Configuration File remediation failed
...
$ScriptPackageName = 'Ensure-Power-Configuration-File'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Power Configuration File'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Contoso\DeviceConfiguration'
$ValueName = 'PowerConfigurationFile'
