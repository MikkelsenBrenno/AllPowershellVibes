<#
.SYNOPSIS
    Remediates Ensure Display Off Timeout 15 and 5 Minutes.
...
$ScriptPackageName = 'Ensure-Display-Off-Timeout-15-5-Minutes'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Power\PowerSettings\3C0BC021-C8A8-4E07-A973-6B14CBCB2B7E'; Name = 'ACSettingIndex'; Type = 'DWord'; Value = 900; Description = 'Turn off display after 15 minutes on AC' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Power\PowerSettings\3C0BC021-C8A8-4E07-A973-6B14CBCB2B7E'; Name = 'DCSettingIndex'; Type = 'DWord'; Value = 300; Description = 'Turn off display after 5 minutes on battery' }
)
