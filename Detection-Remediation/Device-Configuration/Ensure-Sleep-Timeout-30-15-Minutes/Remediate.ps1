<#
.SYNOPSIS
    Remediates Ensure Sleep Timeout 30 and 15 Minutes.
...
$ScriptPackageName = 'Ensure-Sleep-Timeout-30-15-Minutes'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Power\PowerSettings\29F6C1DB-86DA-48C5-9FDB-F2B67B1F44DA'; Name = 'ACSettingIndex'; Type = 'DWord'; Value = 1800; Description = 'Sleep after 30 minutes on AC' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Power\PowerSettings\29F6C1DB-86DA-48C5-9FDB-F2B67B1F44DA'; Name = 'DCSettingIndex'; Type = 'DWord'; Value = 900; Description = 'Sleep after 15 minutes on battery' }
)
