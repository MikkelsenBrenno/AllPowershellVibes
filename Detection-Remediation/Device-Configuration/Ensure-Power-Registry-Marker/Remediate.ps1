<#
.SYNOPSIS
    Remediates Power Registry Marker state.

.DESCRIPTION
    Detects and remediates Power Registry Marker state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Power Registry Marker remediation completed
    Exit 1:      Power Registry Marker remediation failed
...
$ScriptPackageName = 'Ensure-Power-Registry-Marker'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Power Registry Marker'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Contoso\DeviceConfiguration'
$ValueName = 'PowerRegistryMarker'
