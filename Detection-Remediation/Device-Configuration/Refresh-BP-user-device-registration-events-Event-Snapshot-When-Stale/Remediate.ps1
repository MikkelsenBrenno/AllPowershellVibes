<#
.SYNOPSIS
    Refreshes the User Device Registration Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-user-device-registration-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPuserdeviceregistrationeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'User Device Registration Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-User Device Registration/Admin'
$RecentEventCount = 80
$EventIdsToHighlight = @(304, 305, 307, 360)
