<#
.SYNOPSIS
    Remediates Ensure Location Access Disabled Template.
...
.INTUNE
    ...
    Exit 0:      Ensure Location Access Disabled Template remediation succeeded
    Exit 1:      Ensure Location Access Disabled Template remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Location Access Disabled Template.'
    exit 1
}
