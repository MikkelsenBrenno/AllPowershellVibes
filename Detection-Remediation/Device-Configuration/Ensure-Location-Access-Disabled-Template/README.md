# Ensure Location Access Disabled Template

## Summary

Template remediation that detects and disables Windows location access policy for devices where location services are not required.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Location-Access-Disabled-Template`.
