<#
.SYNOPSIS
    Remediates Ensure Hard Disk Timeout 20 and 10 Minutes.
...
$ScriptPackageName = 'Ensure-Hard-Disk-Timeout-20-10-Minutes'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Power\PowerSettings\6738E2C4-E8A5-4A42-B16A-E040E769756E'; Name = 'ACSettingIndex'; Type = 'DWord'; Value = 1200; Description = 'Turn off hard disk after 20 minutes on AC' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Power\PowerSettings\6738E2C4-E8A5-4A42-B16A-E040E769756E'; Name = 'DCSettingIndex'; Type = 'DWord'; Value = 600; Description = 'Turn off hard disk after 10 minutes on battery' }
)
