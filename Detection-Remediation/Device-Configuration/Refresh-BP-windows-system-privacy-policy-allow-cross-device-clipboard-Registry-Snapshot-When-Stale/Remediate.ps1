<#
.SYNOPSIS
    Refreshes the Windows System Privacy Policy AllowCrossDeviceClipboard Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-system-privacy-policy-allow-cross-device-clipboard-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsystemprivacyallowcrossdeviceclipboardRegistrySnapshot.json'
