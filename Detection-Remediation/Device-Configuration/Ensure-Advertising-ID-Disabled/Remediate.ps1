<#
.SYNOPSIS
    Remediates Ensure Advertising ID Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Advertising ID Disabled remediation succeeded
    Exit 1:      Ensure Advertising ID Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Advertising ID Disabled.'
    exit 1
}
