...
Detects and remediates Windows AdvertisingInfo policy so advertising ID is disabled by group policy.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Advertising-ID-Disabled`.
