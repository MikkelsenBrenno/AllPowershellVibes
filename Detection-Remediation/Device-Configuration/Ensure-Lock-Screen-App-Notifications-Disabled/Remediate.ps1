...
$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\System'; Name = 'DisableLockScreenAppNotifications'; Type = 'DWord'; Value = 1; Description = 'Disable lock-screen app notifications' }
)
