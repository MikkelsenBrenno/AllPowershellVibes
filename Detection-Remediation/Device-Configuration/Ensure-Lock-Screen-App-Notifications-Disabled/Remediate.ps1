<#
.SYNOPSIS
    Remediates Ensure Lock Screen App Notifications Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Lock Screen App Notifications Disabled remediation succeeded
    Exit 1:      Ensure Lock Screen App Notifications Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Lock Screen App Notifications Disabled.'
    exit 1
}
