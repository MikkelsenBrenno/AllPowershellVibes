...
Detects and remediates lock screen notification policy to reduce information exposure before sign-in.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Lock-Screen-App-Notifications-Disabled`.
