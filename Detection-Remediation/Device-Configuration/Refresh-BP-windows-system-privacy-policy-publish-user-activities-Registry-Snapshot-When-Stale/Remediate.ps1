<#
.SYNOPSIS
    Refreshes the Windows System Privacy Policy PublishUserActivities Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-system-privacy-policy-publish-user-activities-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsystemprivacypublishuseractivitiesRegistrySnapshot.json'
