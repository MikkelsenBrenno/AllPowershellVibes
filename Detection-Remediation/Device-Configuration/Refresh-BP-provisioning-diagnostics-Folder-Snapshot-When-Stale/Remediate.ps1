<#
.SYNOPSIS
    Refreshes the Provisioning Diagnostics Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-provisioning-diagnostics-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPprovisioningdiagnosticsFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Provisioning Diagnostics folder size snapshot for technician troubleshooting.'
