# Provisioning Diagnostics Folder

## Summary

Refreshes a local Provisioning Diagnostics folder usage troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPprovisioningdiagnosticsFolderSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-provisioning-diagnostics-Folder-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-provisioning-diagnostics-Folder-Snapshot-When-Stale`.
