<#
.SYNOPSIS
    Remediates Power Scheduled Task state.

.DESCRIPTION
    Detects and remediates Power Scheduled Task state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Power Scheduled Task remediation completed
    Exit 1:      Power Scheduled Task remediation failed
...
$ScriptPackageName = 'Ensure-Power-Scheduled-Task'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Power Scheduled Task'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Contoso\DeviceConfiguration'
$ValueName = 'PowerScheduledTask'
