<#
.SYNOPSIS
    Remediates Ensure Power Button Action Sleep.
...
$ScriptPackageName = 'Ensure-Power-Button-Action-Sleep'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Power\PowerSettings\7648EFA3-DD9C-4E3E-B566-50F929386280'; Name = 'ACSettingIndex'; Type = 'DWord'; Value = 1; Description = 'Use sleep for the power button on AC' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Power\PowerSettings\7648EFA3-DD9C-4E3E-B566-50F929386280'; Name = 'DCSettingIndex'; Type = 'DWord'; Value = 1; Description = 'Use sleep for the power button on battery' }
)
