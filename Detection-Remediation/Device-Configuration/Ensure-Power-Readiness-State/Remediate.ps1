<#
.SYNOPSIS
    Remediates Power Readiness State state.

.DESCRIPTION
    Detects and remediates Power Readiness State state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Power Readiness State remediation completed
    Exit 1:      Power Readiness State remediation failed
...
$ScriptPackageName = 'Ensure-Power-Readiness-State'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Power Readiness State'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Contoso\DeviceConfiguration'
$ValueName = 'PowerReadinessState'
