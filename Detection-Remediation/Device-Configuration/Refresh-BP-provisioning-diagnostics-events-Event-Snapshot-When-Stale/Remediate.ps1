<#
.SYNOPSIS
    Refreshes the Provisioning Diagnostics Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-provisioning-diagnostics-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPprovisioningdiagnosticseventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Provisioning Diagnostics Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-Provisioning-Diagnostics-Provider/Admin'
$RecentEventCount = 80
$EventIdsToHighlight = @(1, 2, 3, 4)
