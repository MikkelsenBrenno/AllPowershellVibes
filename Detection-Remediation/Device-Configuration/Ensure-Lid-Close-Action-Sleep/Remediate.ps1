<#
.SYNOPSIS
    Remediates Ensure Lid Close Action Sleep.
...
$ScriptPackageName = 'Ensure-Lid-Close-Action-Sleep'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Power\PowerSettings\5CA83367-6E45-459F-A27B-476B1D01C936'; Name = 'ACSettingIndex'; Type = 'DWord'; Value = 1; Description = 'Use sleep when the lid closes on AC' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Power\PowerSettings\5CA83367-6E45-459F-A27B-476B1D01C936'; Name = 'DCSettingIndex'; Type = 'DWord'; Value = 1; Description = 'Use sleep when the lid closes on battery' }
)
