<#
.SYNOPSIS
    Refreshes the Windows System Privacy Policy UploadUserActivities Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-system-privacy-policy-upload-user-activities-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsystemprivacyuploaduseractivitiesRegistrySnapshot.json'
