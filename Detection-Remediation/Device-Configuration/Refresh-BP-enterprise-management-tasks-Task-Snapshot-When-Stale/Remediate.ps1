<#
.SYNOPSIS
    Refreshes the Enterprise Management Tasks Task snapshot.
...
$ScriptPackageName = 'Refresh-BP-enterprise-management-tasks-Task-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPenterprisemanagementtasksTaskSnapshot.json'
$CollectionMode = 'Task'
$JsonDepth = 8
$RegistryItems = @()
$ServiceNames = @()
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Enterprise Management Tasks scheduled task snapshot for technician troubleshooting.'

$TaskPathPrefix = '\Microsoft\Windows\EnterpriseMgmt\'
$TaskNamePatterns = @('*')
