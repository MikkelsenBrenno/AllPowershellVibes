<#
.SYNOPSIS
    Remediates Ensure Windows Error Reporting Enabled.
...
$ScriptPackageName = 'Ensure-Windows-Error-Reporting-Enabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Microsoft\Windows\Windows Error Reporting'; Name = 'Disabled'; Type = 'DWord'; Value = 0; Description = 'Enable Windows Error Reporting' }
)
