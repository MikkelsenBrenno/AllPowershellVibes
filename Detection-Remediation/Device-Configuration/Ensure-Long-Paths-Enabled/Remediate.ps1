<#
.SYNOPSIS
    Remediates Ensure Win32 Long Paths Enabled.
...
$ScriptPackageName = 'Ensure-Long-Paths-Enabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SYSTEM\CurrentControlSet\Control\FileSystem'; Name = 'LongPathsEnabled'; Type = 'DWord'; Value = 1; Description = 'Enable Win32 long paths for aware applications' }
)
