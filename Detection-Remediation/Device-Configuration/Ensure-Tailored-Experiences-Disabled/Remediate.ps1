<#
.SYNOPSIS
    Remediates Ensure Tailored Experiences Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Tailored Experiences Disabled remediation succeeded
    Exit 1:      Ensure Tailored Experiences Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Tailored Experiences Disabled.'
    exit 1
}
