...
$RegistryValues = @(
    @{ Path = 'HKCU:\SOFTWARE\Policies\Microsoft\Windows\CloudContent'; Name = 'DisableTailoredExperiencesWithDiagnosticData'; Type = 'DWord'; Value = 1; Description = 'Disable tailored experiences based on diagnostic data' }
)
