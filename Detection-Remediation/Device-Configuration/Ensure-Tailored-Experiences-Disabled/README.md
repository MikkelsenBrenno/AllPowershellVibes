...
Detects and remediates Windows Cloud Content policy that disables tailored experiences with diagnostic data.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Tailored-Experiences-Disabled`.
