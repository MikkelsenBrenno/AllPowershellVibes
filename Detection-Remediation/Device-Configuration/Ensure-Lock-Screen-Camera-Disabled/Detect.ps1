<#
.SYNOPSIS
    Detects Ensure Lock Screen Camera Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Lock Screen Camera Disabled is compliant
    Exit 1:      Ensure Lock Screen Camera Disabled is missing or different
...
try {
    ...
    Write-Output 'Not compliant. Ensure Lock Screen Camera Disabled could not be validated.'
    exit 1
}
