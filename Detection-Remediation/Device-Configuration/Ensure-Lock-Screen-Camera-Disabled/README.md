...
Detects and remediates lock screen camera policy for managed endpoints that should not expose camera access before sign-in.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Lock-Screen-Camera-Disabled`.
