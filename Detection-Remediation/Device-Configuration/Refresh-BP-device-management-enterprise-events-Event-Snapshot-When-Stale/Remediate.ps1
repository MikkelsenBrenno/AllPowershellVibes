<#
.SYNOPSIS
    Refreshes the Device Management Enterprise Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-device-management-enterprise-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdevicemanagemententerpriseeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Device Management Enterprise Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-DeviceManagement-Enterprise-Diagnostics-Provider/Admin'
$RecentEventCount = 80
$EventIdsToHighlight = @(75, 76, 201, 404, 814)
