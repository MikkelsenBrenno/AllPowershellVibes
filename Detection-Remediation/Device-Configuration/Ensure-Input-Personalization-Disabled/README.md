...
Detects and remediates input personalization policy so Windows does not collect typing and inking personalization data.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Input-Personalization-Disabled`.
