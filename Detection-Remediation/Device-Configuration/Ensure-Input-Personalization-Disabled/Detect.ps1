<#
.SYNOPSIS
    Detects Ensure Input Personalization Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Input Personalization Disabled is compliant
    Exit 1:      Ensure Input Personalization Disabled is missing or different
...
try {
    ...
    Write-Output 'Not compliant. Ensure Input Personalization Disabled could not be validated.'
    exit 1
}
