...
.INTUNE
    ...
    Exit 0:      Ensure Input Personalization Disabled remediation succeeded
    Exit 1:      Ensure Input Personalization Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Input Personalization Disabled.'
    exit 1
}
