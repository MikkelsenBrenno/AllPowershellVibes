<#
.SYNOPSIS
    Remediates Power Policy State state.

.DESCRIPTION
    Detects and remediates Power Policy State state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Power Policy State remediation completed
    Exit 1:      Power Policy State remediation failed
...
$ScriptPackageName = 'Ensure-Power-Policy-State'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Power Policy State'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Contoso\DeviceConfiguration'
$ValueName = 'PowerPolicyState'
