<#
.SYNOPSIS
    Remediates Ensure Location Access Disabled.
...
$ScriptPackageName = 'Ensure-Location-Access-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\LocationAndSensors'; Name = 'DisableLocation'; Type = 'DWord'; Value = 1; Description = 'Disable location functionality' }
)
