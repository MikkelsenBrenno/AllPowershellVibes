<#
.SYNOPSIS
    Remediates Ensure Feedback Notifications Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Feedback Notifications Disabled remediation succeeded
    Exit 1:      Ensure Feedback Notifications Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Feedback Notifications Disabled.'
    exit 1
}
