...
Detects and remediates Windows Data Collection policy that suppresses feedback notification prompts on managed devices.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Feedback-Notifications-Disabled`.
