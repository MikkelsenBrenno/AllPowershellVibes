<#
.SYNOPSIS
    Refreshes the Device Metadata Cache Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-device-metadata-cache-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdevicemetadatacacheFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Device Metadata Cache folder size snapshot for technician troubleshooting.'
