# Windows Data Collection Policy LimitDiagnosticLogCollection Registry

## Summary

Refreshes a local Windows Data Collection Policy LimitDiagnosticLogCollection registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdatacollectionlimitdiagnosticlogcollectionRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-windows-data-collection-policy-limit-diagnostic-log-collection-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-windows-data-collection-policy-limit-diagnostic-log-collection-Registry-Snapshot-When-Stale`.
