# Windows Data Collection Policy DoNotShowFeedbackNotifications Registry

## Summary

Refreshes a local Windows Data Collection Policy DoNotShowFeedbackNotifications registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdatacollectiondonotshowfeedbacknotificationsRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-windows-data-collection-policy-do-not-show-feedback-notifications-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-windows-data-collection-policy-do-not-show-feedback-notifications-Registry-Snapshot-When-Stale`.
