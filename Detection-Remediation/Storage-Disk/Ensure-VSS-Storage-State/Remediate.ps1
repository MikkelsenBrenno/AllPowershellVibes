<#
.SYNOPSIS
    Remediates VSS Storage state.

.DESCRIPTION
    Writes configurable state evidence for VSS Storage remediation.
...
.INTUNE
    ...
    Exit 0:      VSS Storage remediation completed
    Exit 1:      VSS Storage remediation did not complete
...
$ScriptPackageName = 'Ensure-VSS-Storage-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'VSS Storage'
...
$MarkerFileName = 'ensure-vss-storage-state.state'
$EvidenceFileName = 'ensure-vss-storage-state.json'
