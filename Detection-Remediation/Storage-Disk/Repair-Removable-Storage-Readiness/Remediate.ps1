...
$ScriptPackageName = 'Repair-Removable-Storage-Readiness'
...
$MarkerFileName = 'repair-removable-storage-readiness.state'
$EvidenceFileName = 'repair-removable-storage-readiness.json'
