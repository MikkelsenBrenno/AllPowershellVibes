<#
.SYNOPSIS
    Remediates BitLocker Volume state.

.DESCRIPTION
    Writes configurable state evidence for BitLocker Volume remediation.
...
.INTUNE
    ...
    Exit 0:      BitLocker Volume remediation completed
    Exit 1:      BitLocker Volume remediation did not complete
...
$ScriptPackageName = 'Refresh-BitLocker-Volume-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'BitLocker Volume'
$PurposeCategory = 'Storage-Disk'
$ManagedStateRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Storage-Disk'
$MarkerFileName = 'refresh-bitlocker-volume-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-bitlocker-volume-snapshot-when-stale.json'
