<#
.SYNOPSIS
    Detects BitLocker Volume state.

.DESCRIPTION
    Detects BitLocker Volume state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      BitLocker Volume is compliant
    Exit 1:      BitLocker Volume is noncompliant
