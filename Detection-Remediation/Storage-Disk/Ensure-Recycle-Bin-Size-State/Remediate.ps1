<#
.SYNOPSIS
    Remediates Recycle Bin Size state.

.DESCRIPTION
    Writes configurable state evidence for Recycle Bin Size remediation.
...
.INTUNE
    ...
    Exit 0:      Recycle Bin Size remediation completed
    Exit 1:      Recycle Bin Size remediation did not complete
...
$ScriptPackageName = 'Ensure-Recycle-Bin-Size-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Recycle Bin Size'
...
$MarkerFileName = 'ensure-recycle-bin-size-state.state'
$EvidenceFileName = 'ensure-recycle-bin-size-state.json'
