<#
.SYNOPSIS
    Detects Recycle Bin Size state.

.DESCRIPTION
    Detects Recycle Bin Size state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Recycle Bin Size is compliant
    Exit 1:      Recycle Bin Size is noncompliant
