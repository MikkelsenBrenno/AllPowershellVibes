<#
.SYNOPSIS
    Remediates SMART Status state.

.DESCRIPTION
    Writes configurable state evidence for SMART Status remediation.
...
.INTUNE
    ...
    Exit 0:      SMART Status remediation completed
    Exit 1:      SMART Status remediation did not complete
...
$ScriptPackageName = 'Repair-SMART-Status-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'SMART Status'
...
$MarkerFileName = 'repair-smart-status-readiness.state'
$EvidenceFileName = 'repair-smart-status-readiness.json'
