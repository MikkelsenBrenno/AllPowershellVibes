<#
.SYNOPSIS
    Detects SMART Status state.

.DESCRIPTION
    Detects SMART Status state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      SMART Status is compliant
    Exit 1:      SMART Status is noncompliant
