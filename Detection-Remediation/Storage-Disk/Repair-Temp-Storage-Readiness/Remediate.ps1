<#
.SYNOPSIS
    Remediates Temp Storage state.

.DESCRIPTION
    Writes configurable state evidence for Temp Storage remediation.
...
.INTUNE
    ...
    Exit 0:      Temp Storage remediation completed
    Exit 1:      Temp Storage remediation did not complete
...
$ScriptPackageName = 'Repair-Temp-Storage-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Temp Storage'
...
$MarkerFileName = 'repair-temp-storage-readiness.state'
$EvidenceFileName = 'repair-temp-storage-readiness.json'
