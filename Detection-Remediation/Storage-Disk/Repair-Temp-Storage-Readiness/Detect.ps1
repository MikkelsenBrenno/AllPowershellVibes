<#
.SYNOPSIS
    Detects Temp Storage state.

.DESCRIPTION
    Detects Temp Storage state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Temp Storage is compliant
    Exit 1:      Temp Storage is noncompliant
