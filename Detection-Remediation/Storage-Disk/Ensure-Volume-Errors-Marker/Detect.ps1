<#
.SYNOPSIS
    Detects Volume Errors state.

.DESCRIPTION
    Detects Volume Errors state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Volume Errors is compliant
    Exit 1:      Volume Errors is noncompliant
