<#
.SYNOPSIS
    Remediates Volume Errors state.

.DESCRIPTION
    Writes configurable state evidence for Volume Errors remediation.
...
.INTUNE
    ...
    Exit 0:      Volume Errors remediation completed
    Exit 1:      Volume Errors remediation did not complete
...
$ScriptPackageName = 'Ensure-Volume-Errors-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Volume Errors'
...
$MarkerFileName = 'ensure-volume-errors-marker.state'
$EvidenceFileName = 'ensure-volume-errors-marker.json'
