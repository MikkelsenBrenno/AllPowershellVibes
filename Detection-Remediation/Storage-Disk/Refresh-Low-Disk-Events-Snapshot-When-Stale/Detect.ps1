<#
.SYNOPSIS
    Detects Low Disk Events state.

.DESCRIPTION
    Detects Low Disk Events state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Low Disk Events is compliant
    Exit 1:      Low Disk Events is noncompliant
