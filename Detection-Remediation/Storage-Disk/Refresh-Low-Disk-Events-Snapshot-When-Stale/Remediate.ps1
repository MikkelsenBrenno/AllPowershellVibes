<#
.SYNOPSIS
    Remediates Low Disk Events state.

.DESCRIPTION
    Writes configurable state evidence for Low Disk Events remediation.
...
.INTUNE
    ...
    Exit 0:      Low Disk Events remediation completed
    Exit 1:      Low Disk Events remediation did not complete
...
$ScriptPackageName = 'Refresh-Low-Disk-Events-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Low Disk Events'
...
$MarkerFileName = 'refresh-low-disk-events-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-low-disk-events-snapshot-when-stale.json'
