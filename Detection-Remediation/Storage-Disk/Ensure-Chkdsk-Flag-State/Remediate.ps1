<#
.SYNOPSIS
    Remediates Chkdsk Flag state.

.DESCRIPTION
    Writes configurable state evidence for Chkdsk Flag remediation.
...
.INTUNE
    ...
    Exit 0:      Chkdsk Flag remediation completed
    Exit 1:      Chkdsk Flag remediation did not complete
...
$ScriptPackageName = 'Ensure-Chkdsk-Flag-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Chkdsk Flag'
...
$MarkerFileName = 'ensure-chkdsk-flag-state.state'
$EvidenceFileName = 'ensure-chkdsk-flag-state.json'
