<#
.SYNOPSIS
    Remediates Free Space state.

.DESCRIPTION
    Writes configurable state evidence for Free Space remediation.
...
.INTUNE
    ...
    Exit 0:      Free Space remediation completed
    Exit 1:      Free Space remediation did not complete
...
$ScriptPackageName = 'Ensure-Free-Space-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Free Space'
...
$MarkerFileName = 'ensure-free-space-state.state'
$EvidenceFileName = 'ensure-free-space-state.json'
