<#
.SYNOPSIS
    Detects User Profile Size state.

.DESCRIPTION
    Detects User Profile Size state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      User Profile Size is compliant
    Exit 1:      User Profile Size is noncompliant
