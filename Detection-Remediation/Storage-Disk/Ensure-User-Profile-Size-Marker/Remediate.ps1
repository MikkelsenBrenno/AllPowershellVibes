<#
.SYNOPSIS
    Remediates User Profile Size state.

.DESCRIPTION
    Writes configurable state evidence for User Profile Size remediation.
...
.INTUNE
    ...
    Exit 0:      User Profile Size remediation completed
    Exit 1:      User Profile Size remediation did not complete
...
$ScriptPackageName = 'Ensure-User-Profile-Size-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'User Profile Size'
...
$MarkerFileName = 'ensure-user-profile-size-marker.state'
$EvidenceFileName = 'ensure-user-profile-size-marker.json'
