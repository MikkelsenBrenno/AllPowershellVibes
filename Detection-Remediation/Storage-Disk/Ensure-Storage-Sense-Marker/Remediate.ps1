<#
.SYNOPSIS
    Remediates Storage Sense state.

.DESCRIPTION
    Writes configurable state evidence for Storage Sense remediation.
...
.INTUNE
    ...
    Exit 0:      Storage Sense remediation completed
    Exit 1:      Storage Sense remediation did not complete
...
$ScriptPackageName = 'Ensure-Storage-Sense-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Storage Sense'
...
$MarkerFileName = 'ensure-storage-sense-marker.state'
$EvidenceFileName = 'ensure-storage-sense-marker.json'
