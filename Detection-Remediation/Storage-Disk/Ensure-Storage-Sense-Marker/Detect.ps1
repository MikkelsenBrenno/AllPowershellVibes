<#
.SYNOPSIS
    Detects Storage Sense state.

.DESCRIPTION
    Detects Storage Sense state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Storage Sense is compliant
    Exit 1:      Storage Sense is noncompliant
