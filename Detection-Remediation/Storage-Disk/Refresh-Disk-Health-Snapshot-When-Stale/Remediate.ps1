<#
.SYNOPSIS
    Remediates Disk Health state.

.DESCRIPTION
    Writes configurable state evidence for Disk Health remediation.
...
.INTUNE
    ...
    Exit 0:      Disk Health remediation completed
    Exit 1:      Disk Health remediation did not complete
...
$ScriptPackageName = 'Refresh-Disk-Health-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Disk Health'
...
$MarkerFileName = 'refresh-disk-health-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-disk-health-snapshot-when-stale.json'
