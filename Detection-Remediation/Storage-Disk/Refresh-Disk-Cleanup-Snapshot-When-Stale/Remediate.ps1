<#
.SYNOPSIS
    Remediates Disk Cleanup state.

.DESCRIPTION
    Writes configurable state evidence for Disk Cleanup remediation.
...
.INTUNE
    ...
    Exit 0:      Disk Cleanup remediation completed
    Exit 1:      Disk Cleanup remediation did not complete
...
$ScriptPackageName = 'Refresh-Disk-Cleanup-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Disk Cleanup'
...
$MarkerFileName = 'refresh-disk-cleanup-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-disk-cleanup-snapshot-when-stale.json'
