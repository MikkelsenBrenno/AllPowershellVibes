<#
.SYNOPSIS
    Detects Disk Cleanup state.

.DESCRIPTION
    Detects Disk Cleanup state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Disk Cleanup is compliant
    Exit 1:      Disk Cleanup is noncompliant
