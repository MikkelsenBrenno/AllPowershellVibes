<#
.SYNOPSIS
    Remediates Intermediate CA state.

.DESCRIPTION
    Writes configurable state evidence for Intermediate CA remediation.
...
.INTUNE
    ...
    Exit 0:      Intermediate CA remediation completed
    Exit 1:      Intermediate CA remediation did not complete
...
$ScriptPackageName = 'Ensure-Intermediate-CA-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Intermediate CA'
...
$MarkerFileName = 'ensure-intermediate-ca-state.state'
$EvidenceFileName = 'ensure-intermediate-ca-state.json'
