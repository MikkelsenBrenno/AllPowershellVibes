<#
.SYNOPSIS
    Detects Intermediate CA state.

.DESCRIPTION
    Detects Intermediate CA state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Intermediate CA is compliant
    Exit 1:      Intermediate CA is noncompliant
