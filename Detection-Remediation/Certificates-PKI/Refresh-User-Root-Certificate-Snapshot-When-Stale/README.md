# Refresh-User-Root-Certificate-Snapshot-When-Stale

## Summary

Detects and remediates User Root Certificate state for technician gap scenarios in the Certificates-PKI category.
