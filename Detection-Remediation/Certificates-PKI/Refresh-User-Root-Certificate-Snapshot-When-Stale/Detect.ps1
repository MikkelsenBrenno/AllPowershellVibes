<#
.SYNOPSIS
    Detects User Root Certificate state.

.DESCRIPTION
    Detects User Root Certificate state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      User Root Certificate is compliant
    Exit 1:      User Root Certificate is noncompliant
