<#
.SYNOPSIS
    Detects PKCS Certificate state.

.DESCRIPTION
    Detects PKCS Certificate state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      PKCS Certificate is compliant
    Exit 1:      PKCS Certificate is noncompliant
