<#
.SYNOPSIS
    Remediates PKCS Certificate state.

.DESCRIPTION
    Writes configurable state evidence for PKCS Certificate remediation.
...
.INTUNE
    ...
    Exit 0:      PKCS Certificate remediation completed
    Exit 1:      PKCS Certificate remediation did not complete
...
$ScriptPackageName = 'Repair-PKCS-Certificate-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'PKCS Certificate'
...
$MarkerFileName = 'repair-pkcs-certificate-readiness.state'
$EvidenceFileName = 'repair-pkcs-certificate-readiness.json'
