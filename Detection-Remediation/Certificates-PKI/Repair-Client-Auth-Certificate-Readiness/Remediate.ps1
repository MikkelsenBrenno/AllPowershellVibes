<#
.SYNOPSIS
    Remediates Client Auth Certificate state.

.DESCRIPTION
    Writes configurable state evidence for Client Auth Certificate remediation.
...
.INTUNE
    ...
    Exit 0:      Client Auth Certificate remediation completed
    Exit 1:      Client Auth Certificate remediation did not complete
...
$ScriptPackageName = 'Repair-Client-Auth-Certificate-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Client Auth Certificate'
...
$MarkerFileName = 'repair-client-auth-certificate-readiness.state'
$EvidenceFileName = 'repair-client-auth-certificate-readiness.json'
