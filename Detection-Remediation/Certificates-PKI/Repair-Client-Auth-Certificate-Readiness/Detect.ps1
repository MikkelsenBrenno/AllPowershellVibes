<#
.SYNOPSIS
    Detects Client Auth Certificate state.

.DESCRIPTION
    Detects Client Auth Certificate state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Client Auth Certificate is compliant
    Exit 1:      Client Auth Certificate is noncompliant
