<#
.SYNOPSIS
    Remediates Smart Card Certificate state.

.DESCRIPTION
    Writes configurable state evidence for Smart Card Certificate remediation.
...
.INTUNE
    ...
    Exit 0:      Smart Card Certificate remediation completed
    Exit 1:      Smart Card Certificate remediation did not complete
...
$ScriptPackageName = 'Ensure-Smart-Card-Certificate-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Smart Card Certificate'
...
$MarkerFileName = 'ensure-smart-card-certificate-marker.state'
$EvidenceFileName = 'ensure-smart-card-certificate-marker.json'
