<#
.SYNOPSIS
    Detects Smart Card Certificate state.

.DESCRIPTION
    Detects Smart Card Certificate state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Smart Card Certificate is compliant
    Exit 1:      Smart Card Certificate is noncompliant
