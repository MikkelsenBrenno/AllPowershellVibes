# Ensure-Certificate-Autoenrollment-Marker

## Summary

Detects and remediates Certificate Autoenrollment state for technician gap scenarios in the Certificates-PKI category.
