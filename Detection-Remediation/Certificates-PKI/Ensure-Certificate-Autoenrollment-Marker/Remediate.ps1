<#
.SYNOPSIS
    Remediates Certificate Autoenrollment state.

.DESCRIPTION
    Writes configurable state evidence for Certificate Autoenrollment remediation.
...
.INTUNE
    ...
    Exit 0:      Certificate Autoenrollment remediation completed
    Exit 1:      Certificate Autoenrollment remediation did not complete
...
$ScriptPackageName = 'Ensure-Certificate-Autoenrollment-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Certificate Autoenrollment'
...
$MarkerFileName = 'ensure-certificate-autoenrollment-marker.state'
$EvidenceFileName = 'ensure-certificate-autoenrollment-marker.json'
