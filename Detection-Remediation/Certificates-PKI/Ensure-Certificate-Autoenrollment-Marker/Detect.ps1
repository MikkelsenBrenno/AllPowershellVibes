<#
.SYNOPSIS
    Detects Certificate Autoenrollment state.

.DESCRIPTION
    Detects Certificate Autoenrollment state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Certificate Autoenrollment is compliant
    Exit 1:      Certificate Autoenrollment is noncompliant
