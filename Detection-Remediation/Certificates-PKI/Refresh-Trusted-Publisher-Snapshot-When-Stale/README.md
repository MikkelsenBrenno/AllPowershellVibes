# Refresh-Trusted-Publisher-Snapshot-When-Stale

## Summary

Detects and remediates Trusted Publisher state for technician gap scenarios in the Certificates-PKI category.
