<#
.SYNOPSIS
    Remediates Trusted Publisher state.

.DESCRIPTION
    Writes configurable state evidence for Trusted Publisher remediation.
...
.INTUNE
    ...
    Exit 0:      Trusted Publisher remediation completed
    Exit 1:      Trusted Publisher remediation did not complete
...
$ScriptPackageName = 'Refresh-Trusted-Publisher-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Trusted Publisher'
...
$MarkerFileName = 'refresh-trusted-publisher-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-trusted-publisher-snapshot-when-stale.json'
