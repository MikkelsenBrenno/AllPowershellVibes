<#
.SYNOPSIS
    Detects Trusted Publisher state.

.DESCRIPTION
    Detects Trusted Publisher state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Trusted Publisher is compliant
    Exit 1:      Trusted Publisher is noncompliant
