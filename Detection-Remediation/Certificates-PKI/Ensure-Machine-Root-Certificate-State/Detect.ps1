<#
.SYNOPSIS
    Detects Machine Root Certificate state.

.DESCRIPTION
    Detects Machine Root Certificate state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Machine Root Certificate is compliant
    Exit 1:      Machine Root Certificate is noncompliant
