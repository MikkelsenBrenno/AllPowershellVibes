<#
.SYNOPSIS
    Remediates Machine Root Certificate state.

.DESCRIPTION
    Writes configurable state evidence for Machine Root Certificate remediation.
...
.INTUNE
    ...
    Exit 0:      Machine Root Certificate remediation completed
    Exit 1:      Machine Root Certificate remediation did not complete
...
$ScriptPackageName = 'Ensure-Machine-Root-Certificate-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Machine Root Certificate'
...
$MarkerFileName = 'ensure-machine-root-certificate-state.state'
$EvidenceFileName = 'ensure-machine-root-certificate-state.json'
