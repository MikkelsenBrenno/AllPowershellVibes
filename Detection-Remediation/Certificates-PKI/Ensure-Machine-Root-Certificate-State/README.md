# Ensure-Machine-Root-Certificate-State

## Summary

Detects and remediates Machine Root Certificate state for technician gap scenarios in the Certificates-PKI category.
