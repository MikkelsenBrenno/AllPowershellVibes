<#
.SYNOPSIS
    Detects Expiring Certificates state.

.DESCRIPTION
    Detects Expiring Certificates state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Expiring Certificates is compliant
    Exit 1:      Expiring Certificates is noncompliant
