<#
.SYNOPSIS
    Remediates Expiring Certificates state.

.DESCRIPTION
    Writes configurable state evidence for Expiring Certificates remediation.
...
.INTUNE
    ...
    Exit 0:      Expiring Certificates remediation completed
    Exit 1:      Expiring Certificates remediation did not complete
...
$ScriptPackageName = 'Repair-Expiring-Certificates-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Expiring Certificates'
...
$MarkerFileName = 'repair-expiring-certificates-readiness.state'
$EvidenceFileName = 'repair-expiring-certificates-readiness.json'
