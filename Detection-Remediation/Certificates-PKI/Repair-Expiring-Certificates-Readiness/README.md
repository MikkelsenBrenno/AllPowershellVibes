# Repair-Expiring-Certificates-Readiness

## Summary

Detects and remediates Expiring Certificates state for technician gap scenarios in the Certificates-PKI category.
