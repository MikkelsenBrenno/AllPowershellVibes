<#
.SYNOPSIS
    Detects SCEP Certificate state.

.DESCRIPTION
    Detects SCEP Certificate state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      SCEP Certificate is compliant
    Exit 1:      SCEP Certificate is noncompliant
