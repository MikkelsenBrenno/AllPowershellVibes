<#
.SYNOPSIS
    Remediates SCEP Certificate state.

.DESCRIPTION
    Writes configurable state evidence for SCEP Certificate remediation.
...
.INTUNE
    ...
    Exit 0:      SCEP Certificate remediation completed
    Exit 1:      SCEP Certificate remediation did not complete
...
$ScriptPackageName = 'Refresh-SCEP-Certificate-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'SCEP Certificate'
...
$MarkerFileName = 'refresh-scep-certificate-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-scep-certificate-snapshot-when-stale.json'
