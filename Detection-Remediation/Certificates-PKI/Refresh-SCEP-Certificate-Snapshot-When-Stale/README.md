# Refresh-SCEP-Certificate-Snapshot-When-Stale

## Summary

Detects and remediates SCEP Certificate state for technician gap scenarios in the Certificates-PKI category.
