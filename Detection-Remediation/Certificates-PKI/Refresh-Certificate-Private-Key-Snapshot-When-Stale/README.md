# Refresh-Certificate-Private-Key-Snapshot-When-Stale

## Summary

Detects and remediates Certificate Private Key state for technician gap scenarios in the Certificates-PKI category.
