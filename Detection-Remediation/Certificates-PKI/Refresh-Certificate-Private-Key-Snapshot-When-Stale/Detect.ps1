<#
.SYNOPSIS
    Detects Certificate Private Key state.

.DESCRIPTION
    Detects Certificate Private Key state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Certificate Private Key is compliant
    Exit 1:      Certificate Private Key is noncompliant
