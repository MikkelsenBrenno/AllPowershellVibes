<#
.SYNOPSIS
    Detects CRL Distribution state.

.DESCRIPTION
    Detects CRL Distribution state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      CRL Distribution is compliant
    Exit 1:      CRL Distribution is noncompliant
