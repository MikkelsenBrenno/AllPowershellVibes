<#
.SYNOPSIS
    Remediates CRL Distribution state.

.DESCRIPTION
    Writes configurable state evidence for CRL Distribution remediation.
...
.INTUNE
    ...
    Exit 0:      CRL Distribution remediation completed
    Exit 1:      CRL Distribution remediation did not complete
...
$ScriptPackageName = 'Ensure-CRL-Distribution-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'CRL Distribution'
...
$MarkerFileName = 'ensure-crl-distribution-state.state'
$EvidenceFileName = 'ensure-crl-distribution-state.json'
