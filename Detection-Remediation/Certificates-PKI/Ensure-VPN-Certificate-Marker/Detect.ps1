<#
.SYNOPSIS
    Detects VPN Certificate state.

.DESCRIPTION
    Detects VPN Certificate state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      VPN Certificate is compliant
    Exit 1:      VPN Certificate is noncompliant
