<#
.SYNOPSIS
    Remediates VPN Certificate state.

.DESCRIPTION
    Writes configurable state evidence for VPN Certificate remediation.
...
.INTUNE
    ...
    Exit 0:      VPN Certificate remediation completed
    Exit 1:      VPN Certificate remediation did not complete
...
$ScriptPackageName = 'Ensure-VPN-Certificate-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'VPN Certificate'
...
$MarkerFileName = 'ensure-vpn-certificate-marker.state'
$EvidenceFileName = 'ensure-vpn-certificate-marker.json'
