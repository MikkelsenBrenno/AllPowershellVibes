<#
.SYNOPSIS
    Remediates WiFi Certificate state.

.DESCRIPTION
    Writes configurable state evidence for WiFi Certificate remediation.
...
.INTUNE
    ...
    Exit 0:      WiFi Certificate remediation completed
    Exit 1:      WiFi Certificate remediation did not complete
...
$ScriptPackageName = 'Ensure-WiFi-Certificate-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'WiFi Certificate'
...
$MarkerFileName = 'ensure-wifi-certificate-state.state'
$EvidenceFileName = 'ensure-wifi-certificate-state.json'
