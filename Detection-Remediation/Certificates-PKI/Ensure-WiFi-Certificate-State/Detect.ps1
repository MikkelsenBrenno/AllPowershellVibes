<#
.SYNOPSIS
    Detects WiFi Certificate state.

.DESCRIPTION
    Detects WiFi Certificate state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      WiFi Certificate is compliant
    Exit 1:      WiFi Certificate is noncompliant
