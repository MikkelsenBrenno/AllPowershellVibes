<#
.SYNOPSIS
    Remediates VPN SignIn Readiness state.

.DESCRIPTION
    Detects and remediates VPN SignIn Readiness state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      VPN SignIn Readiness remediation completed
    Exit 1:      VPN SignIn Readiness remediation failed
...
$ScriptPackageName = 'Ensure-VPN-SignIn-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'VPN SignIn Readiness'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'vpn-signin-readiness.state'
