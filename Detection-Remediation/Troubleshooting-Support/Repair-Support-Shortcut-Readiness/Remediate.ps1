<#
.SYNOPSIS
    Remediates Support Shortcut state.

.DESCRIPTION
    Writes configurable state evidence for Support Shortcut remediation.
...
.INTUNE
    ...
    Exit 0:      Support Shortcut remediation completed
    Exit 1:      Support Shortcut remediation did not complete
...
$ScriptPackageName = 'Repair-Support-Shortcut-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Support Shortcut'
...
$MarkerFileName = 'repair-support-shortcut-readiness.state'
$EvidenceFileName = 'repair-support-shortcut-readiness.json'
