<#
.SYNOPSIS
    Detects Support Shortcut state.

.DESCRIPTION
    Detects Support Shortcut state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Support Shortcut is compliant
    Exit 1:      Support Shortcut is noncompliant
