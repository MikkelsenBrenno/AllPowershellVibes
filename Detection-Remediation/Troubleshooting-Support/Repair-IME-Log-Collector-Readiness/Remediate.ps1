<#
.SYNOPSIS
    Remediates IME Log Collector state.

.DESCRIPTION
    Writes configurable state evidence for IME Log Collector remediation.
...
.INTUNE
    ...
    Exit 0:      IME Log Collector remediation completed
    Exit 1:      IME Log Collector remediation did not complete
...
$ScriptPackageName = 'Repair-IME-Log-Collector-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'IME Log Collector'
...
$MarkerFileName = 'repair-ime-log-collector-readiness.state'
$EvidenceFileName = 'repair-ime-log-collector-readiness.json'
