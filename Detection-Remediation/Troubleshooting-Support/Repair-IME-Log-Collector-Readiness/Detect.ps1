<#
.SYNOPSIS
    Detects IME Log Collector state.

.DESCRIPTION
    Detects IME Log Collector state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      IME Log Collector is compliant
    Exit 1:      IME Log Collector is noncompliant
