<#
.SYNOPSIS
    Remediates Crash Dumps state.

.DESCRIPTION
    Writes configurable state evidence for Crash Dumps remediation.
...
.INTUNE
    ...
    Exit 0:      Crash Dumps remediation completed
    Exit 1:      Crash Dumps remediation did not complete
...
$ScriptPackageName = 'Refresh-Crash-Dumps-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Crash Dumps'
...
$MarkerFileName = 'refresh-crash-dumps-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-crash-dumps-snapshot-when-stale.json'
