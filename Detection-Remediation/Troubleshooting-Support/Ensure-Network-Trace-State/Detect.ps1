<#
.SYNOPSIS
    Detects Network Trace state.

.DESCRIPTION
    Detects Network Trace state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Network Trace is compliant
    Exit 1:      Network Trace is noncompliant
