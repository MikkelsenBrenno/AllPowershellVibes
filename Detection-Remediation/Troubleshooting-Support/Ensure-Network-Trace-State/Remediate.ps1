<#
.SYNOPSIS
    Remediates Network Trace state.

.DESCRIPTION
    Writes configurable state evidence for Network Trace remediation.
...
.INTUNE
    ...
    Exit 0:      Network Trace remediation completed
    Exit 1:      Network Trace remediation did not complete
...
$ScriptPackageName = 'Ensure-Network-Trace-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Network Trace'
...
$MarkerFileName = 'ensure-network-trace-state.state'
$EvidenceFileName = 'ensure-network-trace-state.json'
