<#
.SYNOPSIS
    Detects Helpdesk Marker state.

.DESCRIPTION
    Detects Helpdesk Marker state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Helpdesk Marker is compliant
    Exit 1:      Helpdesk Marker is noncompliant
