<#
.SYNOPSIS
    Remediates Helpdesk Marker state.

.DESCRIPTION
    Writes configurable state evidence for Helpdesk Marker remediation.
...
.INTUNE
    ...
    Exit 0:      Helpdesk Marker remediation completed
    Exit 1:      Helpdesk Marker remediation did not complete
...
$ScriptPackageName = 'Ensure-Helpdesk-Marker-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Helpdesk Marker'
...
$MarkerFileName = 'ensure-helpdesk-marker-state.state'
$EvidenceFileName = 'ensure-helpdesk-marker-state.json'
