<#
.SYNOPSIS
    Remediates Diagnostic Data state.

.DESCRIPTION
    Writes configurable state evidence for Diagnostic Data remediation.
...
.INTUNE
    ...
    Exit 0:      Diagnostic Data remediation completed
    Exit 1:      Diagnostic Data remediation did not complete
...
$ScriptPackageName = 'Ensure-Diagnostic-Data-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Diagnostic Data'
...
$MarkerFileName = 'ensure-diagnostic-data-marker.state'
$EvidenceFileName = 'ensure-diagnostic-data-marker.json'
