<#
.SYNOPSIS
    Detects Diagnostic Data state.

.DESCRIPTION
    Detects Diagnostic Data state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Diagnostic Data is compliant
    Exit 1:      Diagnostic Data is noncompliant
