<#
.SYNOPSIS
    Remediates Performance Counter state.

.DESCRIPTION
    Writes configurable state evidence for Performance Counter remediation.
...
.INTUNE
    ...
    Exit 0:      Performance Counter remediation completed
    Exit 1:      Performance Counter remediation did not complete
...
$ScriptPackageName = 'Refresh-Performance-Counter-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Performance Counter'
...
$MarkerFileName = 'refresh-performance-counter-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-performance-counter-snapshot-when-stale.json'
