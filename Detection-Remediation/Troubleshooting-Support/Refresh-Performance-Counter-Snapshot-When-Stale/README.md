# Refresh-Performance-Counter-Snapshot-When-Stale

## Summary

Detects and remediates Performance Counter state for technician gap scenarios in the Troubleshooting-Support category.
