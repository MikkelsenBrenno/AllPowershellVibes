<#
.SYNOPSIS
    Detects Performance Counter state.

.DESCRIPTION
    Detects Performance Counter state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Performance Counter is compliant
    Exit 1:      Performance Counter is noncompliant
