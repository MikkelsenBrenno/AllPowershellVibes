<#
.SYNOPSIS
    Detects Support Bundle state.

.DESCRIPTION
    Detects Support Bundle state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Support Bundle is compliant
    Exit 1:      Support Bundle is noncompliant
