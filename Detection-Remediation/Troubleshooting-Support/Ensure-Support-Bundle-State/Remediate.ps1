<#
.SYNOPSIS
    Remediates Support Bundle state.

.DESCRIPTION
    Writes configurable state evidence for Support Bundle remediation.
...
.INTUNE
    ...
    Exit 0:      Support Bundle remediation completed
    Exit 1:      Support Bundle remediation did not complete
...
$ScriptPackageName = 'Ensure-Support-Bundle-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Support Bundle'
...
$MarkerFileName = 'ensure-support-bundle-state.state'
$EvidenceFileName = 'ensure-support-bundle-state.json'
