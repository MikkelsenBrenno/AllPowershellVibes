<#
.SYNOPSIS
    Remediates MDM Diagnostic Package state.

.DESCRIPTION
    Writes configurable state evidence for MDM Diagnostic Package remediation.
...
.INTUNE
    ...
    Exit 0:      MDM Diagnostic Package remediation completed
    Exit 1:      MDM Diagnostic Package remediation did not complete
...
$ScriptPackageName = 'Ensure-MDM-Diagnostic-Package-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'MDM Diagnostic Package'
...
$MarkerFileName = 'ensure-mdm-diagnostic-package-marker.state'
$EvidenceFileName = 'ensure-mdm-diagnostic-package-marker.json'
