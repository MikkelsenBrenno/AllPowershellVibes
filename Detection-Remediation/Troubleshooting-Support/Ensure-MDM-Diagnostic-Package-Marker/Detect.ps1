<#
.SYNOPSIS
    Detects MDM Diagnostic Package state.

.DESCRIPTION
    Detects MDM Diagnostic Package state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      MDM Diagnostic Package is compliant
    Exit 1:      MDM Diagnostic Package is noncompliant
