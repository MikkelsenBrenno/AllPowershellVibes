<#
.SYNOPSIS
    Detects Event Error Snapshot state.

.DESCRIPTION
    Detects Event Error Snapshot state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Event Error Snapshot is compliant
    Exit 1:      Event Error Snapshot is noncompliant
