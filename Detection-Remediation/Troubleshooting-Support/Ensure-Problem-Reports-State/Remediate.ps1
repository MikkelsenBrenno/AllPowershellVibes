<#
.SYNOPSIS
    Remediates Problem Reports state.

.DESCRIPTION
    Writes configurable state evidence for Problem Reports remediation.
...
.INTUNE
    ...
    Exit 0:      Problem Reports remediation completed
    Exit 1:      Problem Reports remediation did not complete
...
$ScriptPackageName = 'Ensure-Problem-Reports-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Problem Reports'
...
$MarkerFileName = 'ensure-problem-reports-state.state'
$EvidenceFileName = 'ensure-problem-reports-state.json'
