<#
.SYNOPSIS
    Detects Problem Reports state.

.DESCRIPTION
    Detects Problem Reports state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Problem Reports is compliant
    Exit 1:      Problem Reports is noncompliant
