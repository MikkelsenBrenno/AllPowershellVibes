<#
.SYNOPSIS
    Remediates Reliability History state.

.DESCRIPTION
    Writes configurable state evidence for Reliability History remediation.
...
.INTUNE
    ...
    Exit 0:      Reliability History remediation completed
    Exit 1:      Reliability History remediation did not complete
...
$ScriptPackageName = 'Repair-Reliability-History-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Reliability History'
...
$MarkerFileName = 'repair-reliability-history-readiness.state'
$EvidenceFileName = 'repair-reliability-history-readiness.json'
