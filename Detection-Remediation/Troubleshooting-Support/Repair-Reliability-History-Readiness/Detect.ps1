<#
.SYNOPSIS
    Detects Reliability History state.

.DESCRIPTION
    Detects Reliability History state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Reliability History is compliant
    Exit 1:      Reliability History is noncompliant
