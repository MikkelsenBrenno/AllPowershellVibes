<#
.SYNOPSIS
    Detects Remote Assist Readiness state.

.DESCRIPTION
    Detects Remote Assist Readiness state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Remote Assist Readiness is compliant
    Exit 1:      Remote Assist Readiness is noncompliant
