<#
.SYNOPSIS
    Remediates Remote Assist Readiness state.

.DESCRIPTION
    Writes configurable state evidence for Remote Assist Readiness remediation.
...
.INTUNE
    ...
    Exit 0:      Remote Assist Readiness remediation completed
    Exit 1:      Remote Assist Readiness remediation did not complete
...
$ScriptPackageName = 'Ensure-Remote-Assist-Readiness-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Remote Assist Readiness'
...
$MarkerFileName = 'ensure-remote-assist-readiness-marker.state'
$EvidenceFileName = 'ensure-remote-assist-readiness-marker.json'
