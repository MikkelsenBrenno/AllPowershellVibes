<#
.SYNOPSIS
    Refreshes the TPM WMI Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-tpm-wmi-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPtpmwmieventsEventSnapshot.json'
