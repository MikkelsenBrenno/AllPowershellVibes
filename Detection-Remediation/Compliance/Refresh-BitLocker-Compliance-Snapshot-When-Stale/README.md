# BitLocker Compliance Snapshot

## Summary

Refreshes a local BitLocker compliance snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BitLockerComplianceSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BitLocker-Compliance-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BitLocker-Compliance-Snapshot-When-Stale`.
