<#
.SYNOPSIS
    Refreshes the BitLocker Compliance Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-BitLocker-Compliance-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BitLockerComplianceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'BitLocker compliance snapshot.'
