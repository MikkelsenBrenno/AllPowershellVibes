<#
.SYNOPSIS
    Refreshes the Device Install Service Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-device-install-service-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdeviceinstallserviceServiceSnapshot.json'
