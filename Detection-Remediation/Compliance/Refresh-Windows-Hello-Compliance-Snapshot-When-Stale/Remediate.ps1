<#
.SYNOPSIS
    Refreshes the Windows Hello Compliance Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-Windows-Hello-Compliance-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'WindowsHelloComplianceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Hello policy snapshot.'
