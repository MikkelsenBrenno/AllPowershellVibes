<#
.SYNOPSIS
    Refreshes the Device Guard Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-deviceguard-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdeviceguardeventsEventSnapshot.json'
