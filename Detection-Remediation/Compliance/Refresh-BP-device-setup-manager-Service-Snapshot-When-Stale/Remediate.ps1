<#
.SYNOPSIS
    Refreshes the Device Setup Manager Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-device-setup-manager-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdevicesetupmanagerServiceSnapshot.json'
