<#
.SYNOPSIS
    Refreshes the BitLocker API Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-bitlocker-api-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPbitlockerapieventsEventSnapshot.json'
