<#
.SYNOPSIS
    Remediates BitLocker Policy State state.

.DESCRIPTION
    Detects and remediates BitLocker Policy State state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      BitLocker Policy State remediation completed
    Exit 1:      BitLocker Policy State remediation failed
...
$ScriptPackageName = 'Ensure-BitLocker-Policy-State'
$ScriptName = 'Remediate'

$ManagedSettingName = 'BitLocker Policy State'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Contoso\Compliance'
$ValueName = 'BitLockerPolicyState'
