<#
.SYNOPSIS
    Remediates Ensure Password Reveal Button Disabled.
...
$ScriptPackageName = 'Ensure-Password-Reveal-Button-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\CredUI'; Name = 'DisablePasswordReveal'; Type = 'DWord'; Value = 1; Description = 'Disable the password reveal button' }
)
