<#
.SYNOPSIS
    Refreshes the SecureBoot TPM Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-SecureBoot-TPM-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'SecureBootTPMSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Secure Boot and TPM state snapshot.'
