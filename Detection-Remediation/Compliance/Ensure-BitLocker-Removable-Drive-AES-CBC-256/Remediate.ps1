<#
.SYNOPSIS
    Remediates Ensure BitLocker Removable Drive AES-CBC 256 Policy.
...
$ScriptPackageName = 'Ensure-BitLocker-Removable-Drive-AES-CBC-256'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\FVE'; Name = 'EncryptionMethodWithXtsRdv'; Type = 'DWord'; Value = 4; Description = 'Configure removable data drives for AES-CBC 256 when encrypted' }
)
