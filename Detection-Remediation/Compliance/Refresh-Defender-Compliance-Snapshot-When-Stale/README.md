# Defender Compliance Snapshot

## Summary

Refreshes a local Defender compliance status snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `DefenderComplianceSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Defender-Compliance-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Defender-Compliance-Snapshot-When-Stale`.
