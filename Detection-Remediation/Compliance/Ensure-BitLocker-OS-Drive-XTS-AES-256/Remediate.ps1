<#
.SYNOPSIS
    Remediates Ensure BitLocker OS Drive XTS-AES 256 Policy.
...
$ScriptPackageName = 'Ensure-BitLocker-OS-Drive-XTS-AES-256'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\FVE'; Name = 'EncryptionMethodWithXtsOs'; Type = 'DWord'; Value = 7; Description = 'Configure OS drives for XTS-AES 256 when encrypted' }
)
