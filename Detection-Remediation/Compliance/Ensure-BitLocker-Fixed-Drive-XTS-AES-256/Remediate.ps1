<#
.SYNOPSIS
    Remediates Ensure BitLocker Fixed Drive XTS-AES 256 Policy.
...
$ScriptPackageName = 'Ensure-BitLocker-Fixed-Drive-XTS-AES-256'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\FVE'; Name = 'EncryptionMethodWithXtsFdv'; Type = 'DWord'; Value = 7; Description = 'Configure fixed data drives for XTS-AES 256 when encrypted' }
)
