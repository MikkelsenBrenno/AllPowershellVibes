<#
.SYNOPSIS
    Remediates BitLocker Recovery State state.

.DESCRIPTION
    Detects and remediates BitLocker Recovery State state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      BitLocker Recovery State remediation completed
    Exit 1:      BitLocker Recovery State remediation failed
...
$ScriptPackageName = 'Ensure-BitLocker-Recovery-State'
$ScriptName = 'Remediate'

$ManagedSettingName = 'BitLocker Recovery State'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Contoso\Compliance'
$ValueName = 'BitLockerRecoveryState'
