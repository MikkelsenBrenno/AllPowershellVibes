<#
.SYNOPSIS
    Refreshes the BitLocker Drive Encryption Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-bitlocker-drive-encryption-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPbitlockerdriveencryptionServiceSnapshot.json'
