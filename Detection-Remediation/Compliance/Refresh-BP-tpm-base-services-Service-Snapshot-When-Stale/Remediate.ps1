<#
.SYNOPSIS
    Refreshes the TPM Base Services Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-tpm-base-services-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPtpmbaseservicesServiceSnapshot.json'
