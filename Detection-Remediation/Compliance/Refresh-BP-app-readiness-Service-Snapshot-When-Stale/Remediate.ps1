<#
.SYNOPSIS
    Refreshes the App Readiness Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-app-readiness-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPappreadinessServiceSnapshot.json'
