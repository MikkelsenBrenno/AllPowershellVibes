...
Refreshes a local compliance readiness snapshot covering OS, TPM, Secure Boot, and BitLocker signals.
...
| `$SnapshotFileName` | JSON snapshot file name. | `ComplianceReadinessSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Compliance-Readiness-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Compliance-Readiness-Snapshot-When-Stale`.
