<#
.SYNOPSIS
    Remediates Lid Action state.

.DESCRIPTION
    Writes configurable state evidence for Lid Action remediation.
...
.INTUNE
    ...
    Exit 0:      Lid Action remediation completed
    Exit 1:      Lid Action remediation did not complete
...
$ScriptPackageName = 'Refresh-Lid-Action-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Lid Action'
...
$MarkerFileName = 'refresh-lid-action-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-lid-action-snapshot-when-stale.json'
