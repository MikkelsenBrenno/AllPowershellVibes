<#
.SYNOPSIS
    Remediates Hibernate State state.

.DESCRIPTION
    Writes configurable state evidence for Hibernate State remediation.
...
.INTUNE
    ...
    Exit 0:      Hibernate State remediation completed
    Exit 1:      Hibernate State remediation did not complete
...
$ScriptPackageName = 'Ensure-Hibernate-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Hibernate State'
...
$MarkerFileName = 'ensure-hibernate-state.state'
$EvidenceFileName = 'ensure-hibernate-state.json'
