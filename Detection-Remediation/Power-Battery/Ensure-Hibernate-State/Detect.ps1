<#
.SYNOPSIS
    Detects Hibernate State state.

.DESCRIPTION
    Detects Hibernate State state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Hibernate State is compliant
    Exit 1:      Hibernate State is noncompliant
