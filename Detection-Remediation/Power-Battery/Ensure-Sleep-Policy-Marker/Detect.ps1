<#
.SYNOPSIS
    Detects Sleep Policy state.

.DESCRIPTION
    Detects Sleep Policy state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Sleep Policy is compliant
    Exit 1:      Sleep Policy is noncompliant
