<#
.SYNOPSIS
    Remediates Sleep Policy state.

.DESCRIPTION
    Writes configurable state evidence for Sleep Policy remediation.
...
.INTUNE
    ...
    Exit 0:      Sleep Policy remediation completed
    Exit 1:      Sleep Policy remediation did not complete
...
$ScriptPackageName = 'Ensure-Sleep-Policy-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Sleep Policy'
...
$MarkerFileName = 'ensure-sleep-policy-marker.state'
$EvidenceFileName = 'ensure-sleep-policy-marker.json'
