<#
.SYNOPSIS
    Remediates Fast Startup state.

.DESCRIPTION
    Writes configurable state evidence for Fast Startup remediation.
...
.INTUNE
    ...
    Exit 0:      Fast Startup remediation completed
    Exit 1:      Fast Startup remediation did not complete
...
$ScriptPackageName = 'Refresh-Fast-Startup-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Fast Startup'
...
$MarkerFileName = 'refresh-fast-startup-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-fast-startup-snapshot-when-stale.json'
