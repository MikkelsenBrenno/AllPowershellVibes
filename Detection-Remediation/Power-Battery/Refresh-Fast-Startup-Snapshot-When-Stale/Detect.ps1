<#
.SYNOPSIS
    Detects Fast Startup state.

.DESCRIPTION
    Detects Fast Startup state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Fast Startup is compliant
    Exit 1:      Fast Startup is noncompliant
