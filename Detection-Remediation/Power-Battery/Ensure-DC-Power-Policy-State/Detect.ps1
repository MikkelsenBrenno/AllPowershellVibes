<#
.SYNOPSIS
    Detects DC Power Policy state.

.DESCRIPTION
    Detects DC Power Policy state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      DC Power Policy is compliant
    Exit 1:      DC Power Policy is noncompliant
