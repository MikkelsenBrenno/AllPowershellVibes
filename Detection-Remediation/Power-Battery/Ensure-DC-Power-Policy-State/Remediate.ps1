<#
.SYNOPSIS
    Remediates DC Power Policy state.

.DESCRIPTION
    Writes configurable state evidence for DC Power Policy remediation.
...
.INTUNE
    ...
    Exit 0:      DC Power Policy remediation completed
    Exit 1:      DC Power Policy remediation did not complete
...
$ScriptPackageName = 'Ensure-DC-Power-Policy-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'DC Power Policy'
...
$MarkerFileName = 'ensure-dc-power-policy-state.state'
$EvidenceFileName = 'ensure-dc-power-policy-state.json'
