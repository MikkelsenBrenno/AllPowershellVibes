<#
.SYNOPSIS
    Remediates Power Plan state.

.DESCRIPTION
    Writes configurable state evidence for Power Plan remediation.
...
.INTUNE
    ...
    Exit 0:      Power Plan remediation completed
    Exit 1:      Power Plan remediation did not complete
...
$ScriptPackageName = 'Repair-Power-Plan-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Power Plan'
...
$MarkerFileName = 'repair-power-plan-readiness.state'
$EvidenceFileName = 'repair-power-plan-readiness.json'
