<#
.SYNOPSIS
    Detects AC Power Policy state.

.DESCRIPTION
    Detects AC Power Policy state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      AC Power Policy is compliant
    Exit 1:      AC Power Policy is noncompliant
