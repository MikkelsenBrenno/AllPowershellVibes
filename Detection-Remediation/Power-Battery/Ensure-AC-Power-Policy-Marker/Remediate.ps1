<#
.SYNOPSIS
    Remediates AC Power Policy state.

.DESCRIPTION
    Writes configurable state evidence for AC Power Policy remediation.
...
.INTUNE
    ...
    Exit 0:      AC Power Policy remediation completed
    Exit 1:      AC Power Policy remediation did not complete
...
$ScriptPackageName = 'Ensure-AC-Power-Policy-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'AC Power Policy'
...
$MarkerFileName = 'ensure-ac-power-policy-marker.state'
$EvidenceFileName = 'ensure-ac-power-policy-marker.json'
