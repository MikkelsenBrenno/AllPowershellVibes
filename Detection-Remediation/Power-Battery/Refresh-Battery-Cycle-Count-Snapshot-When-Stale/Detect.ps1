<#
.SYNOPSIS
    Detects Battery Cycle Count state.

.DESCRIPTION
    Detects Battery Cycle Count state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Battery Cycle Count is compliant
    Exit 1:      Battery Cycle Count is noncompliant
