<#
.SYNOPSIS
    Remediates Battery Cycle Count state.

.DESCRIPTION
    Writes configurable state evidence for Battery Cycle Count remediation.
...
.INTUNE
    ...
    Exit 0:      Battery Cycle Count remediation completed
    Exit 1:      Battery Cycle Count remediation did not complete
...
$ScriptPackageName = 'Refresh-Battery-Cycle-Count-Snapshot-When-Stale'
...
$MarkerFileName = 'refresh-battery-cycle-count-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-battery-cycle-count-snapshot-when-stale.json'
