<#
.SYNOPSIS
    Detects USB Selective Suspend state.

.DESCRIPTION
    Detects USB Selective Suspend state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      USB Selective Suspend is compliant
    Exit 1:      USB Selective Suspend is noncompliant
