<#
.SYNOPSIS
    Remediates Disk Timeout state.

.DESCRIPTION
    Writes configurable state evidence for Disk Timeout remediation.
...
.INTUNE
    ...
    Exit 0:      Disk Timeout remediation completed
    Exit 1:      Disk Timeout remediation did not complete
...
$ScriptPackageName = 'Ensure-Disk-Timeout-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Disk Timeout'
...
$MarkerFileName = 'ensure-disk-timeout-marker.state'
$EvidenceFileName = 'ensure-disk-timeout-marker.json'
