<#
.SYNOPSIS
    Detects Modern Standby state.

.DESCRIPTION
    Detects Modern Standby state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Modern Standby is compliant
    Exit 1:      Modern Standby is noncompliant
