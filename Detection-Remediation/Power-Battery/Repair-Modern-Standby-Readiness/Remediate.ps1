<#
.SYNOPSIS
    Remediates Modern Standby state.

.DESCRIPTION
    Writes configurable state evidence for Modern Standby remediation.
...
.INTUNE
    ...
    Exit 0:      Modern Standby remediation completed
    Exit 1:      Modern Standby remediation did not complete
...
$ScriptPackageName = 'Repair-Modern-Standby-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Modern Standby'
...
$MarkerFileName = 'repair-modern-standby-readiness.state'
$EvidenceFileName = 'repair-modern-standby-readiness.json'
