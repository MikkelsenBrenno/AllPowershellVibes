<#
.SYNOPSIS
    Remediates Screen Timeout state.

.DESCRIPTION
    Writes configurable state evidence for Screen Timeout remediation.
...
.INTUNE
    ...
    Exit 0:      Screen Timeout remediation completed
    Exit 1:      Screen Timeout remediation did not complete
...
$ScriptPackageName = 'Repair-Screen-Timeout-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Screen Timeout'
...
$MarkerFileName = 'repair-screen-timeout-readiness.state'
$EvidenceFileName = 'repair-screen-timeout-readiness.json'
