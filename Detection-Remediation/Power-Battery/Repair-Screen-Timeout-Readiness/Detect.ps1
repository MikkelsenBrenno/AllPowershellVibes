<#
.SYNOPSIS
    Detects Screen Timeout state.

.DESCRIPTION
    Detects Screen Timeout state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Screen Timeout is compliant
    Exit 1:      Screen Timeout is noncompliant
