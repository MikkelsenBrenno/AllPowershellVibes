<#
.SYNOPSIS
    Remediates Battery Health state.

.DESCRIPTION
    Writes configurable state evidence for Battery Health remediation.
...
.INTUNE
    ...
    Exit 0:      Battery Health remediation completed
    Exit 1:      Battery Health remediation did not complete
...
$ScriptPackageName = 'Ensure-Battery-Health-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Battery Health'
...
$MarkerFileName = 'ensure-battery-health-state.state'
$EvidenceFileName = 'ensure-battery-health-state.json'
