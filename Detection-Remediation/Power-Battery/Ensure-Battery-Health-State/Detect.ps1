<#
.SYNOPSIS
    Detects Battery Health state.

.DESCRIPTION
    Detects Battery Health state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Battery Health is compliant
    Exit 1:      Battery Health is noncompliant
