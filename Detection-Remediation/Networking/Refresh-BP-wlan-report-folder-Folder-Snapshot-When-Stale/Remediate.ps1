<#
.SYNOPSIS
    Refreshes the WLAN Report Folder Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-wlan-report-folder-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwlanreportfolderFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'WLAN Report Folder folder size snapshot for technician troubleshooting.'
