<#
.SYNOPSIS
    Refreshes the DNS Client Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-dns-client-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdnsclientServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'DNS Client service state snapshot for technician troubleshooting.'
