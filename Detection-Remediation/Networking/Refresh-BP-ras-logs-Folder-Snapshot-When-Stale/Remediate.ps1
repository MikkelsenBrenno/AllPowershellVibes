<#
.SYNOPSIS
    Refreshes the Remote Access Logs Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-ras-logs-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPraslogsFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Remote Access Logs folder size snapshot for technician troubleshooting.'
