<#
.SYNOPSIS
    Remediates Ensure Teredo Disabled.
...
$ScriptPackageName = 'Ensure-Teredo-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\TCPIP\v6Transition'; Name = 'Teredo_State'; Type = 'String'; Value = 'Disabled'; Description = 'Disable Teredo transition technology' }
)
