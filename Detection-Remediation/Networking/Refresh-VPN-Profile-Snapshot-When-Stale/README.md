# VPN Profile Snapshot

## Summary

Refreshes a local VPN profile snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `VPNProfileSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-VPN-Profile-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-VPN-Profile-Snapshot-When-Stale`.
