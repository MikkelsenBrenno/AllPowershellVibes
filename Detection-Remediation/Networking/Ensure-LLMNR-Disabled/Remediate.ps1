<#
.SYNOPSIS
    Remediates Ensure LLMNR Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure LLMNR Disabled remediation succeeded
    Exit 1:      Ensure LLMNR Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure LLMNR Disabled.'
    exit 1
}
