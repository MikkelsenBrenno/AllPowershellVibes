...
Detects and remediates the DNS Client policy that disables multicast name resolution on managed Windows endpoints.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-LLMNR-Disabled`.
