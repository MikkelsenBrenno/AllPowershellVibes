<#
.SYNOPSIS
    Remediates Ensure DNS Suffix Devolution Disabled.
...
$ScriptPackageName = 'Ensure-DNS-Suffix-Devolution-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\DNSClient'; Name = 'UseDomainNameDevolution'; Type = 'DWord'; Value = 0; Description = 'Disable primary DNS suffix devolution' }
)
