<#
.SYNOPSIS
    Refreshes the WLAN AutoConfig Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-wlan-autoconfig-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwlanautoconfigeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'WLAN AutoConfig Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-WLAN-AutoConfig/Operational'
$RecentEventCount = 80
$EventIdsToHighlight = @(4001, 8000, 8001, 11004)
