<#
.SYNOPSIS
    Refreshes the WWAN AutoConfig Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-wwan-autoconfig-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwwanautoconfigServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'WWAN AutoConfig service state snapshot for technician troubleshooting.'

$ServiceNames = @('WwanSvc')
