...
.INTUNE
    ...
    Exit 0:      DHCP Client Service remediation succeeded
    Exit 1:      DHCP Client Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for DHCP Client Service.'
    exit 1
}
