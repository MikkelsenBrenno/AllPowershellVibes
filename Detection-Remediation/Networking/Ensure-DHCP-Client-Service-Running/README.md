# Ensure DHCP Client Service Running

## Summary

Detects and remediates devices where the DHCP Client service is stopped, which can break IP addressing and network access.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-DHCP-Client-Service-Running`.
