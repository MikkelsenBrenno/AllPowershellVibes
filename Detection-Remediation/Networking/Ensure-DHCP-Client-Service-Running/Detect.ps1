<#
.SYNOPSIS
    Detects whether DHCP Client Service is running.
...
.INTUNE
    ...
    Exit 0:      DHCP Client Service is running
    Exit 1:      DHCP Client Service is missing or stopped
...
$ScriptPackageName = 'Ensure-DHCP-Client-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. DHCP Client Service could not be validated.'
    exit 1
}
