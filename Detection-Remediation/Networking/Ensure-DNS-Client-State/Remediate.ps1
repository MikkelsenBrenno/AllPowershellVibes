<#
.SYNOPSIS
    Remediates DNS Client State state.

.DESCRIPTION
    Detects and remediates DNS Client State state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      DNS Client State remediation completed
    Exit 1:      DNS Client State remediation failed
...
$ScriptPackageName = 'Ensure-DNS-Client-State'
$ScriptName = 'Remediate'

$ManagedSettingName = 'DNS Client State'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Contoso\Networking'
$ValueName = 'DNSClientState'
