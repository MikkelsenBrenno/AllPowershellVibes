# Ensure Network Location Awareness Service Running

## Summary

Detects and remediates devices where Network Location Awareness is stopped, helping firewall profile and domain network detection.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Network-Location-Awareness-Service-Running`.
