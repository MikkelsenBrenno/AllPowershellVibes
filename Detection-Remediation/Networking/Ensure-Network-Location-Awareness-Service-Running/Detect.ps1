<#
.SYNOPSIS
    Detects whether Network Location Awareness Service is running.
...
.INTUNE
    ...
    Exit 0:      Network Location Awareness Service is running
    Exit 1:      Network Location Awareness Service is missing or stopped
...
$ScriptPackageName = 'Ensure-Network-Location-Awareness-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. Network Location Awareness Service could not be validated.'
    exit 1
}
