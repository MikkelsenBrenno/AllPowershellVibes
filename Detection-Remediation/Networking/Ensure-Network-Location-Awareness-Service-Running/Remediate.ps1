<#
.SYNOPSIS
    Starts Network Location Awareness Service.
...
.INTUNE
    ...
    Exit 0:      Network Location Awareness Service remediation succeeded
    Exit 1:      Network Location Awareness Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Network Location Awareness Service.'
    exit 1
}
