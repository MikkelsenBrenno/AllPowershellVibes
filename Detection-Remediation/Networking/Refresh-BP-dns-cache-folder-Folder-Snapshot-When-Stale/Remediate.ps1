<#
.SYNOPSIS
    Refreshes the DNS Cache Folder Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-dns-cache-folder-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdnscachefolderFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'DNS Cache Folder folder size snapshot for technician troubleshooting.'
