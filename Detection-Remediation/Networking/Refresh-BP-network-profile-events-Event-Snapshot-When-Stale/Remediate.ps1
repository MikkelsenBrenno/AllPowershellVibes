<#
.SYNOPSIS
    Refreshes the Network Profile Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-network-profile-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPnetworkprofileeventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Network Profile Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Microsoft-Windows-NetworkProfile/Operational'
$RecentEventCount = 80
$EventIdsToHighlight = @(10000, 10001)
