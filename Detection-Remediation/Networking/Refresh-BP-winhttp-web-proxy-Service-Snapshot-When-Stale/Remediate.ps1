<#
.SYNOPSIS
    Refreshes the WinHTTP Web Proxy Auto-Discovery Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-winhttp-web-proxy-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwinhttpwebproxyServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'WinHTTP Web Proxy Auto-Discovery service state snapshot for technician troubleshooting.'

$ServiceNames = @('WinHttpAutoProxySvc')
