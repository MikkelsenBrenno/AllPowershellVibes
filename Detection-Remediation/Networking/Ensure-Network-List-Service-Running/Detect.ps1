<#
.SYNOPSIS
    Detects whether Network List Service is running.
...
.INTUNE
    ...
    Exit 0:      Network List Service is running
    Exit 1:      Network List Service is missing or stopped
...
$ScriptPackageName = 'Ensure-Network-List-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. Network List Service could not be validated.'
    exit 1
}
