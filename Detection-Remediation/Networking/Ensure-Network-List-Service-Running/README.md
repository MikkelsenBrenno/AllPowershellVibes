# Ensure Network List Service Running

## Summary

Detects and remediates devices where Network List Service is stopped, which can affect network profile detection and firewall behavior.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Network-List-Service-Running`.
