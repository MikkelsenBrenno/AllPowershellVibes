...
.INTUNE
    ...
    Exit 0:      Network List Service remediation succeeded
    Exit 1:      Network List Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Network List Service.'
    exit 1
}
