<#
.SYNOPSIS
    Refreshes the WLAN AutoConfig Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-wlan-autoconfig-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwlanautoconfigServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'WLAN AutoConfig service state snapshot for technician troubleshooting.'
