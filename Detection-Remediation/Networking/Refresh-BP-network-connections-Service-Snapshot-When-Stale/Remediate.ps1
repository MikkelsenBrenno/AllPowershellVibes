<#
.SYNOPSIS
    Refreshes the Network Connections Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-network-connections-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPnetworkconnectionsServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Network Connections service state snapshot for technician troubleshooting.'
