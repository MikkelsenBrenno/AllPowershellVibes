<#
.SYNOPSIS
    Refreshes the IP Helper Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-ip-helper-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPiphelperServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'IP Helper service state snapshot for technician troubleshooting.'
