<#
.SYNOPSIS
    Refreshes the Network List Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-network-list-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPnetworklistServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Network List service state snapshot for technician troubleshooting.'

$ServiceNames = @('netprofm')
