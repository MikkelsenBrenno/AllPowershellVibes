<#
.SYNOPSIS
    Refreshes the RAS Client Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-rasclient-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPrasclienteventsEventSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'RAS Client Events event log snapshot for technician troubleshooting.'

$EventLogName = 'Application'
$RecentEventCount = 80
$EventIdsToHighlight = @(20221, 20222, 20223, 20227)
