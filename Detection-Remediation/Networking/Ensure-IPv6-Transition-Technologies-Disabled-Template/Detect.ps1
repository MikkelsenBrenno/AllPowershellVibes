<#
.SYNOPSIS
    Detects Ensure IPv6 Transition Technologies Disabled Template.
...
.INTUNE
    ...
    Exit 0:      Ensure IPv6 Transition Technologies Disabled Template is compliant
    Exit 1:      Ensure IPv6 Transition Technologies Disabled Template is missing or different
...
$ScriptPackageName = 'Ensure-IPv6-Transition-Technologies-Disabled-Template'
$ScriptName = 'Detect'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\TCPIP\v6Transition'; Name = '6to4_State'; Type = 'String'; Value = 'Disabled'; Description = 'Disable 6to4 transition technology policy' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\TCPIP\v6Transition'; Name = 'ISATAP_State'; Type = 'String'; Value = 'Disabled'; Description = 'Disable ISATAP transition technology policy' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\TCPIP\v6Transition'; Name = 'Teredo_State'; Type = 'String'; Value = 'Disabled'; Description = 'Disable Teredo transition technology policy' }
)
...
try {
    ...
    Write-Output 'Not compliant. Ensure IPv6 Transition Technologies Disabled Template could not be validated.'
    exit 1
}
