# Ensure IPv6 Transition Technologies Disabled Template

## Summary

Template remediation that detects and disables common IPv6 transition technologies where tunnel mechanisms are not required.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-IPv6-Transition-Technologies-Disabled-Template`.
