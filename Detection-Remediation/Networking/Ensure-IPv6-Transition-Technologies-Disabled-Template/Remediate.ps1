<#
.SYNOPSIS
    Remediates Ensure IPv6 Transition Technologies Disabled Template.
...
.INTUNE
    ...
    Exit 0:      Ensure IPv6 Transition Technologies Disabled Template remediation succeeded
    Exit 1:      Ensure IPv6 Transition Technologies Disabled Template remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure IPv6 Transition Technologies Disabled Template.'
    exit 1
}
