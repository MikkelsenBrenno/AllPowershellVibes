<#
.SYNOPSIS
    Remediates DNS Connectivity state.

.DESCRIPTION
    Detects and remediates DNS Connectivity state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      DNS Connectivity remediation completed
    Exit 1:      DNS Connectivity remediation failed
...
$ScriptPackageName = 'Ensure-DNS-Connectivity'
$ScriptName = 'Remediate'

$ManagedSettingName = 'DNS Connectivity'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Contoso\Networking'
$ValueName = 'DNSConnectivity'
