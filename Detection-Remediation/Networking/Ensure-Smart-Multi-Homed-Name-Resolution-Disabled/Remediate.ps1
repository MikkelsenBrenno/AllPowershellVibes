<#
.SYNOPSIS
    Remediates Ensure Smart Multi-Homed Name Resolution Disabled.
...
$ScriptPackageName = 'Ensure-Smart-Multi-Homed-Name-Resolution-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\DNSClient'; Name = 'DisableSmartNameResolution'; Type = 'DWord'; Value = 1; Description = 'Disable smart multi-homed name resolution' }
)
