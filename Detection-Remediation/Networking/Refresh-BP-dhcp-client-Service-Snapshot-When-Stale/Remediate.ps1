<#
.SYNOPSIS
    Refreshes the DHCP Client Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-dhcp-client-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdhcpclientServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'DHCP Client service state snapshot for technician troubleshooting.'
