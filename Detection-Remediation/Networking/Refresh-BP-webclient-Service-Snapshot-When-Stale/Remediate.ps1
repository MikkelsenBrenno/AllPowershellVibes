<#
.SYNOPSIS
    Refreshes the WebClient Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-webclient-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwebclientServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'WebClient service state snapshot for technician troubleshooting.'

$ServiceNames = @('WebClient')
