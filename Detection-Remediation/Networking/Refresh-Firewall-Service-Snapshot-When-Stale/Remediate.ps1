<#
.SYNOPSIS
    Refreshes the Firewall Service Snapshot snapshot.
...
$ScriptPackageName = 'Refresh-Firewall-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'FirewallServiceSnapshot.json'
