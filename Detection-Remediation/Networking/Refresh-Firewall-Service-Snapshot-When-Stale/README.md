# Firewall Service Snapshot

## Summary

Refreshes a local firewall service snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `FirewallServiceSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Firewall-Service-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-Firewall-Service-Snapshot-When-Stale`.
