<#
.SYNOPSIS
    Detects Ensure Teredo Disabled Template.
...
.INTUNE
    ...
    Exit 0:      Ensure Teredo Disabled Template is compliant
    Exit 1:      Ensure Teredo Disabled Template is missing or different
...
$ScriptPackageName = 'Ensure-Teredo-Disabled-Template'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. Ensure Teredo Disabled Template could not be validated.'
    exit 1
}
