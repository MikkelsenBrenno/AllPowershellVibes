# Ensure Teredo Disabled Template

## Summary

Template remediation that detects and disables Teredo transition technology policy where IPv6 transition tunnels are not required.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Teredo-Disabled-Template`.
