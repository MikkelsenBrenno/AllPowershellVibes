<#
.SYNOPSIS
    Remediates Ensure Teredo Disabled Template.
...
.INTUNE
    ...
    Exit 0:      Ensure Teredo Disabled Template remediation succeeded
    Exit 1:      Ensure Teredo Disabled Template remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Teredo Disabled Template.'
    exit 1
}
