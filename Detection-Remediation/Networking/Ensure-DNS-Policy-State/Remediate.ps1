<#
.SYNOPSIS
    Remediates DNS Policy State state.

.DESCRIPTION
    Detects and remediates DNS Policy State state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      DNS Policy State remediation completed
    Exit 1:      DNS Policy State remediation failed
...
$ScriptPackageName = 'Ensure-DNS-Policy-State'
$ScriptName = 'Remediate'

$ManagedSettingName = 'DNS Policy State'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Contoso\Networking'
$ValueName = 'DNSPolicyState'
