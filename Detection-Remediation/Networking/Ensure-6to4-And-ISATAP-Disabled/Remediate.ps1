<#
.SYNOPSIS
    Remediates Ensure 6to4 And ISATAP Disabled.
...
$ScriptPackageName = 'Ensure-6to4-And-ISATAP-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\TCPIP\v6Transition'; Name = '6to4_State'; Type = 'String'; Value = 'Disabled'; Description = 'Disable 6to4 transition technology' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\TCPIP\v6Transition'; Name = 'ISATAP_State'; Type = 'String'; Value = 'Disabled'; Description = 'Disable ISATAP transition technology' }
)
