<#
.SYNOPSIS
    Refreshes the Network Location Awareness Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-network-location-awareness-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPnetworklocationawarenessServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Network Location Awareness service state snapshot for technician troubleshooting.'
