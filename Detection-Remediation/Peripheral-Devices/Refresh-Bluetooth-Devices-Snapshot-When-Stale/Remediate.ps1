<#
.SYNOPSIS
    Remediates Bluetooth Devices state.

.DESCRIPTION
    Writes configurable state evidence for Bluetooth Devices remediation.
...
.INTUNE
    ...
    Exit 0:      Bluetooth Devices remediation completed
    Exit 1:      Bluetooth Devices remediation did not complete
...
$ScriptPackageName = 'Refresh-Bluetooth-Devices-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Bluetooth Devices'
$PurposeCategory = 'Peripheral-Devices'
$ManagedStateRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Peripheral-Devices'
$MarkerFileName = 'refresh-bluetooth-devices-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-bluetooth-devices-snapshot-when-stale.json'
