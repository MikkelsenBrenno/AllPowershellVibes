<#
.SYNOPSIS
    Detects Bluetooth Devices state.

.DESCRIPTION
    Detects Bluetooth Devices state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Bluetooth Devices is compliant
    Exit 1:      Bluetooth Devices is noncompliant
