<#
.SYNOPSIS
    Remediates Signature Pad state.

.DESCRIPTION
    Writes configurable state evidence for Signature Pad remediation.
...
.INTUNE
    ...
    Exit 0:      Signature Pad remediation completed
    Exit 1:      Signature Pad remediation did not complete
...
$ScriptPackageName = 'Refresh-Signature-Pad-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Signature Pad'
...
$MarkerFileName = 'refresh-signature-pad-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-signature-pad-snapshot-when-stale.json'
