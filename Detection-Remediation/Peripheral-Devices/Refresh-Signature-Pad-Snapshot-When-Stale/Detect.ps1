<#
.SYNOPSIS
    Detects Signature Pad state.

.DESCRIPTION
    Detects Signature Pad state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Signature Pad is compliant
    Exit 1:      Signature Pad is noncompliant
