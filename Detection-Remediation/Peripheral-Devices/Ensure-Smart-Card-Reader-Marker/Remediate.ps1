<#
.SYNOPSIS
    Remediates Smart Card Reader state.

.DESCRIPTION
    Writes configurable state evidence for Smart Card Reader remediation.
...
.INTUNE
    ...
    Exit 0:      Smart Card Reader remediation completed
    Exit 1:      Smart Card Reader remediation did not complete
...
$ScriptPackageName = 'Ensure-Smart-Card-Reader-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Smart Card Reader'
...
$MarkerFileName = 'ensure-smart-card-reader-marker.state'
$EvidenceFileName = 'ensure-smart-card-reader-marker.json'
