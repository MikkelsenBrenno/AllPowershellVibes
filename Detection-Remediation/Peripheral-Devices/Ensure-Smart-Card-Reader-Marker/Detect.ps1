<#
.SYNOPSIS
    Detects Smart Card Reader state.

.DESCRIPTION
    Detects Smart Card Reader state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Smart Card Reader is compliant
    Exit 1:      Smart Card Reader is noncompliant
