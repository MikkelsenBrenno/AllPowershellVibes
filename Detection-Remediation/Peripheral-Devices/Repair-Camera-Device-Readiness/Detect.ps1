<#
.SYNOPSIS
    Detects Camera Device state.

.DESCRIPTION
    Detects Camera Device state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Camera Device is compliant
    Exit 1:      Camera Device is noncompliant
