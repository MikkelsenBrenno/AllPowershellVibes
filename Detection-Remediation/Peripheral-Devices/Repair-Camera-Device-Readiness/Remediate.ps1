<#
.SYNOPSIS
    Remediates Camera Device state.

.DESCRIPTION
    Writes configurable state evidence for Camera Device remediation.
...
.INTUNE
    ...
    Exit 0:      Camera Device remediation completed
    Exit 1:      Camera Device remediation did not complete
...
$ScriptPackageName = 'Repair-Camera-Device-Readiness'
...
$MarkerFileName = 'repair-camera-device-readiness.state'
$EvidenceFileName = 'repair-camera-device-readiness.json'
