<#
.SYNOPSIS
    Remediates USB Devices state.

.DESCRIPTION
    Writes configurable state evidence for USB Devices remediation.
...
.INTUNE
    ...
    Exit 0:      USB Devices remediation completed
    Exit 1:      USB Devices remediation did not complete
...
$ScriptPackageName = 'Ensure-USB-Devices-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'USB Devices'
...
$MarkerFileName = 'ensure-usb-devices-state.state'
$EvidenceFileName = 'ensure-usb-devices-state.json'
