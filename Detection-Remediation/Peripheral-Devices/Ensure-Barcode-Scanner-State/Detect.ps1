<#
.SYNOPSIS
    Detects Barcode Scanner state.

.DESCRIPTION
    Detects Barcode Scanner state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Barcode Scanner is compliant
    Exit 1:      Barcode Scanner is noncompliant
