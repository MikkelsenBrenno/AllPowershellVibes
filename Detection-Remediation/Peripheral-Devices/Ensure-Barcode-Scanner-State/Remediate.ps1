<#
.SYNOPSIS
    Remediates Barcode Scanner state.

.DESCRIPTION
    Writes configurable state evidence for Barcode Scanner remediation.
...
.INTUNE
    ...
    Exit 0:      Barcode Scanner remediation completed
    Exit 1:      Barcode Scanner remediation did not complete
...
$ScriptPackageName = 'Ensure-Barcode-Scanner-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Barcode Scanner'
...
$MarkerFileName = 'ensure-barcode-scanner-state.state'
$EvidenceFileName = 'ensure-barcode-scanner-state.json'
