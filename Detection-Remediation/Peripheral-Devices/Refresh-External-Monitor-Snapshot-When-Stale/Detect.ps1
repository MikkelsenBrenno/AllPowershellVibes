<#
.SYNOPSIS
    Detects External Monitor state.

.DESCRIPTION
    Detects External Monitor state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      External Monitor is compliant
    Exit 1:      External Monitor is noncompliant
