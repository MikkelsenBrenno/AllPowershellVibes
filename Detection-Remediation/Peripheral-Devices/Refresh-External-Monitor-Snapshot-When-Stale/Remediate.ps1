<#
.SYNOPSIS
    Remediates External Monitor state.

.DESCRIPTION
    Writes configurable state evidence for External Monitor remediation.
...
.INTUNE
    ...
    Exit 0:      External Monitor remediation completed
    Exit 1:      External Monitor remediation did not complete
...
$ScriptPackageName = 'Refresh-External-Monitor-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'External Monitor'
...
$MarkerFileName = 'refresh-external-monitor-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-external-monitor-snapshot-when-stale.json'
