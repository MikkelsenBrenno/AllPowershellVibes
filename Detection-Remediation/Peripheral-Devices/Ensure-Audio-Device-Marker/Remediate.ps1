<#
.SYNOPSIS
    Remediates Audio Device state.

.DESCRIPTION
    Writes configurable state evidence for Audio Device remediation.
...
.INTUNE
    ...
    Exit 0:      Audio Device remediation completed
    Exit 1:      Audio Device remediation did not complete
...
$ScriptPackageName = 'Ensure-Audio-Device-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Audio Device'
...
$MarkerFileName = 'ensure-audio-device-marker.state'
$EvidenceFileName = 'ensure-audio-device-marker.json'
