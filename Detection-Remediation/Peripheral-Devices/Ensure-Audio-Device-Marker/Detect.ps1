<#
.SYNOPSIS
    Detects Audio Device state.

.DESCRIPTION
    Detects Audio Device state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Audio Device is compliant
    Exit 1:      Audio Device is noncompliant
