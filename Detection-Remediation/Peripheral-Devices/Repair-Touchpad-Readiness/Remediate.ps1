<#
.SYNOPSIS
    Remediates Touchpad state.

.DESCRIPTION
    Writes configurable state evidence for Touchpad remediation.
...
.INTUNE
    ...
    Exit 0:      Touchpad remediation completed
    Exit 1:      Touchpad remediation did not complete
...
$ScriptPackageName = 'Repair-Touchpad-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Touchpad'
...
$MarkerFileName = 'repair-touchpad-readiness.state'
$EvidenceFileName = 'repair-touchpad-readiness.json'
