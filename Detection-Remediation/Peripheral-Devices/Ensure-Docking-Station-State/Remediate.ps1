<#
.SYNOPSIS
    Remediates Docking Station state.

.DESCRIPTION
    Writes configurable state evidence for Docking Station remediation.
...
.INTUNE
    ...
    Exit 0:      Docking Station remediation completed
    Exit 1:      Docking Station remediation did not complete
...
$ScriptPackageName = 'Ensure-Docking-Station-State'
$ScriptName = 'Remediate'

$ManagedItemName = 'Docking Station'
...
$MarkerFileName = 'ensure-docking-station-state.state'
$EvidenceFileName = 'ensure-docking-station-state.json'
