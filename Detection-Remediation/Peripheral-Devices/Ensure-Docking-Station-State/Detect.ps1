<#
.SYNOPSIS
    Detects Docking Station state.

.DESCRIPTION
    Detects Docking Station state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Docking Station is compliant
    Exit 1:      Docking Station is noncompliant
