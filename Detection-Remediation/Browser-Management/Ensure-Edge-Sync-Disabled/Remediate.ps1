<#
.SYNOPSIS
    Remediates Ensure Edge Sync Disabled.
...
$ScriptPackageName = 'Ensure-Edge-Sync-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'SyncDisabled'; Type = 'DWord'; Value = 1; Description = 'Disable browser profile-data synchronization' }
)
