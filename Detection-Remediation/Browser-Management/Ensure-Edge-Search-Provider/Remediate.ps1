<#
.SYNOPSIS
    Remediates Edge Search Provider state.

.DESCRIPTION
    Detects and remediates Edge Search Provider state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Edge Search Provider remediation completed
    Exit 1:      Edge Search Provider remediation failed
...
$ScriptPackageName = 'Ensure-Edge-Search-Provider'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Edge Search Provider'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'
$ValueName = 'EdgeSearchProvider'
$ExpectedValue = 'Contoso Search'
