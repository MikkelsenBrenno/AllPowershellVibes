<#
.SYNOPSIS
    Remediates Ensure Edge Dangerous Downloads Blocked.
...
$ScriptPackageName = 'Ensure-Edge-Dangerous-Downloads-Blocked'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'DownloadRestrictions'; Type = 'DWord'; Value = 1; Description = 'Block malicious downloads and dangerous file types' }
)
