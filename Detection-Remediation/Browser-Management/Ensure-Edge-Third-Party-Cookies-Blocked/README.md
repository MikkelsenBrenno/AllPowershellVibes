# Ensure Edge Third-Party Cookies Blocked

## Summary

Blocks third-party cookies in Microsoft Edge.
...
| --- | --- | --- | --- |
| `HKLM:\SOFTWARE\Policies\Microsoft\Edge` | `BlockThirdPartyCookies` | `DWord` | `1` |

**Effect:** Applies the Edge policy that prevents third-party sites from setting cookies.
...
- Pilot line-of-business, identity, payment, and embedded-content workflows because blocking third-party cookies can break cross-site scenarios.
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Edge-Third-Party-Cookies-Blocked`.
...
8. Run detection again, review the package logs and Intune Management Extension logs, then perform the product check: Open `edge://policy`, confirm `BlockThirdPartyCookies` is applied, and test representative cross-site sign-in and embedded-content workflows.
...
- [Microsoft Edge policy documentation](https://learn.microsoft.com/en-us/deployedge/microsoft-edge-policies/blockthirdpartycookies)
