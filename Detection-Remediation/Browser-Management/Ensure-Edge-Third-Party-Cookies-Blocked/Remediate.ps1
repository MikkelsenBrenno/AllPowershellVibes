<#
.SYNOPSIS
    Remediates Ensure Edge Third-Party Cookies Blocked.
...
$ScriptPackageName = 'Ensure-Edge-Third-Party-Cookies-Blocked'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'BlockThirdPartyCookies'; Type = 'DWord'; Value = 1; Description = 'Block third-party cookies' }
)
