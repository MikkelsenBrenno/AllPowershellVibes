<#
.SYNOPSIS
    Remediates Ensure Edge External Extensions Blocked.
...
$ScriptPackageName = 'Ensure-Edge-External-Extensions-Blocked'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'BlockExternalExtensions'; Type = 'DWord'; Value = 1; Description = 'Block extensions from external locations' }
)
