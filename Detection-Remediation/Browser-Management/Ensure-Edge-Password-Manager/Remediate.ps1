<#
.SYNOPSIS
    Remediates Edge Password Manager state.

.DESCRIPTION
    Detects and remediates Edge Password Manager state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Edge Password Manager remediation completed
    Exit 1:      Edge Password Manager remediation failed
...
$ScriptPackageName = 'Ensure-Edge-Password-Manager'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Edge Password Manager'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'
$ValueName = 'EdgePasswordManager'
