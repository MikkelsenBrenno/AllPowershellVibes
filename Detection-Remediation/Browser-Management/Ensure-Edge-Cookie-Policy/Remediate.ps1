<#
.SYNOPSIS
    Remediates Edge Cookie Policy state.

.DESCRIPTION
    Detects and remediates Edge Cookie Policy state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Edge Cookie Policy remediation completed
    Exit 1:      Edge Cookie Policy remediation failed
...
$ScriptPackageName = 'Ensure-Edge-Cookie-Policy'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Edge Cookie Policy'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'
$ValueName = 'EdgeCookiePolicy'
