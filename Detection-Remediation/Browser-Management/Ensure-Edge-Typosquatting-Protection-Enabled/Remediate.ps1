<#
.SYNOPSIS
    Remediates Ensure Edge Typosquatting Protection Enabled.
...
$ScriptPackageName = 'Ensure-Edge-Typosquatting-Protection-Enabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'TyposquattingCheckerEnabled'; Type = 'DWord'; Value = 1; Description = 'Enable website typo protection' }
)
