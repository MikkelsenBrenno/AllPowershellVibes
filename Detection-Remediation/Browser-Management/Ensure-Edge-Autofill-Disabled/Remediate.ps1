<#
.SYNOPSIS
    Remediates Ensure Edge Autofill Disabled.
...
$ScriptPackageName = 'Ensure-Edge-Autofill-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'AutofillAddressEnabled'; Type = 'DWord'; Value = 0; Description = 'Disable address autofill' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'AutofillCreditCardEnabled'; Type = 'DWord'; Value = 0; Description = 'Disable payment-card autofill' }
)
