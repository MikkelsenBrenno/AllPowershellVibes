<#
.SYNOPSIS
    Remediates Edge Sync Policy state.

.DESCRIPTION
    Detects and remediates Edge Sync Policy state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Edge Sync Policy remediation completed
    Exit 1:      Edge Sync Policy remediation failed
...
$ScriptPackageName = 'Ensure-Edge-Sync-Policy'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Edge Sync Policy'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'
$ValueName = 'EdgeSyncPolicy'
