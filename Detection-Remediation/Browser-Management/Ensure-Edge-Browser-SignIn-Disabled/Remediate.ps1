<#
.SYNOPSIS
    Remediates Ensure Edge Browser Sign-In Disabled.
...
$ScriptPackageName = 'Ensure-Edge-Browser-SignIn-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'BrowserSignin'; Type = 'DWord'; Value = 0; Description = 'Disable browser profile sign-in' }
)
