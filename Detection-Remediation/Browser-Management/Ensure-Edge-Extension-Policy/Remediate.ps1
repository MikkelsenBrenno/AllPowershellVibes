<#
.SYNOPSIS
    Remediates Edge Extension Policy state.

.DESCRIPTION
    Detects and remediates Edge Extension Policy state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Edge Extension Policy remediation completed
    Exit 1:      Edge Extension Policy remediation failed
...
$ScriptPackageName = 'Ensure-Edge-Extension-Policy'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Edge Extension Policy'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'
$ValueName = 'EdgeExtensionPolicy'
