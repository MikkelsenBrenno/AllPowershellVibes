<#
.SYNOPSIS
    Remediates Edge Profile SignIn state.

.DESCRIPTION
    Detects and remediates Edge Profile SignIn state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Edge Profile SignIn remediation completed
    Exit 1:      Edge Profile SignIn remediation failed
...
$ScriptPackageName = 'Ensure-Edge-Profile-SignIn'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Edge Profile SignIn'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'
$ValueName = 'EdgeProfileSignIn'
