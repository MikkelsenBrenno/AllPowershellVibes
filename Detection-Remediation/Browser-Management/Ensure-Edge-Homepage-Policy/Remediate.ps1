<#
.SYNOPSIS
    Remediates Edge Homepage Policy state.

.DESCRIPTION
    Detects and remediates Edge Homepage Policy state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Edge Homepage Policy remediation completed
    Exit 1:      Edge Homepage Policy remediation failed
...
$ScriptPackageName = 'Ensure-Edge-Homepage-Policy'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Edge Homepage Policy'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'
$ValueName = 'EdgeHomepagePolicy'
$ExpectedValue = 'https://www.contoso.com'
