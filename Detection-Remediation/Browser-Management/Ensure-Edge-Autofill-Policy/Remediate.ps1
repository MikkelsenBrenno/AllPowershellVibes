<#
.SYNOPSIS
    Remediates Edge Autofill Policy state.

.DESCRIPTION
    Detects and remediates Edge Autofill Policy state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Edge Autofill Policy remediation completed
    Exit 1:      Edge Autofill Policy remediation failed
...
$ScriptPackageName = 'Ensure-Edge-Autofill-Policy'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Edge Autofill Policy'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'
$ValueName = 'EdgeAutofillPolicy'
