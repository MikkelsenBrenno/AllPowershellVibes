<#
.SYNOPSIS
    Remediates Ensure Edge Password Import Disabled.
...
$ScriptPackageName = 'Ensure-Edge-Password-Import-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'ImportSavedPasswords'; Type = 'DWord'; Value = 0; Description = 'Disable saved-password import' }
)
