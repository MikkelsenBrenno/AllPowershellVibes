<#
.SYNOPSIS
    Remediates Edge Update Policy state.

.DESCRIPTION
    Detects and remediates Edge Update Policy state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      Edge Update Policy remediation completed
    Exit 1:      Edge Update Policy remediation failed
...
$ScriptPackageName = 'Ensure-Edge-Update-Policy'
$ScriptName = 'Remediate'

$ManagedSettingName = 'Edge Update Policy'
$RegistryPath = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'
$ValueName = 'EdgeUpdatePolicy'
