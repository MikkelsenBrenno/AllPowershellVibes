<#
.SYNOPSIS
    Remediates Ensure Edge Automatic Updates Enabled.
...
$ScriptPackageName = 'Ensure-Edge-Automatic-Updates-Enabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\EdgeUpdate'; Name = 'UpdateDefault'; Type = 'DWord'; Value = 1; Description = 'Always allow Microsoft Edge updates' }
)
