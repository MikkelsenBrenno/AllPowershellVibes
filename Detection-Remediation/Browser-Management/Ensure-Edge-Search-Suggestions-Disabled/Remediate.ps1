<#
.SYNOPSIS
    Remediates Ensure Edge Search Suggestions Disabled.
...
$ScriptPackageName = 'Ensure-Edge-Search-Suggestions-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'SearchSuggestEnabled'; Type = 'DWord'; Value = 0; Description = 'Disable provider-supplied search suggestions' }
)
