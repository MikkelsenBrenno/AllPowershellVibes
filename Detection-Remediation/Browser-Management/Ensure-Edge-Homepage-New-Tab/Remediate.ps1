<#
.SYNOPSIS
    Remediates Ensure Edge Homepage New Tab.
...
$ScriptPackageName = 'Ensure-Edge-Homepage-New-Tab'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Edge'; Name = 'HomepageIsNewTabPage'; Type = 'DWord'; Value = 1; Description = 'Use the new tab page as the homepage' }
)
