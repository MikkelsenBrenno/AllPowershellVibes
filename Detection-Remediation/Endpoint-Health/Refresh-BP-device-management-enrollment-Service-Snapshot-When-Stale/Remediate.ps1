<#
.SYNOPSIS
    Refreshes the Device Management Enrollment Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-device-management-enrollment-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdevicemanagementenrollmentServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Device Management Enrollment service state snapshot for technician troubleshooting.'

$ServiceNames = @('DeviceManagementEnrollmentService')
