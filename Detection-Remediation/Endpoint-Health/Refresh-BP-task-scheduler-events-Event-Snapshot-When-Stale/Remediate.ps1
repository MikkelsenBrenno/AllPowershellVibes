<#
.SYNOPSIS
    Refreshes the Task Scheduler Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-task-scheduler-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPtaskschedulereventsEventSnapshot.json'
