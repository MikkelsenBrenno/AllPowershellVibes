<#
.SYNOPSIS
    Detects whether Device Association Service is running.
...
.INTUNE
    ...
    Exit 0:      Device Association Service is running
    Exit 1:      Device Association Service is missing or stopped
...
$ScriptPackageName = 'Ensure-Device-Association-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. Device Association Service could not be validated.'
    exit 1
}
