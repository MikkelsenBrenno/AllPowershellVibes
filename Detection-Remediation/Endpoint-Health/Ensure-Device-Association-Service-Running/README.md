# Ensure Device Association Service Running

## Summary

Detects and remediates devices where Device Association Service is stopped, useful for Bluetooth, peripheral, and device pairing support cases.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Device-Association-Service-Running`.
