<#
.SYNOPSIS
    Starts Device Association Service.
...
.INTUNE
    ...
    Exit 0:      Device Association Service remediation succeeded
    Exit 1:      Device Association Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Device Association Service.'
    exit 1
}
