<#
.SYNOPSIS
    Refreshes the Performance Logs And Alerts Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-performance-logs-alerts-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPperformancelogsalertsServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Performance Logs And Alerts service state snapshot for technician troubleshooting.'
