<#
.SYNOPSIS
    Refreshes the Problem Reports Control Panel Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-problem-reports-control-panel-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPproblemreportscontrolpanelServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Problem Reports Control Panel service state snapshot for technician troubleshooting.'

$ServiceNames = @('wercplsupport')
