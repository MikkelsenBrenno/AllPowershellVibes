# Diagnostic Data Viewer Folder

## Summary

Refreshes a local Diagnostic Data Viewer folder usage troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdiagnosticdataviewerFolderSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-diagnostic-data-viewer-Folder-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-diagnostic-data-viewer-Folder-Snapshot-When-Stale`.
