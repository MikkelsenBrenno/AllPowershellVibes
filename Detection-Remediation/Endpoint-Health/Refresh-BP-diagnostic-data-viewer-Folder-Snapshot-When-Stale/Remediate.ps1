<#
.SYNOPSIS
    Refreshes the Diagnostic Data Viewer Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-diagnostic-data-viewer-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdiagnosticdataviewerFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Diagnostic Data Viewer folder size snapshot for technician troubleshooting.'
