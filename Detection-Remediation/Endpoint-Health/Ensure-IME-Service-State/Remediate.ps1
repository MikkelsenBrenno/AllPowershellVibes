<#
.SYNOPSIS
    Remediates IME Service State state.

.DESCRIPTION
    Detects and remediates IME Service State state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      IME Service State remediation completed
    Exit 1:      IME Service State remediation failed
