<#
.SYNOPSIS
    Refreshes the Minidump Folder Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-minidump-folder-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPminidumpfolderFolderSnapshot.json'
