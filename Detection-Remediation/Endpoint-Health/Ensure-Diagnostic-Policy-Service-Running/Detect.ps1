<#
.SYNOPSIS
    Detects whether Diagnostic Policy Service is running.
...
.INTUNE
    ...
    Exit 0:      Diagnostic Policy Service is running
    Exit 1:      Diagnostic Policy Service is missing or stopped
...
$ScriptPackageName = 'Ensure-Diagnostic-Policy-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. Diagnostic Policy Service could not be validated.'
    exit 1
}
