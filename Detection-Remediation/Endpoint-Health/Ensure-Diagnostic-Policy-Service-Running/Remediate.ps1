<#
.SYNOPSIS
    Starts Diagnostic Policy Service.
...
.INTUNE
    ...
    Exit 0:      Diagnostic Policy Service remediation succeeded
    Exit 1:      Diagnostic Policy Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Diagnostic Policy Service.'
    exit 1
}
