<#
.SYNOPSIS
    Refreshes the Windows Time Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-time-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwindowstimeServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Time service state snapshot for technician troubleshooting.'
