# Ensure Windows Event Log Service Running

## Summary

Detects and remediates devices where the Windows Event Log service is not running, which can break support evidence and monitoring.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Windows-Event-Log-Service-Running`.
