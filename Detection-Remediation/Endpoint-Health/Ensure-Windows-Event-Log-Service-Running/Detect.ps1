<#
.SYNOPSIS
    Detects whether Windows Event Log Service is running.
...
.INTUNE
    ...
    Exit 0:      Windows Event Log Service is running
    Exit 1:      Windows Event Log Service is missing or stopped
...
try {
    ...
    Write-Output 'Not compliant. Windows Event Log Service could not be validated.'
    exit 1
}
