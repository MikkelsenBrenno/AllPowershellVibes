# Ensure Windows Error Reporting Service Running

## Summary

Detects and remediates devices where Windows Error Reporting is stopped, helping technicians retain crash and reliability evidence.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Windows-Error-Reporting-Service-Running`.
