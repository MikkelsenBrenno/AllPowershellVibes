<#
.SYNOPSIS
    Detects whether Windows Error Reporting Service is running.
...
.INTUNE
    ...
    Exit 0:      Windows Error Reporting Service is running
    Exit 1:      Windows Error Reporting Service is missing or stopped
...
$ScriptPackageName = 'Ensure-Windows-Error-Reporting-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. Windows Error Reporting Service could not be validated.'
    exit 1
}
