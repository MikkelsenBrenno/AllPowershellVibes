<#
.SYNOPSIS
    Starts Windows Error Reporting Service.
...
.INTUNE
    ...
    Exit 0:      Windows Error Reporting Service remediation succeeded
    Exit 1:      Windows Error Reporting Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Windows Error Reporting Service.'
    exit 1
}
