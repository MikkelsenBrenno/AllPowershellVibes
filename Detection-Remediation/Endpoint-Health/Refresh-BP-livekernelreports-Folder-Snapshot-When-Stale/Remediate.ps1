<#
.SYNOPSIS
    Refreshes the Live Kernel Reports Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-livekernelreports-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPlivekernelreportsFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Live Kernel Reports folder size snapshot for technician troubleshooting.'
