<#
.SYNOPSIS
    Refreshes the Intune Management Extension Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-intune-management-extension-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPintunemanagementextensionServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Intune Management Extension service state snapshot for technician troubleshooting.'

$ServiceNames = @('IntuneManagementExtension')
