<#
.SYNOPSIS
    Remediates IME Log Snapshot state.

.DESCRIPTION
    Detects and remediates IME Log Snapshot state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 0:      IME Log Snapshot remediation completed
    Exit 1:      IME Log Snapshot remediation failed
...
$ScriptPackageName = 'Refresh-IME-Log-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotName = 'IME Log Snapshot'
$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Snapshots\Endpoint-Health'
$SnapshotFileName = 'ime-log-snapshot-snapshot.json'
