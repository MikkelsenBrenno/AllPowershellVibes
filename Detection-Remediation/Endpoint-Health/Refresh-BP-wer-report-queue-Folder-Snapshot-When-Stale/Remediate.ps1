<#
.SYNOPSIS
    Refreshes the Windows Error Reporting Queue Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-wer-report-queue-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwerreportqueueFolderSnapshot.json'
