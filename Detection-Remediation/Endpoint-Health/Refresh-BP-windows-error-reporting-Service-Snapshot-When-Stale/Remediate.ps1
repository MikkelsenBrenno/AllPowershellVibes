<#
.SYNOPSIS
    Refreshes the Windows Error Reporting Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-error-reporting-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwindowserrorreportingServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Windows Error Reporting service state snapshot for technician troubleshooting.'
