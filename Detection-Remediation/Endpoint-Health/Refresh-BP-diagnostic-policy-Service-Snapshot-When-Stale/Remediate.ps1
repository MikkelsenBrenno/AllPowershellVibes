<#
.SYNOPSIS
    Refreshes the Diagnostic Policy Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-diagnostic-policy-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdiagnosticpolicyServiceSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Diagnostic Policy service state snapshot for technician troubleshooting.'
