<#
.SYNOPSIS
    Refreshes the System Service Control Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-system-service-control-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsystemservicecontroleventsEventSnapshot.json'
