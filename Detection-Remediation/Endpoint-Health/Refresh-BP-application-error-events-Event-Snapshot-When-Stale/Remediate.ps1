<#
.SYNOPSIS
    Refreshes the Application Error Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-application-error-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPapplicationerroreventsEventSnapshot.json'
