<#
.SYNOPSIS
    Refreshes the Windows Error Reporting Archive Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-wer-report-archive-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwerreportarchiveFolderSnapshot.json'
