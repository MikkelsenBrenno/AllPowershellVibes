<#
.SYNOPSIS
    Refreshes the WMI Activity Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-wmi-activity-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwmiactivityeventsEventSnapshot.json'
