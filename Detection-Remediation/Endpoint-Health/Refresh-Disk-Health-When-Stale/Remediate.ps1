...
.DESCRIPTION
    Detects and remediates Disk Health state for Intune-managed Windows devices.
...
.INTUNE
    ...
    Exit 1:      Disk Health remediation failed
...
$ScriptPackageName = 'Refresh-Disk-Health-When-Stale'
$ScriptName = 'Remediate'

$SnapshotName = 'Disk Health'
$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Snapshots\Endpoint-Health'
$SnapshotFileName = 'disk-health-snapshot.json'
