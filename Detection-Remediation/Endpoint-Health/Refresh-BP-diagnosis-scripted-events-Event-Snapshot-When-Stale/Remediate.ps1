<#
.SYNOPSIS
    Refreshes the Diagnosis Scripted Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-diagnosis-scripted-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdiagnosisscriptedeventsEventSnapshot.json'
