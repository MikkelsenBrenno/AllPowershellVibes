<#
.SYNOPSIS
    Detects Company Portal Enrollment state.

.DESCRIPTION
    Detects Company Portal Enrollment state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Company Portal Enrollment is compliant
    Exit 1:      Company Portal Enrollment is noncompliant
