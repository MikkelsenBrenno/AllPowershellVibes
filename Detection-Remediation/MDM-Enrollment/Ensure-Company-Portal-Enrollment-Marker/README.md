# Ensure-Company-Portal-Enrollment-Marker

## Summary

Detects and remediates Company Portal Enrollment state for technician gap scenarios in the MDM-Enrollment category.
