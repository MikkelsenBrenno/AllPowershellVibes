<#
.SYNOPSIS
    Remediates Company Portal Enrollment state.

.DESCRIPTION
    Writes configurable state evidence for Company Portal Enrollment remediation.
...
.INTUNE
    ...
    Exit 0:      Company Portal Enrollment remediation completed
    Exit 1:      Company Portal Enrollment remediation did not complete
...
$ScriptPackageName = 'Ensure-Company-Portal-Enrollment-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Company Portal Enrollment'
...
$MarkerFileName = 'ensure-company-portal-enrollment-marker.state'
$EvidenceFileName = 'ensure-company-portal-enrollment-marker.json'
