<#
.SYNOPSIS
    Detects MDM Diagnostics state.

.DESCRIPTION
    Detects MDM Diagnostics state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      MDM Diagnostics is compliant
    Exit 1:      MDM Diagnostics is noncompliant
