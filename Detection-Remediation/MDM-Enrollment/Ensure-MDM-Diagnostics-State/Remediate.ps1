<#
.SYNOPSIS
    Remediates MDM Diagnostics state.

.DESCRIPTION
    Writes configurable state evidence for MDM Diagnostics remediation.
...
.INTUNE
    ...
    Exit 0:      MDM Diagnostics remediation completed
    Exit 1:      MDM Diagnostics remediation did not complete
...
$ScriptPackageName = 'Ensure-MDM-Diagnostics-State'
...
$MarkerFileName = 'ensure-mdm-diagnostics-state.state'
$EvidenceFileName = 'ensure-mdm-diagnostics-state.json'
