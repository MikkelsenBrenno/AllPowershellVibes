<#
.SYNOPSIS
    Detects AAD Device Token state.

.DESCRIPTION
    Detects AAD Device Token state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      AAD Device Token is compliant
    Exit 1:      AAD Device Token is noncompliant
