<#
.SYNOPSIS
    Remediates Autopilot Diagnostics state.

.DESCRIPTION
    Writes configurable state evidence for Autopilot Diagnostics remediation.
...
.INTUNE
    ...
    Exit 0:      Autopilot Diagnostics remediation completed
    Exit 1:      Autopilot Diagnostics remediation did not complete
...
$ScriptPackageName = 'Repair-Autopilot-Diagnostics-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Autopilot Diagnostics'
...
$MarkerFileName = 'repair-autopilot-diagnostics-readiness.state'
$EvidenceFileName = 'repair-autopilot-diagnostics-readiness.json'
