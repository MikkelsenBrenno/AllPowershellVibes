<#
.SYNOPSIS
    Detects Autopilot Diagnostics state.

.DESCRIPTION
    Detects Autopilot Diagnostics state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Autopilot Diagnostics is compliant
    Exit 1:      Autopilot Diagnostics is noncompliant
