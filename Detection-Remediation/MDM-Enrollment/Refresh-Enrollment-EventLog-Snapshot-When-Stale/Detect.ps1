<#
.SYNOPSIS
    Detects Enrollment EventLog state.

.DESCRIPTION
    Detects Enrollment EventLog state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Enrollment EventLog is compliant
    Exit 1:      Enrollment EventLog is noncompliant
