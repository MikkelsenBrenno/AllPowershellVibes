<#
.SYNOPSIS
    Remediates Enrollment EventLog state.

.DESCRIPTION
    Writes configurable state evidence for Enrollment EventLog remediation.
...
.INTUNE
    ...
    Exit 0:      Enrollment EventLog remediation completed
    Exit 1:      Enrollment EventLog remediation did not complete
...
$ScriptPackageName = 'Refresh-Enrollment-EventLog-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Enrollment EventLog'
...
$MarkerFileName = 'refresh-enrollment-eventlog-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-enrollment-eventlog-snapshot-when-stale.json'
