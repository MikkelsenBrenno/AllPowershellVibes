<#
.SYNOPSIS
    Detects Management Certificate state.

.DESCRIPTION
    Detects Management Certificate state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Management Certificate is compliant
    Exit 1:      Management Certificate is noncompliant
