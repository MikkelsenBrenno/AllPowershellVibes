<#
.SYNOPSIS
    Remediates Management Certificate state.

.DESCRIPTION
    Writes configurable state evidence for Management Certificate remediation.
...
.INTUNE
    ...
    Exit 0:      Management Certificate remediation completed
    Exit 1:      Management Certificate remediation did not complete
...
$ScriptPackageName = 'Ensure-Management-Certificate-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Management Certificate'
...
$MarkerFileName = 'ensure-management-certificate-marker.state'
$EvidenceFileName = 'ensure-management-certificate-marker.json'
