<#
.SYNOPSIS
    Detects Device Registration state.

.DESCRIPTION
    Detects Device Registration state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Device Registration is compliant
    Exit 1:      Device Registration is noncompliant
