<#
.SYNOPSIS
    Remediates Device Registration state.

.DESCRIPTION
    Writes configurable state evidence for Device Registration remediation.
...
.INTUNE
    ...
    Exit 0:      Device Registration remediation completed
    Exit 1:      Device Registration remediation did not complete
...
$ScriptPackageName = 'Repair-Device-Registration-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Device Registration'
...
$MarkerFileName = 'repair-device-registration-readiness.state'
$EvidenceFileName = 'repair-device-registration-readiness.json'
