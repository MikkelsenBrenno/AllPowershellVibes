<#
.SYNOPSIS
    Remediates OMA DM Session state.

.DESCRIPTION
    Writes configurable state evidence for OMA DM Session remediation.
...
.INTUNE
    ...
    Exit 0:      OMA DM Session remediation completed
    Exit 1:      OMA DM Session remediation did not complete
...
$ScriptPackageName = 'Refresh-OMA-DM-Session-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'OMA DM Session'
...
$MarkerFileName = 'refresh-oma-dm-session-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-oma-dm-session-snapshot-when-stale.json'
