<#
.SYNOPSIS
    Detects OMA DM Session state.

.DESCRIPTION
    Detects OMA DM Session state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      OMA DM Session is compliant
    Exit 1:      OMA DM Session is noncompliant
