<#
.SYNOPSIS
    Remediates IME Service state.

.DESCRIPTION
    Writes configurable state evidence for IME Service remediation.
...
.INTUNE
    ...
    Exit 0:      IME Service remediation completed
    Exit 1:      IME Service remediation did not complete
...
$ScriptPackageName = 'Ensure-IME-Service-State'
...
$MarkerFileName = 'ensure-ime-service-state.state'
$EvidenceFileName = 'ensure-ime-service-state.json'
