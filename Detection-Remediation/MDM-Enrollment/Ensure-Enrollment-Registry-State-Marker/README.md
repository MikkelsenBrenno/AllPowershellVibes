# Ensure-Enrollment-Registry-State-Marker

## Summary

Detects and remediates Enrollment Registry State state for technician gap scenarios in the MDM-Enrollment category.
