<#
.SYNOPSIS
    Detects Enrollment Registry State state.

.DESCRIPTION
    Detects Enrollment Registry State state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Enrollment Registry State is compliant
    Exit 1:      Enrollment Registry State is noncompliant
