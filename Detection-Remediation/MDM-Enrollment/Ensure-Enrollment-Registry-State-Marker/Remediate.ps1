<#
.SYNOPSIS
    Remediates Enrollment Registry State state.

.DESCRIPTION
    Writes configurable state evidence for Enrollment Registry State remediation.
...
.INTUNE
    ...
    Exit 0:      Enrollment Registry State remediation completed
    Exit 1:      Enrollment Registry State remediation did not complete
...
$ScriptPackageName = 'Ensure-Enrollment-Registry-State-Marker'
$ScriptName = 'Remediate'

$ManagedItemName = 'Enrollment Registry State'
...
$MarkerFileName = 'ensure-enrollment-registry-state-marker.state'
$EvidenceFileName = 'ensure-enrollment-registry-state-marker.json'
