<#
.SYNOPSIS
    Detects ESP Tracking state.

.DESCRIPTION
    Detects ESP Tracking state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      ESP Tracking is compliant
    Exit 1:      ESP Tracking is noncompliant
