<#
.SYNOPSIS
    Remediates Policy Sync state.

.DESCRIPTION
    Writes configurable state evidence for Policy Sync remediation.
...
.INTUNE
    ...
    Exit 0:      Policy Sync remediation completed
    Exit 1:      Policy Sync remediation did not complete
...
$ScriptPackageName = 'Repair-Policy-Sync-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'Policy Sync'
...
$MarkerFileName = 'repair-policy-sync-readiness.state'
$EvidenceFileName = 'repair-policy-sync-readiness.json'
