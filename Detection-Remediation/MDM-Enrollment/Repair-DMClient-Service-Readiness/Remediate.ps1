<#
.SYNOPSIS
    Remediates DMClient Service state.

.DESCRIPTION
    Writes configurable state evidence for DMClient Service remediation.
...
.INTUNE
    ...
    Exit 0:      DMClient Service remediation completed
    Exit 1:      DMClient Service remediation did not complete
...
$ScriptPackageName = 'Repair-DMClient-Service-Readiness'
$ScriptName = 'Remediate'

$ManagedItemName = 'DMClient Service'
...
$MarkerFileName = 'repair-dmclient-service-readiness.state'
$EvidenceFileName = 'repair-dmclient-service-readiness.json'
