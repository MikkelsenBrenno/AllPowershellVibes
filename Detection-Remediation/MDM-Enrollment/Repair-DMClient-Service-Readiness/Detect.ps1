<#
.SYNOPSIS
    Detects DMClient Service state.

.DESCRIPTION
    Detects DMClient Service state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      DMClient Service is compliant
    Exit 1:      DMClient Service is noncompliant
