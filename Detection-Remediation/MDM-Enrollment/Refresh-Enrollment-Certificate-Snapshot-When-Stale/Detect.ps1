<#
.SYNOPSIS
    Detects Enrollment Certificate state.

.DESCRIPTION
    Detects Enrollment Certificate state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Enrollment Certificate is compliant
    Exit 1:      Enrollment Certificate is noncompliant
