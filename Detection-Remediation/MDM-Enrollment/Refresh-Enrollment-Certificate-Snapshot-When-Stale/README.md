# Refresh-Enrollment-Certificate-Snapshot-When-Stale

## Summary

Detects and remediates Enrollment Certificate state for technician gap scenarios in the MDM-Enrollment category.
