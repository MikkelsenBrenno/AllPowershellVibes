<#
.SYNOPSIS
    Remediates Enrollment Certificate state.

.DESCRIPTION
    Writes configurable state evidence for Enrollment Certificate remediation.
...
.INTUNE
    ...
    Exit 0:      Enrollment Certificate remediation completed
    Exit 1:      Enrollment Certificate remediation did not complete
...
$ScriptPackageName = 'Refresh-Enrollment-Certificate-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$ManagedItemName = 'Enrollment Certificate'
...
$MarkerFileName = 'refresh-enrollment-certificate-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-enrollment-certificate-snapshot-when-stale.json'
