<#
.SYNOPSIS
    Remediates Autopilot Profile state.

.DESCRIPTION
    Writes configurable state evidence for Autopilot Profile remediation.
...
.INTUNE
    ...
    Exit 0:      Autopilot Profile remediation completed
    Exit 1:      Autopilot Profile remediation did not complete
...
$ScriptPackageName = 'Ensure-Autopilot-Profile-Marker'
...
$MarkerFileName = 'ensure-autopilot-profile-marker.state'
$EvidenceFileName = 'ensure-autopilot-profile-marker.json'
