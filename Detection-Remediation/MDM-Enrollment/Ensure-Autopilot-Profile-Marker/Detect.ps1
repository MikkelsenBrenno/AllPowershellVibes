<#
.SYNOPSIS
    Detects Autopilot Profile state.

.DESCRIPTION
    Detects Autopilot Profile state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Autopilot Profile is compliant
    Exit 1:      Autopilot Profile is noncompliant
