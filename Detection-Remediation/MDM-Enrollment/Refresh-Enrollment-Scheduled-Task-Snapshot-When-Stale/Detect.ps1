<#
.SYNOPSIS
    Detects Enrollment Scheduled Task state.

.DESCRIPTION
    Detects Enrollment Scheduled Task state for Intune remediation targeting.
...
.INTUNE
    ...
    Exit 0:      Enrollment Scheduled Task is compliant
    Exit 1:      Enrollment Scheduled Task is noncompliant
