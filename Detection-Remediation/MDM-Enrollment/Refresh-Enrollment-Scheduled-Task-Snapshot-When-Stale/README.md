# Refresh-Enrollment-Scheduled-Task-Snapshot-When-Stale

## Summary

Detects and remediates Enrollment Scheduled Task state for technician gap scenarios in the MDM-Enrollment category.
