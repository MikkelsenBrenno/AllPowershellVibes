<#
.SYNOPSIS
    Remediates Enrollment Scheduled Task state.

.DESCRIPTION
    Writes configurable state evidence for Enrollment Scheduled Task remediation.
...
.INTUNE
    ...
    Exit 0:      Enrollment Scheduled Task remediation completed
    Exit 1:      Enrollment Scheduled Task remediation did not complete
...
$ScriptPackageName = 'Refresh-Enrollment-Scheduled-Task-Snapshot-When-Stale'
...
$MarkerFileName = 'refresh-enrollment-scheduled-task-snapshot-when-stale.state'
$EvidenceFileName = 'refresh-enrollment-scheduled-task-snapshot-when-stale.json'
