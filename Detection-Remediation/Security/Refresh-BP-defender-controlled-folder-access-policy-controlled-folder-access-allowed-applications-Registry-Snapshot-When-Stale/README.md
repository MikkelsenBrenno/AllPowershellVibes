# Defender Controlled Folder Access Policy ControlledFolderAccessAllowedApplications Registry

## Summary

Refreshes a local Defender Controlled Folder Access Policy ControlledFolderAccessAllowedApplications registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdefendercontrolledfolderaccesscontrolledfolderaccessallowedapplicationsRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-controlled-folder-access-policy-controlled-folder-access-allowed-applications-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-controlled-folder-access-policy-controlled-folder-access-allowed-applications-Registry-Snapshot-When-Stale`.
