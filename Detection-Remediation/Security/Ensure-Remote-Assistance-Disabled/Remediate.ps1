<#
.SYNOPSIS
    Remediates Ensure Remote Assistance Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Remote Assistance Disabled remediation succeeded
    Exit 1:      Ensure Remote Assistance Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Remote Assistance Disabled.'
    exit 1
}
