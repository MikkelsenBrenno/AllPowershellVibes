...
$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'; Name = 'fAllowToGetHelp'; Type = 'DWord'; Value = 0; Description = 'Disable solicited Remote Assistance' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'; Name = 'fAllowUnsolicited'; Type = 'DWord'; Value = 0; Description = 'Disable offered Remote Assistance' }
)
