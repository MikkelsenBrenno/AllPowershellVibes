...
Detects and remediates Remote Assistance policy so unsolicited help sessions are disabled unless intentionally re-enabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Remote-Assistance-Disabled`.
