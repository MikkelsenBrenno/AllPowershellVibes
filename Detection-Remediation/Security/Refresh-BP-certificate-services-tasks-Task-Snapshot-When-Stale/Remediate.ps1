<#
.SYNOPSIS
    Refreshes the Certificate Services Tasks Task snapshot.
...
$ScriptPackageName = 'Refresh-BP-certificate-services-tasks-Task-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcertificateservicestasksTaskSnapshot.json'
$CollectionMode = 'Task'
$JsonDepth = 8
$RegistryItems = @()
$ServiceNames = @()
