# Ensure PowerShell ScriptBlock Logging Enabled

## Summary

Detects and remediates PowerShell policy so script block logging is enabled for troubleshooting and security review.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-PowerShell-ScriptBlock-Logging-Enabled`.
