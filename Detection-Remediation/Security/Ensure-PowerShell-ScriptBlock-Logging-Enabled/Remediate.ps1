<#
.SYNOPSIS
    Remediates Ensure PowerShell ScriptBlock Logging Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure PowerShell ScriptBlock Logging Enabled remediation succeeded
    Exit 1:      Ensure PowerShell ScriptBlock Logging Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure PowerShell ScriptBlock Logging Enabled.'
    exit 1
}
