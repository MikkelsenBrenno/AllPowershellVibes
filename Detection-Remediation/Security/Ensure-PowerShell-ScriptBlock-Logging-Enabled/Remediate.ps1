<#
.SYNOPSIS
    Remediates Ensure PowerShell Script Block Logging Enabled.
...
$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\PowerShell\ScriptBlockLogging'; Name = 'EnableScriptBlockLogging'; Type = 'DWord'; Value = 1; Description = 'Enable script block logging' }
)
