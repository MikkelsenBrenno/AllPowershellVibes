<#
.SYNOPSIS
    Remediates Ensure Defender PUA Protection Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Defender PUA Protection Enabled remediation succeeded
    Exit 1:      Ensure Defender PUA Protection Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Defender PUA Protection Enabled.'
    exit 1
}
