...
Detects and remediates Microsoft Defender policy so potentially unwanted app protection is enabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Defender-PUA-Protection-Enabled`.
