<#
.SYNOPSIS
    Refreshes the Defender Platform Folder Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-defender-platform-folder-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdefenderplatformfolderFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Defender Platform Folder folder size snapshot for technician troubleshooting.'
