<#
.SYNOPSIS
    Refreshes the Defender Platform Policy DisableAntiVirus Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-defender-platform-policy-disable-anti-virus-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdefenderplatformdisableantivirusRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Defender Platform Policy DisableAntiVirus registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender'; Name = 'DisableAntiVirus'; Description = 'Antivirus disable flag' }
)
