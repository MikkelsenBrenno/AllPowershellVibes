# Defender Network Protection Policy EnableNetworkProtection Registry

## Summary

Refreshes a local Defender Network Protection Policy EnableNetworkProtection registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdefendernetworkprotectionenablenetworkprotectionRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-network-protection-policy-enable-network-protection-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-network-protection-policy-enable-network-protection-Registry-Snapshot-When-Stale`.
