<#
.SYNOPSIS
    Remediates Ensure UAC Secure Desktop Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure UAC Secure Desktop Enabled remediation succeeded
    Exit 1:      Ensure UAC Secure Desktop Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure UAC Secure Desktop Enabled.'
    exit 1
}
