...
Detects and remediates User Account Control policy so elevation prompts use the secure desktop.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-UAC-Secure-Desktop-Enabled`.
