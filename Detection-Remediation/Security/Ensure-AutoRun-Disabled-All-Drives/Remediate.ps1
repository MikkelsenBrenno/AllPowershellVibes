<#
.SYNOPSIS
    Remediates Ensure AutoRun Disabled All Drives.
...
.INTUNE
    ...
    Exit 0:      Ensure AutoRun Disabled All Drives remediation succeeded
    Exit 1:      Ensure AutoRun Disabled All Drives remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure AutoRun Disabled All Drives.'
    exit 1
}
