# Ensure AutoRun Disabled All Drives

## Summary

Detects and remediates Explorer policy so AutoRun is disabled for all drive types.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-AutoRun-Disabled-All-Drives`.
