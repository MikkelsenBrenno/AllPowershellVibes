<#
.SYNOPSIS
    Refreshes the AppLocker EXE DLL Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-applocker-exe-dll-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPapplockerexedlleventsEventSnapshot.json'
