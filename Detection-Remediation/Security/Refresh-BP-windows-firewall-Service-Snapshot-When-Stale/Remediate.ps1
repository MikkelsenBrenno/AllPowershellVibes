<#
.SYNOPSIS
    Refreshes the Windows Firewall Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-firewall-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwindowsfirewallServiceSnapshot.json'
