<#
.SYNOPSIS
    Remediates Ensure SMBv1 Server Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure SMBv1 Server Disabled remediation succeeded
    Exit 1:      Ensure SMBv1 Server Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure SMBv1 Server Disabled.'
    exit 1
}
