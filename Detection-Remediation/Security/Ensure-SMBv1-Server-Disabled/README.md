# Ensure SMBv1 Server Disabled

## Summary

Detects and remediates Lanman Server policy so SMBv1 server support is disabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-SMBv1-Server-Disabled`.
