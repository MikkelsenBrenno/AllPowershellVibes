<#
.SYNOPSIS
    Enables Microsoft Defender real-time protection.

.DESCRIPTION
    Intune Remediations remediation script. The script sets the Microsoft
    Defender Antivirus DisableRealtimeMonitoring preference to false and
    validates that real-time protection is enabled.
