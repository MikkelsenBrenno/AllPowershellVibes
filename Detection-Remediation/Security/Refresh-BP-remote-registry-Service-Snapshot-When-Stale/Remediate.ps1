<#
.SYNOPSIS
    Refreshes the Remote Registry Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-remote-registry-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPremoteregistryServiceSnapshot.json'
