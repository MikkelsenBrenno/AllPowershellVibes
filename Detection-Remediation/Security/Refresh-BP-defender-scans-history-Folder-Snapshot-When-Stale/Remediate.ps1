<#
.SYNOPSIS
    Refreshes the Defender Scan History Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-defender-scans-history-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdefenderscanshistoryFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Defender Scan History folder size snapshot for technician troubleshooting.'
