<#
.SYNOPSIS
    Remediates Ensure Windows Script Host Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Windows Script Host Disabled remediation succeeded
    Exit 1:      Ensure Windows Script Host Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Windows Script Host Disabled.'
    exit 1
}
