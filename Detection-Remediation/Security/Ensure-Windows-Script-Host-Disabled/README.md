...
Detects and remediates Windows Script Host policy so unmanaged VBScript and JScript execution is disabled on managed endpoints.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Windows-Script-Host-Disabled`.
