<#
.SYNOPSIS
    Refreshes the Defender Support Folder Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-defender-support-folder-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdefendersupportfolderFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Defender Support Folder folder size snapshot for technician troubleshooting.'
