<#
.SYNOPSIS
    Remediates Ensure SMBv1 Client Driver Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure SMBv1 Client Driver Disabled remediation succeeded
    Exit 1:      Ensure SMBv1 Client Driver Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure SMBv1 Client Driver Disabled.'
    exit 1
}
