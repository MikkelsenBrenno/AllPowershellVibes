<#
.SYNOPSIS
    Detects Ensure SMBv1 Client Driver Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure SMBv1 Client Driver Disabled is compliant
    Exit 1:      Ensure SMBv1 Client Driver Disabled is missing or different
...
$ScriptPackageName = 'Ensure-SMBv1-Client-Driver-Disabled'
$ScriptName = 'Detect'

$RegistryValues = @(
    @{ Path = 'HKLM:\SYSTEM\CurrentControlSet\Services\mrxsmb10'; Name = 'Start'; Type = 'DWord'; Value = 4; Description = 'Disable SMBv1 client driver' }
)
...
try {
    ...
    Write-Output 'Not compliant. Ensure SMBv1 Client Driver Disabled could not be validated.'
    exit 1
}
