# Ensure SMBv1 Client Driver Disabled

## Summary

Detects and remediates the SMBv1 client driver start mode so legacy SMBv1 client support is disabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-SMBv1-Client-Driver-Disabled`.
