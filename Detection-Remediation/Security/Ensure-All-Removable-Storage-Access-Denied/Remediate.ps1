<#
.SYNOPSIS
    Remediates Ensure All Removable Storage Access Denied.
...
$ScriptPackageName = 'Ensure-All-Removable-Storage-Access-Denied'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\RemovableStorageDevices'; Name = 'Deny_All'; Type = 'DWord'; Value = 1; Description = 'Deny access to all removable-storage classes' }
)
