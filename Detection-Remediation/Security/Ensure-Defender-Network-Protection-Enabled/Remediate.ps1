...
$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Windows Defender Exploit Guard\Network Protection'; Name = 'EnableNetworkProtection'; Type = 'DWord'; Value = 1; Description = 'Enable Network Protection in block mode' }
)
