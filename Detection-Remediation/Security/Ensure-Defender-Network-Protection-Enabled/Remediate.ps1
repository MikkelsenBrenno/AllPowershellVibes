<#
.SYNOPSIS
    Remediates Ensure Defender Network Protection Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Defender Network Protection Enabled remediation succeeded
    Exit 1:      Ensure Defender Network Protection Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Defender Network Protection Enabled.'
    exit 1
}
