...
Detects and remediates Microsoft Defender Network Protection policy so malicious network destinations are blocked.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Defender-Network-Protection-Enabled`.
