<#
.SYNOPSIS
    Refreshes the Defender Cloud Protection Policy SubmitSamplesConsent Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-defender-cloud-protection-policy-submit-samples-consent-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdefendercloudsubmitsamplesconsentRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Defender Cloud Protection Policy SubmitSamplesConsent registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Spynet'; Name = 'SubmitSamplesConsent'; Description = 'Sample submission consent' }
)
