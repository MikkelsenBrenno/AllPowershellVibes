# Defender Cloud Protection Policy SubmitSamplesConsent Registry

## Summary

Refreshes a local Defender Cloud Protection Policy SubmitSamplesConsent registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdefendercloudsubmitsamplesconsentRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-cloud-protection-policy-submit-samples-consent-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-cloud-protection-policy-submit-samples-consent-Registry-Snapshot-When-Stale`.
