# Firewall Private Profile Policy DisableNotifications Registry

## Summary

Refreshes a local Firewall Private Profile Policy DisableNotifications registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPfirewallprivateprofiledisablenotificationsRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-private-profile-policy-disable-notifications-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-private-profile-policy-disable-notifications-Registry-Snapshot-When-Stale`.
