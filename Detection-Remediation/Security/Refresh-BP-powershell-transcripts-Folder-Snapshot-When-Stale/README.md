# PowerShell Transcripts Folder

## Summary

Refreshes a local PowerShell Transcripts folder usage troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPpowershelltranscriptsFolderSnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-powershell-transcripts-Folder-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-powershell-transcripts-Folder-Snapshot-When-Stale`.
