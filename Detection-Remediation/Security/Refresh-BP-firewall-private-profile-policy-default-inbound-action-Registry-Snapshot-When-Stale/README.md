# Firewall Private Profile Policy DefaultInboundAction Registry

## Summary

Refreshes a local Firewall Private Profile Policy DefaultInboundAction registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPfirewallprivateprofiledefaultinboundactionRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-private-profile-policy-default-inbound-action-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-private-profile-policy-default-inbound-action-Registry-Snapshot-When-Stale`.
