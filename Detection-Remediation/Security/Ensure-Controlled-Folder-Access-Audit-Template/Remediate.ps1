<#
.SYNOPSIS
    Remediates Ensure Controlled Folder Access Audit Template.
...
.INTUNE
    ...
    Exit 0:      Ensure Controlled Folder Access Audit Template remediation succeeded
    Exit 1:      Ensure Controlled Folder Access Audit Template remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Controlled Folder Access Audit Template.'
    exit 1
}
