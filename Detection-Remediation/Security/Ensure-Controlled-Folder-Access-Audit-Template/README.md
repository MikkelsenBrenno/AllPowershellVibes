# Ensure Controlled Folder Access Audit Template

## Summary

Template remediation that detects and enables Controlled Folder Access audit mode before administrators choose block mode.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Controlled-Folder-Access-Audit-Template`.
