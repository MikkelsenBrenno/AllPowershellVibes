<#
.SYNOPSIS
    Detects Microsoft Defender email scanning.
...
.INTUNE
    ...
    Exit 0:      Microsoft Defender email scanning is compliant
    Exit 1:      Microsoft Defender email scanning is missing, different, or unavailable
