<#
.SYNOPSIS
    Remediates Microsoft Defender email scanning.
...
.INTUNE
    ...
    Exit 0:      Microsoft Defender email scanning remediated
    Exit 1:      Microsoft Defender email scanning remediation failed
...
$ScriptPackageName = 'Defender-Enable-Email-Scanning'
$ScriptName = 'Remediate'

$PreferenceName = 'DisableEmailScanning'
$DesiredValue = $false
$FriendlySettingName = 'Microsoft Defender email scanning'
...
try {
    ...
    Write-Output 'Remediation failed for Microsoft Defender email scanning.'
    exit 1
}
