<#
.SYNOPSIS
    Remediates Microsoft Defender archive scanning.
...
.INTUNE
    ...
    Exit 0:      Microsoft Defender archive scanning remediated
    Exit 1:      Microsoft Defender archive scanning remediation failed
