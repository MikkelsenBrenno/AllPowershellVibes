<#
.SYNOPSIS
    Detects Microsoft Defender archive scanning.
...
.INTUNE
    ...
    Exit 0:      Microsoft Defender archive scanning is compliant
    Exit 1:      Microsoft Defender archive scanning is missing, different, or unavailable
...
$ScriptPackageName = 'Defender-Enable-Archive-Scanning'
$ScriptName = 'Detect'

$PreferenceName = 'DisableArchiveScanning'
$DesiredValue = $false
$FriendlySettingName = 'Microsoft Defender archive scanning'
...
try {
    ...
    Write-Output 'Not compliant. Microsoft Defender archive scanning could not be validated.'
    exit 1
}
