<#
.SYNOPSIS
    Remediates Ensure RDP Network Level Authentication Required.
...
$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'; Name = 'UserAuthentication'; Type = 'DWord'; Value = 1; Description = 'Require Network Level Authentication for RDP' }
)
