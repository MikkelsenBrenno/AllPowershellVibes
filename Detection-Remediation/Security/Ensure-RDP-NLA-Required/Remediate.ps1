<#
.SYNOPSIS
    Remediates Ensure RDP NLA Required.
...
.INTUNE
    ...
    Exit 0:      Ensure RDP NLA Required remediation succeeded
    Exit 1:      Ensure RDP NLA Required remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure RDP NLA Required.'
    exit 1
}
