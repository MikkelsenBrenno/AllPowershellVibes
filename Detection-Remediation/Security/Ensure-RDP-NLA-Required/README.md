# Ensure RDP NLA Required

## Summary

Detects and remediates Remote Desktop listener policy so Network Level Authentication is required when RDP is enabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-RDP-NLA-Required`.
