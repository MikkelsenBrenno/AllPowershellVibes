# Defender Realtime Protection Policy DisableRealtimeMonitoring Registry

## Summary

Refreshes a local Defender Realtime Protection Policy DisableRealtimeMonitoring registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdefenderrealtimedisablerealtimemonitoringRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-realtime-protection-policy-disable-realtime-monitoring-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-realtime-protection-policy-disable-realtime-monitoring-Registry-Snapshot-When-Stale`.
