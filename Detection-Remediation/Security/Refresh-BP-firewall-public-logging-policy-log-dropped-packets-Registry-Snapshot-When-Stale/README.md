# Firewall Public Logging Policy LogDroppedPackets Registry

## Summary

Refreshes a local Firewall Public Logging Policy LogDroppedPackets registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPfirewallpubliclogginglogdroppedpacketsRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-public-logging-policy-log-dropped-packets-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-public-logging-policy-log-dropped-packets-Registry-Snapshot-When-Stale`.
