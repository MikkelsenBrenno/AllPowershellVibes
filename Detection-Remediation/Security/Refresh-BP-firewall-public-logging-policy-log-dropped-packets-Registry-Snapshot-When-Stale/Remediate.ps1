<#
.SYNOPSIS
    Refreshes the Firewall Public Logging Policy LogDroppedPackets Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-firewall-public-logging-policy-log-dropped-packets-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPfirewallpubliclogginglogdroppedpacketsRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Firewall Public Logging Policy LogDroppedPackets registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\PublicProfile\Logging'; Name = 'LogDroppedPackets'; Description = 'Dropped packet logging' }
)
