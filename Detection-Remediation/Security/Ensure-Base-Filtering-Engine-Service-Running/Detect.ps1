<#
.SYNOPSIS
    Detects whether Base Filtering Engine Service is running.
...
.INTUNE
    ...
    Exit 0:      Base Filtering Engine Service is running
    Exit 1:      Base Filtering Engine Service is missing or stopped
...
$ScriptPackageName = 'Ensure-Base-Filtering-Engine-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. Base Filtering Engine Service could not be validated.'
    exit 1
}
