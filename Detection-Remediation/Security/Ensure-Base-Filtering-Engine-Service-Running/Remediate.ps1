<#
.SYNOPSIS
    Starts Base Filtering Engine Service.
...
.INTUNE
    ...
    Exit 0:      Base Filtering Engine Service remediation succeeded
    Exit 1:      Base Filtering Engine Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Base Filtering Engine Service.'
    exit 1
}
