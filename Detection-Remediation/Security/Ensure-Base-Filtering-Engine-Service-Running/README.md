# Ensure Base Filtering Engine Service Running

## Summary

Detects and remediates devices where Base Filtering Engine is stopped, which can break Windows Firewall and IPsec behavior.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Base-Filtering-Engine-Service-Running`.
