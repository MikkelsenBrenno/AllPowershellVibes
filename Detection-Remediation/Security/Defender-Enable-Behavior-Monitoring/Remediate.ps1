<#
.SYNOPSIS
    Enables Microsoft Defender behavior monitoring.

.DESCRIPTION
    Intune Remediations remediation script. The script sets the Microsoft
    Defender Antivirus DisableBehaviorMonitoring preference to false and
    validates that behavior monitoring is enabled.
