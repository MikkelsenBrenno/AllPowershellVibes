# Firewall Public Profile Policy DefaultInboundAction Registry

## Summary

Refreshes a local Firewall Public Profile Policy DefaultInboundAction registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPfirewallpublicprofiledefaultinboundactionRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-public-profile-policy-default-inbound-action-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-public-profile-policy-default-inbound-action-Registry-Snapshot-When-Stale`.
