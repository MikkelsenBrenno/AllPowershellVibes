<#
.SYNOPSIS
    Refreshes the Windows Defender Antivirus Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-windows-defender-antivirus-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPwindowsdefenderantivirusServiceSnapshot.json'
