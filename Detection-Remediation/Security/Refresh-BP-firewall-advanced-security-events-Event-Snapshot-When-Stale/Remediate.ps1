<#
.SYNOPSIS
    Refreshes the Firewall Advanced Security Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-firewall-advanced-security-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPfirewalladvancedsecurityeventsEventSnapshot.json'
