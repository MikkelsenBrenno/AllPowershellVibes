<#
.SYNOPSIS
    Remediates Ensure Firewall Domain Profile Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Firewall Domain Profile Enabled remediation succeeded
    Exit 1:      Ensure Firewall Domain Profile Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Firewall Domain Profile Enabled.'
    exit 1
}
