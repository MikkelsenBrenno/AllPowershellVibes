...
$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\WindowsFirewall\DomainProfile'; Name = 'EnableFirewall'; Type = 'DWord'; Value = 1; Description = 'Enable the domain firewall profile' }
)
