...
Detects and remediates Windows Firewall policy so the domain profile is enabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Firewall-Domain-Profile-Enabled`.
