<#
.SYNOPSIS
    Remediates Ensure .NET Framework Strong Crypto And System TLS Defaults.
...
$ScriptPackageName = 'Ensure-NETFramework-Strong-Crypto-System-Defaults'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Microsoft\.NETFramework\v2.0.50727'; Name = 'SchUseStrongCrypto'; Type = 'DWord'; Value = 1; Description = 'Use strong cryptography for 64-bit .NET 2.x applications' },
    @{ Path = 'HKLM:\SOFTWARE\Microsoft\.NETFramework\v2.0.50727'; Name = 'SystemDefaultTlsVersions'; Type = 'DWord'; Value = 1; Description = 'Use operating-system TLS defaults for 64-bit .NET 2.x applications' },
    @{ Path = 'HKLM:\SOFTWARE\Wow6432Node\Microsoft\.NETFramework\v2.0.50727'; Name = 'SchUseStrongCrypto'; Type = 'DWord'; Value = 1; Description = 'Use strong cryptography for 32-bit .NET 2.x applications' },
    @{ Path = 'HKLM:\SOFTWARE\Wow6432Node\Microsoft\.NETFramework\v2.0.50727'; Name = 'SystemDefaultTlsVersions'; Type = 'DWord'; Value = 1; Description = 'Use operating-system TLS defaults for 32-bit .NET 2.x applications' },
    @{ Path = 'HKLM:\SOFTWARE\Microsoft\.NETFramework\v4.0.30319'; Name = 'SchUseStrongCrypto'; Type = 'DWord'; Value = 1; Description = 'Use strong cryptography for 64-bit .NET 4.x applications' },
    @{ Path = 'HKLM:\SOFTWARE\Microsoft\.NETFramework\v4.0.30319'; Name = 'SystemDefaultTlsVersions'; Type = 'DWord'; Value = 1; Description = 'Use operating-system TLS defaults for 64-bit .NET 4.x applications' },
    @{ Path = 'HKLM:\SOFTWARE\Wow6432Node\Microsoft\.NETFramework\v4.0.30319'; Name = 'SchUseStrongCrypto'; Type = 'DWord'; Value = 1; Description = 'Use strong cryptography for 32-bit .NET 4.x applications' },
    @{ Path = 'HKLM:\SOFTWARE\Wow6432Node\Microsoft\.NETFramework\v4.0.30319'; Name = 'SystemDefaultTlsVersions'; Type = 'DWord'; Value = 1; Description = 'Use operating-system TLS defaults for 32-bit .NET 4.x applications' }
)
