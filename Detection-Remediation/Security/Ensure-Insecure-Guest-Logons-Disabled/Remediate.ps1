<#
.SYNOPSIS
    Remediates Ensure Insecure Guest Logons Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Insecure Guest Logons Disabled remediation succeeded
    Exit 1:      Ensure Insecure Guest Logons Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Insecure Guest Logons Disabled.'
    exit 1
}
