...
Detects and remediates Lanman Workstation policy so insecure guest logons are disabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Insecure-Guest-Logons-Disabled`.
