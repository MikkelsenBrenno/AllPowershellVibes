# Ensure CredSSP Oracle Remediation Enforced

## Summary

Detects and remediates CredSSP encryption oracle remediation policy so vulnerable CredSSP connections are blocked.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-CredSSP-Oracle-Remediation-Enforced`.
