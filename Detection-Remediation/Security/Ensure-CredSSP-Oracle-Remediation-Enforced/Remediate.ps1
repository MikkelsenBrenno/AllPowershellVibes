<#
.SYNOPSIS
    Remediates Ensure CredSSP Oracle Remediation Enforced.
...
.INTUNE
    ...
    Exit 0:      Ensure CredSSP Oracle Remediation Enforced remediation succeeded
    Exit 1:      Ensure CredSSP Oracle Remediation Enforced remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure CredSSP Oracle Remediation Enforced.'
    exit 1
}
