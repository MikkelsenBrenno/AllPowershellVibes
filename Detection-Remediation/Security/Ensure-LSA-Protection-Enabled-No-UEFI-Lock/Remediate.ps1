<#
.SYNOPSIS
    Remediates Ensure LSA Protection Enabled Without UEFI Lock.
...
$ScriptPackageName = 'Ensure-LSA-Protection-Enabled-No-UEFI-Lock'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SYSTEM\CurrentControlSet\Control\Lsa'; Name = 'RunAsPPL'; Type = 'DWord'; Value = 2; Description = 'Enable LSA protection without UEFI lock' }
)
