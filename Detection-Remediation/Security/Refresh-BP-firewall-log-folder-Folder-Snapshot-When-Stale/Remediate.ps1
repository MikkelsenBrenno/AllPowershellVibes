<#
.SYNOPSIS
    Refreshes the Firewall Log Folder Folder snapshot.
...
$ScriptPackageName = 'Refresh-BP-firewall-log-folder-Folder-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPfirewalllogfolderFolderSnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Firewall Log Folder folder size snapshot for technician troubleshooting.'
