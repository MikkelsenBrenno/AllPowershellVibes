<#
.SYNOPSIS
    Refreshes the Security Accounts Manager Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-security-accounts-manager-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsecurityaccountsmanagerServiceSnapshot.json'
