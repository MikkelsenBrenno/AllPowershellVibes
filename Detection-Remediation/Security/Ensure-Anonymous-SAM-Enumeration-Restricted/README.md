...
Detects and remediates local security policy registry state that restricts anonymous SAM account enumeration.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Anonymous-SAM-Enumeration-Restricted`.
