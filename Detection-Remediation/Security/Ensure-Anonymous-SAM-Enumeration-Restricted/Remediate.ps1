<#
.SYNOPSIS
    Remediates Ensure Anonymous SAM Enumeration Restricted.
...
.INTUNE
    ...
    Exit 0:      Ensure Anonymous SAM Enumeration Restricted remediation succeeded
    Exit 1:      Ensure Anonymous SAM Enumeration Restricted remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Anonymous SAM Enumeration Restricted.'
    exit 1
}
