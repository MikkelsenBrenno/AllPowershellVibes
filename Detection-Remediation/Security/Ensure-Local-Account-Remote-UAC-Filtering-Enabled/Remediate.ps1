<#
.SYNOPSIS
    Remediates Ensure Local Account Remote UAC Filtering Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Local Account Remote UAC Filtering Enabled remediation succeeded
    Exit 1:      Ensure Local Account Remote UAC Filtering Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Local Account Remote UAC Filtering Enabled.'
    exit 1
}
