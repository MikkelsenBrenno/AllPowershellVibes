...
$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System'; Name = 'LocalAccountTokenFilterPolicy'; Type = 'DWord'; Value = 0; Description = 'Apply UAC token filtering to remote local-account logons' }
)
