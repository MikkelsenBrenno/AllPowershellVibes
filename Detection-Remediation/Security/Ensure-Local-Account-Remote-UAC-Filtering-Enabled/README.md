...
Detects and remediates LocalAccountTokenFilterPolicy so local administrator tokens are filtered over remote connections.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Local-Account-Remote-UAC-Filtering-Enabled`.
