<#
.SYNOPSIS
    Remediates Ensure AutoPlay For Non-Volume Devices Disabled.
...
$ScriptPackageName = 'Ensure-AutoPlay-NonVolume-Devices-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer'; Name = 'NoAutoplayfornonVolume'; Type = 'DWord'; Value = 1; Description = 'Disable AutoPlay for non-volume devices' }
)
