<#
.SYNOPSIS
    Detects whether the Defender Network Inspection Service snapshot is current.
...
$ScriptPackageName = 'Refresh-BP-defender-network-inspection-Service-Snapshot-When-Stale'
$ScriptName = 'Detect'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdefendernetworkinspectionServiceSnapshot.json'
