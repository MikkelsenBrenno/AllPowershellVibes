<#
.SYNOPSIS
    Refreshes the CNG Key Isolation Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-key-isolation-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPkeyisolationServiceSnapshot.json'
