# Defender Controlled Folder Access Policy EnableControlledFolderAccess Registry

## Summary

Refreshes a local Defender Controlled Folder Access Policy EnableControlledFolderAccess registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdefendercontrolledfolderaccessenablecontrolledfolderaccessRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-controlled-folder-access-policy-enable-controlled-folder-access-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-controlled-folder-access-policy-enable-controlled-folder-access-Registry-Snapshot-When-Stale`.
