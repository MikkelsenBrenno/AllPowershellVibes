<#
.SYNOPSIS
    Refreshes the Defender Cloud Protection Policy SpynetReporting Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-defender-cloud-protection-policy-spynet-reporting-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdefendercloudspynetreportingRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Defender Cloud Protection Policy SpynetReporting registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Spynet'; Name = 'SpynetReporting'; Description = 'MAPS reporting level' }
)
