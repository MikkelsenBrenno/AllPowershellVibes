<#
.SYNOPSIS
    Remediates Microsoft Defender IOAV protection.
...
.INTUNE
    ...
    Exit 0:      Microsoft Defender IOAV protection remediated
    Exit 1:      Microsoft Defender IOAV protection remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Microsoft Defender IOAV protection.'
    exit 1
}
