<#
.SYNOPSIS
    Refreshes the Defender Cloud Protection Policy CloudExtendedTimeout Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-defender-cloud-protection-policy-cloud-extended-timeout-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdefendercloudcloudextendedtimeoutRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Defender Cloud Protection Policy CloudExtendedTimeout registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Spynet'; Name = 'CloudExtendedTimeout'; Description = 'Cloud extended timeout' }
)
