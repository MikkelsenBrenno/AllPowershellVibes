# Defender Cloud Protection Policy CloudExtendedTimeout Registry

## Summary

Refreshes a local Defender Cloud Protection Policy CloudExtendedTimeout registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdefendercloudcloudextendedtimeoutRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-cloud-protection-policy-cloud-extended-timeout-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-cloud-protection-policy-cloud-extended-timeout-Registry-Snapshot-When-Stale`.
