...
Detects and remediates WDigest credential caching so cleartext credentials are not stored in memory on managed Windows endpoints.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-WDigest-Credential-Caching-Disabled`.
