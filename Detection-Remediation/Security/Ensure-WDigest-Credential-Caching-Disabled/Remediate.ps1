<#
.SYNOPSIS
    Remediates Ensure WDigest Credential Caching Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure WDigest Credential Caching Disabled remediation succeeded
    Exit 1:      Ensure WDigest Credential Caching Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure WDigest Credential Caching Disabled.'
    exit 1
}
