# Defender Network Protection Policy DisableHttpParsing Registry

## Summary

Refreshes a local Defender Network Protection Policy DisableHttpParsing registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdefendernetworkprotectiondisablehttpparsingRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-network-protection-policy-disable-http-parsing-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-network-protection-policy-disable-http-parsing-Registry-Snapshot-When-Stale`.
