# Firewall Private Logging Policy LogSuccessfulConnections Registry

## Summary

Refreshes a local Firewall Private Logging Policy LogSuccessfulConnections registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPfirewallprivatelogginglogsuccessfulconnectionsRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-private-logging-policy-log-successful-connections-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-private-logging-policy-log-successful-connections-Registry-Snapshot-When-Stale`.
