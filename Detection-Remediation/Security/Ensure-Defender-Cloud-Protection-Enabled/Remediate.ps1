<#
.SYNOPSIS
    Remediates Ensure Defender Cloud Protection Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Defender Cloud Protection Enabled remediation succeeded
    Exit 1:      Ensure Defender Cloud Protection Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Defender Cloud Protection Enabled.'
    exit 1
}
