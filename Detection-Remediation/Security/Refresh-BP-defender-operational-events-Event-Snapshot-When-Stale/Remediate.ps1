<#
.SYNOPSIS
    Refreshes the Defender Operational Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-defender-operational-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdefenderoperationaleventsEventSnapshot.json'
