<#
.SYNOPSIS
    Refreshes the Base Filtering Engine Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-base-filtering-engine-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPbasefilteringengineServiceSnapshot.json'
