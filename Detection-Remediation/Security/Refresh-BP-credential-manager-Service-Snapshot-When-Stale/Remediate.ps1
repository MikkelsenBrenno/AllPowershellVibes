<#
.SYNOPSIS
    Refreshes the Credential Manager Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-credential-manager-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcredentialmanagerServiceSnapshot.json'
