# Ensure Remote Desktop Disabled Template

## Summary

Template remediation that detects and disables inbound Remote Desktop on endpoints where RDP should not be enabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Remote-Desktop-Disabled-Template`.
