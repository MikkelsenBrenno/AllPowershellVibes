<#
.SYNOPSIS
    Detects Ensure Remote Desktop Disabled Template.
...
.INTUNE
    ...
    Exit 0:      Ensure Remote Desktop Disabled Template is compliant
    Exit 1:      Ensure Remote Desktop Disabled Template is missing or different
...
$ScriptPackageName = 'Ensure-Remote-Desktop-Disabled-Template'
$ScriptName = 'Detect'

$RegistryValues = @(
    @{ Path = 'HKLM:\SYSTEM\CurrentControlSet\Control\Terminal Server'; Name = 'fDenyTSConnections'; Type = 'DWord'; Value = 1; Description = 'Deny inbound Remote Desktop connections' }
)
...
try {
    ...
    Write-Output 'Not compliant. Ensure Remote Desktop Disabled Template could not be validated.'
    exit 1
}
