<#
.SYNOPSIS
    Remediates Ensure Remote Desktop Disabled Template.
...
.INTUNE
    ...
    Exit 0:      Ensure Remote Desktop Disabled Template remediation succeeded
    Exit 1:      Ensure Remote Desktop Disabled Template remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Remote Desktop Disabled Template.'
    exit 1
}
