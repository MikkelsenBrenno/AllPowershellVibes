# Defender Cloud Protection Policy DisableBlockAtFirstSeen Registry

## Summary

Refreshes a local Defender Cloud Protection Policy DisableBlockAtFirstSeen registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdefenderclouddisableblockatfirstseenRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-cloud-protection-policy-disable-block-at-first-seen-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-cloud-protection-policy-disable-block-at-first-seen-Registry-Snapshot-When-Stale`.
