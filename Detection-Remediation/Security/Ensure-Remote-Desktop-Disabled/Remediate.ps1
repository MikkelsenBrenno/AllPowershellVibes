<#
.SYNOPSIS
    Remediates Ensure Remote Desktop Disabled.
...
$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'; Name = 'fDenyTSConnections'; Type = 'DWord'; Value = 1; Description = 'Deny Remote Desktop connections' }
)
