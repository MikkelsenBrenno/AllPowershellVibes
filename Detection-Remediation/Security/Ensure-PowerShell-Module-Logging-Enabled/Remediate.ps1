<#
.SYNOPSIS
    Remediates Ensure PowerShell Module Logging Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure PowerShell Module Logging Enabled remediation succeeded
    Exit 1:      Ensure PowerShell Module Logging Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure PowerShell Module Logging Enabled.'
    exit 1
}
