...
$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\PowerShell\ModuleLogging'; Name = 'EnableModuleLogging'; Type = 'DWord'; Value = 1; Description = 'Enable Windows PowerShell module logging' },
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\PowerShell\ModuleLogging\ModuleNames'; Name = '*'; Type = 'String'; Value = '*'; Description = 'Log all installed modules' }
)
