...
Detects and remediates PowerShell module logging policy with an editable module-name template.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-PowerShell-Module-Logging-Enabled`.
