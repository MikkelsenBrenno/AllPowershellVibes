# Firewall Public Profile Policy DefaultOutboundAction Registry

## Summary

Refreshes a local Firewall Public Profile Policy DefaultOutboundAction registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPfirewallpublicprofiledefaultoutboundactionRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-public-profile-policy-default-outbound-action-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-public-profile-policy-default-outbound-action-Registry-Snapshot-When-Stale`.
