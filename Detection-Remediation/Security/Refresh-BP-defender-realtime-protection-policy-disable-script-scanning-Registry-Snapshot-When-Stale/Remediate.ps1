<#
.SYNOPSIS
    Refreshes the Defender Realtime Protection Policy DisableScriptScanning Registry snapshot.
...
$ScriptPackageName = 'Refresh-BP-defender-realtime-protection-policy-disable-script-scanning-Registry-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPdefenderrealtimedisablescriptscanningRegistrySnapshot.json'
...
$TaskPathPrefix = '\'
$TaskNamePatterns = @()
$SnapshotNote = 'Defender Realtime Protection Policy DisableScriptScanning registry policy snapshot for technician troubleshooting.'

$RegistryItems = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows Defender\Real-Time Protection'; Name = 'DisableScriptScanning'; Description = 'Script scanning state' }
)
