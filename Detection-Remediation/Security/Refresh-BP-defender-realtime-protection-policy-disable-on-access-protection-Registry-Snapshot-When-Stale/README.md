# Defender Realtime Protection Policy DisableOnAccessProtection Registry

## Summary

Refreshes a local Defender Realtime Protection Policy DisableOnAccessProtection registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdefenderrealtimedisableonaccessprotectionRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-realtime-protection-policy-disable-on-access-protection-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-realtime-protection-policy-disable-on-access-protection-Registry-Snapshot-When-Stale`.
