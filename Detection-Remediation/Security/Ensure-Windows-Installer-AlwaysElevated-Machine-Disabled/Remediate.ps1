<#
.SYNOPSIS
    Remediates Ensure Windows Installer AlwaysElevated Machine Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Windows Installer AlwaysElevated Machine Disabled remediation succeeded
    Exit 1:      Ensure Windows Installer AlwaysElevated Machine Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Windows Installer AlwaysElevated Machine Disabled.'
    exit 1
}
