# Ensure Windows Installer AlwaysElevated Machine Disabled

## Summary

Detects and remediates the machine-scope AlwaysInstallElevated policy so MSI packages cannot be elevated through unsafe policy.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Windows-Installer-AlwaysElevated-Machine-Disabled`.
