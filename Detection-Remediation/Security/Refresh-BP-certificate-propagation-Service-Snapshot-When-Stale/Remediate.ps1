<#
.SYNOPSIS
    Refreshes the Certificate Propagation Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-certificate-propagation-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcertificatepropagationServiceSnapshot.json'
