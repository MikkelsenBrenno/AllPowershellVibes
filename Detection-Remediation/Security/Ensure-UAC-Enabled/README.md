...
Detects and remediates User Account Control policy so admin approval mode remains enabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-UAC-Enabled`.
