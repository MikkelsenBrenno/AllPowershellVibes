...
.INTUNE
    ...
    Exit 0:      Ensure UAC Enabled remediation succeeded
    Exit 1:      Ensure UAC Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure UAC Enabled.'
    exit 1
}
