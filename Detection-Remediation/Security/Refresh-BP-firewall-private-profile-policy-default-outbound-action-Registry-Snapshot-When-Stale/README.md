# Firewall Private Profile Policy DefaultOutboundAction Registry

## Summary

Refreshes a local Firewall Private Profile Policy DefaultOutboundAction registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPfirewallprivateprofiledefaultoutboundactionRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-private-profile-policy-default-outbound-action-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-private-profile-policy-default-outbound-action-Registry-Snapshot-When-Stale`.
