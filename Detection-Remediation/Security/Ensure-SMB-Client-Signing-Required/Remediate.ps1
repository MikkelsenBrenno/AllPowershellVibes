<#
.SYNOPSIS
    Remediates Ensure SMB Client Signing Required.
...
$ScriptPackageName = 'Ensure-SMB-Client-Signing-Required'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SYSTEM\CurrentControlSet\Services\LanmanWorkstation\Parameters'; Name = 'RequireSecuritySignature'; Type = 'DWord'; Value = 1; Description = 'Require SMB client signing' }
)
