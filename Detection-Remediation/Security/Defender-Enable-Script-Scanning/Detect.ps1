<#
.SYNOPSIS
    Detects whether Microsoft Defender script scanning is enabled.

.DESCRIPTION
    Intune Remediations detection script. The script checks the Microsoft
    Defender Antivirus DisableScriptScanning preference and exits 0 when
    script scanning is enabled. It exits 1 when remediation should run.
...
.INTUNE
    ...
    Exit 0:      Script scanning is compliant
    Exit 1:      Script scanning is disabled or unavailable
