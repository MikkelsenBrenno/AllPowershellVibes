<#
.SYNOPSIS
    Remediates Ensure LM Hash Storage Disabled.
...
.INTUNE
    ...
    Exit 0:      Ensure LM Hash Storage Disabled remediation succeeded
    Exit 1:      Ensure LM Hash Storage Disabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure LM Hash Storage Disabled.'
    exit 1
}
