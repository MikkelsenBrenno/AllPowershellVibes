<#
.SYNOPSIS
    Remediates Ensure Firewall Private Profile Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Firewall Private Profile Enabled remediation succeeded
    Exit 1:      Ensure Firewall Private Profile Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Firewall Private Profile Enabled.'
    exit 1
}
