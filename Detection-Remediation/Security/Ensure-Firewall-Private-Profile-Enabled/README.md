...
Detects and remediates Windows Firewall policy so the private profile is enabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Firewall-Private-Profile-Enabled`.
