<#
.SYNOPSIS
    Refreshes the Code Integrity Operational Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-codeintegrity-operational-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPcodeintegrityoperationaleventsEventSnapshot.json'
