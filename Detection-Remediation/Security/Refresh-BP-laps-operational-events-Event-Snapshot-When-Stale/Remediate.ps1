<#
.SYNOPSIS
    Refreshes the Windows LAPS Operational Events Event snapshot.
...
$ScriptPackageName = 'Refresh-BP-laps-operational-events-Event-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPlapsoperationaleventsEventSnapshot.json'
