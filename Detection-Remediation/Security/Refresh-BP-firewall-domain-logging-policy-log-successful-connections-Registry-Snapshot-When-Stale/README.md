# Firewall Domain Logging Policy LogSuccessfulConnections Registry

## Summary

Refreshes a local Firewall Domain Logging Policy LogSuccessfulConnections registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPfirewalldomainlogginglogsuccessfulconnectionsRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-domain-logging-policy-log-successful-connections-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-firewall-domain-logging-policy-log-successful-connections-Registry-Snapshot-When-Stale`.
