<#
.SYNOPSIS
    Refreshes the Windows Security Center Service snapshot.
...
$ScriptPackageName = 'Refresh-BP-security-center-Service-Snapshot-When-Stale'
$ScriptName = 'Remediate'

$SnapshotRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\RemediationSnapshots'
$SnapshotFileName = 'BPsecuritycenterServiceSnapshot.json'
