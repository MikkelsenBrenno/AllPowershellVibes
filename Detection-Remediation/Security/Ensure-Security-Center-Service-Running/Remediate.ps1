<#
.SYNOPSIS
    Starts Security Center Service.
...
.INTUNE
    ...
    Exit 0:      Security Center Service remediation succeeded
    Exit 1:      Security Center Service remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Security Center Service.'
    exit 1
}
