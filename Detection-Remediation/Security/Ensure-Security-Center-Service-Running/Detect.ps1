<#
.SYNOPSIS
    Detects whether Security Center Service is running.
...
.INTUNE
    ...
    Exit 0:      Security Center Service is running
    Exit 1:      Security Center Service is missing or stopped
...
$ScriptPackageName = 'Ensure-Security-Center-Service-Running'
$ScriptName = 'Detect'
...
try {
    ...
    Write-Output 'Not compliant. Security Center Service could not be validated.'
    exit 1
}
