# Ensure Security Center Service Running

## Summary

Detects and remediates devices where Windows Security Center service is stopped, helping Defender and firewall status reporting.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Security-Center-Service-Running`.
