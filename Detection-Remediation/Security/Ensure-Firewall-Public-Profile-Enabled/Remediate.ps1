<#
.SYNOPSIS
    Remediates Ensure Firewall Public Profile Enabled.
...
.INTUNE
    ...
    Exit 0:      Ensure Firewall Public Profile Enabled remediation succeeded
    Exit 1:      Ensure Firewall Public Profile Enabled remediation failed
...
try {
    ...
    Write-Output 'Remediation failed for Ensure Firewall Public Profile Enabled.'
    exit 1
}
