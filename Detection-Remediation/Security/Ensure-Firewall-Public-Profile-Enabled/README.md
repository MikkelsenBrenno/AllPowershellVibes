...
Detects and remediates Windows Firewall policy so the public profile is enabled.
...
- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Ensure-Firewall-Public-Profile-Enabled`.
