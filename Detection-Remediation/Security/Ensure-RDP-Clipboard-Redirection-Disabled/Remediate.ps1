<#
.SYNOPSIS
    Remediates Ensure RDP Clipboard Redirection Disabled.
...
$ScriptPackageName = 'Ensure-RDP-Clipboard-Redirection-Disabled'
$ScriptName = 'Remediate'

$RegistryValues = @(
    @{ Path = 'HKLM:\SOFTWARE\Policies\Microsoft\Windows NT\Terminal Services'; Name = 'fDisableClip'; Type = 'DWord'; Value = 1; Description = 'Disable RDP clipboard redirection' }
)
