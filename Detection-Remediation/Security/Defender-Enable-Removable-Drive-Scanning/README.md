# Defender Enable Removable Drive Scanning

## Summary

Detects and remediates Microsoft Defender removable drive scanning by keeping `DisableRemovableDriveScanning` set to `$false`.
