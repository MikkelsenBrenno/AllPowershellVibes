<#
.SYNOPSIS
    Detects Microsoft Defender removable drive scanning.
...
.INTUNE
    ...
    Exit 0:      Microsoft Defender removable drive scanning is compliant
    Exit 1:      Microsoft Defender removable drive scanning is missing, different, or unavailable
...
try {
    ...
    Write-Output 'Not compliant. Microsoft Defender removable drive scanning could not be validated.'
    exit 1
}
