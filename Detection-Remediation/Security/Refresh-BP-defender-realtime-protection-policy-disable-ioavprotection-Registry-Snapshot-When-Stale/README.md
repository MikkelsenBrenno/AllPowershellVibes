# Defender Realtime Protection Policy DisableIOAVProtection Registry

## Summary

Refreshes a local Defender Realtime Protection Policy DisableIOAVProtection registry policy troubleshooting snapshot when it is missing or stale.
...
| `$SnapshotFileName` | JSON snapshot file name. | `BPdefenderrealtimedisableioavprotectionRegistrySnapshot.json` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-realtime-protection-policy-disable-ioavprotection-Registry-Snapshot-When-Stale`.

## Troubleshooting

- Review logs in `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Refresh-BP-defender-realtime-protection-policy-disable-ioavprotection-Registry-Snapshot-When-Stale`.
