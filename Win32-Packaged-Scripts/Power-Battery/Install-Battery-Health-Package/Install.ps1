<#
.SYNOPSIS
    Installs Battery Health package marker.

.DESCRIPTION
    Installs Battery Health as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Battery-Health-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Battery Health'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Power-Battery\Install-Battery-Health-Package'
$MarkerFileName = 'install-battery-health-package.state'
