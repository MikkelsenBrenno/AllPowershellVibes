<#
.SYNOPSIS
    Installs Lid Action package marker.

.DESCRIPTION
    Installs Lid Action as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Lid-Action-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Lid Action'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Power-Battery\Install-Lid-Action-Package'
$MarkerFileName = 'install-lid-action-package.state'
