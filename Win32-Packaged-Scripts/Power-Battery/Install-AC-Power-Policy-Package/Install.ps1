<#
.SYNOPSIS
    Installs AC Power Policy package marker.

.DESCRIPTION
    Installs AC Power Policy as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-AC-Power-Policy-Package'
$ScriptName = 'Install'

$ManagedItemName = 'AC Power Policy'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Power-Battery\Install-AC-Power-Policy-Package'
$MarkerFileName = 'install-ac-power-policy-package.state'
