<#
.SYNOPSIS
    Installs Modern Standby package marker.

.DESCRIPTION
    Installs Modern Standby as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Modern-Standby-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Modern Standby'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Power-Battery\Install-Modern-Standby-Package'
$MarkerFileName = 'install-modern-standby-package.state'
