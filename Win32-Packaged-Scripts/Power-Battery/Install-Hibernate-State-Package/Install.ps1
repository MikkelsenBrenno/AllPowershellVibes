<#
.SYNOPSIS
    Installs Hibernate State package marker.

.DESCRIPTION
    Installs Hibernate State as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Hibernate-State-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Hibernate State'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Power-Battery\Install-Hibernate-State-Package'
$MarkerFileName = 'install-hibernate-state-package.state'
