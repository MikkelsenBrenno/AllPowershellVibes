<#
.SYNOPSIS
    Installs Power Plan package marker.

.DESCRIPTION
    Installs Power Plan as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Power-Plan-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Power Plan'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Power-Battery\Install-Power-Plan-Package'
$MarkerFileName = 'install-power-plan-package.state'
