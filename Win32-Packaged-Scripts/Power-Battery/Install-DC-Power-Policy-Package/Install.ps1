<#
.SYNOPSIS
    Installs DC Power Policy package marker.

.DESCRIPTION
    Installs DC Power Policy as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-DC-Power-Policy-Package'
$ScriptName = 'Install'

$ManagedItemName = 'DC Power Policy'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Power-Battery\Install-DC-Power-Policy-Package'
$MarkerFileName = 'install-dc-power-policy-package.state'
