<#
.SYNOPSIS
    Installs Sleep Policy package marker.

.DESCRIPTION
    Installs Sleep Policy as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Sleep-Policy-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Sleep Policy'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Power-Battery\Install-Sleep-Policy-Package'
$MarkerFileName = 'install-sleep-policy-package.state'
