<#
.SYNOPSIS
    Installs Battery Cycle Count package marker.

.DESCRIPTION
    Installs Battery Cycle Count as a reusable Win32 script package.
...
$MarkerFileName = 'install-battery-cycle-count-package.state'
