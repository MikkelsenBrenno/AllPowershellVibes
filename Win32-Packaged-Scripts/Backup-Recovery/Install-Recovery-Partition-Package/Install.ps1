<#
.SYNOPSIS
    Installs Recovery Partition package marker.

.DESCRIPTION
    Installs Recovery Partition as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Recovery-Partition-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Recovery Partition'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Backup-Recovery\Install-Recovery-Partition-Package'
$MarkerFileName = 'install-recovery-partition-package.state'
