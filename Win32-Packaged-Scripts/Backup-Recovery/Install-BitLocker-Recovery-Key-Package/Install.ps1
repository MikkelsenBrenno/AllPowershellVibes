<#
.SYNOPSIS
    Installs BitLocker Recovery Key package marker.

.DESCRIPTION
    Installs BitLocker Recovery Key as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-BitLocker-Recovery-Key-Package'
$ScriptName = 'Install'

$ManagedItemName = 'BitLocker Recovery Key'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Backup-Recovery\Install-BitLocker-Recovery-Key-Package'
$MarkerFileName = 'install-bitlocker-recovery-key-package.state'
