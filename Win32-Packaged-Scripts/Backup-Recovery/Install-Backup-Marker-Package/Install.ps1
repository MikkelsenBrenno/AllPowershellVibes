<#
.SYNOPSIS
    Installs Backup Marker package marker.

.DESCRIPTION
    Installs Backup Marker as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Backup-Marker-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Backup Marker'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Backup-Recovery\Install-Backup-Marker-Package'
$MarkerFileName = 'install-backup-marker-package.state'
