<#
.SYNOPSIS
    Installs File History package marker.

.DESCRIPTION
    Installs File History as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-File-History-Package'
$ScriptName = 'Install'

$ManagedItemName = 'File History'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Backup-Recovery\Install-File-History-Package'
$MarkerFileName = 'install-file-history-package.state'
