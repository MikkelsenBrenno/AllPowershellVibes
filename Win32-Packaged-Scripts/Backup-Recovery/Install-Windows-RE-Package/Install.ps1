<#
.SYNOPSIS
    Installs Windows RE package marker.

.DESCRIPTION
    Installs Windows RE as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Windows-RE-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Windows RE'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Backup-Recovery\Install-Windows-RE-Package'
$MarkerFileName = 'install-windows-re-package.state'
