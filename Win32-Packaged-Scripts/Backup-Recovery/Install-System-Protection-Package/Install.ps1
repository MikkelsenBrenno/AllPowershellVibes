<#
.SYNOPSIS
    Installs System Protection package marker.

.DESCRIPTION
    Installs System Protection as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-System-Protection-Package'
$ScriptName = 'Install'

$ManagedItemName = 'System Protection'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Backup-Recovery\Install-System-Protection-Package'
$MarkerFileName = 'install-system-protection-package.state'
