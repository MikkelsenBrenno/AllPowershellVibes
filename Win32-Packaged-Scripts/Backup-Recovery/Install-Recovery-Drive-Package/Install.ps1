<#
.SYNOPSIS
    Installs Recovery Drive package marker.

.DESCRIPTION
    Installs Recovery Drive as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Recovery-Drive-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Recovery Drive'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Backup-Recovery\Install-Recovery-Drive-Package'
$MarkerFileName = 'install-recovery-drive-package.state'
