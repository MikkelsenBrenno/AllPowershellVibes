<#
.SYNOPSIS
    Installs Restore Point package marker.

.DESCRIPTION
    Installs Restore Point as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Restore-Point-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Restore Point'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Backup-Recovery\Install-Restore-Point-Package'
$MarkerFileName = 'install-restore-point-package.state'
