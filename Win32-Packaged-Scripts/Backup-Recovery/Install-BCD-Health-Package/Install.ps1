<#
.SYNOPSIS
    Installs BCD Health package marker.

.DESCRIPTION
    Installs BCD Health as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-BCD-Health-Package'
$ScriptName = 'Install'

$ManagedItemName = 'BCD Health'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Backup-Recovery\Install-BCD-Health-Package'
$MarkerFileName = 'install-bcd-health-package.state'
