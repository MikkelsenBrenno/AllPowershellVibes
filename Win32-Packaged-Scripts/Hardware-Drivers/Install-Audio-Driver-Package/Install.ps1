<#
.SYNOPSIS
    Installs Audio Driver package marker.

.DESCRIPTION
    Installs Audio Driver as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Audio-Driver-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Audio Driver'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Hardware-Drivers\Install-Audio-Driver-Package'
$MarkerFileName = 'install-audio-driver-package.state'
