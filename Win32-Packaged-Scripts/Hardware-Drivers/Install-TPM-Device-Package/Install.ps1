<#
.SYNOPSIS
    Installs TPM Device package marker.

.DESCRIPTION
    Installs TPM Device as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-TPM-Device-Package'
$ScriptName = 'Install'

$ManagedItemName = 'TPM Device'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Hardware-Drivers\Install-TPM-Device-Package'
$MarkerFileName = 'install-tpm-device-package.state'
