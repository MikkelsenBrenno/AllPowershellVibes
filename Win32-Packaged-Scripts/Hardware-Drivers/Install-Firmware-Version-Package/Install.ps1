<#
.SYNOPSIS
    Installs Firmware Version package marker.

.DESCRIPTION
    Installs Firmware Version as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Firmware-Version-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Firmware Version'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Hardware-Drivers\Install-Firmware-Version-Package'
$MarkerFileName = 'install-firmware-version-package.state'
