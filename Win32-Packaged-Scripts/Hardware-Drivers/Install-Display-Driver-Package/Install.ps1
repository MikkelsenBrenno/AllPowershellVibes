<#
.SYNOPSIS
    Installs Display Driver package marker.

.DESCRIPTION
    Installs Display Driver as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Display-Driver-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Display Driver'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Hardware-Drivers\Install-Display-Driver-Package'
$MarkerFileName = 'install-display-driver-package.state'
