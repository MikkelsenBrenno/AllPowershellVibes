<#
.SYNOPSIS
    Installs Bluetooth Driver package marker.

.DESCRIPTION
    Installs Bluetooth Driver as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Bluetooth-Driver-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Bluetooth Driver'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Hardware-Drivers\Install-Bluetooth-Driver-Package'
$MarkerFileName = 'install-bluetooth-driver-package.state'
