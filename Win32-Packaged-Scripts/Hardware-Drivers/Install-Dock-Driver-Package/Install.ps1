<#
.SYNOPSIS
    Installs Dock Driver package marker.

.DESCRIPTION
    Installs Dock Driver as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Dock-Driver-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Dock Driver'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Hardware-Drivers\Install-Dock-Driver-Package'
$MarkerFileName = 'install-dock-driver-package.state'
