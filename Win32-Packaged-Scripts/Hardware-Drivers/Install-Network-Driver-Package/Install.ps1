<#
.SYNOPSIS
    Installs Network Driver package marker.

.DESCRIPTION
    Installs Network Driver as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Network-Driver-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Network Driver'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Hardware-Drivers\Install-Network-Driver-Package'
$MarkerFileName = 'install-network-driver-package.state'
