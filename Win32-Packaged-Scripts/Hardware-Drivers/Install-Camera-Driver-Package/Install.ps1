<#
.SYNOPSIS
    Installs Camera Driver package marker.

.DESCRIPTION
    Installs Camera Driver as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Camera-Driver-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Camera Driver'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Hardware-Drivers\Install-Camera-Driver-Package'
$MarkerFileName = 'install-camera-driver-package.state'
