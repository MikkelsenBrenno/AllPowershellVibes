<#
.SYNOPSIS
    Installs BIOS Version package marker.

.DESCRIPTION
    Installs BIOS Version as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-BIOS-Version-Package'
$ScriptName = 'Install'

$ManagedItemName = 'BIOS Version'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Hardware-Drivers\Install-BIOS-Version-Package'
$MarkerFileName = 'install-bios-version-package.state'
