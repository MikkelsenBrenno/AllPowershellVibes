<#
.SYNOPSIS
    Installs Driver Date package marker.

.DESCRIPTION
    Installs Driver Date as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Driver-Date-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Driver Date'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Hardware-Drivers\Install-Driver-Date-Package'
$MarkerFileName = 'install-driver-date-package.state'
