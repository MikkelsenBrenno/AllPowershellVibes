<#
.SYNOPSIS
    Installs Missing Drivers package marker.

.DESCRIPTION
    Installs Missing Drivers as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Missing-Drivers-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Missing Drivers'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Hardware-Drivers\Install-Missing-Drivers-Package'
$MarkerFileName = 'install-missing-drivers-package.state'
