...
.INTUNE
    Workload:    Win32 App
    Exit 0:      Endpoint health tool removed
    Exit 1:      Endpoint health tool removal failed
...
$ToolFileNames = @('EndpointHealthSnapshot.ps1', 'tool-version.txt')
...
try {
    ...
    Write-Output 'Uninstall succeeded. Endpoint health tool is absent.'
    exit 0
}
catch {
