<#
.SYNOPSIS
    Installs External Monitor package marker.

.DESCRIPTION
    Installs External Monitor as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-External-Monitor-Package'
$ScriptName = 'Install'

$ManagedItemName = 'External Monitor'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Peripheral-Devices\Install-External-Monitor-Package'
$MarkerFileName = 'install-external-monitor-package.state'
