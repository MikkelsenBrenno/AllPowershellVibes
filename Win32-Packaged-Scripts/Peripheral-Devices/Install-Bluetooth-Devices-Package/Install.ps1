<#
.SYNOPSIS
    Installs Bluetooth Devices package marker.

.DESCRIPTION
    Installs Bluetooth Devices as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Bluetooth-Devices-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Bluetooth Devices'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Peripheral-Devices\Install-Bluetooth-Devices-Package'
$MarkerFileName = 'install-bluetooth-devices-package.state'
