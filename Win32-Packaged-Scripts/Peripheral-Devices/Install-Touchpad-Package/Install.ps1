<#
.SYNOPSIS
    Installs Touchpad package marker.

.DESCRIPTION
    Installs Touchpad as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Touchpad-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Touchpad'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Peripheral-Devices\Install-Touchpad-Package'
$MarkerFileName = 'install-touchpad-package.state'
