<#
.SYNOPSIS
    Installs Audio Device package marker.

.DESCRIPTION
    Installs Audio Device as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Audio-Device-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Audio Device'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Peripheral-Devices\Install-Audio-Device-Package'
$MarkerFileName = 'install-audio-device-package.state'
