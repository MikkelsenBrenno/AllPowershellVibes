<#
.SYNOPSIS
    Installs Docking Station package marker.

.DESCRIPTION
    Installs Docking Station as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Docking-Station-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Docking Station'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Peripheral-Devices\Install-Docking-Station-Package'
$MarkerFileName = 'install-docking-station-package.state'
