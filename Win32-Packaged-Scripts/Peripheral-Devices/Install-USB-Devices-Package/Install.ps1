<#
.SYNOPSIS
    Installs USB Devices package marker.

.DESCRIPTION
    Installs USB Devices as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-USB-Devices-Package'
$ScriptName = 'Install'

$ManagedItemName = 'USB Devices'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Peripheral-Devices\Install-USB-Devices-Package'
$MarkerFileName = 'install-usb-devices-package.state'
