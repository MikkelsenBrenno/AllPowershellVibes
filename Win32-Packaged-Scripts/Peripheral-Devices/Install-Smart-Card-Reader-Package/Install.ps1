<#
.SYNOPSIS
    Installs Smart Card Reader package marker.

.DESCRIPTION
    Installs Smart Card Reader as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Smart-Card-Reader-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Smart Card Reader'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Peripheral-Devices\Install-Smart-Card-Reader-Package'
$MarkerFileName = 'install-smart-card-reader-package.state'
