...
.DESCRIPTION
    Installs Enrollment Scheduled Task as a reusable Win32 script package.
...
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\MDM-Enrollment\Install-Enrollment-Scheduled-Task-Package'
$MarkerFileName = 'install-enrollment-scheduled-task-package.state'
