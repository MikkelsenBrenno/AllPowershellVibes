<#
.SYNOPSIS
    Installs IME Service package marker.

.DESCRIPTION
    Installs IME Service as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-IME-Service-Package'
$ScriptName = 'Install'

$ManagedItemName = 'IME Service'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\MDM-Enrollment\Install-IME-Service-Package'
$MarkerFileName = 'install-ime-service-package.state'
