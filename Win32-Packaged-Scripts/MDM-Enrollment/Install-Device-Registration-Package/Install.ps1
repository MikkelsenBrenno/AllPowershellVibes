<#
.SYNOPSIS
    Installs Device Registration package marker.

.DESCRIPTION
    Installs Device Registration as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Device-Registration-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Device Registration'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\MDM-Enrollment\Install-Device-Registration-Package'
$MarkerFileName = 'install-device-registration-package.state'
