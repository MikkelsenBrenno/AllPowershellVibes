<#
.SYNOPSIS
    Installs DMClient Service package marker.

.DESCRIPTION
    Installs DMClient Service as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-DMClient-Service-Package'
$ScriptName = 'Install'

$ManagedItemName = 'DMClient Service'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\MDM-Enrollment\Install-DMClient-Service-Package'
$MarkerFileName = 'install-dmclient-service-package.state'
