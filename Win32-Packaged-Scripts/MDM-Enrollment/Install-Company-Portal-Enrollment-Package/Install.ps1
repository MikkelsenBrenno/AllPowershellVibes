<#
.SYNOPSIS
    Installs Company Portal Enrollment package marker.

.DESCRIPTION
    Installs Company Portal Enrollment as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Company-Portal-Enrollment-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Company Portal Enrollment'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\MDM-Enrollment\Install-Company-Portal-Enrollment-Package'
$MarkerFileName = 'install-company-portal-enrollment-package.state'
