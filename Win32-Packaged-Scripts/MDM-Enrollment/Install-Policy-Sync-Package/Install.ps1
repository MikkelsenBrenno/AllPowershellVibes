<#
.SYNOPSIS
    Installs Policy Sync package marker.

.DESCRIPTION
    Installs Policy Sync as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Policy-Sync-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Policy Sync'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\MDM-Enrollment\Install-Policy-Sync-Package'
$MarkerFileName = 'install-policy-sync-package.state'
