<#
.SYNOPSIS
    Installs Enrollment EventLog package marker.

.DESCRIPTION
    Installs Enrollment EventLog as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Enrollment-EventLog-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Enrollment EventLog'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\MDM-Enrollment\Install-Enrollment-EventLog-Package'
$MarkerFileName = 'install-enrollment-eventlog-package.state'
