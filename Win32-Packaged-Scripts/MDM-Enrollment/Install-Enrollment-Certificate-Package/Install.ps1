<#
.SYNOPSIS
    Installs Enrollment Certificate package marker.

.DESCRIPTION
    Installs Enrollment Certificate as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Enrollment-Certificate-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Enrollment Certificate'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\MDM-Enrollment\Install-Enrollment-Certificate-Package'
$MarkerFileName = 'install-enrollment-certificate-package.state'
