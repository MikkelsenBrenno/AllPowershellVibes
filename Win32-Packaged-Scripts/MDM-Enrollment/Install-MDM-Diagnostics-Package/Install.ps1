<#
.SYNOPSIS
    Installs MDM Diagnostics package marker.

.DESCRIPTION
    Installs MDM Diagnostics as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-MDM-Diagnostics-Package'
$ScriptName = 'Install'

$ManagedItemName = 'MDM Diagnostics'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\MDM-Enrollment\Install-MDM-Diagnostics-Package'
$MarkerFileName = 'install-mdm-diagnostics-package.state'
