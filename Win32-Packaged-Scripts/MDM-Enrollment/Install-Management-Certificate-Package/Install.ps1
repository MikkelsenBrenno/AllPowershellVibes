<#
.SYNOPSIS
    Installs Management Certificate package marker.

.DESCRIPTION
    Installs Management Certificate as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Management-Certificate-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Management Certificate'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\MDM-Enrollment\Install-Management-Certificate-Package'
$MarkerFileName = 'install-management-certificate-package.state'
