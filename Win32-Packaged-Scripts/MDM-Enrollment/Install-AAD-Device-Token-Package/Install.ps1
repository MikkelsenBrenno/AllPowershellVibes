<#
.SYNOPSIS
    Installs AAD Device Token package marker.

.DESCRIPTION
    Installs AAD Device Token as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-AAD-Device-Token-Package'
$ScriptName = 'Install'

$ManagedItemName = 'AAD Device Token'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\MDM-Enrollment\Install-AAD-Device-Token-Package'
$MarkerFileName = 'install-aad-device-token-package.state'
