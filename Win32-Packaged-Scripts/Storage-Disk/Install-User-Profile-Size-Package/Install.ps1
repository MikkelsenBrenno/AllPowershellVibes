<#
.SYNOPSIS
    Installs User Profile Size package marker.

.DESCRIPTION
    Installs User Profile Size as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-User-Profile-Size-Package'
$ScriptName = 'Install'

$ManagedItemName = 'User Profile Size'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Storage-Disk\Install-User-Profile-Size-Package'
$MarkerFileName = 'install-user-profile-size-package.state'
