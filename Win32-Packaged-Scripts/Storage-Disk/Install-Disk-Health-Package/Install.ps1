<#
.SYNOPSIS
    Installs Disk Health package marker.

.DESCRIPTION
    Installs Disk Health as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Disk-Health-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Disk Health'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Storage-Disk\Install-Disk-Health-Package'
$MarkerFileName = 'install-disk-health-package.state'
