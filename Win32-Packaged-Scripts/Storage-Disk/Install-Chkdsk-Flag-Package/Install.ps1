<#
.SYNOPSIS
    Installs Chkdsk Flag package marker.

.DESCRIPTION
    Installs Chkdsk Flag as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Chkdsk-Flag-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Chkdsk Flag'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Storage-Disk\Install-Chkdsk-Flag-Package'
$MarkerFileName = 'install-chkdsk-flag-package.state'
