<#
.SYNOPSIS
    Installs Volume Errors package marker.

.DESCRIPTION
    Installs Volume Errors as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Volume-Errors-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Volume Errors'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Storage-Disk\Install-Volume-Errors-Package'
$MarkerFileName = 'install-volume-errors-package.state'
