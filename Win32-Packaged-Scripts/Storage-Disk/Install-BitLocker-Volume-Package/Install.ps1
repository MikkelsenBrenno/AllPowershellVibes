<#
.SYNOPSIS
    Installs BitLocker Volume package marker.

.DESCRIPTION
    Installs BitLocker Volume as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-BitLocker-Volume-Package'
$ScriptName = 'Install'

$ManagedItemName = 'BitLocker Volume'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Storage-Disk\Install-BitLocker-Volume-Package'
$MarkerFileName = 'install-bitlocker-volume-package.state'
