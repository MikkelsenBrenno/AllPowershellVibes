<#
.SYNOPSIS
    Installs Recycle Bin Size package marker.

.DESCRIPTION
    Installs Recycle Bin Size as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Recycle-Bin-Size-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Recycle Bin Size'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Storage-Disk\Install-Recycle-Bin-Size-Package'
$MarkerFileName = 'install-recycle-bin-size-package.state'
