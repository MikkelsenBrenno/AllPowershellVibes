<#
.SYNOPSIS
    Installs SMART Status package marker.

.DESCRIPTION
    Installs SMART Status as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-SMART-Status-Package'
$ScriptName = 'Install'

$ManagedItemName = 'SMART Status'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Storage-Disk\Install-SMART-Status-Package'
$MarkerFileName = 'install-smart-status-package.state'
