<#
.SYNOPSIS
    Installs Disk Cleanup package marker.

.DESCRIPTION
    Installs Disk Cleanup as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Disk-Cleanup-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Disk Cleanup'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Storage-Disk\Install-Disk-Cleanup-Package'
$MarkerFileName = 'install-disk-cleanup-package.state'
