<#
.SYNOPSIS
    Installs Temp Storage package marker.

.DESCRIPTION
    Installs Temp Storage as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Temp-Storage-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Temp Storage'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Storage-Disk\Install-Temp-Storage-Package'
$MarkerFileName = 'install-temp-storage-package.state'
