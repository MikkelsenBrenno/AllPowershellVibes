<#
.SYNOPSIS
    Installs Free Space package marker.

.DESCRIPTION
    Installs Free Space as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Free-Space-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Free Space'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Storage-Disk\Install-Free-Space-Package'
$MarkerFileName = 'install-free-space-package.state'
