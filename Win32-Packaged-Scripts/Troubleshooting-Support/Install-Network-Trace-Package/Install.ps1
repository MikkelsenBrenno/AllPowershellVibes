<#
.SYNOPSIS
    Installs Network Trace package marker.

.DESCRIPTION
    Installs Network Trace as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Network-Trace-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Network Trace'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Troubleshooting-Support\Install-Network-Trace-Package'
$MarkerFileName = 'install-network-trace-package.state'
