<#
.SYNOPSIS
    Installs Support Bundle package marker.

.DESCRIPTION
    Installs Support Bundle as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Support-Bundle-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Support Bundle'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Troubleshooting-Support\Install-Support-Bundle-Package'
$MarkerFileName = 'install-support-bundle-package.state'
