<#
.SYNOPSIS
    Installs Problem Reports package marker.

.DESCRIPTION
    Installs Problem Reports as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Problem-Reports-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Problem Reports'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Troubleshooting-Support\Install-Problem-Reports-Package'
$MarkerFileName = 'install-problem-reports-package.state'
