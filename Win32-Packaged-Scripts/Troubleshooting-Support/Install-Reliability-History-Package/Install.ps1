<#
.SYNOPSIS
    Installs Reliability History package marker.

.DESCRIPTION
    Installs Reliability History as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Reliability-History-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Reliability History'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Troubleshooting-Support\Install-Reliability-History-Package'
$MarkerFileName = 'install-reliability-history-package.state'
