<#
.SYNOPSIS
    Installs IME Log Collector package marker.

.DESCRIPTION
    Installs IME Log Collector as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-IME-Log-Collector-Package'
$ScriptName = 'Install'

$ManagedItemName = 'IME Log Collector'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Troubleshooting-Support\Install-IME-Log-Collector-Package'
$MarkerFileName = 'install-ime-log-collector-package.state'
