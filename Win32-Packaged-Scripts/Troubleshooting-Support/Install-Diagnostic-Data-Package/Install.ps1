<#
.SYNOPSIS
    Installs Diagnostic Data package marker.

.DESCRIPTION
    Installs Diagnostic Data as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Diagnostic-Data-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Diagnostic Data'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Troubleshooting-Support\Install-Diagnostic-Data-Package'
$MarkerFileName = 'install-diagnostic-data-package.state'
