<#
.SYNOPSIS
    Installs MDM Diagnostic Package package marker.

.DESCRIPTION
    Installs MDM Diagnostic Package as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-MDM-Diagnostic-Package-Package'
$ScriptName = 'Install'

$ManagedItemName = 'MDM Diagnostic Package'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Troubleshooting-Support\Install-MDM-Diagnostic-Package-Package'
$MarkerFileName = 'install-mdm-diagnostic-package-package.state'
