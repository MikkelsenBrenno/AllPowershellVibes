<#
.SYNOPSIS
    Installs Crash Dumps package marker.

.DESCRIPTION
    Installs Crash Dumps as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Crash-Dumps-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Crash Dumps'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Troubleshooting-Support\Install-Crash-Dumps-Package'
$MarkerFileName = 'install-crash-dumps-package.state'
