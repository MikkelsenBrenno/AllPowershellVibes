<#
.SYNOPSIS
    Installs Event Error Snapshot package marker.

.DESCRIPTION
    Installs Event Error Snapshot as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Event-Error-Snapshot-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Event Error Snapshot'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Troubleshooting-Support\Install-Event-Error-Snapshot-Package'
$MarkerFileName = 'install-event-error-snapshot-package.state'
