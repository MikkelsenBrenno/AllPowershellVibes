<#
.SYNOPSIS
    Installs BitLocker Evidence package marker.

.DESCRIPTION
    Installs BitLocker Evidence as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-BitLocker-Evidence-Package'
$ScriptName = 'Install'

$ManagedItemName = 'BitLocker Evidence'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Data-Protection\Install-BitLocker-Evidence-Package'
$MarkerFileName = 'install-bitlocker-evidence-package.state'
