<#
.SYNOPSIS
    Installs Sensitive Data Share package marker.

.DESCRIPTION
    Installs Sensitive Data Share as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Sensitive-Data-Share-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Sensitive Data Share'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Data-Protection\Install-Sensitive-Data-Share-Package'
$MarkerFileName = 'install-sensitive-data-share-package.state'
