<#
.SYNOPSIS
    Installs File Recovery package marker.

.DESCRIPTION
    Installs File Recovery as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-File-Recovery-Package'
$ScriptName = 'Install'

$ManagedItemName = 'File Recovery'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Data-Protection\Install-File-Recovery-Package'
$MarkerFileName = 'install-file-recovery-package.state'
