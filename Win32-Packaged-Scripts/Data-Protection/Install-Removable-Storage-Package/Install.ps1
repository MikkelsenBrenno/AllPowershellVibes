<#
.SYNOPSIS
    Installs Removable Storage package marker.

.DESCRIPTION
    Installs Removable Storage as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Removable-Storage-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Removable Storage'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Data-Protection\Install-Removable-Storage-Package'
$MarkerFileName = 'install-removable-storage-package.state'
