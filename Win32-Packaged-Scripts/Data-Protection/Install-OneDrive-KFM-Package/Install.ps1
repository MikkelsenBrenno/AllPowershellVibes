<#
.SYNOPSIS
    Installs OneDrive KFM package marker.

.DESCRIPTION
    Installs OneDrive KFM as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-OneDrive-KFM-Package'
$ScriptName = 'Install'

$ManagedItemName = 'OneDrive KFM'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Data-Protection\Install-OneDrive-KFM-Package'
$MarkerFileName = 'install-onedrive-kfm-package.state'
