<#
.SYNOPSIS
    Installs Protected Folder package marker.

.DESCRIPTION
    Installs Protected Folder as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Protected-Folder-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Protected Folder'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Data-Protection\Install-Protected-Folder-Package'
$MarkerFileName = 'install-protected-folder-package.state'
