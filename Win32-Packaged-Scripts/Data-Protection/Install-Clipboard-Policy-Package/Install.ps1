<#
.SYNOPSIS
    Installs Clipboard Policy package marker.

.DESCRIPTION
    Installs Clipboard Policy as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Clipboard-Policy-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Clipboard Policy'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Data-Protection\Install-Clipboard-Policy-Package'
$MarkerFileName = 'install-clipboard-policy-package.state'
