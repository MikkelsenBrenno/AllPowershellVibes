<#
.SYNOPSIS
    Installs Controlled Folder package marker.

.DESCRIPTION
    Installs Controlled Folder as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Controlled-Folder-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Controlled Folder'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Data-Protection\Install-Controlled-Folder-Package'
$MarkerFileName = 'install-controlled-folder-package.state'
