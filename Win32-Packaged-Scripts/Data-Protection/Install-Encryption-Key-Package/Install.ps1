<#
.SYNOPSIS
    Installs Encryption Key package marker.

.DESCRIPTION
    Installs Encryption Key as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Encryption-Key-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Encryption Key'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Data-Protection\Install-Encryption-Key-Package'
$MarkerFileName = 'install-encryption-key-package.state'
