<#
.SYNOPSIS
    Installs DLP Marker package marker.

.DESCRIPTION
    Installs DLP Marker as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-DLP-Marker-Package'
$ScriptName = 'Install'

$ManagedItemName = 'DLP Marker'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Data-Protection\Install-DLP-Marker-Package'
$MarkerFileName = 'install-dlp-marker-package.state'
