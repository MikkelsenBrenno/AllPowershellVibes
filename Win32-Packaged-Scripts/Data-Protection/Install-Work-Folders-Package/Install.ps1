<#
.SYNOPSIS
    Installs Work Folders package marker.

.DESCRIPTION
    Installs Work Folders as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Work-Folders-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Work Folders'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Data-Protection\Install-Work-Folders-Package'
$MarkerFileName = 'install-work-folders-package.state'
