<#
.SYNOPSIS
    Installs Backup Readiness package marker.

.DESCRIPTION
    Installs Backup Readiness as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Backup-Readiness-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Backup Readiness'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Data-Protection\Install-Backup-Readiness-Package'
$MarkerFileName = 'install-backup-readiness-package.state'
