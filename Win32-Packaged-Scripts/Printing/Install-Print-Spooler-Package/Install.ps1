<#
.SYNOPSIS
    Installs Print Spooler package marker.

.DESCRIPTION
    Installs Print Spooler as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Print-Spooler-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Print Spooler'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Printing\Install-Print-Spooler-Package'
$MarkerFileName = 'install-print-spooler-package.state'
