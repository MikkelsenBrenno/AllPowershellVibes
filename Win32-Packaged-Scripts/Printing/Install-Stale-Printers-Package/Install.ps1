<#
.SYNOPSIS
    Installs Stale Printers package marker.

.DESCRIPTION
    Installs Stale Printers as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Stale-Printers-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Stale Printers'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Printing\Install-Stale-Printers-Package'
$MarkerFileName = 'install-stale-printers-package.state'
