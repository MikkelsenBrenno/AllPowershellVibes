<#
.SYNOPSIS
    Installs Universal Print package marker.

.DESCRIPTION
    Installs Universal Print as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Universal-Print-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Universal Print'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Printing\Install-Universal-Print-Package'
$MarkerFileName = 'install-universal-print-package.state'
