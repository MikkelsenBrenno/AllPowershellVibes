<#
.SYNOPSIS
    Installs Printer Queue package marker.

.DESCRIPTION
    Installs Printer Queue as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Printer-Queue-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Printer Queue'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Printing\Install-Printer-Queue-Package'
$MarkerFileName = 'install-printer-queue-package.state'
