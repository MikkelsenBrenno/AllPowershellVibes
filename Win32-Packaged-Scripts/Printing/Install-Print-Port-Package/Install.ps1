<#
.SYNOPSIS
    Installs Print Port package marker.

.DESCRIPTION
    Installs Print Port as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Print-Port-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Print Port'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Printing\Install-Print-Port-Package'
$MarkerFileName = 'install-print-port-package.state'
