<#
.SYNOPSIS
    Installs Printer Driver package marker.

.DESCRIPTION
    Installs Printer Driver as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Printer-Driver-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Printer Driver'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Printing\Install-Printer-Driver-Package'
$MarkerFileName = 'install-printer-driver-package.state'
