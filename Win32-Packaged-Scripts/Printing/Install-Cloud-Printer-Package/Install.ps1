<#
.SYNOPSIS
    Installs Cloud Printer package marker.

.DESCRIPTION
    Installs Cloud Printer as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Cloud-Printer-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Cloud Printer'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Printing\Install-Cloud-Printer-Package'
$MarkerFileName = 'install-cloud-printer-package.state'
