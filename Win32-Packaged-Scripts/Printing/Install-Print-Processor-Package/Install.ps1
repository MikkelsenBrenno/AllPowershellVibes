<#
.SYNOPSIS
    Installs Print Processor package marker.

.DESCRIPTION
    Installs Print Processor as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Print-Processor-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Print Processor'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Printing\Install-Print-Processor-Package'
$MarkerFileName = 'install-print-processor-package.state'
