<#
.SYNOPSIS
    Installs Default Printer package marker.

.DESCRIPTION
    Installs Default Printer as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Default-Printer-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Default Printer'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Printing\Install-Default-Printer-Package'
$MarkerFileName = 'install-default-printer-package.state'
