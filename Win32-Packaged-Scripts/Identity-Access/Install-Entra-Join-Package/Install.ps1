<#
.SYNOPSIS
    Installs Entra Join package marker.

.DESCRIPTION
    Installs Entra Join as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Entra-Join-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Entra Join'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Identity-Access\Install-Entra-Join-Package'
$MarkerFileName = 'install-entra-join-package.state'
