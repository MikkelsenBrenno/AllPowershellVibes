<#
.SYNOPSIS
    Installs Password Policy package marker.

.DESCRIPTION
    Installs Password Policy as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Password-Policy-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Password Policy'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Identity-Access\Install-Password-Policy-Package'
$MarkerFileName = 'install-password-policy-package.state'
