<#
.SYNOPSIS
    Installs Windows Hello package marker.

.DESCRIPTION
    Installs Windows Hello as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Windows-Hello-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Windows Hello'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Identity-Access\Install-Windows-Hello-Package'
$MarkerFileName = 'install-windows-hello-package.state'
