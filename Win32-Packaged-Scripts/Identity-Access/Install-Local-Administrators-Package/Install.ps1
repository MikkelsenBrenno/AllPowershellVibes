<#
.SYNOPSIS
    Installs Local Administrators package marker.

.DESCRIPTION
    Installs Local Administrators as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Local-Administrators-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Local Administrators'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Identity-Access\Install-Local-Administrators-Package'
$MarkerFileName = 'install-local-administrators-package.state'
