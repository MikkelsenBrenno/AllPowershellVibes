<#
.SYNOPSIS
    Installs Account Lockout package marker.

.DESCRIPTION
    Installs Account Lockout as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Account-Lockout-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Account Lockout'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Identity-Access\Install-Account-Lockout-Package'
$MarkerFileName = 'install-account-lockout-package.state'
