<#
.SYNOPSIS
    Installs Cached Logons package marker.

.DESCRIPTION
    Installs Cached Logons as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Cached-Logons-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Cached Logons'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Identity-Access\Install-Cached-Logons-Package'
$MarkerFileName = 'install-cached-logons-package.state'
