<#
.SYNOPSIS
    Installs Primary Refresh Token package marker.

.DESCRIPTION
    Installs Primary Refresh Token as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Primary-Refresh-Token-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Primary Refresh Token'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Identity-Access\Install-Primary-Refresh-Token-Package'
$MarkerFileName = 'install-primary-refresh-token-package.state'
