<#
.SYNOPSIS
    Installs Remote Logon package marker.

.DESCRIPTION
    Installs Remote Logon as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Remote-Logon-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Remote Logon'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Identity-Access\Install-Remote-Logon-Package'
$MarkerFileName = 'install-remote-logon-package.state'
