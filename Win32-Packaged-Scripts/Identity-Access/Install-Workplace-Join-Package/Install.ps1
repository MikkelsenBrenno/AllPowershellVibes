<#
.SYNOPSIS
    Installs Workplace Join package marker.

.DESCRIPTION
    Installs Workplace Join as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Workplace-Join-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Workplace Join'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Identity-Access\Install-Workplace-Join-Package'
$MarkerFileName = 'install-workplace-join-package.state'
