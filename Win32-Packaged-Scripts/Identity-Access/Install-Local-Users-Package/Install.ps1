<#
.SYNOPSIS
    Installs Local Users package marker.

.DESCRIPTION
    Installs Local Users as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Local-Users-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Local Users'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Identity-Access\Install-Local-Users-Package'
$MarkerFileName = 'install-local-users-package.state'
