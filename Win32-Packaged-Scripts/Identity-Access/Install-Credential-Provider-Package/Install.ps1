<#
.SYNOPSIS
    Installs Credential Provider package marker.

.DESCRIPTION
    Installs Credential Provider as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Credential-Provider-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Credential Provider'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Identity-Access\Install-Credential-Provider-Package'
$MarkerFileName = 'install-credential-provider-package.state'
