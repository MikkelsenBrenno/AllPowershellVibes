<#
.SYNOPSIS
    Installs Guest Account package marker.

.DESCRIPTION
    Installs Guest Account as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Guest-Account-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Guest Account'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Identity-Access\Install-Guest-Account-Package'
$MarkerFileName = 'install-guest-account-package.state'
