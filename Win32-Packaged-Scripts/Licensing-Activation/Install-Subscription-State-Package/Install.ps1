<#
.SYNOPSIS
    Installs Subscription State package marker.

.DESCRIPTION
    Installs Subscription State as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Subscription-State-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Subscription State'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Licensing-Activation\Install-Subscription-State-Package'
$MarkerFileName = 'install-subscription-state-package.state'
