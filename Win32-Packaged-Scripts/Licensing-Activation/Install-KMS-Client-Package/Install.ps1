<#
.SYNOPSIS
    Installs KMS Client package marker.

.DESCRIPTION
    Installs KMS Client as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-KMS-Client-Package'
$ScriptName = 'Install'

$ManagedItemName = 'KMS Client'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Licensing-Activation\Install-KMS-Client-Package'
$MarkerFileName = 'install-kms-client-package.state'
