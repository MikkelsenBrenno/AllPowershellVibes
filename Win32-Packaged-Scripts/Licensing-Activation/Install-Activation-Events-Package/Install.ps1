<#
.SYNOPSIS
    Installs Activation Events package marker.

.DESCRIPTION
    Installs Activation Events as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Activation-Events-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Activation Events'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Licensing-Activation\Install-Activation-Events-Package'
$MarkerFileName = 'install-activation-events-package.state'
