<#
.SYNOPSIS
    Installs Office Licensing package marker.

.DESCRIPTION
    Installs Office Licensing as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Office-Licensing-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Office Licensing'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Licensing-Activation\Install-Office-Licensing-Package'
$MarkerFileName = 'install-office-licensing-package.state'
