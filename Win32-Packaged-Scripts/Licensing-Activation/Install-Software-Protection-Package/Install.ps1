<#
.SYNOPSIS
    Installs Software Protection package marker.

.DESCRIPTION
    Installs Software Protection as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Software-Protection-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Software Protection'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Licensing-Activation\Install-Software-Protection-Package'
$MarkerFileName = 'install-software-protection-package.state'
