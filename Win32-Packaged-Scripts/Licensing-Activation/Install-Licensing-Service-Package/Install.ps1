<#
.SYNOPSIS
    Installs Licensing Service package marker.

.DESCRIPTION
    Installs Licensing Service as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Licensing-Service-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Licensing Service'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Licensing-Activation\Install-Licensing-Service-Package'
$MarkerFileName = 'install-licensing-service-package.state'
