<#
.SYNOPSIS
    Installs Windows Activation package marker.

.DESCRIPTION
    Installs Windows Activation as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Windows-Activation-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Windows Activation'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Licensing-Activation\Install-Windows-Activation-Package'
$MarkerFileName = 'install-windows-activation-package.state'
