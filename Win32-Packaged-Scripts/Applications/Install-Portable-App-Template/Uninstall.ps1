<#
.SYNOPSIS
    Removes a portable application folder.

.DESCRIPTION
    Win32 app uninstall script template. The script removes only the configured
    portable application install folder.
...
.INTUNE
    Workload:    Win32 App
    Exit 0:      Portable app removed
    Exit 1:      Portable app removal failed
...
try {
    ...
    Write-Output 'Uninstall succeeded. Portable app folder is absent.'
    exit 0
}
catch {
