<#
.SYNOPSIS
    Detects a local support tool bundle.
...
.INTUNE
    ...
    Exit 0:      Support tool bundle detected, with STDOUT
    Exit 1:      Support tool bundle missing or marker version mismatch
...
try {
    ...
    Write-Output "Detected. Support tool bundle version '$PackageVersion' is installed at '$DestinationRoot'."
    exit 0
}
catch {
