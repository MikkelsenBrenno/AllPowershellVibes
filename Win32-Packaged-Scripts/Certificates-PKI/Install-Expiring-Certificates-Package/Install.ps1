<#
.SYNOPSIS
    Installs Expiring Certificates package marker.

.DESCRIPTION
    Installs Expiring Certificates as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Expiring-Certificates-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Expiring Certificates'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Certificates-PKI\Install-Expiring-Certificates-Package'
$MarkerFileName = 'install-expiring-certificates-package.state'
