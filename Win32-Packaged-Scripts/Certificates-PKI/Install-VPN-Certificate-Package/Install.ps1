<#
.SYNOPSIS
    Installs VPN Certificate package marker.

.DESCRIPTION
    Installs VPN Certificate as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-VPN-Certificate-Package'
$ScriptName = 'Install'

$ManagedItemName = 'VPN Certificate'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Certificates-PKI\Install-VPN-Certificate-Package'
$MarkerFileName = 'install-vpn-certificate-package.state'
