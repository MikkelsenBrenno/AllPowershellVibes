<#
.SYNOPSIS
    Installs SCEP Certificate package marker.

.DESCRIPTION
    Installs SCEP Certificate as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-SCEP-Certificate-Package'
$ScriptName = 'Install'

$ManagedItemName = 'SCEP Certificate'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Certificates-PKI\Install-SCEP-Certificate-Package'
$MarkerFileName = 'install-scep-certificate-package.state'
