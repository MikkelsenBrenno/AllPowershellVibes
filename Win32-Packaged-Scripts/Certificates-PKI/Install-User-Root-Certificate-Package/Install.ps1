<#
.SYNOPSIS
    Installs User Root Certificate package marker.

.DESCRIPTION
    Installs User Root Certificate as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-User-Root-Certificate-Package'
$ScriptName = 'Install'

$ManagedItemName = 'User Root Certificate'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Certificates-PKI\Install-User-Root-Certificate-Package'
$MarkerFileName = 'install-user-root-certificate-package.state'
