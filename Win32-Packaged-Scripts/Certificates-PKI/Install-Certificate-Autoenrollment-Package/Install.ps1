<#
.SYNOPSIS
    Installs Certificate Autoenrollment package marker.

.DESCRIPTION
    Installs Certificate Autoenrollment as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Certificate-Autoenrollment-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Certificate Autoenrollment'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Certificates-PKI\Install-Certificate-Autoenrollment-Package'
$MarkerFileName = 'install-certificate-autoenrollment-package.state'
