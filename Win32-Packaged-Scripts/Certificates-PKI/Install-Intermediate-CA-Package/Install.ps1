<#
.SYNOPSIS
    Installs Intermediate CA package marker.

.DESCRIPTION
    Installs Intermediate CA as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Intermediate-CA-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Intermediate CA'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Certificates-PKI\Install-Intermediate-CA-Package'
$MarkerFileName = 'install-intermediate-ca-package.state'
