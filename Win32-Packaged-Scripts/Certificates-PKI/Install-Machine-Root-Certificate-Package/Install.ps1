<#
.SYNOPSIS
    Installs Machine Root Certificate package marker.

.DESCRIPTION
    Installs Machine Root Certificate as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Machine-Root-Certificate-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Machine Root Certificate'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Certificates-PKI\Install-Machine-Root-Certificate-Package'
$MarkerFileName = 'install-machine-root-certificate-package.state'
