<#
.SYNOPSIS
    Installs Trusted Publisher package marker.

.DESCRIPTION
    Installs Trusted Publisher as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Trusted-Publisher-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Trusted Publisher'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Certificates-PKI\Install-Trusted-Publisher-Package'
$MarkerFileName = 'install-trusted-publisher-package.state'
