<#
.SYNOPSIS
    Installs WiFi Certificate package marker.

.DESCRIPTION
    Installs WiFi Certificate as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-WiFi-Certificate-Package'
$ScriptName = 'Install'

$ManagedItemName = 'WiFi Certificate'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Certificates-PKI\Install-WiFi-Certificate-Package'
$MarkerFileName = 'install-wifi-certificate-package.state'
