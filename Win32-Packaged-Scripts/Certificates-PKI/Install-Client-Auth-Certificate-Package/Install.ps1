<#
.SYNOPSIS
    Installs Client Auth Certificate package marker.

.DESCRIPTION
    Installs Client Auth Certificate as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-Client-Auth-Certificate-Package'
$ScriptName = 'Install'

$ManagedItemName = 'Client Auth Certificate'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Certificates-PKI\Install-Client-Auth-Certificate-Package'
$MarkerFileName = 'install-client-auth-certificate-package.state'
