<#
.SYNOPSIS
    Installs PKCS Certificate package marker.

.DESCRIPTION
    Installs PKCS Certificate as a reusable Win32 script package.
...
$ScriptPackageName = 'Install-PKCS-Certificate-Package'
$ScriptName = 'Install'

$ManagedItemName = 'PKCS Certificate'
$PackageVersion = '1.0.0'
$InstallRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Win32Packages\Certificates-PKI\Install-PKCS-Certificate-Package'
$MarkerFileName = 'install-pkcs-certificate-package.state'
