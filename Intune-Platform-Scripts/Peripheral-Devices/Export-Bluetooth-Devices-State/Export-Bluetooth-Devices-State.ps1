<#
.SYNOPSIS
    Exports Bluetooth Devices state.

.DESCRIPTION
    Exports Bluetooth Devices state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Bluetooth-Devices-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Bluetooth-Devices-State'
$ScriptName = 'Export-Bluetooth-Devices-State'

$ManagedItemName = 'Bluetooth Devices'
$PurposeCategory = 'Peripheral-Devices'
$ReportRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Reports\Peripheral-Devices'
$ReportFileName = 'export-bluetooth-devices-state.json'
