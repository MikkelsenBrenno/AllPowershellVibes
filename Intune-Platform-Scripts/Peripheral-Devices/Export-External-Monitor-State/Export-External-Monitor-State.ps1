<#
.SYNOPSIS
    Exports External Monitor state.

.DESCRIPTION
    Exports External Monitor state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-External-Monitor-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-External-Monitor-State'
$ScriptName = 'Export-External-Monitor-State'
...
$ReportFileName = 'export-external-monitor-state.json'
