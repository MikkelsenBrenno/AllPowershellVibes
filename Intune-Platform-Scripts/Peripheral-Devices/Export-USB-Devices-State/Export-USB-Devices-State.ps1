<#
.SYNOPSIS
    Exports USB Devices state.

.DESCRIPTION
    Exports USB Devices state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-USB-Devices-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-USB-Devices-State'
$ScriptName = 'Export-USB-Devices-State'
...
$ReportFileName = 'export-usb-devices-state.json'
