<#
.SYNOPSIS
    Exports Docking Station state.

.DESCRIPTION
    Exports Docking Station state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Docking-Station-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Docking-Station-State'
$ScriptName = 'Export-Docking-Station-State'
...
$ReportFileName = 'export-docking-station-state.json'
