<#
.SYNOPSIS
    Exports Audio Device state.

.DESCRIPTION
    Exports Audio Device state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Audio-Device-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Audio-Device-State'
$ScriptName = 'Export-Audio-Device-State'
...
$ReportFileName = 'export-audio-device-state.json'
