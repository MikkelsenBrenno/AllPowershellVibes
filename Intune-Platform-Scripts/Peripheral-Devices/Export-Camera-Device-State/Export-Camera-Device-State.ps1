<#
.SYNOPSIS
    Exports Camera Device state.

.DESCRIPTION
    Exports Camera Device state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Camera-Device-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Camera-Device-State'
$ScriptName = 'Export-Camera-Device-State'
...
$ReportFileName = 'export-camera-device-state.json'
