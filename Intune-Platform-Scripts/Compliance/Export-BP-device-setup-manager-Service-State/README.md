...
Exports a local Device Setup Manager service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-device-setup-manager-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdevicesetupmanagerServiceSnapshot.json` |
...
| Script file | `Export-BP-device-setup-manager-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-device-setup-manager-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-device-setup-manager-Service-State`.
