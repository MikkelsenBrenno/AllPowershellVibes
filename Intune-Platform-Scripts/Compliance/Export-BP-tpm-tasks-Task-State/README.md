...
Exports a local TPM Tasks scheduled task troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-tpm-tasks-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformtpmtasksTaskSnapshot.json` |
...
| Script file | `Export-BP-tpm-tasks-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-tpm-tasks-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-tpm-tasks-Task-State`.
