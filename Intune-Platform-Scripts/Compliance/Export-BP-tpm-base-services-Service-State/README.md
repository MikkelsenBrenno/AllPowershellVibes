# TPM Base Services Service

## Summary

Exports a local TPM Base Services service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-tpm-base-services-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformtpmbaseservicesServiceSnapshot.json` |
...
| Script file | `Export-BP-tpm-base-services-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-tpm-base-services-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-tpm-base-services-Service-State`.
