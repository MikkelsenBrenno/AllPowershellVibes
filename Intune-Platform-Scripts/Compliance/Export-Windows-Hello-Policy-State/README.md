# Export Windows Hello Policy State

## Summary

Exports Windows Hello for Business policy registry values for enrollment and compliance troubleshooting.

## File

- `Export-Windows-Hello-Policy-State.ps1`
...
| `$OutputFileName` | Output file name. | `WindowsHelloPolicyState.json` |
...
| Script file | `Export-Windows-Hello-Policy-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Windows-Hello-Policy-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Windows-Hello-Policy-State`.
