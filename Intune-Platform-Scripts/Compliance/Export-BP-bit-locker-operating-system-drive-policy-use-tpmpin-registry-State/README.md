# BitLocker Operating System Drive Policy UseTPMPIN Registry

## Summary

Exports a local BitLocker Operating System Drive Policy UseTPMPIN registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-bit-locker-operating-system-drive-policy-use-tpmpin-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformbitlockerospolicyusetpmpinRegistrySnapshot.json` |
...
| Script file | `Export-BP-bit-locker-operating-system-drive-policy-use-tpmpin-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bit-locker-operating-system-drive-policy-use-tpmpin-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bit-locker-operating-system-drive-policy-use-tpmpin-registry-State`.
