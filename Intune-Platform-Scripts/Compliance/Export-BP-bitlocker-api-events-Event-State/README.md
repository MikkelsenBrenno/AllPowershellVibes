# BitLocker API Events Event

## Summary

Exports a local BitLocker API Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-bitlocker-api-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformbitlockerapieventsEventSnapshot.json` |
...
| Script file | `Export-BP-bitlocker-api-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bitlocker-api-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bitlocker-api-events-Event-State`.
