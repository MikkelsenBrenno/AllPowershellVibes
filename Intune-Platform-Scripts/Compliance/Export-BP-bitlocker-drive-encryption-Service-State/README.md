...
Exports a local BitLocker Drive Encryption service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-bitlocker-drive-encryption-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformbitlockerdriveencryptionServiceSnapshot.json` |
...
| Script file | `Export-BP-bitlocker-drive-encryption-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bitlocker-drive-encryption-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bitlocker-drive-encryption-Service-State`.
