# TPM WMI Events Event

## Summary

Exports a local TPM WMI Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-tpm-wmi-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformtpmwmieventsEventSnapshot.json` |
...
| Script file | `Export-BP-tpm-wmi-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-tpm-wmi-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-tpm-wmi-events-Event-State`.
