# BitLocker Operating System Drive Policy EncryptionMethodWithXtsOs Registry

## Summary

Exports a local BitLocker Operating System Drive Policy EncryptionMethodWithXtsOs registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-bit-locker-operating-system-drive-policy-encryption-method-with-xts-os-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformbitlockerospolicyencryptionmethodwithxtsosRegistrySnapshot.json` |
...
| Script file | `Export-BP-bit-locker-operating-system-drive-policy-encryption-method-with-xts-os-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bit-locker-operating-system-drive-policy-encryption-method-with-xts-os-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bit-locker-operating-system-drive-policy-encryption-method-with-xts-os-registry-State`.
