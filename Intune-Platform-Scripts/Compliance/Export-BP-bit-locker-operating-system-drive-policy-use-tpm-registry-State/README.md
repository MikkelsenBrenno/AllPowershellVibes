# BitLocker Operating System Drive Policy UseTPM Registry

## Summary

Exports a local BitLocker Operating System Drive Policy UseTPM registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-bit-locker-operating-system-drive-policy-use-tpm-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformbitlockerospolicyusetpmRegistrySnapshot.json` |
...
| Script file | `Export-BP-bit-locker-operating-system-drive-policy-use-tpm-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bit-locker-operating-system-drive-policy-use-tpm-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bit-locker-operating-system-drive-policy-use-tpm-registry-State`.
