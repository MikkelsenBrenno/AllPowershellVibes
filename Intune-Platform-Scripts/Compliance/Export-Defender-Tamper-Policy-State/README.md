# Export Defender Tamper Policy State

## Summary

Exports Defender policy values useful when troubleshooting Defender for Business compliance posture.

## File

- `Export-Defender-Tamper-Policy-State.ps1`
...
| `$OutputFileName` | Output file name. | `DefenderTamperPolicyState.json` |
...
| Script file | `Export-Defender-Tamper-Policy-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Defender-Tamper-Policy-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Defender-Tamper-Policy-State`.
