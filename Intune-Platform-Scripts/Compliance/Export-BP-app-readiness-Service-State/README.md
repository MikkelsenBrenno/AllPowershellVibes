...
Exports a local App Readiness service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-app-readiness-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformappreadinessServiceSnapshot.json` |
...
| Script file | `Export-BP-app-readiness-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-app-readiness-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-app-readiness-Service-State`.
