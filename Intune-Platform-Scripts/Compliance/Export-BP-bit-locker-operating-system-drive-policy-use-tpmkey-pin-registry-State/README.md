# BitLocker Operating System Drive Policy UseTPMKeyPIN Registry

## Summary

Exports a local BitLocker Operating System Drive Policy UseTPMKeyPIN registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-bit-locker-operating-system-drive-policy-use-tpmkey-pin-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformbitlockerospolicyusetpmkeypinRegistrySnapshot.json` |
...
| Script file | `Export-BP-bit-locker-operating-system-drive-policy-use-tpmkey-pin-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bit-locker-operating-system-drive-policy-use-tpmkey-pin-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bit-locker-operating-system-drive-policy-use-tpmkey-pin-registry-State`.
