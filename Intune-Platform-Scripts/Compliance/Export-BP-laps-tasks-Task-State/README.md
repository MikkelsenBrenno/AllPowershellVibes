...
Exports a local LAPS Tasks scheduled task troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-laps-tasks-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformlapstasksTaskSnapshot.json` |
...
| Script file | `Export-BP-laps-tasks-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-laps-tasks-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-laps-tasks-Task-State`.
