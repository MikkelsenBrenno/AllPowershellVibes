# Export Compliance Prerequisite State

## Summary

Exports key local signals often used by Intune compliance policies: TPM, Secure Boot, BitLocker, OS build, and activation state.

## File

- `Export-Compliance-Prerequisite-State.ps1`
...
| `$OutputFileName` | Output file name. | `CompliancePrerequisiteState.json` |
| `$MinimumRecommendedBuild` | Build threshold highlighted in the output. | `19045` |
...
| Script file | `Export-Compliance-Prerequisite-State.ps1` |
