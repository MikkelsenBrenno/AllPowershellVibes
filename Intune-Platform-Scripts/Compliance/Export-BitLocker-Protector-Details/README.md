...
Exports BitLocker volume and key protector details without exposing recovery passwords, useful for Business Premium compliance troubleshooting.

## File

- `Export-BitLocker-Protector-Details.ps1`
...
| `$OutputFileName` | Output file name. | `BitLockerProtectorDetails.json` |
| `$IncludeRecoveryPasswordValues` | Include recovery password values in JSON. Keep `$false` for repository/default use. | `$false` |
...
| Script file | `Export-BitLocker-Protector-Details.ps1` |
