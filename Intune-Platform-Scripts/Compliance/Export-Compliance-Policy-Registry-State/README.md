# Export Compliance Policy Registry State

## Summary

Exports local policy values commonly referenced by Business Premium compliance troubleshooting.

## File

- `Export-Compliance-Policy-Registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `CompliancePolicyRegistryState.json` |
...
| Script file | `Export-Compliance-Policy-Registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Compliance-Policy-Registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Compliance-Policy-Registry-State`.
