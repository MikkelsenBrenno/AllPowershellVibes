# Export BitLocker Policy Registry State

## Summary

Exports BitLocker policy registry values used by common Intune encryption baselines.

## File

- `Export-BitLocker-Policy-Registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BitLockerPolicyRegistryState.json` |
...
| Script file | `Export-BitLocker-Policy-Registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BitLocker-Policy-Registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BitLocker-Policy-Registry-State`.
