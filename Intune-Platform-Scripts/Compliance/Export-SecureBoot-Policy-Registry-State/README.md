# Export SecureBoot Policy Registry State

## Summary

Exports Secure Boot and Device Guard-adjacent registry values for compliance troubleshooting.

## File

- `Export-SecureBoot-Policy-Registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `SecureBootPolicyRegistryState.json` |
...
| Script file | `Export-SecureBoot-Policy-Registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-SecureBoot-Policy-Registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-SecureBoot-Policy-Registry-State`.
