# BitLocker Tasks Task

## Summary

Exports a local BitLocker Tasks scheduled task troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-bitlocker-tasks-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformbitlockertasksTaskSnapshot.json` |
...
| Script file | `Export-BP-bitlocker-tasks-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bitlocker-tasks-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bitlocker-tasks-Task-State`.
