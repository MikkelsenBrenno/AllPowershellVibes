# Device Install Service Service

## Summary

Exports a local Device Install Service service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-device-install-service-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdeviceinstallserviceServiceSnapshot.json` |
...
| Script file | `Export-BP-device-install-service-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-device-install-service-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-device-install-service-Service-State`.
