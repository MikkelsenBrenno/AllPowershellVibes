# BitLocker Operating System Drive Policy UseAdvancedStartup Registry

## Summary

Exports a local BitLocker Operating System Drive Policy UseAdvancedStartup registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-bit-locker-operating-system-drive-policy-use-advanced-startup-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformbitlockerospolicyuseadvancedstartupRegistrySnapshot.json` |
...
| Script file | `Export-BP-bit-locker-operating-system-drive-policy-use-advanced-startup-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bit-locker-operating-system-drive-policy-use-advanced-startup-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-bit-locker-operating-system-drive-policy-use-advanced-startup-registry-State`.
