# Device Guard Events Event

## Summary

Exports a local Device Guard Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-deviceguard-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdeviceguardeventsEventSnapshot.json` |
...
| Script file | `Export-BP-deviceguard-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-deviceguard-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-deviceguard-events-Event-State`.
