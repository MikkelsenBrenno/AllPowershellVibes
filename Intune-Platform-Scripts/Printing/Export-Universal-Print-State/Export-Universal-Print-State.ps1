<#
.SYNOPSIS
    Exports Universal Print state.

.DESCRIPTION
    Exports Universal Print state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Universal-Print-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Universal-Print-State'
$ScriptName = 'Export-Universal-Print-State'
...
$ReportFileName = 'export-universal-print-state.json'
