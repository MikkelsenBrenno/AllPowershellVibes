<#
.SYNOPSIS
    Exports Print Port state.

.DESCRIPTION
    Exports Print Port state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Print-Port-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Print-Port-State'
$ScriptName = 'Export-Print-Port-State'
...
$ReportFileName = 'export-print-port-state.json'
