<#
.SYNOPSIS
    Exports Printer Driver state.

.DESCRIPTION
    Exports Printer Driver state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Printer-Driver-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Printer-Driver-State'
$ScriptName = 'Export-Printer-Driver-State'
...
$ReportFileName = 'export-printer-driver-state.json'
