<#
.SYNOPSIS
    Exports Print Spooler state.

.DESCRIPTION
    Exports Print Spooler state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Print-Spooler-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Print-Spooler-State'
$ScriptName = 'Export-Print-Spooler-State'
...
$ReportFileName = 'export-print-spooler-state.json'
