<#
.SYNOPSIS
    Exports Stale Printers state.

.DESCRIPTION
    Exports Stale Printers state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Stale-Printers-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Stale-Printers-State'
$ScriptName = 'Export-Stale-Printers-State'
...
$ReportFileName = 'export-stale-printers-state.json'
