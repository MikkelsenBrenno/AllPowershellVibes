<#
.SYNOPSIS
    Exports Default Printer state.

.DESCRIPTION
    Exports Default Printer state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Default-Printer-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Default-Printer-State'
$ScriptName = 'Export-Default-Printer-State'
...
$ReportFileName = 'export-default-printer-state.json'
