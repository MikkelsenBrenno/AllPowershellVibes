<#
.SYNOPSIS
    Exports Printer Queue state.

.DESCRIPTION
    Exports Printer Queue state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Printer-Queue-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Printer-Queue-State'
$ScriptName = 'Export-Printer-Queue-State'
...
$ReportFileName = 'export-printer-queue-state.json'
