<#
.SYNOPSIS
    Exports Cloud Printer state.

.DESCRIPTION
    Exports Cloud Printer state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Cloud-Printer-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Cloud-Printer-State'
$ScriptName = 'Export-Cloud-Printer-State'
...
$ReportFileName = 'export-cloud-printer-state.json'
