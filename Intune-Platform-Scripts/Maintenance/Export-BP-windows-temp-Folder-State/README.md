...
Exports a local Windows Temp folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-temp-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowstempFolderSnapshot.json` |
...
| Script file | `Export-BP-windows-temp-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-temp-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-temp-Folder-State`.
