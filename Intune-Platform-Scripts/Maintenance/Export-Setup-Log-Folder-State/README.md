# Export Setup Log Folder State

## Summary

Exports Panther, setup, and rollback log folder size details for upgrade troubleshooting.

## File

- `Export-Setup-Log-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `SetupLogFolderState.json` |
...
| Script file | `Export-Setup-Log-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Setup-Log-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Setup-Log-Folder-State`.
