# Intune Management Extension Logs Folder

## Summary

Exports a local Intune Management Extension Logs folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-intune-management-extension-logs-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformintunemanagementextensionlogsFolderSnapshot.json` |
...
| Script file | `Export-BP-intune-management-extension-logs-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-intune-management-extension-logs-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-intune-management-extension-logs-Folder-State`.
