<#
.SYNOPSIS
    Exports Intune Management Extension Logs Folder state.

.DESCRIPTION
    Intune platform script that exports intune management extension logs folder state to a local JSON file for Business Premium troubleshooting.

.NOTES
    Name:        Export-BP-intune-management-extension-logs-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BP-intune-management-extension-logs-Folder-State'
$ScriptName = 'Export-BP-intune-management-extension-logs-Folder-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'BPPlatformintunemanagementextensionlogsFolderSnapshot.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Intune Management Extension Logs folder size snapshot for technician troubleshooting.'
