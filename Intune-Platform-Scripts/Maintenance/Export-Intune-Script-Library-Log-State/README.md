# Export Intune Script Library Log State

## Summary

Exports local Intune Script Library log folder size, file count, and last-write timing.

## File

- `Export-Intune-Script-Library-Log-State.ps1`
...
| `$OutputFileName` | Output file name. | `IntuneScriptLibraryLogState.json` |
...
| Script file | `Export-Intune-Script-Library-Log-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Intune-Script-Library-Log-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Intune-Script-Library-Log-State`.
