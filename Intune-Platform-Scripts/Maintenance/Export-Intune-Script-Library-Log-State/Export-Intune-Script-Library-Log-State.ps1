<#
.SYNOPSIS
    Exports Intune Script Library log state.

.DESCRIPTION
    Intune platform script that measures this repository standard log folder.

.NOTES
    Name:        Export-Intune-Script-Library-Log-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Intune-Script-Library-Log-State'
$ScriptName = 'Export-Intune-Script-Library-Log-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'IntuneScriptLibraryLogState.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Repository script log folder size snapshot.'
