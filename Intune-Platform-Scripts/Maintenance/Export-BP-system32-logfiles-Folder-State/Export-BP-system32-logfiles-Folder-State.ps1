<#
.SYNOPSIS
    Exports System32 LogFiles Folder state.

.DESCRIPTION
    Intune platform script that exports system32 logfiles folder state to a local JSON file for Business Premium troubleshooting.

.NOTES
    Name:        Export-BP-system32-logfiles-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BP-system32-logfiles-Folder-State'
$ScriptName = 'Export-BP-system32-logfiles-Folder-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'BPPlatformsystem32logfilesFolderSnapshot.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'System32 LogFiles folder size snapshot for technician troubleshooting.'
