...
Exports a local System32 LogFiles folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-system32-logfiles-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformsystem32logfilesFolderSnapshot.json` |
...
| Script file | `Export-BP-system32-logfiles-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-system32-logfiles-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-system32-logfiles-Folder-State`.
