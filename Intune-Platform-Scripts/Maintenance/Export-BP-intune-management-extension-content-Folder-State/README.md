# Intune Management Extension Content Folder

## Summary

Exports a local Intune Management Extension Content folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-intune-management-extension-content-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformintunemanagementextensioncontentFolderSnapshot.json` |
| `$CollectionMode` | Collection mode used by this script. | `Folder` |
| `$FolderPaths` | Folder paths to size and count. Supports environment variables. | Package-specific |
...
| Script file | `Export-BP-intune-management-extension-content-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-intune-management-extension-content-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-intune-management-extension-content-Folder-State`.
