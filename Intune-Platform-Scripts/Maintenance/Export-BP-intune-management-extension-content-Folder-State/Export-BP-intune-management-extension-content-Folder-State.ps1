<#
.SYNOPSIS
    Exports Intune Management Extension Content Folder state.

.DESCRIPTION
    Intune platform script that exports intune management extension content folder state to a local JSON file for Business Premium troubleshooting.

.NOTES
    Name:        Export-BP-intune-management-extension-content-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BP-intune-management-extension-content-Folder-State'
$ScriptName = 'Export-BP-intune-management-extension-content-Folder-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'BPPlatformintunemanagementextensioncontentFolderSnapshot.json'
$JsonDepth = 8
$CollectionMode = 'Folder'
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Intune Management Extension Content folder size snapshot for technician troubleshooting.'
