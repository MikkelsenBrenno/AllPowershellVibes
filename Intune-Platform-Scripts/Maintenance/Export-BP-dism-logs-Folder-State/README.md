...
Exports a local DISM Logs folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-dism-logs-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdismlogsFolderSnapshot.json` |
...
| Script file | `Export-BP-dism-logs-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-dism-logs-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-dism-logs-Folder-State`.
