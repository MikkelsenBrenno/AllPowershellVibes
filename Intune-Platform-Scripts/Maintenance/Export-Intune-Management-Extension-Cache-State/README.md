# Export Intune Management Extension Cache State

## Summary

Exports Intune Management Extension cache and log folder size details for technician troubleshooting.

## File

- `Export-Intune-Management-Extension-Cache-State.ps1`
...
| `$OutputFileName` | Output file name. | `IntuneManagementExtensionCacheState.json` |
...
| Script file | `Export-Intune-Management-Extension-Cache-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Intune-Management-Extension-Cache-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Intune-Management-Extension-Cache-State`.
