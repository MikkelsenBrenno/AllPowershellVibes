<#
.SYNOPSIS
    Exports Prefetch Folder Folder state.

.DESCRIPTION
    Intune platform script that exports prefetch folder folder state to a local JSON file for Business Premium troubleshooting.

.NOTES
    Name:        Export-BP-prefetch-folder-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BP-prefetch-folder-Folder-State'
$ScriptName = 'Export-BP-prefetch-folder-Folder-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'BPPlatformprefetchfolderFolderSnapshot.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Prefetch Folder folder size snapshot for technician troubleshooting.'
