...
Exports a local Prefetch Folder folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-prefetch-folder-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformprefetchfolderFolderSnapshot.json` |
...
| Script file | `Export-BP-prefetch-folder-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-prefetch-folder-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-prefetch-folder-Folder-State`.
