# Export User Profile Temp Usage State

## Summary

Exports current user temp and cache folder usage for support sessions that run in user context.

## File

- `Export-User-Profile-Temp-Usage-State.ps1`
...
| `$OutputFileName` | Output file name. | `UserProfileTempUsageState.json` |
...
| Script file | `Export-User-Profile-Temp-Usage-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-User-Profile-Temp-Usage-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-User-Profile-Temp-Usage-State`.
