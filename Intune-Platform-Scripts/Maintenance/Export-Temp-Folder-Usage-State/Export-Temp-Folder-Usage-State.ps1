<#
.SYNOPSIS
    Exports temp folder usage.

.DESCRIPTION
    Intune platform script that measures common temporary file locations.

.NOTES
    Name:        Export-Temp-Folder-Usage-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Temp-Folder-Usage-State'
$ScriptName = 'Export-Temp-Folder-Usage-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'TempFolderUsageState.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'System and Windows temp folder size snapshot.'
