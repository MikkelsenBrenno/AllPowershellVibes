# Export Temp Folder Usage State

## Summary

Exports system temp and Windows temp folder usage to help technicians spot cleanup candidates.

## File

- `Export-Temp-Folder-Usage-State.ps1`
...
| `$OutputFileName` | Output file name. | `TempFolderUsageState.json` |
...
| Script file | `Export-Temp-Folder-Usage-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Temp-Folder-Usage-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Temp-Folder-Usage-State`.
