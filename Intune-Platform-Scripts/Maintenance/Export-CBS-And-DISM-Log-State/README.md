# Export CBS And DISM Log State

## Summary

Exports CBS and DISM log folder size details for servicing troubleshooting.

## File

- `Export-CBS-And-DISM-Log-State.ps1`
...
| `$OutputFileName` | Output file name. | `CBSAndDISMLogState.json` |
...
| Script file | `Export-CBS-And-DISM-Log-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-CBS-And-DISM-Log-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-CBS-And-DISM-Log-State`.
