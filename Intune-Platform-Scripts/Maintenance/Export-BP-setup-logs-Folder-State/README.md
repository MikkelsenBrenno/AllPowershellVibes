...
Exports a local Setup Logs folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-setup-logs-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformsetuplogsFolderSnapshot.json` |
...
| Script file | `Export-BP-setup-logs-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-setup-logs-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-setup-logs-Folder-State`.
