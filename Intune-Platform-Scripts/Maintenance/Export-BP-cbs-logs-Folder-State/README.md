...
Exports a local CBS Logs folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-cbs-logs-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformcbslogsFolderSnapshot.json` |
...
| Script file | `Export-BP-cbs-logs-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-cbs-logs-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-cbs-logs-Folder-State`.
