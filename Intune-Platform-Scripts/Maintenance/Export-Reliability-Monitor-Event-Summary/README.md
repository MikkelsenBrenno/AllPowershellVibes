# Export Reliability Monitor Event Summary

## Summary

Exports recent Application log reliability events such as crashes and application hangs.

## File

- `Export-Reliability-Monitor-Event-Summary.ps1`
...
| `$OutputFileName` | Output file name. | `ReliabilityMonitorEventSummary.json` |
...
| Script file | `Export-Reliability-Monitor-Event-Summary.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Reliability-Monitor-Event-Summary`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Reliability-Monitor-Event-Summary`.
