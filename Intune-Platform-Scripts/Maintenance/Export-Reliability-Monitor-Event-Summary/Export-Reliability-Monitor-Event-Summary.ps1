<#
.SYNOPSIS
    Exports reliability monitor event summary.

.DESCRIPTION
    Intune platform script that collects recent Application log events commonly used in reliability troubleshooting.

.NOTES
    Name:        Export-Reliability-Monitor-Event-Summary.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Reliability-Monitor-Event-Summary'
$ScriptName = 'Export-Reliability-Monitor-Event-Summary'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'ReliabilityMonitorEventSummary.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Recent reliability and application error event summary.'

$EventLogName = 'Application'
$RecentEventCount = 80
$EventIdsToHighlight = @(1000, 1001, 1002, 1026)
