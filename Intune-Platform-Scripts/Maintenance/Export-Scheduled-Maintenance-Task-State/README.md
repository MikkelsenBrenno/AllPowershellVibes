# Export Scheduled Maintenance Task State

## Summary

Exports scheduled maintenance tasks so technicians can verify task state and availability.

## File

- `Export-Scheduled-Maintenance-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `ScheduledMaintenanceTaskState.json` |
...
| Script file | `Export-Scheduled-Maintenance-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Scheduled-Maintenance-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Scheduled-Maintenance-Task-State`.
