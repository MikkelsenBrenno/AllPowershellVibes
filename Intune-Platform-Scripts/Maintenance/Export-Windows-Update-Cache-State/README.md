# Export Windows Update Cache State

## Summary

Exports Windows Update cache folder size details without deleting content.

## File

- `Export-Windows-Update-Cache-State.ps1`
...
| `$OutputFileName` | Output file name. | `WindowsUpdateCacheState.json` |
...
| Script file | `Export-Windows-Update-Cache-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Windows-Update-Cache-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Windows-Update-Cache-State`.
