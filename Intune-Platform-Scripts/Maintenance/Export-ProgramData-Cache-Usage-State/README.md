# Export ProgramData Cache Usage State

## Summary

Exports common ProgramData cache folder usage to help technicians spot local storage pressure.

## File

- `Export-ProgramData-Cache-Usage-State.ps1`
...
| `$OutputFileName` | Output file name. | `ProgramDataCacheUsageState.json` |
...
| Script file | `Export-ProgramData-Cache-Usage-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-ProgramData-Cache-Usage-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-ProgramData-Cache-Usage-State`.
