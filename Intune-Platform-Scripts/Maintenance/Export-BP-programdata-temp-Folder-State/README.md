# ProgramData Temp Folder

## Summary

Exports a local ProgramData Temp folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-programdata-temp-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformprogramdatatempFolderSnapshot.json` |
...
| Script file | `Export-BP-programdata-temp-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-programdata-temp-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-programdata-temp-Folder-State`.
