# Intune Script Library Logs Folder

## Summary

Exports a local Intune Script Library Logs folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-intune-script-library-logs-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformintunescriptlibrarylogsFolderSnapshot.json` |
...
| Script file | `Export-BP-intune-script-library-logs-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-intune-script-library-logs-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-intune-script-library-logs-Folder-State`.
