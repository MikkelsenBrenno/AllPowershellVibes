<#
.SYNOPSIS
    Exports Enrollment Certificate state.

.DESCRIPTION
    Exports Enrollment Certificate state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Enrollment-Certificate-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Enrollment-Certificate-State'
$ScriptName = 'Export-Enrollment-Certificate-State'
...
$ReportFileName = 'export-enrollment-certificate-state.json'
