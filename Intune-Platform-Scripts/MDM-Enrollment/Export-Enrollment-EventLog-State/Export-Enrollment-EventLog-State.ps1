<#
.SYNOPSIS
    Exports Enrollment EventLog state.

.DESCRIPTION
    Exports Enrollment EventLog state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Enrollment-EventLog-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Enrollment-EventLog-State'
$ScriptName = 'Export-Enrollment-EventLog-State'
...
$ReportFileName = 'export-enrollment-eventlog-state.json'
