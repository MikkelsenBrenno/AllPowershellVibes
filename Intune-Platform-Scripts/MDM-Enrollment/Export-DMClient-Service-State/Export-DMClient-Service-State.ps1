<#
.SYNOPSIS
    Exports DMClient Service state.

.DESCRIPTION
    Exports DMClient Service state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-DMClient-Service-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-DMClient-Service-State'
$ScriptName = 'Export-DMClient-Service-State'
...
$ReportFileName = 'export-dmclient-service-state.json'
