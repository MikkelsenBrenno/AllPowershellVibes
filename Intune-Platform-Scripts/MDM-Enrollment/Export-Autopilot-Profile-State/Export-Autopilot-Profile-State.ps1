<#
.SYNOPSIS
    Exports Autopilot Profile state.

.DESCRIPTION
    Exports Autopilot Profile state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Autopilot-Profile-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Autopilot-Profile-State'
$ScriptName = 'Export-Autopilot-Profile-State'
...
$ReportFileName = 'export-autopilot-profile-state.json'
