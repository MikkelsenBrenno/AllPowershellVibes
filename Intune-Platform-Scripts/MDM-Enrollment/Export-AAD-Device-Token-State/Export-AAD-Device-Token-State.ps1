<#
.SYNOPSIS
    Exports AAD Device Token state.

.DESCRIPTION
    Exports AAD Device Token state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-AAD-Device-Token-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-AAD-Device-Token-State'
$ScriptName = 'Export-AAD-Device-Token-State'
...
$ReportFileName = 'export-aad-device-token-state.json'
