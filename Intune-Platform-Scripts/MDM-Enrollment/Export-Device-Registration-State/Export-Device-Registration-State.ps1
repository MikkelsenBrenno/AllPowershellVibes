<#
.SYNOPSIS
    Exports Device Registration state.

.DESCRIPTION
    Exports Device Registration state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Device-Registration-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Device-Registration-State'
$ScriptName = 'Export-Device-Registration-State'
...
$ReportFileName = 'export-device-registration-state.json'
