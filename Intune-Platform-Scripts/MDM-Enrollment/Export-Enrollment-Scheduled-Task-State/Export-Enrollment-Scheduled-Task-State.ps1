<#
.SYNOPSIS
    Exports Enrollment Scheduled Task state.

.DESCRIPTION
    Exports Enrollment Scheduled Task state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Enrollment-Scheduled-Task-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Enrollment-Scheduled-Task-State'
$ScriptName = 'Export-Enrollment-Scheduled-Task-State'
...
$ReportFileName = 'export-enrollment-scheduled-task-state.json'
