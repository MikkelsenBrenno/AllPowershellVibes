# Export-Enrollment-Scheduled-Task-State

## Summary

Exports Enrollment Scheduled Task state for technician troubleshooting and reporting in the MDM-Enrollment category.
