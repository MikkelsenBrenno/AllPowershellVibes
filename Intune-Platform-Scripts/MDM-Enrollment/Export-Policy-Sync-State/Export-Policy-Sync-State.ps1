<#
.SYNOPSIS
    Exports Policy Sync state.

.DESCRIPTION
    Exports Policy Sync state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Policy-Sync-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Policy-Sync-State'
$ScriptName = 'Export-Policy-Sync-State'
...
$ReportFileName = 'export-policy-sync-state.json'
