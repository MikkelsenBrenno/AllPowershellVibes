# Export-Company-Portal-Enrollment-State

## Summary

Exports Company Portal Enrollment state for technician troubleshooting and reporting in the MDM-Enrollment category.
