<#
.SYNOPSIS
    Exports Company Portal Enrollment state.

.DESCRIPTION
    Exports Company Portal Enrollment state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Company-Portal-Enrollment-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Company-Portal-Enrollment-State'
$ScriptName = 'Export-Company-Portal-Enrollment-State'
...
$ReportFileName = 'export-company-portal-enrollment-state.json'
