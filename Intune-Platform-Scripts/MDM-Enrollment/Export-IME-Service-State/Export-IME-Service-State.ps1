<#
.SYNOPSIS
    Exports IME Service state.

.DESCRIPTION
    Exports IME Service state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-IME-Service-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-IME-Service-State'
$ScriptName = 'Export-IME-Service-State'
...
$ReportFileName = 'export-ime-service-state.json'
