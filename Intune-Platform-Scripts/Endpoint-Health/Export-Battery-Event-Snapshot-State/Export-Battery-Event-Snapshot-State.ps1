<#
.SYNOPSIS
    Exports Battery Event Snapshot state.

.DESCRIPTION
    Exports Battery Event Snapshot state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-Battery-Event-Snapshot-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Battery-Event-Snapshot-State'
$ScriptName = 'Export-Battery-Event-Snapshot-State'

$ManagedItemName = 'Battery Event Snapshot'
$InventoryRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory\Endpoint-Health'
$InventoryFileName = 'battery-event-snapshot-snapshot.json'
$EvidenceRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Endpoint-Health'
$EvidenceFileName = 'battery-event-snapshot.state'
