# Application Error Events Event

## Summary

Exports a local Application Error Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-application-error-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformapplicationerroreventsEventSnapshot.json` |
...
| Script file | `Export-BP-application-error-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-application-error-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-application-error-events-Event-State`.
