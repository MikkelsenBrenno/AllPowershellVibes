# System Service Control Events Event

## Summary

Exports a local System Service Control Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-system-service-control-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformsystemservicecontroleventsEventSnapshot.json` |
...
| Script file | `Export-BP-system-service-control-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-system-service-control-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-system-service-control-events-Event-State`.
