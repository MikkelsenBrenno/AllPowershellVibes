# Task Scheduler Events Event

## Summary

Exports a local Task Scheduler Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-task-scheduler-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformtaskschedulereventsEventSnapshot.json` |
...
| Script file | `Export-BP-task-scheduler-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-task-scheduler-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-task-scheduler-events-Event-State`.
