# WMI Activity Events Event

## Summary

Exports a local WMI Activity Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-wmi-activity-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwmiactivityeventsEventSnapshot.json` |
...
| Script file | `Export-BP-wmi-activity-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-wmi-activity-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-wmi-activity-events-Event-State`.
