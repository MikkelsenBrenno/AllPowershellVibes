<#
.SYNOPSIS
    Exports WMI Service State state.

.DESCRIPTION
    Exports WMI Service State state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-WMI-Service-State.ps1
    Version:     1.0.0
