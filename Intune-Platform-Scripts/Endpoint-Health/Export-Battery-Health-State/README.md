# Export Battery Health State

## Summary

Exports battery inventory and estimated charge state for laptop support and device replacement conversations.

## File

- `Export-Battery-Health-State.ps1`
...
| `$OutputFileName` | Output file name. | `BatteryHealthState.json` |
| `$BatteryClasses` | Battery classes documented for this snapshot. | `Win32_Battery` |
...
| Script file | `Export-Battery-Health-State.ps1` |
