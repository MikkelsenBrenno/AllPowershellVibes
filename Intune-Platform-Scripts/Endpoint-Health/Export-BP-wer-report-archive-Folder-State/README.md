# Windows Error Reporting Archive Folder

## Summary

Exports a local Windows Error Reporting Archive folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-wer-report-archive-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwerreportarchiveFolderSnapshot.json` |
...
| Script file | `Export-BP-wer-report-archive-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-wer-report-archive-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-wer-report-archive-Folder-State`.
