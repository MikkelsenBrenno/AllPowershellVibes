<#
.SYNOPSIS
    Exports Windows Error Reporting Archive Folder state.

.DESCRIPTION
    Intune platform script that exports windows error reporting archive folder state to a local JSON file for Business Premium troubleshooting.

.NOTES
    Name:        Export-BP-wer-report-archive-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BP-wer-report-archive-Folder-State'
$ScriptName = 'Export-BP-wer-report-archive-Folder-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'BPPlatformwerreportarchiveFolderSnapshot.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Windows Error Reporting Archive folder size snapshot for technician troubleshooting.'
