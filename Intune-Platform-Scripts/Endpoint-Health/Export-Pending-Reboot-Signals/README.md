# Export Pending Reboot Signals

## Summary

Exports common Windows pending reboot registry signals for technicians troubleshooting stuck installs, updates, and compliance drift.

## File

- `Export-Pending-Reboot-Signals.ps1`
...
| `$OutputFileName` | Output file name. | `PendingRebootSignals.json` |
| `$PendingRebootItems` | Registry keys and values used as pending reboot signals. | CBS, Windows Update, Session Manager, RunOnce |
...
| Script file | `Export-Pending-Reboot-Signals.ps1` |
