<#
.SYNOPSIS
    Exports Minidump Folder Folder state.

.DESCRIPTION
    Intune platform script that exports minidump folder folder state to a local JSON file for Business Premium troubleshooting.

.NOTES
    Name:        Export-BP-minidump-folder-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BP-minidump-folder-Folder-State'
$ScriptName = 'Export-BP-minidump-folder-Folder-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'BPPlatformminidumpfolderFolderSnapshot.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Minidump Folder folder size snapshot for technician troubleshooting.'
