# Minidump Folder Folder

## Summary

Exports a local Minidump Folder folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-minidump-folder-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformminidumpfolderFolderSnapshot.json` |
...
| Script file | `Export-BP-minidump-folder-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-minidump-folder-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-minidump-folder-Folder-State`.
