# Windows Error Reporting Queue Folder

## Summary

Exports a local Windows Error Reporting Queue folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-wer-report-queue-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwerreportqueueFolderSnapshot.json` |
...
| Script file | `Export-BP-wer-report-queue-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-wer-report-queue-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-wer-report-queue-Folder-State`.
