<#
.SYNOPSIS
    Exports Windows Error Reporting Queue Folder state.

.DESCRIPTION
    Intune platform script that exports windows error reporting queue folder state to a local JSON file for Business Premium troubleshooting.

.NOTES
    Name:        Export-BP-wer-report-queue-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BP-wer-report-queue-Folder-State'
$ScriptName = 'Export-BP-wer-report-queue-Folder-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'BPPlatformwerreportqueueFolderSnapshot.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Windows Error Reporting Queue folder size snapshot for technician troubleshooting.'
