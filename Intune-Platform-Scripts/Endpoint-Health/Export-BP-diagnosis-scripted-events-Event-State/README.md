# Diagnosis Scripted Events Event

## Summary

Exports a local Diagnosis Scripted Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-diagnosis-scripted-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdiagnosisscriptedeventsEventSnapshot.json` |
...
| Script file | `Export-BP-diagnosis-scripted-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-diagnosis-scripted-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-diagnosis-scripted-events-Event-State`.
