<#
.SYNOPSIS
    Exports WMI Health state.

.DESCRIPTION
    Exports WMI Health state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-WMI-Health-State.ps1
    Version:     1.0.0
