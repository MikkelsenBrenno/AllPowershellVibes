<#
.SYNOPSIS
    Exports Reliability History state.

.DESCRIPTION
    Exports Reliability History state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Reliability-History-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Reliability-History-State'
$ScriptName = 'Export-Reliability-History-State'
...
$ReportFileName = 'export-reliability-history-state.json'
