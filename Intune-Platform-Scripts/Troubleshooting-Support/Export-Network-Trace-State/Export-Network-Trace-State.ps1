<#
.SYNOPSIS
    Exports Network Trace state.

.DESCRIPTION
    Exports Network Trace state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Network-Trace-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Network-Trace-State'
$ScriptName = 'Export-Network-Trace-State'
...
$ReportFileName = 'export-network-trace-state.json'
