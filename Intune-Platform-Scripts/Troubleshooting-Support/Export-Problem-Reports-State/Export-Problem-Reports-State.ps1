<#
.SYNOPSIS
    Exports Problem Reports state.

.DESCRIPTION
    Exports Problem Reports state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Problem-Reports-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Problem-Reports-State'
$ScriptName = 'Export-Problem-Reports-State'
...
$ReportFileName = 'export-problem-reports-state.json'
