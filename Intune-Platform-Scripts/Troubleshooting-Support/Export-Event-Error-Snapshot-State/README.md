# Export-Event-Error-Snapshot-State

## Summary

Exports Event Error Snapshot state for technician troubleshooting and reporting in the Troubleshooting-Support category.
