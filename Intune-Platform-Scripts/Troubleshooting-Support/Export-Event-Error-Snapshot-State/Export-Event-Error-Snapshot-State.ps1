<#
.SYNOPSIS
    Exports Event Error Snapshot state.

.DESCRIPTION
    Exports Event Error Snapshot state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Event-Error-Snapshot-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Event-Error-Snapshot-State'
$ScriptName = 'Export-Event-Error-Snapshot-State'
...
$ReportFileName = 'export-event-error-snapshot-state.json'
