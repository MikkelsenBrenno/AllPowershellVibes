<#
.SYNOPSIS
    Exports Support Bundle state.

.DESCRIPTION
    Exports Support Bundle state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Support-Bundle-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Support-Bundle-State'
$ScriptName = 'Export-Support-Bundle-State'
...
$ReportFileName = 'export-support-bundle-state.json'
