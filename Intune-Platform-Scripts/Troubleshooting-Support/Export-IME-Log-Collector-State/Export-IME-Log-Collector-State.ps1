<#
.SYNOPSIS
    Exports IME Log Collector state.

.DESCRIPTION
    Exports IME Log Collector state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-IME-Log-Collector-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-IME-Log-Collector-State'
$ScriptName = 'Export-IME-Log-Collector-State'
...
$ReportFileName = 'export-ime-log-collector-state.json'
