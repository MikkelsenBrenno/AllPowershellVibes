<#
.SYNOPSIS
    Exports MDM Diagnostic Package state.

.DESCRIPTION
    Exports MDM Diagnostic Package state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-MDM-Diagnostic-Package-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-MDM-Diagnostic-Package-State'
$ScriptName = 'Export-MDM-Diagnostic-Package-State'

$ManagedItemName = 'MDM Diagnostic Package'
$PurposeCategory = 'Troubleshooting-Support'
$ReportRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Reports\Troubleshooting-Support'
$ReportFileName = 'export-mdm-diagnostic-package-state.json'
