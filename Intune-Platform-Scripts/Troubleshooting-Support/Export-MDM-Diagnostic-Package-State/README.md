# Export-MDM-Diagnostic-Package-State

## Summary

Exports MDM Diagnostic Package state for technician troubleshooting and reporting in the Troubleshooting-Support category.
