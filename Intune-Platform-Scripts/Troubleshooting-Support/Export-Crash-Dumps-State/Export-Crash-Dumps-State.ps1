<#
.SYNOPSIS
    Exports Crash Dumps state.

.DESCRIPTION
    Exports Crash Dumps state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Crash-Dumps-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Crash-Dumps-State'
$ScriptName = 'Export-Crash-Dumps-State'
...
$ReportFileName = 'export-crash-dumps-state.json'
