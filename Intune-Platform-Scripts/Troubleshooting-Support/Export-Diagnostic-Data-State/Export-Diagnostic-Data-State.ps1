<#
.SYNOPSIS
    Exports Diagnostic Data state.

.DESCRIPTION
    Exports Diagnostic Data state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Diagnostic-Data-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Diagnostic-Data-State'
$ScriptName = 'Export-Diagnostic-Data-State'
...
$ReportFileName = 'export-diagnostic-data-state.json'
