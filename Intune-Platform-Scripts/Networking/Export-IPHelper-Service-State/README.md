# Export IP Helper Service State

## Summary

Exports IP Helper service state for VPN, IPv6 transition, and network troubleshooting.

## File

- `Export-IPHelper-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `IPHelperServiceState.json` |
...
| Script file | `Export-IPHelper-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-IPHelper-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-IPHelper-Service-State`.
