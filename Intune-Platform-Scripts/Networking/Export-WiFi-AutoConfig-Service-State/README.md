# Export WiFi AutoConfig Service State

## Summary

Exports WLAN AutoConfig service state for Wi-Fi troubleshooting.

## File

- `Export-WiFi-AutoConfig-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `WiFiAutoConfigServiceState.json` |
...
| Script file | `Export-WiFi-AutoConfig-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-WiFi-AutoConfig-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-WiFi-AutoConfig-Service-State`.
