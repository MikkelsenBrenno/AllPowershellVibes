# Export Firewall Service State

## Summary

Exports Windows Firewall and Base Filtering Engine service state.

## File

- `Export-Firewall-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `FirewallServiceState.json` |
...
| Script file | `Export-Firewall-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Firewall-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Firewall-Service-State`.
