# Export Proxy Policy Registry State

## Summary

Exports machine and user proxy policy registry values for Intune connectivity troubleshooting.

## File

- `Export-Proxy-Policy-Registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `ProxyPolicyRegistryState.json` |
...
| Script file | `Export-Proxy-Policy-Registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Proxy-Policy-Registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Proxy-Policy-Registry-State`.
