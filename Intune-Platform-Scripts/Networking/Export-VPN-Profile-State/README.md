# Export VPN Profile State

## Summary

Exports Windows VPN profile state for configured profile names, including split tunneling and server address details when available.

## File

- `Export-VPN-Profile-State.ps1`
...
| `$OutputFileName` | Output file name. | `VPNProfileState.json` |
| `$ExpectedVpnProfileNames` | VPN profile names to query. | `Contoso VPN` |
| `$IncludeAllUserConnections` | Query all-user VPN profiles. | `$true` |
...
| Script file | `Export-VPN-Profile-State.ps1` |
