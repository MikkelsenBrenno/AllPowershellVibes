# Export Intune Service Connectivity Check

## Summary

Tests configurable Microsoft Intune and Microsoft 365 service URLs and exports HTTP status and timing details.

## File

- `Export-Intune-Service-Connectivity-Check.ps1`
...
| `$OutputFileName` | Output file name. | `IntuneServiceConnectivityCheck.json` |
| `$TestUris` | Service URLs to test. | Microsoft sign-in, Graph, and Intune management endpoints |
| `$TimeoutSeconds` | HTTP timeout for each URL. | `15` |
...
| Script file | `Export-Intune-Service-Connectivity-Check.ps1` |
