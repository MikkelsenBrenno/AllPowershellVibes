<#
.SYNOPSIS
    Exports Licensing Service state.

.DESCRIPTION
    Exports Licensing Service state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Licensing-Service-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Licensing-Service-State'
$ScriptName = 'Export-Licensing-Service-State'
...
$ReportFileName = 'export-licensing-service-state.json'
