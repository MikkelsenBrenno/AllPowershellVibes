<#
.SYNOPSIS
    Exports Subscription State state.

.DESCRIPTION
    Exports Subscription State state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Subscription-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Subscription-State'
$ScriptName = 'Export-Subscription-State'
...
$ReportFileName = 'export-subscription-state.json'
