<#
.SYNOPSIS
    Exports Software Protection state.

.DESCRIPTION
    Exports Software Protection state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Software-Protection-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Software-Protection-State'
$ScriptName = 'Export-Software-Protection-State'

$ManagedItemName = 'Software Protection'
$PurposeCategory = 'Licensing-Activation'
$ReportRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Reports\Licensing-Activation'
$ReportFileName = 'export-software-protection-state.json'
