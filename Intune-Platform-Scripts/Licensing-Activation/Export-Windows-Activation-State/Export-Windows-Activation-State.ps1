<#
.SYNOPSIS
    Exports Windows Activation state.

.DESCRIPTION
    Exports Windows Activation state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Windows-Activation-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Windows-Activation-State'
$ScriptName = 'Export-Windows-Activation-State'
...
$ReportFileName = 'export-windows-activation-state.json'
