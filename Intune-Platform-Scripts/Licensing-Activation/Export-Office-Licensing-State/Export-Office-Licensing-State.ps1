<#
.SYNOPSIS
    Exports Office Licensing state.

.DESCRIPTION
    Exports Office Licensing state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Office-Licensing-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Office-Licensing-State'
$ScriptName = 'Export-Office-Licensing-State'
...
$ReportFileName = 'export-office-licensing-state.json'
