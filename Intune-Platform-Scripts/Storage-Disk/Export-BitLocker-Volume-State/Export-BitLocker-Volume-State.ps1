<#
.SYNOPSIS
    Exports BitLocker Volume state.

.DESCRIPTION
    Exports BitLocker Volume state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-BitLocker-Volume-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BitLocker-Volume-State'
$ScriptName = 'Export-BitLocker-Volume-State'
...
$ReportFileName = 'export-bitlocker-volume-state.json'
