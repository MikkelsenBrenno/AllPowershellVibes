<#
.SYNOPSIS
    Exports Disk Cleanup state.

.DESCRIPTION
    Exports Disk Cleanup state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Disk-Cleanup-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Disk-Cleanup-State'
$ScriptName = 'Export-Disk-Cleanup-State'
...
$ReportFileName = 'export-disk-cleanup-state.json'
