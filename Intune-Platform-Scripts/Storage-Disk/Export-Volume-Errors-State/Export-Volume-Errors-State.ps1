<#
.SYNOPSIS
    Exports Volume Errors state.

.DESCRIPTION
    Exports Volume Errors state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Volume-Errors-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Volume-Errors-State'
$ScriptName = 'Export-Volume-Errors-State'
...
$ReportFileName = 'export-volume-errors-state.json'
