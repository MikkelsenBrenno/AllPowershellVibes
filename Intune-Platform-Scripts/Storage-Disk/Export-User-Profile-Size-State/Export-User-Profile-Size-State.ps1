<#
.SYNOPSIS
    Exports User Profile Size state.

.DESCRIPTION
    Exports User Profile Size state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-User-Profile-Size-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-User-Profile-Size-State'
$ScriptName = 'Export-User-Profile-Size-State'

$ManagedItemName = 'User Profile Size'
$PurposeCategory = 'Storage-Disk'
$ReportRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Reports\Storage-Disk'
$ReportFileName = 'export-user-profile-size-state.json'
