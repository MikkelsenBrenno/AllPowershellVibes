<#
.SYNOPSIS
    Exports Temp Storage state.

.DESCRIPTION
    Exports Temp Storage state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Temp-Storage-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Temp-Storage-State'
$ScriptName = 'Export-Temp-Storage-State'
...
$ReportFileName = 'export-temp-storage-state.json'
