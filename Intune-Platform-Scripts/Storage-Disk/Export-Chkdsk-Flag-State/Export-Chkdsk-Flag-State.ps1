<#
.SYNOPSIS
    Exports Chkdsk Flag state.

.DESCRIPTION
    Exports Chkdsk Flag state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Chkdsk-Flag-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Chkdsk-Flag-State'
$ScriptName = 'Export-Chkdsk-Flag-State'
...
$ReportFileName = 'export-chkdsk-flag-state.json'
