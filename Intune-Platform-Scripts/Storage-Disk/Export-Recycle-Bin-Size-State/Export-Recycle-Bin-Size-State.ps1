<#
.SYNOPSIS
    Exports Recycle Bin Size state.

.DESCRIPTION
    Exports Recycle Bin Size state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Recycle-Bin-Size-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Recycle-Bin-Size-State'
$ScriptName = 'Export-Recycle-Bin-Size-State'
...
$ReportFileName = 'export-recycle-bin-size-state.json'
