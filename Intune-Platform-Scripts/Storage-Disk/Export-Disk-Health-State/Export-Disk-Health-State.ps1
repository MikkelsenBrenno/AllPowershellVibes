<#
.SYNOPSIS
    Exports Disk Health state.

.DESCRIPTION
    Exports Disk Health state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Disk-Health-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Disk-Health-State'
$ScriptName = 'Export-Disk-Health-State'
...
$ReportFileName = 'export-disk-health-state.json'
