<#
.SYNOPSIS
    Exports SMART Status state.

.DESCRIPTION
    Exports SMART Status state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-SMART-Status-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-SMART-Status-State'
$ScriptName = 'Export-SMART-Status-State'
...
$ReportFileName = 'export-smart-status-state.json'
