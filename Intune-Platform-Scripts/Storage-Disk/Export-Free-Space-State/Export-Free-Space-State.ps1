<#
.SYNOPSIS
    Exports Free Space state.

.DESCRIPTION
    Exports Free Space state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Free-Space-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Free-Space-State'
$ScriptName = 'Export-Free-Space-State'
...
$ReportFileName = 'export-free-space-state.json'
