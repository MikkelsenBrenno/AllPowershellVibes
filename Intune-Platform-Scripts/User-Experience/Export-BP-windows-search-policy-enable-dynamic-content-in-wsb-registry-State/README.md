# Windows Search Policy EnableDynamicContentInWSB Registry

## Summary

Exports a local Windows Search Policy EnableDynamicContentInWSB registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-search-policy-enable-dynamic-content-in-wsb-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowssearchenabledynamiccontentinwsbRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-search-policy-enable-dynamic-content-in-wsb-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-search-policy-enable-dynamic-content-in-wsb-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-search-policy-enable-dynamic-content-in-wsb-registry-State`.
