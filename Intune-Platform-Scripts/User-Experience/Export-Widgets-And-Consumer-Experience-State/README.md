# Export Widgets And Consumer Experience State

## Summary

Exports Widgets, News and Interests, consumer features, and tailored experiences policy values.

## File

- `Export-Widgets-And-Consumer-Experience-State.ps1`
...
| `$OutputFileName` | Output file name. | `WidgetsAndConsumerExperienceState.json` |
...
| Script file | `Export-Widgets-And-Consumer-Experience-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Widgets-And-Consumer-Experience-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Widgets-And-Consumer-Experience-State`.
