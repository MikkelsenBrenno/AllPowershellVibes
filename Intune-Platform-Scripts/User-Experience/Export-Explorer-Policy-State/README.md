# Export Explorer Policy State

## Summary

Exports Explorer policy values that affect search, taskbar, and shell user experience.

## File

- `Export-Explorer-Policy-State.ps1`
...
| `$OutputFileName` | Output file name. | `ExplorerPolicyState.json` |
...
| Script file | `Export-Explorer-Policy-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Explorer-Policy-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Explorer-Policy-State`.
