# Windows Search Policy ConnectedSearchUseWeb Registry

## Summary

Exports a local Windows Search Policy ConnectedSearchUseWeb registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-search-policy-connected-search-use-web-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowssearchconnectedsearchusewebRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-search-policy-connected-search-use-web-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-search-policy-connected-search-use-web-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-search-policy-connected-search-use-web-registry-State`.
