# Windows Search Policy AllowCortana Registry

## Summary

Exports a local Windows Search Policy AllowCortana registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-search-policy-allow-cortana-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowssearchallowcortanaRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-search-policy-allow-cortana-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-search-policy-allow-cortana-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-search-policy-allow-cortana-registry-State`.
