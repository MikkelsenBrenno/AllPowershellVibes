# Windows Search Policy AllowCloudSearch Registry

## Summary

Exports a local Windows Search Policy AllowCloudSearch registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-search-policy-allow-cloud-search-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowssearchallowcloudsearchRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-search-policy-allow-cloud-search-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-search-policy-allow-cloud-search-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-search-policy-allow-cloud-search-registry-State`.
