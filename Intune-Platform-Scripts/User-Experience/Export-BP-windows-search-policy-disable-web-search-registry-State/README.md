# Windows Search Policy DisableWebSearch Registry

## Summary

Exports a local Windows Search Policy DisableWebSearch registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-search-policy-disable-web-search-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowssearchdisablewebsearchRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-search-policy-disable-web-search-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-search-policy-disable-web-search-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-search-policy-disable-web-search-registry-State`.
