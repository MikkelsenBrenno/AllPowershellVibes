# Export Start Menu And Taskbar Policy State

## Summary

Exports common Start menu, taskbar, and Explorer policy registry values that affect Windows 10/11 user experience.

## File

- `Export-Start-Menu-And-Taskbar-Policy-State.ps1`
...
| `$OutputFileName` | Output file name. | `StartMenuAndTaskbarPolicyState.json` |
| `$ExperiencePolicyItems` | Start, taskbar, and Explorer values to export. | Web suggestions and taskbar values |
...
| Script file | `Export-Start-Menu-And-Taskbar-Policy-State.ps1` |
| Run this script using the logged-on credentials | Yes when targeting HKCU taskbar state |
