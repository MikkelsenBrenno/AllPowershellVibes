<#
.SYNOPSIS
    Exports WebView2 SmartScreen State state.

.DESCRIPTION
    Exports WebView2 SmartScreen State state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-WebView2-SmartScreen-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-WebView2-SmartScreen-State'
$ScriptName = 'Export-WebView2-SmartScreen-State'

$ManagedItemName = 'WebView2 SmartScreen State'
$InventoryRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory\Browser-Management'
$InventoryFileName = 'webview2-smartscreen-state-snapshot.json'
$EvidenceRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$EvidenceFileName = 'webview2-smartscreen-state.state'
