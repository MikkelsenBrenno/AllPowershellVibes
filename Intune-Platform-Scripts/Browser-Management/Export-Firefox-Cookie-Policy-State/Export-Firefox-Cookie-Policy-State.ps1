<#
.SYNOPSIS
    Exports Firefox Cookie Policy state.

.DESCRIPTION
    Exports Firefox Cookie Policy state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-Firefox-Cookie-Policy-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Firefox-Cookie-Policy-State'
$ScriptName = 'Export-Firefox-Cookie-Policy-State'

$ManagedItemName = 'Firefox Cookie Policy'
$InventoryRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory\Browser-Management'
$InventoryFileName = 'firefox-cookie-policy-snapshot.json'
$EvidenceRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$EvidenceFileName = 'firefox-cookie-policy.state'
