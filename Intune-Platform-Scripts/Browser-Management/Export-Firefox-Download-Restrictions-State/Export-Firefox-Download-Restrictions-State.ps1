<#
.SYNOPSIS
    Exports Firefox Download Restrictions state.

.DESCRIPTION
    Exports Firefox Download Restrictions state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-Firefox-Download-Restrictions-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Firefox-Download-Restrictions-State'
$ScriptName = 'Export-Firefox-Download-Restrictions-State'

$ManagedItemName = 'Firefox Download Restrictions'
$InventoryRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory\Browser-Management'
$InventoryFileName = 'firefox-download-restrictions-snapshot.json'
$EvidenceRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$EvidenceFileName = 'firefox-download-restrictions.state'
