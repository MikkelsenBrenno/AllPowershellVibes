<#
.SYNOPSIS
    Exports Firefox Profile SignIn state.

.DESCRIPTION
    Exports Firefox Profile SignIn state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-Firefox-Profile-SignIn-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Firefox-Profile-SignIn-State'
$ScriptName = 'Export-Firefox-Profile-SignIn-State'

$ManagedItemName = 'Firefox Profile SignIn'
$InventoryRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory\Browser-Management'
$InventoryFileName = 'firefox-profile-signin-snapshot.json'
$EvidenceRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$EvidenceFileName = 'firefox-profile-signin.state'
