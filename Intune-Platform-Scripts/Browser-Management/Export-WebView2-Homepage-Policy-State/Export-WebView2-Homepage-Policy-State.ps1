<#
.SYNOPSIS
    Exports WebView2 Homepage Policy state.

.DESCRIPTION
    Exports WebView2 Homepage Policy state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-WebView2-Homepage-Policy-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-WebView2-Homepage-Policy-State'
$ScriptName = 'Export-WebView2-Homepage-Policy-State'

$ManagedItemName = 'WebView2 Homepage Policy'
$InventoryRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory\Browser-Management'
$InventoryFileName = 'webview2-homepage-policy-snapshot.json'
$EvidenceRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$EvidenceFileName = 'webview2-homepage-policy.state'
