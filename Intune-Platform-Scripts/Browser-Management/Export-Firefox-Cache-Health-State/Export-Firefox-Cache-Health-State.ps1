<#
.SYNOPSIS
    Exports Firefox Cache Health state.

.DESCRIPTION
    Exports Firefox Cache Health state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-Firefox-Cache-Health-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Firefox-Cache-Health-State'
$ScriptName = 'Export-Firefox-Cache-Health-State'

$ManagedItemName = 'Firefox Cache Health'
$InventoryRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory\Browser-Management'
$InventoryFileName = 'firefox-cache-health-snapshot.json'
$EvidenceRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$EvidenceFileName = 'firefox-cache-health.state'
