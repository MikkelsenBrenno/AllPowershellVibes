<#
.SYNOPSIS
    Exports File Recovery state.

.DESCRIPTION
    Exports File Recovery state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-File-Recovery-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-File-Recovery-State'
$ScriptName = 'Export-File-Recovery-State'
...
$ReportFileName = 'export-file-recovery-state.json'
