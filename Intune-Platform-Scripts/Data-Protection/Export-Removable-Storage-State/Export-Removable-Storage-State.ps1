<#
.SYNOPSIS
    Exports Removable Storage state.

.DESCRIPTION
    Exports Removable Storage state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Removable-Storage-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Removable-Storage-State'
$ScriptName = 'Export-Removable-Storage-State'
...
$ReportFileName = 'export-removable-storage-state.json'
