<#
.SYNOPSIS
    Exports Backup Readiness state.

.DESCRIPTION
    Exports Backup Readiness state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Backup-Readiness-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Backup-Readiness-State'
$ScriptName = 'Export-Backup-Readiness-State'
...
$ReportFileName = 'export-backup-readiness-state.json'
