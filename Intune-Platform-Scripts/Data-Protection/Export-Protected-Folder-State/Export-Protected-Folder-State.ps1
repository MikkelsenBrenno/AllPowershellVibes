<#
.SYNOPSIS
    Exports Protected Folder state.

.DESCRIPTION
    Exports Protected Folder state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Protected-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Protected-Folder-State'
$ScriptName = 'Export-Protected-Folder-State'
...
$ReportFileName = 'export-protected-folder-state.json'
