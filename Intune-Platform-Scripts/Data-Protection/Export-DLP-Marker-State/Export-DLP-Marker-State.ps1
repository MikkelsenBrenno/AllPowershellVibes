<#
.SYNOPSIS
    Exports DLP Marker state.

.DESCRIPTION
    Exports DLP Marker state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-DLP-Marker-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-DLP-Marker-State'
$ScriptName = 'Export-DLP-Marker-State'
...
$ReportFileName = 'export-dlp-marker-state.json'
