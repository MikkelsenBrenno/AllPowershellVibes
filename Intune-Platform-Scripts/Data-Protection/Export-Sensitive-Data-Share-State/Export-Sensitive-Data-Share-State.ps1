<#
.SYNOPSIS
    Exports Sensitive Data Share state.

.DESCRIPTION
    Exports Sensitive Data Share state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Sensitive-Data-Share-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Sensitive-Data-Share-State'
$ScriptName = 'Export-Sensitive-Data-Share-State'

$ManagedItemName = 'Sensitive Data Share'
$PurposeCategory = 'Data-Protection'
$ReportRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Reports\Data-Protection'
$ReportFileName = 'export-sensitive-data-share-state.json'
