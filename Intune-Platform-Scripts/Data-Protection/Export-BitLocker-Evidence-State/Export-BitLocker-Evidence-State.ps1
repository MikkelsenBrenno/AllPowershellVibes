<#
.SYNOPSIS
    Exports BitLocker Evidence state.

.DESCRIPTION
    Exports BitLocker Evidence state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-BitLocker-Evidence-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BitLocker-Evidence-State'
$ScriptName = 'Export-BitLocker-Evidence-State'
...
$ReportFileName = 'export-bitlocker-evidence-state.json'
