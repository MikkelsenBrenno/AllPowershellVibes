<#
.SYNOPSIS
    Exports Controlled Folder state.

.DESCRIPTION
    Exports Controlled Folder state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Controlled-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Controlled-Folder-State'
$ScriptName = 'Export-Controlled-Folder-State'
...
$ReportFileName = 'export-controlled-folder-state.json'
