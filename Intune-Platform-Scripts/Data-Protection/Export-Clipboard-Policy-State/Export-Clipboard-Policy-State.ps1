<#
.SYNOPSIS
    Exports Clipboard Policy state.

.DESCRIPTION
    Exports Clipboard Policy state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Clipboard-Policy-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Clipboard-Policy-State'
$ScriptName = 'Export-Clipboard-Policy-State'
...
$ReportFileName = 'export-clipboard-policy-state.json'
