<#
.SYNOPSIS
    Exports Work Folders state.

.DESCRIPTION
    Exports Work Folders state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Work-Folders-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Work-Folders-State'
$ScriptName = 'Export-Work-Folders-State'
...
$ReportFileName = 'export-work-folders-state.json'
