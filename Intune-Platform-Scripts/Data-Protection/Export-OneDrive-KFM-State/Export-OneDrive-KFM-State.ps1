<#
.SYNOPSIS
    Exports OneDrive KFM state.

.DESCRIPTION
    Exports OneDrive KFM state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-OneDrive-KFM-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-OneDrive-KFM-State'
$ScriptName = 'Export-OneDrive-KFM-State'
...
$ReportFileName = 'export-onedrive-kfm-state.json'
