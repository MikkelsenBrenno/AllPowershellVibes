<#
.SYNOPSIS
    Exports Account Lockout state.

.DESCRIPTION
    Exports Account Lockout state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Account-Lockout-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Account-Lockout-State'
$ScriptName = 'Export-Account-Lockout-State'

$ManagedItemName = 'Account Lockout'
...
$ReportFileName = 'export-account-lockout-state.json'
