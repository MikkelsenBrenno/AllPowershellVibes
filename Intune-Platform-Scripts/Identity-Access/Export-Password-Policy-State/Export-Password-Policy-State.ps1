<#
.SYNOPSIS
    Exports Password Policy state.

.DESCRIPTION
    Exports Password Policy state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Password-Policy-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Password-Policy-State'
$ScriptName = 'Export-Password-Policy-State'

$ManagedItemName = 'Password Policy'
...
$ReportFileName = 'export-password-policy-state.json'
