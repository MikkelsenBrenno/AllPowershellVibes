<#
.SYNOPSIS
    Exports Credential Provider state.

.DESCRIPTION
    Exports Credential Provider state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Credential-Provider-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Credential-Provider-State'
$ScriptName = 'Export-Credential-Provider-State'
...
$ReportFileName = 'export-credential-provider-state.json'
