<#
.SYNOPSIS
    Exports Guest Account state.

.DESCRIPTION
    Exports Guest Account state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Guest-Account-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Guest-Account-State'
$ScriptName = 'Export-Guest-Account-State'
...
$ReportFileName = 'export-guest-account-state.json'
