<#
.SYNOPSIS
    Exports Windows Hello state.

.DESCRIPTION
    Exports Windows Hello state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Windows-Hello-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Windows-Hello-State'
$ScriptName = 'Export-Windows-Hello-State'

$ManagedItemName = 'Windows Hello'
...
$ReportFileName = 'export-windows-hello-state.json'
