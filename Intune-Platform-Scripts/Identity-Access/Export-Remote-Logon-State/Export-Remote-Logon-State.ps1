<#
.SYNOPSIS
    Exports Remote Logon state.

.DESCRIPTION
    Exports Remote Logon state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Remote-Logon-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Remote-Logon-State'
$ScriptName = 'Export-Remote-Logon-State'

$ManagedItemName = 'Remote Logon'
...
$ReportFileName = 'export-remote-logon-state.json'
