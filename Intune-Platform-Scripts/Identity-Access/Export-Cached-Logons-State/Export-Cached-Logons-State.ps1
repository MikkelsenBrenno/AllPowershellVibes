<#
.SYNOPSIS
    Exports Cached Logons state.

.DESCRIPTION
    Exports Cached Logons state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Cached-Logons-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Cached-Logons-State'
$ScriptName = 'Export-Cached-Logons-State'

$ManagedItemName = 'Cached Logons'
...
$ReportFileName = 'export-cached-logons-state.json'
