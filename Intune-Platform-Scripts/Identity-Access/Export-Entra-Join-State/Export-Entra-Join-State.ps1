<#
.SYNOPSIS
    Exports Entra Join state.

.DESCRIPTION
    Exports Entra Join state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Entra-Join-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Entra-Join-State'
$ScriptName = 'Export-Entra-Join-State'
...
$ReportFileName = 'export-entra-join-state.json'
