<#
.SYNOPSIS
    Exports Workplace Join state.

.DESCRIPTION
    Exports Workplace Join state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Workplace-Join-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Workplace-Join-State'
$ScriptName = 'Export-Workplace-Join-State'

$ManagedItemName = 'Workplace Join'
...
$ReportFileName = 'export-workplace-join-state.json'
