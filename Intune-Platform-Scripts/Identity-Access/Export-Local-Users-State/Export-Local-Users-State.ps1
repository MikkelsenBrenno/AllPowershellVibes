<#
.SYNOPSIS
    Exports Local Users state.

.DESCRIPTION
    Exports Local Users state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Local-Users-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Local-Users-State'
$ScriptName = 'Export-Local-Users-State'

$ManagedItemName = 'Local Users'
...
$ReportFileName = 'export-local-users-state.json'
