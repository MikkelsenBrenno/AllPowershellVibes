<#
.SYNOPSIS
    Exports OneDrive Certificate Readiness state.

.DESCRIPTION
    Exports OneDrive Certificate Readiness state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-OneDrive-Certificate-Readiness-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-OneDrive-Certificate-Readiness-State'
$ScriptName = 'Export-OneDrive-Certificate-Readiness-State'

$ManagedItemName = 'OneDrive Certificate Readiness'
$InventoryRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory\Remote-Work'
$InventoryFileName = 'onedrive-certificate-readiness-snapshot.json'
$EvidenceRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$EvidenceFileName = 'onedrive-certificate-readiness.state'
