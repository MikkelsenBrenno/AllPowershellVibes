<#
.SYNOPSIS
    Exports OneDrive Recovery Marker state.

.DESCRIPTION
    Exports OneDrive Recovery Marker state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-OneDrive-Recovery-Marker-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-OneDrive-Recovery-Marker-State'
$ScriptName = 'Export-OneDrive-Recovery-Marker-State'

$ManagedItemName = 'OneDrive Recovery Marker'
$InventoryRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory\Remote-Work'
$InventoryFileName = 'onedrive-recovery-marker-snapshot.json'
$EvidenceRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$EvidenceFileName = 'onedrive-recovery-marker.state'
