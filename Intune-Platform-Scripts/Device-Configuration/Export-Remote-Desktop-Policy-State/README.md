# Export Remote Desktop Policy State

## Summary

Exports Remote Desktop policy and terminal server values for support and hardening checks.

## File

- `Export-Remote-Desktop-Policy-State.ps1`
...
| `$OutputFileName` | Output file name. | `RemoteDesktopPolicyState.json` |
...
| Script file | `Export-Remote-Desktop-Policy-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Remote-Desktop-Policy-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Remote-Desktop-Policy-State`.
