# Windows System Privacy Policy PublishUserActivities Registry

## Summary

Exports a local Windows System Privacy Policy PublishUserActivities registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-system-privacy-policy-publish-user-activities-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformsystemprivacypublishuseractivitiesRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-system-privacy-policy-publish-user-activities-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-system-privacy-policy-publish-user-activities-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-system-privacy-policy-publish-user-activities-registry-State`.
