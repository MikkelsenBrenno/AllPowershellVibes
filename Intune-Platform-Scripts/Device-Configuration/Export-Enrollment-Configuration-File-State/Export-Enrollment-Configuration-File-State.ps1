<#
.SYNOPSIS
    Exports Enrollment Configuration File state.

.DESCRIPTION
    Exports Enrollment Configuration File state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-Enrollment-Configuration-File-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Enrollment-Configuration-File-State'
$ScriptName = 'Export-Enrollment-Configuration-File-State'

$ManagedItemName = 'Enrollment Configuration File'
$InventoryRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory\Device-Configuration'
$InventoryFileName = 'enrollment-configuration-file-snapshot.json'
$EvidenceRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Device-Configuration'
$EvidenceFileName = 'enrollment-configuration-file.state'
