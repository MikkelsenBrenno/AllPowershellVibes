# Windows System Privacy Policy AllowClipboardHistory Registry

## Summary

Exports a local Windows System Privacy Policy AllowClipboardHistory registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-system-privacy-policy-allow-clipboard-history-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformsystemprivacyallowclipboardhistoryRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-system-privacy-policy-allow-clipboard-history-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-system-privacy-policy-allow-clipboard-history-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-system-privacy-policy-allow-clipboard-history-registry-State`.
