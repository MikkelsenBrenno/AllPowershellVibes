# Windows System Privacy Policy AllowCrossDeviceClipboard Registry

## Summary

Exports a local Windows System Privacy Policy AllowCrossDeviceClipboard registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-system-privacy-policy-allow-cross-device-clipboard-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformsystemprivacyallowcrossdeviceclipboardRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-system-privacy-policy-allow-cross-device-clipboard-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-system-privacy-policy-allow-cross-device-clipboard-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-system-privacy-policy-allow-cross-device-clipboard-registry-State`.
