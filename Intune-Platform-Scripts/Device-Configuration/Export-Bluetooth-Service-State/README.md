# Export Bluetooth Service State

## Summary

Exports Bluetooth-related service state for peripheral and pairing troubleshooting.

## File

- `Export-Bluetooth-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BluetoothServiceState.json` |
...
| Script file | `Export-Bluetooth-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Bluetooth-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Bluetooth-Service-State`.
