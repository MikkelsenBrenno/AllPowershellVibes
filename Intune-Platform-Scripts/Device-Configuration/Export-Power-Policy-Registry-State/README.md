# Export Power Policy Registry State

## Summary

Exports power policy registry values that affect sleep, hibernate, and fast startup behavior.

## File

- `Export-Power-Policy-Registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `PowerPolicyRegistryState.json` |
...
| Script file | `Export-Power-Policy-Registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Power-Policy-Registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Power-Policy-Registry-State`.
