# Export Local User Profile Policy State

## Summary

Exports profile management policy values that affect local user profile cleanup and behavior.

## File

- `Export-Local-User-Profile-Policy-State.ps1`
...
| `$OutputFileName` | Output file name. | `LocalUserProfilePolicyState.json` |
...
| Script file | `Export-Local-User-Profile-Policy-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Local-User-Profile-Policy-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Local-User-Profile-Policy-State`.
