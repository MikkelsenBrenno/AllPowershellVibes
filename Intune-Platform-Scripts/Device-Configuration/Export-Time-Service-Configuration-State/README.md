...
Exports Windows Time service state for devices with sign-in, Kerberos, or compliance timestamp issues.

## File

- `Export-Time-Service-Configuration-State.ps1`
...
| `$OutputFileName` | Output file name. | `TimeServiceConfigurationState.json` |
...
| Script file | `Export-Time-Service-Configuration-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Time-Service-Configuration-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Time-Service-Configuration-State`.
