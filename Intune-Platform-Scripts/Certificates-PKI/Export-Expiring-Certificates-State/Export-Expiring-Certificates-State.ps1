<#
.SYNOPSIS
    Exports Expiring Certificates state.

.DESCRIPTION
    Exports Expiring Certificates state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Expiring-Certificates-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Expiring-Certificates-State'
$ScriptName = 'Export-Expiring-Certificates-State'
...
$ReportFileName = 'export-expiring-certificates-state.json'
