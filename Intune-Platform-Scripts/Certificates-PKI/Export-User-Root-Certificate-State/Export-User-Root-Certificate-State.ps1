<#
.SYNOPSIS
    Exports User Root Certificate state.

.DESCRIPTION
    Exports User Root Certificate state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-User-Root-Certificate-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-User-Root-Certificate-State'
$ScriptName = 'Export-User-Root-Certificate-State'
...
$ReportFileName = 'export-user-root-certificate-state.json'
