<#
.SYNOPSIS
    Exports SCEP Certificate state.

.DESCRIPTION
    Exports SCEP Certificate state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-SCEP-Certificate-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-SCEP-Certificate-State'
$ScriptName = 'Export-SCEP-Certificate-State'
...
$ReportFileName = 'export-scep-certificate-state.json'
