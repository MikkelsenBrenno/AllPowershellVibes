<#
.SYNOPSIS
    Exports VPN Certificate state.

.DESCRIPTION
    Exports VPN Certificate state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-VPN-Certificate-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-VPN-Certificate-State'
$ScriptName = 'Export-VPN-Certificate-State'
...
$ReportFileName = 'export-vpn-certificate-state.json'
