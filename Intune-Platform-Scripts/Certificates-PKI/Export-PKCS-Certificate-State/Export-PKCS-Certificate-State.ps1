<#
.SYNOPSIS
    Exports PKCS Certificate state.

.DESCRIPTION
    Exports PKCS Certificate state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-PKCS-Certificate-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-PKCS-Certificate-State'
$ScriptName = 'Export-PKCS-Certificate-State'
...
$ReportFileName = 'export-pkcs-certificate-state.json'
