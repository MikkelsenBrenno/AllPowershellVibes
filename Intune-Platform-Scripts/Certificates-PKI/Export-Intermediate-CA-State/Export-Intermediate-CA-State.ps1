<#
.SYNOPSIS
    Exports Intermediate CA state.

.DESCRIPTION
    Exports Intermediate CA state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Intermediate-CA-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Intermediate-CA-State'
$ScriptName = 'Export-Intermediate-CA-State'
...
$ReportFileName = 'export-intermediate-ca-state.json'
