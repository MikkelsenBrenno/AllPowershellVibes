<#
.SYNOPSIS
    Exports WiFi Certificate state.

.DESCRIPTION
    Exports WiFi Certificate state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-WiFi-Certificate-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-WiFi-Certificate-State'
$ScriptName = 'Export-WiFi-Certificate-State'
...
$ReportFileName = 'export-wifi-certificate-state.json'
