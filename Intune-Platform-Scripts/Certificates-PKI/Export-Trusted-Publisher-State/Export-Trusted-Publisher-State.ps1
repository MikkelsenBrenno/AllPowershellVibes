<#
.SYNOPSIS
    Exports Trusted Publisher state.

.DESCRIPTION
    Exports Trusted Publisher state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Trusted-Publisher-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Trusted-Publisher-State'
$ScriptName = 'Export-Trusted-Publisher-State'
...
$ReportFileName = 'export-trusted-publisher-state.json'
