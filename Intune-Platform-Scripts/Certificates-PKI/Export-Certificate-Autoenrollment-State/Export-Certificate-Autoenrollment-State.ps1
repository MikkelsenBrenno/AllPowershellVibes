<#
.SYNOPSIS
    Exports Certificate Autoenrollment state.

.DESCRIPTION
    Exports Certificate Autoenrollment state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Certificate-Autoenrollment-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Certificate-Autoenrollment-State'
$ScriptName = 'Export-Certificate-Autoenrollment-State'

$ManagedItemName = 'Certificate Autoenrollment'
$PurposeCategory = 'Certificates-PKI'
$ReportRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Reports\Certificates-PKI'
$ReportFileName = 'export-certificate-autoenrollment-state.json'
