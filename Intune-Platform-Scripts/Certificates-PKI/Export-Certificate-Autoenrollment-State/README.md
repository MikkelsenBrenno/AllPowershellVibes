# Export-Certificate-Autoenrollment-State

## Summary

Exports Certificate Autoenrollment state for technician troubleshooting and reporting in the Certificates-PKI category.
