<#
.SYNOPSIS
    Exports Machine Root Certificate state.

.DESCRIPTION
    Exports Machine Root Certificate state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Machine-Root-Certificate-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Machine-Root-Certificate-State'
$ScriptName = 'Export-Machine-Root-Certificate-State'
...
$ReportFileName = 'export-machine-root-certificate-state.json'
