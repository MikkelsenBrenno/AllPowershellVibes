# Export-Machine-Root-Certificate-State

## Summary

Exports Machine Root Certificate state for technician troubleshooting and reporting in the Certificates-PKI category.
