# Export Delivery Optimization Status

## Summary

Exports Delivery Optimization service, policy, and cache status for Windows Update for Business troubleshooting.

## File

- `Export-Delivery-Optimization-Status.ps1`
...
| `$OutputFileName` | Output file name. | `DeliveryOptimizationStatus.json` |
| `$DeliveryOptimizationPolicyItems` | Delivery Optimization policy values to export. | Download mode and cache policy values |
...
| Script file | `Export-Delivery-Optimization-Status.ps1` |
