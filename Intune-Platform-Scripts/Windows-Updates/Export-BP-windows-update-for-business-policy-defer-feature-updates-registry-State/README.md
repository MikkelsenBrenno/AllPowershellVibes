# Windows Update For Business Policy DeferFeatureUpdates Registry

## Summary

Exports a local Windows Update For Business Policy DeferFeatureUpdates registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-update-for-business-policy-defer-feature-updates-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwufbpolicydeferfeatureupdatesRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-update-for-business-policy-defer-feature-updates-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-for-business-policy-defer-feature-updates-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-for-business-policy-defer-feature-updates-registry-State`.
