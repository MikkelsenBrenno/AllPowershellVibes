# Delivery Optimization Policy DOAbsoluteMaxCacheSize Registry

## Summary

Exports a local Delivery Optimization Policy DOAbsoluteMaxCacheSize registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-delivery-optimization-policy-doabsolute-max-cache-size-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdeliveryoptimizationdoabsolutemaxcachesizeRegistrySnapshot.json` |
...
| Script file | `Export-BP-delivery-optimization-policy-doabsolute-max-cache-size-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-delivery-optimization-policy-doabsolute-max-cache-size-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-delivery-optimization-policy-doabsolute-max-cache-size-registry-State`.
