# Windows Update For Business Policy ProductVersion Registry

## Summary

Exports a local Windows Update For Business Policy ProductVersion registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-update-for-business-policy-product-version-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwufbpolicyproductversionRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-update-for-business-policy-product-version-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-for-business-policy-product-version-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-for-business-policy-product-version-registry-State`.
