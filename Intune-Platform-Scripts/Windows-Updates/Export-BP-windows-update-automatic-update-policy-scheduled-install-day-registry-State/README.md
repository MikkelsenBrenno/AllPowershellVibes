# Windows Update Automatic Update Policy ScheduledInstallDay Registry

## Summary

Exports a local Windows Update Automatic Update Policy ScheduledInstallDay registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-update-automatic-update-policy-scheduled-install-day-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowsupdateauscheduledinstalldayRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-update-automatic-update-policy-scheduled-install-day-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-automatic-update-policy-scheduled-install-day-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-automatic-update-policy-scheduled-install-day-registry-State`.
