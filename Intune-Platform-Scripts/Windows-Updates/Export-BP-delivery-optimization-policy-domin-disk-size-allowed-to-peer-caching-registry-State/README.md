# Delivery Optimization Policy DOMinDiskSizeAllowedToPeerCaching Registry

## Summary

Exports a local Delivery Optimization Policy DOMinDiskSizeAllowedToPeerCaching registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-delivery-optimization-policy-domin-disk-size-allowed-to-peer-caching-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdeliveryoptimizationdomindisksizeallowedtopeercachingRegistrySnapshot.json` |
...
| Script file | `Export-BP-delivery-optimization-policy-domin-disk-size-allowed-to-peer-caching-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-delivery-optimization-policy-domin-disk-size-allowed-to-peer-caching-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-delivery-optimization-policy-domin-disk-size-allowed-to-peer-caching-registry-State`.
