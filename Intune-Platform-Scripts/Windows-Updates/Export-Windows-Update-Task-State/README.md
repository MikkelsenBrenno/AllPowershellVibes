# Export Windows Update Task State

## Summary

Exports Windows Update scheduled task state for update scan and install troubleshooting.

## File

- `Export-Windows-Update-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `WindowsUpdateTaskState.json` |
...
| Script file | `Export-Windows-Update-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Windows-Update-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Windows-Update-Task-State`.
