# Export WUfB Policy Registry State

## Summary

Exports Windows Update for Business policy registry values, including deferral, pause, active hours, and target release settings.

## File

- `Export-WUfB-Policy-Registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `WUfBPolicyRegistryState.json` |
| `$WufbPolicyItems` | Windows Update for Business policy registry values to export. | Target release, deferrals, and active hours |
...
| Script file | `Export-WUfB-Policy-Registry-State.ps1` |
