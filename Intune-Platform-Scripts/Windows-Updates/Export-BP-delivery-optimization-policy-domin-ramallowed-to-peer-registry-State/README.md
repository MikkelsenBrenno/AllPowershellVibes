# Delivery Optimization Policy DOMinRAMAllowedToPeer Registry

## Summary

Exports a local Delivery Optimization Policy DOMinRAMAllowedToPeer registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-delivery-optimization-policy-domin-ramallowed-to-peer-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdeliveryoptimizationdominramallowedtopeerRegistrySnapshot.json` |
...
| Script file | `Export-BP-delivery-optimization-policy-domin-ramallowed-to-peer-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-delivery-optimization-policy-domin-ramallowed-to-peer-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-delivery-optimization-policy-domin-ramallowed-to-peer-registry-State`.
