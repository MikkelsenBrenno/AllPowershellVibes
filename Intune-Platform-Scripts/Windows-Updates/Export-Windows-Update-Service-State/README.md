# Export Windows Update Service State

## Summary

Exports Windows Update related service state for Windows Update for Business troubleshooting.

## File

- `Export-Windows-Update-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `WindowsUpdateServiceState.json` |
...
| Script file | `Export-Windows-Update-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Windows-Update-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Windows-Update-Service-State`.
