# Windows Update For Business Policy DeferQualityUpdatesPeriodInDays Registry

## Summary

Exports a local Windows Update For Business Policy DeferQualityUpdatesPeriodInDays registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-update-for-business-policy-defer-quality-updates-period-in-days-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwufbpolicydeferqualityupdatesperiodindaysRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-update-for-business-policy-defer-quality-updates-period-in-days-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-for-business-policy-defer-quality-updates-period-in-days-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-for-business-policy-defer-quality-updates-period-in-days-registry-State`.
