# Export Windows Update Policy Safety State

## Summary

Exports Windows Update policy values that commonly block scans, downloads, or Microsoft Update integration.

## File

- `Export-Windows-Update-Policy-Safety-State.ps1`
...
| `$OutputFileName` | Output file name. | `WindowsUpdatePolicySafetyState.json` |
...
| Script file | `Export-Windows-Update-Policy-Safety-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Windows-Update-Policy-Safety-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Windows-Update-Policy-Safety-State`.
