# Windows Update Automatic Update Policy NoAutoRebootWithLoggedOnUsers Registry

## Summary

Exports a local Windows Update Automatic Update Policy NoAutoRebootWithLoggedOnUsers registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-update-automatic-update-policy-no-auto-reboot-with-logged-on-users-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowsupdateaunoautorebootwithloggedonusersRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-update-automatic-update-policy-no-auto-reboot-with-logged-on-users-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-automatic-update-policy-no-auto-reboot-with-logged-on-users-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-automatic-update-policy-no-auto-reboot-with-logged-on-users-registry-State`.
