# Windows Update Automatic Update Policy NoAutoUpdate Registry

## Summary

Exports a local Windows Update Automatic Update Policy NoAutoUpdate registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-update-automatic-update-policy-no-auto-update-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowsupdateaunoautoupdateRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-update-automatic-update-policy-no-auto-update-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-automatic-update-policy-no-auto-update-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-automatic-update-policy-no-auto-update-registry-State`.
