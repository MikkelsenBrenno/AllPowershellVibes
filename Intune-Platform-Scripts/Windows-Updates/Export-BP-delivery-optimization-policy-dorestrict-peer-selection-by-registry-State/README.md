# Delivery Optimization Policy DORestrictPeerSelectionBy Registry

## Summary

Exports a local Delivery Optimization Policy DORestrictPeerSelectionBy registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-delivery-optimization-policy-dorestrict-peer-selection-by-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdeliveryoptimizationdorestrictpeerselectionbyRegistrySnapshot.json` |
...
| Script file | `Export-BP-delivery-optimization-policy-dorestrict-peer-selection-by-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-delivery-optimization-policy-dorestrict-peer-selection-by-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-delivery-optimization-policy-dorestrict-peer-selection-by-registry-State`.
