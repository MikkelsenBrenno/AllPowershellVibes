# Windows Update Automatic Update Policy AUOptions Registry

## Summary

Exports a local Windows Update Automatic Update Policy AUOptions registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-update-automatic-update-policy-auoptions-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowsupdateauauoptionsRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-update-automatic-update-policy-auoptions-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-automatic-update-policy-auoptions-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-automatic-update-policy-auoptions-registry-State`.
