# Delivery Optimization Policy DOGroupIdSource Registry

## Summary

Exports a local Delivery Optimization Policy DOGroupIdSource registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-delivery-optimization-policy-dogroup-id-source-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdeliveryoptimizationdogroupidsourceRegistrySnapshot.json` |
...
| Script file | `Export-BP-delivery-optimization-policy-dogroup-id-source-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-delivery-optimization-policy-dogroup-id-source-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-delivery-optimization-policy-dogroup-id-source-registry-State`.
