# Windows Update Automatic Update Policy UseWUServer Registry

## Summary

Exports a local Windows Update Automatic Update Policy UseWUServer registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-update-automatic-update-policy-use-wuserver-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowsupdateauusewuserverRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-update-automatic-update-policy-use-wuserver-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-automatic-update-policy-use-wuserver-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-automatic-update-policy-use-wuserver-registry-State`.
