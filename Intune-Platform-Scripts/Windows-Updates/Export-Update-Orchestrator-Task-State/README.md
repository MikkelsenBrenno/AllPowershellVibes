# Export Update Orchestrator Task State

## Summary

Exports Update Orchestrator scheduled task state for Windows Update for Business troubleshooting.

## File

- `Export-Update-Orchestrator-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `UpdateOrchestratorTaskState.json` |
...
| Script file | `Export-Update-Orchestrator-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Update-Orchestrator-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Update-Orchestrator-Task-State`.
