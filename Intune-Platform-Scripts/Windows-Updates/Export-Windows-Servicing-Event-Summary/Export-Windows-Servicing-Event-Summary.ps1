<#
.SYNOPSIS
    Exports Windows servicing event summary.

.DESCRIPTION
    Intune platform script that collects recent Setup log servicing events.

.NOTES
    Name:        Export-Windows-Servicing-Event-Summary.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Windows-Servicing-Event-Summary'
$ScriptName = 'Export-Windows-Servicing-Event-Summary'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'WindowsServicingEventSummary.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Windows servicing event summary.'

$EventLogName = 'Setup'
$RecentEventCount = 80
$EventIdsToHighlight = @(2, 3, 4, 7, 20)
