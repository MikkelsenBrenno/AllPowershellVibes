# Export Windows Servicing Event Summary

## Summary

Exports recent servicing events from the Setup log for feature update and repair troubleshooting.

## File

- `Export-Windows-Servicing-Event-Summary.ps1`
...
| `$OutputFileName` | Output file name. | `WindowsServicingEventSummary.json` |
...
| Script file | `Export-Windows-Servicing-Event-Summary.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Windows-Servicing-Event-Summary`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Windows-Servicing-Event-Summary`.
