# Windows Update For Business Policy ExcludeWUDriversInQualityUpdate Registry

## Summary

Exports a local Windows Update For Business Policy ExcludeWUDriversInQualityUpdate registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-update-for-business-policy-exclude-wudrivers-in-quality-update-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwufbpolicyexcludewudriversinqualityupdateRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-update-for-business-policy-exclude-wudrivers-in-quality-update-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-for-business-policy-exclude-wudrivers-in-quality-update-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-for-business-policy-exclude-wudrivers-in-quality-update-registry-State`.
