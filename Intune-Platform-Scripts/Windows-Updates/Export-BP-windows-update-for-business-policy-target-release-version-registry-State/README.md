# Windows Update For Business Policy TargetReleaseVersion Registry

## Summary

Exports a local Windows Update For Business Policy TargetReleaseVersion registry policy troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-update-for-business-policy-target-release-version-registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwufbpolicytargetreleaseversionRegistrySnapshot.json` |
...
| Script file | `Export-BP-windows-update-for-business-policy-target-release-version-registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-for-business-policy-target-release-version-registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-update-for-business-policy-target-release-version-registry-State`.
