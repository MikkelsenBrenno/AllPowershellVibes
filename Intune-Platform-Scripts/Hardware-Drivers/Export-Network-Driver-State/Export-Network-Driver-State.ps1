<#
.SYNOPSIS
    Exports Network Driver state.

.DESCRIPTION
    Exports Network Driver state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Network-Driver-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Network-Driver-State'
$ScriptName = 'Export-Network-Driver-State'

$ManagedItemName = 'Network Driver'
...
$ReportFileName = 'export-network-driver-state.json'
