<#
.SYNOPSIS
    Exports Firmware Version state.

.DESCRIPTION
    Exports Firmware Version state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Firmware-Version-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Firmware-Version-State'
$ScriptName = 'Export-Firmware-Version-State'
...
$ReportFileName = 'export-firmware-version-state.json'
