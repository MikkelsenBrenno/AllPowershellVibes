<#
.SYNOPSIS
    Exports Dock Driver state.

.DESCRIPTION
    Exports Dock Driver state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Dock-Driver-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Dock-Driver-State'
$ScriptName = 'Export-Dock-Driver-State'
...
$ReportFileName = 'export-dock-driver-state.json'
