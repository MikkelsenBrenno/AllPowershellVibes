<#
.SYNOPSIS
    Exports Missing Drivers state.

.DESCRIPTION
    Exports Missing Drivers state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Missing-Drivers-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Missing-Drivers-State'
$ScriptName = 'Export-Missing-Drivers-State'

$ManagedItemName = 'Missing Drivers'
$PurposeCategory = 'Hardware-Drivers'
$ReportRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Reports\Hardware-Drivers'
$ReportFileName = 'export-missing-drivers-state.json'
