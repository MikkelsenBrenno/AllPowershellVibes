<#
.SYNOPSIS
    Exports Display Driver state.

.DESCRIPTION
    Exports Display Driver state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Display-Driver-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Display-Driver-State'
$ScriptName = 'Export-Display-Driver-State'

$ManagedItemName = 'Display Driver'
...
$ReportFileName = 'export-display-driver-state.json'
