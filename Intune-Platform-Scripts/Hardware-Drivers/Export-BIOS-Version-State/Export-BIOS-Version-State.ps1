<#
.SYNOPSIS
    Exports BIOS Version state.

.DESCRIPTION
    Exports BIOS Version state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-BIOS-Version-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BIOS-Version-State'
$ScriptName = 'Export-BIOS-Version-State'

$ManagedItemName = 'BIOS Version'
...
$ReportFileName = 'export-bios-version-state.json'
