<#
.SYNOPSIS
    Exports Camera Driver state.

.DESCRIPTION
    Exports Camera Driver state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Camera-Driver-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Camera-Driver-State'
$ScriptName = 'Export-Camera-Driver-State'
...
$ReportFileName = 'export-camera-driver-state.json'
