<#
.SYNOPSIS
    Exports Audio Driver state.

.DESCRIPTION
    Exports Audio Driver state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Audio-Driver-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Audio-Driver-State'
$ScriptName = 'Export-Audio-Driver-State'

$ManagedItemName = 'Audio Driver'
...
$ReportFileName = 'export-audio-driver-state.json'
