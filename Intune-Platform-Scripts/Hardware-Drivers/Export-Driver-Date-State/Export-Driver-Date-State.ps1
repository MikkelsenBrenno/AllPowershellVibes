<#
.SYNOPSIS
    Exports Driver Date state.

.DESCRIPTION
    Exports Driver Date state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Driver-Date-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Driver-Date-State'
$ScriptName = 'Export-Driver-Date-State'
...
$ReportFileName = 'export-driver-date-state.json'
