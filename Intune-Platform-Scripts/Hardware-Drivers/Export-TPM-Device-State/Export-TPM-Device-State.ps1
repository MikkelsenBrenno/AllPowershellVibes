<#
.SYNOPSIS
    Exports TPM Device state.

.DESCRIPTION
    Exports TPM Device state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-TPM-Device-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-TPM-Device-State'
$ScriptName = 'Export-TPM-Device-State'

$ManagedItemName = 'TPM Device'
...
$ReportFileName = 'export-tpm-device-state.json'
