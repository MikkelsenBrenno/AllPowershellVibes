<#
.SYNOPSIS
    Exports File History state.

.DESCRIPTION
    Exports File History state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-File-History-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-File-History-State'
$ScriptName = 'Export-File-History-State'
...
$ReportFileName = 'export-file-history-state.json'
