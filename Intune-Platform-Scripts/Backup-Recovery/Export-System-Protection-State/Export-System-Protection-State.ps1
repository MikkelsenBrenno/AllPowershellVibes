<#
.SYNOPSIS
    Exports System Protection state.

.DESCRIPTION
    Exports System Protection state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-System-Protection-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-System-Protection-State'
$ScriptName = 'Export-System-Protection-State'

$ManagedItemName = 'System Protection'
...
$ReportFileName = 'export-system-protection-state.json'
