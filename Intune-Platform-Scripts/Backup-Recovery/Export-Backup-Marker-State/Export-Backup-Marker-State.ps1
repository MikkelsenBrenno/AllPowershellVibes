<#
.SYNOPSIS
    Exports Backup Marker state.

.DESCRIPTION
    Exports Backup Marker state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Backup-Marker-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Backup-Marker-State'
$ScriptName = 'Export-Backup-Marker-State'

$ManagedItemName = 'Backup Marker'
...
$ReportFileName = 'export-backup-marker-state.json'
