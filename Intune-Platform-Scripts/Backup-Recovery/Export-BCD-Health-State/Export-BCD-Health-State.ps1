<#
.SYNOPSIS
    Exports BCD Health state.

.DESCRIPTION
    Exports BCD Health state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-BCD-Health-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BCD-Health-State'
$ScriptName = 'Export-BCD-Health-State'

$ManagedItemName = 'BCD Health'
...
$ReportFileName = 'export-bcd-health-state.json'
