<#
.SYNOPSIS
    Exports Windows RE state.

.DESCRIPTION
    Exports Windows RE state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Windows-RE-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Windows-RE-State'
$ScriptName = 'Export-Windows-RE-State'
...
$ReportFileName = 'export-windows-re-state.json'
