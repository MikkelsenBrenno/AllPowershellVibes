<#
.SYNOPSIS
    Exports Restore Point state.

.DESCRIPTION
    Exports Restore Point state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Restore-Point-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Restore-Point-State'
$ScriptName = 'Export-Restore-Point-State'

$ManagedItemName = 'Restore Point'
...
$ReportFileName = 'export-restore-point-state.json'
