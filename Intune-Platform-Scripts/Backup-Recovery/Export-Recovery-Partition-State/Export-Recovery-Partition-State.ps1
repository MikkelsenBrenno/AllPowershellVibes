<#
.SYNOPSIS
    Exports Recovery Partition state.

.DESCRIPTION
    Exports Recovery Partition state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Recovery-Partition-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Recovery-Partition-State'
$ScriptName = 'Export-Recovery-Partition-State'

$ManagedItemName = 'Recovery Partition'
...
$ReportFileName = 'export-recovery-partition-state.json'
