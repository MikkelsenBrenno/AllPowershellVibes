<#
.SYNOPSIS
    Exports Recovery Drive state.

.DESCRIPTION
    Exports Recovery Drive state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Recovery-Drive-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Recovery-Drive-State'
$ScriptName = 'Export-Recovery-Drive-State'

$ManagedItemName = 'Recovery Drive'
...
$ReportFileName = 'export-recovery-drive-state.json'
