...
Exports a local Base Filtering Engine service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-base-filtering-engine-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformbasefilteringengineServiceSnapshot.json` |
...
| Script file | `Export-BP-base-filtering-engine-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-base-filtering-engine-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-base-filtering-engine-Service-State`.
