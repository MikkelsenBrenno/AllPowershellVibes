# Export Windows LAPS Policy State

## Summary

Exports Windows LAPS policy registry values and local service availability for environments using Intune account protection policy.

## File

- `Export-Windows-LAPS-Policy-State.ps1`
...
| `$OutputFileName` | Output file name. | `WindowsLAPSPolicyState.json` |
| `$LapsPolicyValues` | Windows LAPS registry values to export. | Backup directory, age, account, and post-authentication values |
...
| Script file | `Export-Windows-LAPS-Policy-State.ps1` |
