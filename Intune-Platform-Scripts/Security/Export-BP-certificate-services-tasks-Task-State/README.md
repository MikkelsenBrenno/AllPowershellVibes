# Certificate Services Tasks Task

## Summary

Exports a local Certificate Services Tasks scheduled task troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-certificate-services-tasks-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformcertificateservicestasksTaskSnapshot.json` |
...
| Script file | `Export-BP-certificate-services-tasks-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-certificate-services-tasks-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-certificate-services-tasks-Task-State`.
