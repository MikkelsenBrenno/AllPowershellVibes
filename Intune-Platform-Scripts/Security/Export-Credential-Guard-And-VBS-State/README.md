# Export Credential Guard And VBS State

## Summary

Exports virtualization-based security and Credential Guard registry/CIM state for endpoint hardening troubleshooting.

## File

- `Export-Credential-Guard-And-VBS-State.ps1`
...
| `$OutputFileName` | Output file name. | `CredentialGuardAndVBSState.json` |
| `$DeviceGuardRegistryValues` | Device Guard and LSA values to export. | VBS and Credential Guard keys |
...
| Script file | `Export-Credential-Guard-And-VBS-State.ps1` |
