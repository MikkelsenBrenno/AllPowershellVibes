# Export Firewall Logging Policy State

## Summary

Exports Windows Firewall logging policy values for troubleshooting missing firewall logs.

## File

- `Export-Firewall-Logging-Policy-State.ps1`
...
| `$OutputFileName` | Output file name. | `FirewallLoggingPolicyState.json` |
...
| Script file | `Export-Firewall-Logging-Policy-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Firewall-Logging-Policy-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Firewall-Logging-Policy-State`.
