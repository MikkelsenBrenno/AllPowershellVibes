<#
.SYNOPSIS
    Exports Windows Security Center Service state.

.DESCRIPTION
    Intune platform script that exports windows security center service state to a local JSON file for Business Premium troubleshooting.

.NOTES
    Name:        Export-BP-security-center-Service-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BP-security-center-Service-State'
$ScriptName = 'Export-BP-security-center-Service-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'BPPlatformsecuritycenterServiceSnapshot.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Windows Security Center service state snapshot for technician troubleshooting.'
