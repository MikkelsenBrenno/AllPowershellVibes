...
Exports a local Windows Security Center service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-security-center-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformsecuritycenterServiceSnapshot.json` |
...
| Script file | `Export-BP-security-center-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-security-center-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-security-center-Service-State`.
