# Windows LAPS Operational Events Event

## Summary

Exports a local Windows LAPS Operational Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-laps-operational-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformlapsoperationaleventsEventSnapshot.json` |
...
| Script file | `Export-BP-laps-operational-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-laps-operational-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-laps-operational-events-Event-State`.
