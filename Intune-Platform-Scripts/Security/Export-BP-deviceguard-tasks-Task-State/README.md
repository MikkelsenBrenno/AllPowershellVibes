# Device Guard Tasks Task

## Summary

Exports a local Device Guard Tasks scheduled task troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-deviceguard-tasks-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdeviceguardtasksTaskSnapshot.json` |
...
| Script file | `Export-BP-deviceguard-tasks-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-deviceguard-tasks-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-deviceguard-tasks-Task-State`.
