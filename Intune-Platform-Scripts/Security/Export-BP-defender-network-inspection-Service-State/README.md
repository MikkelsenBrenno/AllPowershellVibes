...
Exports a local Defender Network Inspection service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-defender-network-inspection-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdefendernetworkinspectionServiceSnapshot.json` |
...
| Script file | `Export-BP-defender-network-inspection-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-defender-network-inspection-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-defender-network-inspection-Service-State`.
