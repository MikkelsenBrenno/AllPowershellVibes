...
Exports a local Remote Registry service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-remote-registry-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformremoteregistryServiceSnapshot.json` |
...
| Script file | `Export-BP-remote-registry-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-remote-registry-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-remote-registry-Service-State`.
