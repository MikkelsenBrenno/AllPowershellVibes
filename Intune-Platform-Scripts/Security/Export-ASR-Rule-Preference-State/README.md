# Export ASR Rule Preference State

## Summary

Exports Microsoft Defender Attack Surface Reduction rule preference IDs, actions, and configured names for Business Premium troubleshooting.

## File

- `Export-ASR-Rule-Preference-State.ps1`
...
| `$OutputFileName` | Output file name. | `ASRRulePreferenceState.json` |
| `$KnownASRRuleNames` | Friendly names for common ASR rule IDs. | Common Microsoft Defender ASR rules |
...
| Script file | `Export-ASR-Rule-Preference-State.ps1` |
