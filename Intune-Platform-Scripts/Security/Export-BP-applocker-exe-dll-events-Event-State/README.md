# AppLocker EXE DLL Events Event

## Summary

Exports a local AppLocker EXE DLL Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-applocker-exe-dll-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformapplockerexedlleventsEventSnapshot.json` |
...
| Script file | `Export-BP-applocker-exe-dll-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-applocker-exe-dll-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-applocker-exe-dll-events-Event-State`.
