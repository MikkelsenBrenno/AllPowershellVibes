# Export Security Center Product State

## Summary

Exports Windows Security Center antivirus and firewall product state for quick third-party security product troubleshooting.

## File

- `Export-Security-Center-Product-State.ps1`
...
| `$OutputFileName` | Output file name. | `SecurityCenterProductState.json` |
| `$SecurityCenterNamespace` | WMI namespace used for Windows Security Center product inventory. | `root\SecurityCenter2` |
...
| Script file | `Export-Security-Center-Product-State.ps1` |
