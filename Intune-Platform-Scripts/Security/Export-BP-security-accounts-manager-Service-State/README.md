...
Exports a local Security Accounts Manager service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-security-accounts-manager-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformsecurityaccountsmanagerServiceSnapshot.json` |
...
| Script file | `Export-BP-security-accounts-manager-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-security-accounts-manager-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-security-accounts-manager-Service-State`.
