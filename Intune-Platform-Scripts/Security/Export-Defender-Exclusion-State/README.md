# Export Defender Exclusion State

## Summary

Exports Microsoft Defender exclusion paths, processes, extensions, and IP addresses to help technicians find risky local exclusions.

## File

- `Export-Defender-Exclusion-State.ps1`
...
| `$OutputFileName` | Output file name. | `DefenderExclusionState.json` |
| `$IncludeEmptyCollections` | Keeps empty exclusion arrays visible in JSON. | `$true` |
...
| Script file | `Export-Defender-Exclusion-State.ps1` |
