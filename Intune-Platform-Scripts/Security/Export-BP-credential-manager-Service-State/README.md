...
Exports a local Credential Manager service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-credential-manager-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformcredentialmanagerServiceSnapshot.json` |
...
| Script file | `Export-BP-credential-manager-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-credential-manager-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-credential-manager-Service-State`.
