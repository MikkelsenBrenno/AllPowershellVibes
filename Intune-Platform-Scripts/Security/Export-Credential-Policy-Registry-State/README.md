# Export Credential Policy Registry State

## Summary

Exports credential hardening policy values such as WDigest, LM hash storage, and LSA protection.

## File

- `Export-Credential-Policy-Registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `CredentialPolicyRegistryState.json` |
...
| Script file | `Export-Credential-Policy-Registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Credential-Policy-Registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Credential-Policy-Registry-State`.
