# Application Experience Tasks Task

## Summary

Exports a local Application Experience Tasks scheduled task troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-application-experience-tasks-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformapplicationexperiencetasksTaskSnapshot.json` |
| `$CollectionMode` | Collection mode used by this script. | `Task` |
| `$TaskPathPrefix` | Scheduled task path prefix to search. | Package-specific |
| `$TaskNamePatterns` | Wildcard filters for task path/name. | Package-specific |
...
| Script file | `Export-BP-application-experience-tasks-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-application-experience-tasks-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-application-experience-tasks-Task-State`.
