# Code Integrity Operational Events Event

## Summary

Exports a local Code Integrity Operational Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-codeintegrity-operational-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformcodeintegrityoperationaleventsEventSnapshot.json` |
...
| Script file | `Export-BP-codeintegrity-operational-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-codeintegrity-operational-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-codeintegrity-operational-events-Event-State`.
