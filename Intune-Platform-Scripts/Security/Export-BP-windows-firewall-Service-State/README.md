...
Exports a local Windows Firewall service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-firewall-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowsfirewallServiceSnapshot.json` |
...
| Script file | `Export-BP-windows-firewall-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-firewall-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-firewall-Service-State`.
