# Defender Scheduled Tasks Task

## Summary

Exports a local Defender Scheduled Tasks scheduled task troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-defender-scheduled-tasks-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdefenderscheduledtasksTaskSnapshot.json` |
...
| Script file | `Export-BP-defender-scheduled-tasks-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-defender-scheduled-tasks-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-defender-scheduled-tasks-Task-State`.
