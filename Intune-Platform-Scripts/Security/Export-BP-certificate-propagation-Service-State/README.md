...
Exports a local Certificate Propagation service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-certificate-propagation-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformcertificatepropagationServiceSnapshot.json` |
...
| Script file | `Export-BP-certificate-propagation-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-certificate-propagation-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-certificate-propagation-Service-State`.
