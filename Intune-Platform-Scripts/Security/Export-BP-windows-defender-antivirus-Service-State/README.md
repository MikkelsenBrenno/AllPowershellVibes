...
Exports a local Windows Defender Antivirus service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-defender-antivirus-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowsdefenderantivirusServiceSnapshot.json` |
...
| Script file | `Export-BP-windows-defender-antivirus-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-defender-antivirus-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-defender-antivirus-Service-State`.
