# Defender Operational Events Event

## Summary

Exports a local Defender Operational Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-defender-operational-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformdefenderoperationaleventsEventSnapshot.json` |
...
| Script file | `Export-BP-defender-operational-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-defender-operational-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-defender-operational-events-Event-State`.
