<#
.SYNOPSIS
    Exports Certificate Service Snapshot state.

.DESCRIPTION
    Exports Certificate Service Snapshot state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-Certificate-Service-Snapshot-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Certificate-Service-Snapshot-State'
$ScriptName = 'Export-Certificate-Service-Snapshot-State'

$ManagedItemName = 'Certificate Service Snapshot'
$InventoryRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory\Inventory-Reporting'
$InventoryFileName = 'certificate-service-snapshot-snapshot.json'
$EvidenceRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$EvidenceFileName = 'certificate-service-snapshot.state'
