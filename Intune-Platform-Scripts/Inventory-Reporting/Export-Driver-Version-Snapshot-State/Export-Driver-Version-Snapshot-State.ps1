<#
.SYNOPSIS
    Exports Driver Version Snapshot state.

.DESCRIPTION
    Exports Driver Version Snapshot state to a local JSON troubleshooting snapshot.

.NOTES
    Name:        Export-Driver-Version-Snapshot-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Driver-Version-Snapshot-State'
$ScriptName = 'Export-Driver-Version-Snapshot-State'

$ManagedItemName = 'Driver Version Snapshot'
$InventoryRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory\Inventory-Reporting'
$InventoryFileName = 'driver-version-snapshot-snapshot.json'
$EvidenceRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$EvidenceFileName = 'driver-version-snapshot.state'
