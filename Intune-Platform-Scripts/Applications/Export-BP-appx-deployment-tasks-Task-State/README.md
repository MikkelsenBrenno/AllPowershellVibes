# AppX Deployment Tasks Task

## Summary

Exports a local AppX Deployment Tasks scheduled task troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-appx-deployment-tasks-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformappxdeploymenttasksTaskSnapshot.json` |
...
| Script file | `Export-BP-appx-deployment-tasks-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-appx-deployment-tasks-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-appx-deployment-tasks-Task-State`.
