# Company Portal Cache Folder

## Summary

Exports a local Company Portal Cache folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-company-portal-cache-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformcompanyportalcacheFolderSnapshot.json` |
...
| Script file | `Export-BP-company-portal-cache-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-company-portal-cache-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-company-portal-cache-Folder-State`.
