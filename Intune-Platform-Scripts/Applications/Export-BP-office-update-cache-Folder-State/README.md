# Office Update Cache Folder

## Summary

Exports a local Office Update Cache folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-office-update-cache-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformofficeupdatecacheFolderSnapshot.json` |
...
| Script file | `Export-BP-office-update-cache-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-office-update-cache-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-office-update-cache-Folder-State`.
