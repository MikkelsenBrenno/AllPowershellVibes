# Export Company Portal Install Details

## Summary

Exports Company Portal app package and Store-related install evidence for technicians troubleshooting app availability.

## File

- `Export-Company-Portal-Install-Details.ps1`
...
| `$OutputFileName` | Output file name. | `CompanyPortalInstallDetails.json` |
| `$CompanyPortalPackageName` | Company Portal package name to query. | `Microsoft.CompanyPortal` |
| `$StoreAppPackageName` | Microsoft Store package name to query. | `Microsoft.WindowsStore` |
...
| Script file | `Export-Company-Portal-Install-Details.ps1` |
