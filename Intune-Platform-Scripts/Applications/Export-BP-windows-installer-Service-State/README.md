...
Exports a local Windows Installer service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-windows-installer-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwindowsinstallerServiceSnapshot.json` |
...
| Script file | `Export-BP-windows-installer-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-installer-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-windows-installer-Service-State`.
