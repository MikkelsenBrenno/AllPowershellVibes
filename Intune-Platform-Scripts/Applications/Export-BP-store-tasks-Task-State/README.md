# Microsoft Store Tasks Task

## Summary

Exports a local Microsoft Store Tasks scheduled task troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-store-tasks-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformstoretasksTaskSnapshot.json` |
...
| Script file | `Export-BP-store-tasks-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-store-tasks-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-store-tasks-Task-State`.
