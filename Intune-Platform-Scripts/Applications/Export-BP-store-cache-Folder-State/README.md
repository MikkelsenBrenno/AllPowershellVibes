# Microsoft Store Cache Folder

## Summary

Exports a local Microsoft Store Cache folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-store-cache-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformstorecacheFolderSnapshot.json` |
...
| Script file | `Export-BP-store-cache-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-store-cache-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-store-cache-Folder-State`.
