# Export Teams Policy Registry State

## Summary

Exports common Microsoft Teams policy registry values for client deployment and user experience troubleshooting.

## File

- `Export-Teams-Policy-Registry-State.ps1`
...
| `$OutputFileName` | Output file name. | `TeamsPolicyRegistryState.json` |
...
| Script file | `Export-Teams-Policy-Registry-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Teams-Policy-Registry-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Teams-Policy-Registry-State`.
