<#
.SYNOPSIS
    Exports Teams Machine Installer Folder state.

.DESCRIPTION
    Intune platform script that exports teams machine installer folder state to a local JSON file for Business Premium troubleshooting.

.NOTES
    Name:        Export-BP-teams-machine-installer-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BP-teams-machine-installer-Folder-State'
$ScriptName = 'Export-BP-teams-machine-installer-Folder-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'BPPlatformteamsmachineinstallerFolderSnapshot.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Teams Machine Installer folder size snapshot for technician troubleshooting.'
