# Teams Machine Installer Folder

## Summary

Exports a local Teams Machine Installer folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-teams-machine-installer-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformteamsmachineinstallerFolderSnapshot.json` |
...
| Script file | `Export-BP-teams-machine-installer-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-teams-machine-installer-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-teams-machine-installer-Folder-State`.
