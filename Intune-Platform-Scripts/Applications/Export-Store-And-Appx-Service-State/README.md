# Export Store And Appx Service State

## Summary

Exports Microsoft Store and AppX deployment service state for app install troubleshooting.

## File

- `Export-Store-And-Appx-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `StoreAndAppxServiceState.json` |
...
| Script file | `Export-Store-And-Appx-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Store-And-Appx-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Store-And-Appx-Service-State`.
