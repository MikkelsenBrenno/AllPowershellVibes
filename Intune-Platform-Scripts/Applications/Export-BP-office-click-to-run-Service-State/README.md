# Office Click To Run Service

## Summary

Exports a local Office Click To Run service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-office-click-to-run-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformofficeclicktorunServiceSnapshot.json` |
...
| Script file | `Export-BP-office-click-to-run-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-office-click-to-run-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-office-click-to-run-Service-State`.
