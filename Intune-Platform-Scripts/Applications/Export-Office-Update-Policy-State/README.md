# Export Office Update Policy State

## Summary

Exports Microsoft 365 Apps update policy values for channel, update path, and automatic update troubleshooting.

## File

- `Export-Office-Update-Policy-State.ps1`
...
| `$OutputFileName` | Output file name. | `OfficeUpdatePolicyState.json` |
...
| Script file | `Export-Office-Update-Policy-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Office-Update-Policy-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-Office-Update-Policy-State`.
