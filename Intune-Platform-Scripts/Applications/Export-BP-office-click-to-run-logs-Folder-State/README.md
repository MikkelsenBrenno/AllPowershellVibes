# Office Click To Run Logs Folder

## Summary

Exports a local Office Click To Run Logs folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-office-click-to-run-logs-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformofficeclicktorunlogsFolderSnapshot.json` |
...
| Script file | `Export-BP-office-click-to-run-logs-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-office-click-to-run-logs-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-office-click-to-run-logs-Folder-State`.
