<#
.SYNOPSIS
    Exports Office Click To Run Logs Folder state.

.DESCRIPTION
    Intune platform script that exports office click to run logs folder state to a local JSON file for Business Premium troubleshooting.

.NOTES
    Name:        Export-BP-office-click-to-run-logs-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BP-office-click-to-run-logs-Folder-State'
$ScriptName = 'Export-BP-office-click-to-run-logs-Folder-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'BPPlatformofficeclicktorunlogsFolderSnapshot.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Office Click To Run Logs folder size snapshot for technician troubleshooting.'
