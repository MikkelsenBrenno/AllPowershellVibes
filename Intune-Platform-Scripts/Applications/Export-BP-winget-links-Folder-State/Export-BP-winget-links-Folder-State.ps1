<#
.SYNOPSIS
    Exports WinGet Links Folder state.

.DESCRIPTION
    Intune platform script that exports winget links folder state to a local JSON file for Business Premium troubleshooting.

.NOTES
    Name:        Export-BP-winget-links-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BP-winget-links-Folder-State'
$ScriptName = 'Export-BP-winget-links-Folder-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'BPPlatformwingetlinksFolderSnapshot.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'WinGet Links folder size snapshot for technician troubleshooting.'
