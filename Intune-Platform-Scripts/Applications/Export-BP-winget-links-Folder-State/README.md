...
Exports a local WinGet Links folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-winget-links-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformwingetlinksFolderSnapshot.json` |
...
| Script file | `Export-BP-winget-links-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-winget-links-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-winget-links-Folder-State`.
