# Office Maintenance Tasks Task

## Summary

Exports a local Office Maintenance Tasks scheduled task troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-office-maintenance-tasks-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformofficemaintenancetasksTaskSnapshot.json` |
...
| Script file | `Export-BP-office-maintenance-tasks-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-office-maintenance-tasks-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-office-maintenance-tasks-Task-State`.
