...
Exports a local AppX Deployment service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-appx-deployment-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformappxdeploymentServiceSnapshot.json` |
...
| Script file | `Export-BP-appx-deployment-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-appx-deployment-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-appx-deployment-Service-State`.
