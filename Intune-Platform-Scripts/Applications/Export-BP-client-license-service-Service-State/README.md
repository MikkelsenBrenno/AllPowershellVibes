# Client License Service Service

## Summary

Exports a local Client License Service service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-client-license-service-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformclientlicenseserviceServiceSnapshot.json` |
| `$CollectionMode` | Collection mode used by this script. | `Service` |
| `$ServiceNames` | Windows service names to export. | Package-specific |
...
| Script file | `Export-BP-client-license-service-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-client-license-service-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-client-license-service-Service-State`.
