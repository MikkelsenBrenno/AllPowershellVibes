...
Exports a local Microsoft Store Install service state troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-microsoft-store-install-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformmicrosoftstoreinstallServiceSnapshot.json` |
...
| Script file | `Export-BP-microsoft-store-install-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-microsoft-store-install-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-microsoft-store-install-Service-State`.
