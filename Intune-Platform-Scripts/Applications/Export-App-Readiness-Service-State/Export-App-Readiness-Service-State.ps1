...
.DESCRIPTION
    Intune platform script that captures App Readiness service details.

.NOTES
    Name:        Export-App-Readiness-Service-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-App-Readiness-Service-State'
$ScriptName = 'Export-App-Readiness-Service-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'AppReadinessServiceState.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'App Readiness service state snapshot.'
