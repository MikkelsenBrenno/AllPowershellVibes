# Export App Readiness Service State

## Summary

Exports App Readiness service state for packaged app and first sign-in troubleshooting.

## File

- `Export-App-Readiness-Service-State.ps1`
...
| `$OutputFileName` | Output file name. | `AppReadinessServiceState.json` |
...
| Script file | `Export-App-Readiness-Service-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-App-Readiness-Service-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-App-Readiness-Service-State`.
