# AppX Deployment Events Event

## Summary

Exports a local AppX Deployment Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-appx-deployment-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformappxdeploymenteventsEventSnapshot.json` |
...
| Script file | `Export-BP-appx-deployment-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-appx-deployment-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-appx-deployment-events-Event-State`.
