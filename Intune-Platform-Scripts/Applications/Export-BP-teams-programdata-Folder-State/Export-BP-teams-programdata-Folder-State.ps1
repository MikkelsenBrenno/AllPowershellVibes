<#
.SYNOPSIS
    Exports Teams ProgramData Folder state.

.DESCRIPTION
    Intune platform script that exports teams programdata folder state to a local JSON file for Business Premium troubleshooting.

.NOTES
    Name:        Export-BP-teams-programdata-Folder-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-BP-teams-programdata-Folder-State'
$ScriptName = 'Export-BP-teams-programdata-Folder-State'

$OutputRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\Inventory'
$OutputFileName = 'BPPlatformteamsprogramdataFolderSnapshot.json'
$JsonDepth = 8
...
$TaskNamePatterns = @()
$TaskPathPrefix = '\'
$SnapshotNote = 'Teams ProgramData folder size snapshot for technician troubleshooting.'
