# Teams ProgramData Folder

## Summary

Exports a local Teams ProgramData folder usage troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-teams-programdata-Folder-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformteamsprogramdataFolderSnapshot.json` |
...
| Script file | `Export-BP-teams-programdata-Folder-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-teams-programdata-Folder-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-teams-programdata-Folder-State`.
