# Export M365 App Repair Task State

## Summary

Exports Office and Click-to-Run scheduled task state for update and repair troubleshooting.

## File

- `Export-M365-App-Repair-Task-State.ps1`
...
| `$OutputFileName` | Output file name. | `M365AppRepairTaskState.json` |
...
| Script file | `Export-M365-App-Repair-Task-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-M365-App-Repair-Task-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-M365-App-Repair-Task-State`.
