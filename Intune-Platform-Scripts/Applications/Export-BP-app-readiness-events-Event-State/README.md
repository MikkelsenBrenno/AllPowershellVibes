# App Readiness Events Event

## Summary

Exports a local App Readiness Events event log troubleshooting snapshot for technician troubleshooting.

## File

- `Export-BP-app-readiness-events-Event-State.ps1`
...
| `$OutputFileName` | Output file name. | `BPPlatformappreadinesseventsEventSnapshot.json` |
...
| Script file | `Export-BP-app-readiness-events-Event-State.ps1` |
...
- Logs are written under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-app-readiness-events-Event-State`.

## Troubleshooting

- Review the script log under `C:\ProgramData\Microsoft\IntuneScriptLibrary\Logs\Export-BP-app-readiness-events-Event-State`.
