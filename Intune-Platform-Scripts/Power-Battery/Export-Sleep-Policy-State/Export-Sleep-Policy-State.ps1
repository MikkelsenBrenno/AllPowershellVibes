<#
.SYNOPSIS
    Exports Sleep Policy state.

.DESCRIPTION
    Exports Sleep Policy state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Sleep-Policy-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Sleep-Policy-State'
$ScriptName = 'Export-Sleep-Policy-State'
...
$ReportFileName = 'export-sleep-policy-state.json'
