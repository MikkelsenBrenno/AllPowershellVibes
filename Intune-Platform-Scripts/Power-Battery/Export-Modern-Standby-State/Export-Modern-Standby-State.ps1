<#
.SYNOPSIS
    Exports Modern Standby state.

.DESCRIPTION
    Exports Modern Standby state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Modern-Standby-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Modern-Standby-State'
$ScriptName = 'Export-Modern-Standby-State'
...
$ReportFileName = 'export-modern-standby-state.json'
