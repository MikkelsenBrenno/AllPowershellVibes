<#
.SYNOPSIS
    Exports Lid Action state.

.DESCRIPTION
    Exports Lid Action state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Lid-Action-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Lid-Action-State'
$ScriptName = 'Export-Lid-Action-State'
...
$ReportFileName = 'export-lid-action-state.json'
