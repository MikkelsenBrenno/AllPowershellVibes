<#
.SYNOPSIS
    Exports Hibernate State state.

.DESCRIPTION
    Exports Hibernate State state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Hibernate-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Hibernate-State'
$ScriptName = 'Export-Hibernate-State'
...
$ReportFileName = 'export-hibernate-state.json'
