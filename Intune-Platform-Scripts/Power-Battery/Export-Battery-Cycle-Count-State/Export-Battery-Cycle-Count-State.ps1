<#
.SYNOPSIS
    Exports Battery Cycle Count state.

.DESCRIPTION
    Exports Battery Cycle Count state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Battery-Cycle-Count-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Battery-Cycle-Count-State'
$ScriptName = 'Export-Battery-Cycle-Count-State'
...
$ReportFileName = 'export-battery-cycle-count-state.json'
