<#
.SYNOPSIS
    Exports Power Plan state.

.DESCRIPTION
    Exports Power Plan state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-Power-Plan-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-Power-Plan-State'
$ScriptName = 'Export-Power-Plan-State'
...
$ReportFileName = 'export-power-plan-state.json'
