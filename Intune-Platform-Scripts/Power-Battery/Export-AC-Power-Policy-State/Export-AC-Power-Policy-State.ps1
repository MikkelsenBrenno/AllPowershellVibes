<#
.SYNOPSIS
    Exports AC Power Policy state.

.DESCRIPTION
    Exports AC Power Policy state to a local JSON report for Intune platform script use.

.NOTES
    Name:        Export-AC-Power-Policy-State.ps1
    Version:     1.0.0
...
$ScriptPackageName = 'Export-AC-Power-Policy-State'
$ScriptName = 'Export-AC-Power-Policy-State'
...
$ReportFileName = 'export-ac-power-policy-state.json'
