<#
.SYNOPSIS
    Discovers Sensitive Data Share compliance state.

.DESCRIPTION
    Discovers Sensitive Data Share state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Sensitive-Data-Share-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Sensitive Data Share'
$PurposeCategory = 'Data-Protection'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Data-Protection'
$MarkerFileName = 'check-sensitive-data-share-state.state'
