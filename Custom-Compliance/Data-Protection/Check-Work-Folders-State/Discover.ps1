<#
.SYNOPSIS
    Discovers Work Folders compliance state.

.DESCRIPTION
    Discovers Work Folders state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Work-Folders-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-work-folders-state.state'
