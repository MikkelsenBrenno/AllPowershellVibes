<#
.SYNOPSIS
    Discovers Clipboard Policy compliance state.

.DESCRIPTION
    Discovers Clipboard Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Clipboard-Policy-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-clipboard-policy-state.state'
