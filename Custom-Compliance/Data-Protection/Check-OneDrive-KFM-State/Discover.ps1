<#
.SYNOPSIS
    Discovers OneDrive KFM compliance state.

.DESCRIPTION
    Discovers OneDrive KFM state for Intune custom compliance evaluation.
...
$MarkerFileName = 'check-onedrive-kfm-state.state'
