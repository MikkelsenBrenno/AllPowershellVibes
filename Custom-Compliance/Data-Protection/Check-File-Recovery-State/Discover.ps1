<#
.SYNOPSIS
    Discovers File Recovery compliance state.

.DESCRIPTION
    Discovers File Recovery state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-File-Recovery-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-file-recovery-state.state'
