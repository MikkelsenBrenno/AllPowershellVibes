<#
.SYNOPSIS
    Discovers Removable Storage compliance state.

.DESCRIPTION
    Discovers Removable Storage state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Removable-Storage-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-removable-storage-state.state'
