<#
.SYNOPSIS
    Discovers Protected Folder compliance state.

.DESCRIPTION
    Discovers Protected Folder state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Protected-Folder-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-protected-folder-state.state'
