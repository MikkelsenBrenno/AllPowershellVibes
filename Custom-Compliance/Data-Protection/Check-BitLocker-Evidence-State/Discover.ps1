<#
.SYNOPSIS
    Discovers BitLocker Evidence compliance state.

.DESCRIPTION
    Discovers BitLocker Evidence state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-BitLocker-Evidence-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-bitlocker-evidence-state.state'
