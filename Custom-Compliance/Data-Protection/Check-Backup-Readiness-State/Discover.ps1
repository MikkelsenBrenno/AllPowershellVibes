<#
.SYNOPSIS
    Discovers Backup Readiness compliance state.

.DESCRIPTION
    Discovers Backup Readiness state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Backup-Readiness-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-backup-readiness-state.state'
