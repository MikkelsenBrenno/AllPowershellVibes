<#
.SYNOPSIS
    Discovers Controlled Folder compliance state.

.DESCRIPTION
    Discovers Controlled Folder state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Controlled-Folder-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-controlled-folder-state.state'
