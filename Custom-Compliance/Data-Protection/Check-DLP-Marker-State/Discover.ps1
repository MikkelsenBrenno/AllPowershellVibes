<#
.SYNOPSIS
    Discovers DLP Marker compliance state.

.DESCRIPTION
    Discovers DLP Marker state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-DLP-Marker-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-dlp-marker-state.state'
