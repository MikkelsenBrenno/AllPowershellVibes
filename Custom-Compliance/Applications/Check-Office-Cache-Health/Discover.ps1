<#
.SYNOPSIS
    Discovers Office Cache Health compliance state.

.DESCRIPTION
    Discovers Office Cache Health state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Office-Cache-Health'
$ScriptName = 'Discover'

$ManagedItemName = 'Office Cache Health'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Applications'
$MarkerFileName = 'office-cache-health.state'
