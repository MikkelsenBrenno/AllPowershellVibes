<#
.SYNOPSIS
    Discovers Office Policy State compliance state.

.DESCRIPTION
    Discovers Office Policy State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Office-Policy-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Office Policy State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Applications'
$MarkerFileName = 'office-policy-state.state'
