<#
.SYNOPSIS
    Discovers Office Update State compliance state.

.DESCRIPTION
    Discovers Office Update State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Office-Update-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Office Update State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Applications'
$MarkerFileName = 'office-update-state.state'
