<#
.SYNOPSIS
    Discovers Defender Policy State compliance state.

.DESCRIPTION
    Discovers Defender Policy State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Defender-Policy-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Defender Policy State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Compliance'
$MarkerFileName = 'defender-policy-state.state'
