<#
.SYNOPSIS
    Discovers BitLocker Readiness State compliance state.

.DESCRIPTION
    Discovers BitLocker Readiness State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-BitLocker-Readiness-State'
$ScriptName = 'Discover'

$ManagedItemName = 'BitLocker Readiness State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Compliance'
$MarkerFileName = 'bitlocker-readiness-state.state'
