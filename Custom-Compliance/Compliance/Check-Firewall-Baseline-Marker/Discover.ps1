<#
.SYNOPSIS
    Discovers Firewall Baseline Marker compliance state.
...
$ScriptPackageName = 'Check-Firewall-Baseline-Marker'
$ScriptName = 'Discover'

$ManagedItemName = 'Firewall Baseline Marker'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Compliance'
$MarkerFileName = 'firewall-baseline-marker.state'
