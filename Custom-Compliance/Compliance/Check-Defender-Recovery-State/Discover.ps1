<#
.SYNOPSIS
    Discovers Defender Recovery State compliance state.

.DESCRIPTION
    Discovers Defender Recovery State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Defender-Recovery-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Defender Recovery State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Compliance'
$MarkerFileName = 'defender-recovery-state.state'
