<#
.SYNOPSIS
    Discovers Defender Baseline Marker compliance state.

.DESCRIPTION
    Discovers Defender Baseline Marker state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Defender-Baseline-Marker'
$ScriptName = 'Discover'

$ManagedItemName = 'Defender Baseline Marker'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Compliance'
$MarkerFileName = 'defender-baseline-marker.state'
