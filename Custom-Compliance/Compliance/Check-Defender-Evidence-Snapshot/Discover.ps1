<#
.SYNOPSIS
    Discovers Defender Evidence Snapshot compliance state.

.DESCRIPTION
    Discovers Defender Evidence Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Defender-Evidence-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Defender Evidence Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Compliance'
$MarkerFileName = 'defender-evidence-snapshot.state'
