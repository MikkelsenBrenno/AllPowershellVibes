<#
.SYNOPSIS
    Discovers Defender Readiness State compliance state.

.DESCRIPTION
    Discovers Defender Readiness State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Defender-Readiness-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Defender Readiness State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Compliance'
$MarkerFileName = 'defender-readiness-state.state'
