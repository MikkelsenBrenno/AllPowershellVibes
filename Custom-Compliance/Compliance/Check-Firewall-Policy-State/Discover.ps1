<#
.SYNOPSIS
    Discovers Firewall Policy State compliance state.

.DESCRIPTION
    Discovers Firewall Policy State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Firewall-Policy-State'
$ScriptName = 'Discover'
