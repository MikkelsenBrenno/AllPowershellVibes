<#
.SYNOPSIS
    Discovers Licensing Service compliance state.

.DESCRIPTION
    Discovers Licensing Service state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Licensing-Service-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-licensing-service-state.state'
