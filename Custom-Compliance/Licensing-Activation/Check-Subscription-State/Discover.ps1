<#
.SYNOPSIS
    Discovers Subscription State compliance state.

.DESCRIPTION
    Discovers Subscription State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Subscription-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-subscription-state.state'
