<#
.SYNOPSIS
    Discovers Windows Activation compliance state.

.DESCRIPTION
    Discovers Windows Activation state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Windows-Activation-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-windows-activation-state.state'
