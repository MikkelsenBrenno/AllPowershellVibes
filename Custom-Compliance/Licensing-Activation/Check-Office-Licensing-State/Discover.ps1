<#
.SYNOPSIS
    Discovers Office Licensing compliance state.

.DESCRIPTION
    Discovers Office Licensing state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Office-Licensing-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-office-licensing-state.state'
