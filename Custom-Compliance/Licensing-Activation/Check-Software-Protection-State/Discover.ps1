<#
.SYNOPSIS
    Discovers Software Protection compliance state.

.DESCRIPTION
    Discovers Software Protection state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Software-Protection-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Software Protection'
$PurposeCategory = 'Licensing-Activation'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Licensing-Activation'
$MarkerFileName = 'check-software-protection-state.state'
