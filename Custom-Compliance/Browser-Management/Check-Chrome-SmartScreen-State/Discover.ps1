<#
.SYNOPSIS
    Discovers Chrome SmartScreen State compliance state.

.DESCRIPTION
    Discovers Chrome SmartScreen State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chrome-SmartScreen-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Chrome SmartScreen State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'chrome-smartscreen-state.state'
