<#
.SYNOPSIS
    Discovers Chrome Cache Health compliance state.

.DESCRIPTION
    Discovers Chrome Cache Health state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chrome-Cache-Health'
$ScriptName = 'Discover'

$ManagedItemName = 'Chrome Cache Health'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'chrome-cache-health.state'
