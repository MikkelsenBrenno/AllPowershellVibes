<#
.SYNOPSIS
    Discovers Chrome Extension Policy compliance state.

.DESCRIPTION
    Discovers Chrome Extension Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chrome-Extension-Policy'
$ScriptName = 'Discover'

$ManagedItemName = 'Chrome Extension Policy'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'chrome-extension-policy.state'
