<#
.SYNOPSIS
    Discovers Chrome Password Manager compliance state.

.DESCRIPTION
    Discovers Chrome Password Manager state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chrome-Password-Manager'
$ScriptName = 'Discover'

$ManagedItemName = 'Chrome Password Manager'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'chrome-password-manager.state'
