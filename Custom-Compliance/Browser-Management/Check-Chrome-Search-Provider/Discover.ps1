<#
.SYNOPSIS
    Discovers Chrome Search Provider compliance state.

.DESCRIPTION
    Discovers Chrome Search Provider state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chrome-Search-Provider'
$ScriptName = 'Discover'

$ManagedItemName = 'Chrome Search Provider'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'chrome-search-provider.state'
