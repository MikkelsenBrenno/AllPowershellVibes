<#
.SYNOPSIS
    Discovers Chrome Update Policy compliance state.

.DESCRIPTION
    Discovers Chrome Update Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chrome-Update-Policy'
$ScriptName = 'Discover'

$ManagedItemName = 'Chrome Update Policy'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'chrome-update-policy.state'
