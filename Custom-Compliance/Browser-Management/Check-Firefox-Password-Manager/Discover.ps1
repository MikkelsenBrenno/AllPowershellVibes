<#
.SYNOPSIS
    Discovers Firefox Password Manager compliance state.

.DESCRIPTION
    Discovers Firefox Password Manager state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Firefox-Password-Manager'
$ScriptName = 'Discover'

$ManagedItemName = 'Firefox Password Manager'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'firefox-password-manager.state'
