<#
.SYNOPSIS
    Discovers Firefox Homepage Policy compliance state.

.DESCRIPTION
    Discovers Firefox Homepage Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Firefox-Homepage-Policy'
$ScriptName = 'Discover'

$ManagedItemName = 'Firefox Homepage Policy'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'firefox-homepage-policy.state'
