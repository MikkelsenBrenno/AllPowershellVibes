<#
.SYNOPSIS
    Discovers Chrome Homepage Policy compliance state.

.DESCRIPTION
    Discovers Chrome Homepage Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chrome-Homepage-Policy'
$ScriptName = 'Discover'

$ManagedItemName = 'Chrome Homepage Policy'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'chrome-homepage-policy.state'
