<#
.SYNOPSIS
    Discovers Firefox Extension Policy compliance state.

.DESCRIPTION
    Discovers Firefox Extension Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Firefox-Extension-Policy'
$ScriptName = 'Discover'

$ManagedItemName = 'Firefox Extension Policy'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'firefox-extension-policy.state'
