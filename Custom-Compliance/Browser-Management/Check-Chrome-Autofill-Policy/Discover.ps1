<#
.SYNOPSIS
    Discovers Chrome Autofill Policy compliance state.

.DESCRIPTION
    Discovers Chrome Autofill Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chrome-Autofill-Policy'
$ScriptName = 'Discover'

$ManagedItemName = 'Chrome Autofill Policy'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'chrome-autofill-policy.state'
