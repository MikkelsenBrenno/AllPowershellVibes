<#
.SYNOPSIS
    Discovers Chrome Profile SignIn compliance state.

.DESCRIPTION
    Discovers Chrome Profile SignIn state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chrome-Profile-SignIn'
$ScriptName = 'Discover'

$ManagedItemName = 'Chrome Profile SignIn'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'chrome-profile-signin.state'
