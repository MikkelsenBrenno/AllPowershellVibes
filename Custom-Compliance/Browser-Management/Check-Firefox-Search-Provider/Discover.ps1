<#
.SYNOPSIS
    Discovers Firefox Search Provider compliance state.

.DESCRIPTION
    Discovers Firefox Search Provider state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Firefox-Search-Provider'
$ScriptName = 'Discover'

$ManagedItemName = 'Firefox Search Provider'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'firefox-search-provider.state'
