<#
.SYNOPSIS
    Discovers Firefox SmartScreen State compliance state.

.DESCRIPTION
    Discovers Firefox SmartScreen State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Firefox-SmartScreen-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Firefox SmartScreen State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'firefox-smartscreen-state.state'
