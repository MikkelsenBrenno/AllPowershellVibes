<#
.SYNOPSIS
    Discovers Chrome Sync Policy compliance state.

.DESCRIPTION
    Discovers Chrome Sync Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chrome-Sync-Policy'
$ScriptName = 'Discover'

$ManagedItemName = 'Chrome Sync Policy'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'chrome-sync-policy.state'
