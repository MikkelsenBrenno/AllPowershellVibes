<#
.SYNOPSIS
    Discovers Chrome Download Restrictions compliance state.

.DESCRIPTION
    Discovers Chrome Download Restrictions state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chrome-Download-Restrictions'
$ScriptName = 'Discover'

$ManagedItemName = 'Chrome Download Restrictions'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'chrome-download-restrictions.state'
