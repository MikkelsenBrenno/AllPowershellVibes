<#
.SYNOPSIS
    Discovers Firefox Autofill Policy compliance state.

.DESCRIPTION
    Discovers Firefox Autofill Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Firefox-Autofill-Policy'
$ScriptName = 'Discover'

$ManagedItemName = 'Firefox Autofill Policy'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'firefox-autofill-policy.state'
