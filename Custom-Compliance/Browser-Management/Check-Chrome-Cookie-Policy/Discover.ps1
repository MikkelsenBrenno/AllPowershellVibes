<#
.SYNOPSIS
    Discovers Chrome Cookie Policy compliance state.

.DESCRIPTION
    Discovers Chrome Cookie Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chrome-Cookie-Policy'
$ScriptName = 'Discover'

$ManagedItemName = 'Chrome Cookie Policy'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Browser-Management'
$MarkerFileName = 'chrome-cookie-policy.state'
