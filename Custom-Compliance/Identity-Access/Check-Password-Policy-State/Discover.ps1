<#
.SYNOPSIS
    Discovers Password Policy compliance state.

.DESCRIPTION
    Discovers Password Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Password-Policy-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-password-policy-state.state'
