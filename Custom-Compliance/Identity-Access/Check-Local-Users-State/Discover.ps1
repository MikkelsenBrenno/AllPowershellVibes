<#
.SYNOPSIS
    Discovers Local Users compliance state.

.DESCRIPTION
    Discovers Local Users state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Local-Users-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-local-users-state.state'
