<#
.SYNOPSIS
    Discovers Windows Hello compliance state.

.DESCRIPTION
    Discovers Windows Hello state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Windows-Hello-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-windows-hello-state.state'
