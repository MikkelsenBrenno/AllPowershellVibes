<#
.SYNOPSIS
    Discovers Local Administrators compliance state.

.DESCRIPTION
    Discovers Local Administrators state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Local-Administrators-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Local Administrators'
$PurposeCategory = 'Identity-Access'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Identity-Access'
$MarkerFileName = 'check-local-administrators-state.state'
