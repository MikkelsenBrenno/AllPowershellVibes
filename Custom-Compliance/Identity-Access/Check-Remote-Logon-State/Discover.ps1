<#
.SYNOPSIS
    Discovers Remote Logon compliance state.

.DESCRIPTION
    Discovers Remote Logon state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Remote-Logon-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-remote-logon-state.state'
