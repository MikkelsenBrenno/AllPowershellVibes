<#
.SYNOPSIS
    Discovers Cached Logons compliance state.

.DESCRIPTION
    Discovers Cached Logons state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Cached-Logons-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-cached-logons-state.state'
