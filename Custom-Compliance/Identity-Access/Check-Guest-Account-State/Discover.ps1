<#
.SYNOPSIS
    Discovers Guest Account compliance state.

.DESCRIPTION
    Discovers Guest Account state for Intune custom compliance evaluation.
...
$MarkerFileName = 'check-guest-account-state.state'
