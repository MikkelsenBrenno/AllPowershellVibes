<#
.SYNOPSIS
    Discovers Account Lockout compliance state.

.DESCRIPTION
    Discovers Account Lockout state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Account-Lockout-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-account-lockout-state.state'
