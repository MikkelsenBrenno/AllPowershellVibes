<#
.SYNOPSIS
    Discovers Entra Join compliance state.

.DESCRIPTION
    Discovers Entra Join state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Entra-Join-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-entra-join-state.state'
