<#
.SYNOPSIS
    Discovers Workplace Join compliance state.

.DESCRIPTION
    Discovers Workplace Join state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Workplace-Join-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-workplace-join-state.state'
