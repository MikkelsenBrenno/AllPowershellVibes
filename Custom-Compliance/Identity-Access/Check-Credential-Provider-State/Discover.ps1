<#
.SYNOPSIS
    Discovers Credential Provider compliance state.

.DESCRIPTION
    Discovers Credential Provider state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Credential-Provider-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-credential-provider-state.state'
