<#
.SYNOPSIS
    Discovers Privacy Scheduled Task compliance state.

.DESCRIPTION
    Discovers Privacy Scheduled Task state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Privacy-Scheduled-Task'
$ScriptName = 'Discover'

$ManagedItemName = 'Privacy Scheduled Task'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Device-Configuration'
$MarkerFileName = 'privacy-scheduled-task.state'
