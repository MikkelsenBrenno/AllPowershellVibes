<#
.SYNOPSIS
    Discovers Locale Registry Marker compliance state.

.DESCRIPTION
    Discovers Locale Registry Marker state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Locale-Registry-Marker'
$ScriptName = 'Discover'

$ManagedItemName = 'Locale Registry Marker'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Device-Configuration'
$MarkerFileName = 'locale-registry-marker.state'
