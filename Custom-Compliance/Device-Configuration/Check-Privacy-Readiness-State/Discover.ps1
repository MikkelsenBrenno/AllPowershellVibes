<#
.SYNOPSIS
    Discovers Privacy Readiness State compliance state.

.DESCRIPTION
    Discovers Privacy Readiness State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Privacy-Readiness-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Privacy Readiness State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Device-Configuration'
$MarkerFileName = 'privacy-readiness-state.state'
