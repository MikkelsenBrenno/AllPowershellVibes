<#
.SYNOPSIS
    Discovers Privacy Policy State compliance state.

.DESCRIPTION
    Discovers Privacy Policy State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Privacy-Policy-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Privacy Policy State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Device-Configuration'
$MarkerFileName = 'privacy-policy-state.state'
