<#
.SYNOPSIS
    Discovers Privacy Configuration File compliance state.

.DESCRIPTION
    Discovers Privacy Configuration File state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Privacy-Configuration-File'
$ScriptName = 'Discover'

$ManagedItemName = 'Privacy Configuration File'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Device-Configuration'
$MarkerFileName = 'privacy-configuration-file.state'
