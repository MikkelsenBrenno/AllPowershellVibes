<#
.SYNOPSIS
    Discovers Locale Configuration File compliance state.

.DESCRIPTION
    Discovers Locale Configuration File state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Locale-Configuration-File'
$ScriptName = 'Discover'

$ManagedItemName = 'Locale Configuration File'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Device-Configuration'
$MarkerFileName = 'locale-configuration-file.state'
