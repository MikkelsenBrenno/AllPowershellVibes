<#
.SYNOPSIS
    Discovers Privacy Registry Marker compliance state.

.DESCRIPTION
    Discovers Privacy Registry Marker state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Privacy-Registry-Marker'
$ScriptName = 'Discover'

$ManagedItemName = 'Privacy Registry Marker'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Device-Configuration'
$MarkerFileName = 'privacy-registry-marker.state'
