<#
.SYNOPSIS
    Discovers Locale Policy State compliance state.

.DESCRIPTION
    Discovers Locale Policy State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Locale-Policy-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Locale Policy State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Device-Configuration'
$MarkerFileName = 'locale-policy-state.state'
