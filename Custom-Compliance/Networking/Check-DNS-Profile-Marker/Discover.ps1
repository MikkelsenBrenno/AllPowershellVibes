<#
.SYNOPSIS
    Discovers DNS Profile Marker compliance state.

.DESCRIPTION
    Discovers DNS Profile Marker state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-DNS-Profile-Marker'
$ScriptName = 'Discover'

$ManagedItemName = 'DNS Profile Marker'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Networking'
$MarkerFileName = 'dns-profile-marker.state'
