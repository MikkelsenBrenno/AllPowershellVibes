<#
.SYNOPSIS
    Discovers DNS Cache Health compliance state.

.DESCRIPTION
    Discovers DNS Cache Health state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-DNS-Cache-Health'
$ScriptName = 'Discover'

$ManagedItemName = 'DNS Cache Health'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Networking'
$MarkerFileName = 'dns-cache-health.state'
