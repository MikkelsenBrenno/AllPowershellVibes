<#
.SYNOPSIS
    Discovers Proxy Client State compliance state.

.DESCRIPTION
    Discovers Proxy Client State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Proxy-Client-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Proxy Client State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Networking'
$MarkerFileName = 'proxy-client-state.state'
