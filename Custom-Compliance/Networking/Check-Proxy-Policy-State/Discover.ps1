<#
.SYNOPSIS
    Discovers Proxy Policy State compliance state.

.DESCRIPTION
    Discovers Proxy Policy State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Proxy-Policy-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Proxy Policy State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Networking'
$MarkerFileName = 'proxy-policy-state.state'
