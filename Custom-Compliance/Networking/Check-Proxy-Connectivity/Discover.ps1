<#
.SYNOPSIS
    Discovers Proxy Connectivity compliance state.

.DESCRIPTION
    Discovers Proxy Connectivity state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Proxy-Connectivity'
$ScriptName = 'Discover'

$ManagedItemName = 'Proxy Connectivity'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Networking'
$MarkerFileName = 'proxy-connectivity.state'
