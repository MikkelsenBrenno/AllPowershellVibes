<#
.SYNOPSIS
    Discovers BitLocker Recovery Key compliance state.

.DESCRIPTION
    Discovers BitLocker Recovery Key state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-BitLocker-Recovery-Key-State'
$ScriptName = 'Discover'

$ManagedItemName = 'BitLocker Recovery Key'
$PurposeCategory = 'Backup-Recovery'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Backup-Recovery'
$MarkerFileName = 'check-bitlocker-recovery-key-state.state'
