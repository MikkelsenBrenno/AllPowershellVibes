<#
.SYNOPSIS
    Discovers BCD Health compliance state.

.DESCRIPTION
    Discovers BCD Health state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-BCD-Health-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-bcd-health-state.state'
