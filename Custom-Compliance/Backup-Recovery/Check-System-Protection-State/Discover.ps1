<#
.SYNOPSIS
    Discovers System Protection compliance state.

.DESCRIPTION
    Discovers System Protection state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-System-Protection-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-system-protection-state.state'
