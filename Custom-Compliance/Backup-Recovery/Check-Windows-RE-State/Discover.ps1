<#
.SYNOPSIS
    Discovers Windows RE compliance state.

.DESCRIPTION
    Discovers Windows RE state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Windows-RE-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-windows-re-state.state'
