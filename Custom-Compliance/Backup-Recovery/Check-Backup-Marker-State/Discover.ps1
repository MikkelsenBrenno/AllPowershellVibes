<#
.SYNOPSIS
    Discovers Backup Marker compliance state.

.DESCRIPTION
    Discovers Backup Marker state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Backup-Marker-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-backup-marker-state.state'
