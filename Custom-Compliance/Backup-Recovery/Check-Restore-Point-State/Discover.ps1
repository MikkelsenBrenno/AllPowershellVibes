<#
.SYNOPSIS
    Discovers Restore Point compliance state.

.DESCRIPTION
    Discovers Restore Point state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Restore-Point-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-restore-point-state.state'
