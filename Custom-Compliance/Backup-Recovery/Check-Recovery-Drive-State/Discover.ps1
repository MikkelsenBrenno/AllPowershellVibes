<#
.SYNOPSIS
    Discovers Recovery Drive compliance state.

.DESCRIPTION
    Discovers Recovery Drive state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Recovery-Drive-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-recovery-drive-state.state'
