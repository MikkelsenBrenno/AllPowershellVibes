<#
.SYNOPSIS
    Discovers Recovery Partition compliance state.

.DESCRIPTION
    Discovers Recovery Partition state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Recovery-Partition-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-recovery-partition-state.state'
