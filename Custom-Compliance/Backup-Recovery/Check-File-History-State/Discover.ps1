<#
.SYNOPSIS
    Discovers File History compliance state.

.DESCRIPTION
    Discovers File History state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-File-History-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-file-history-state.state'
