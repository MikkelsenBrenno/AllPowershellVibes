<#
.SYNOPSIS
    Discovers Certificate Health Snapshot compliance state.

.DESCRIPTION
    Discovers Certificate Health Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Certificate-Health-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Certificate Health Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$MarkerFileName = 'certificate-health-snapshot.state'
