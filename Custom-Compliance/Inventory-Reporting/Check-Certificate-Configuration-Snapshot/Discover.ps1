<#
.SYNOPSIS
    Discovers Certificate Configuration Snapshot compliance state.

.DESCRIPTION
    Discovers Certificate Configuration Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Certificate-Configuration-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Certificate Configuration Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$MarkerFileName = 'certificate-configuration-snapshot.state'
