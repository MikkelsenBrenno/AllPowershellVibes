<#
.SYNOPSIS
    Discovers Network Health Snapshot compliance state.

.DESCRIPTION
    Discovers Network Health Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Network-Health-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Network Health Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$MarkerFileName = 'network-health-snapshot.state'
