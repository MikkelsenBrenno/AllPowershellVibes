<#
.SYNOPSIS
    Discovers Network Service Snapshot compliance state.

.DESCRIPTION
    Discovers Network Service Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Network-Service-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Network Service Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$MarkerFileName = 'network-service-snapshot.state'
