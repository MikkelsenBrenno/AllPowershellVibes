<#
.SYNOPSIS
    Discovers Certificate Log Snapshot compliance state.

.DESCRIPTION
    Discovers Certificate Log Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Certificate-Log-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Certificate Log Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$MarkerFileName = 'certificate-log-snapshot.state'
