<#
.SYNOPSIS
    Discovers Certificate Policy Snapshot compliance state.

.DESCRIPTION
    Discovers Certificate Policy Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Certificate-Policy-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Certificate Policy Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$MarkerFileName = 'certificate-policy-snapshot.state'
