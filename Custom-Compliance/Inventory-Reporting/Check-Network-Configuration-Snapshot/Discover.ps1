<#
.SYNOPSIS
    Discovers Network Configuration Snapshot compliance state.

.DESCRIPTION
    Discovers Network Configuration Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Network-Configuration-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Network Configuration Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$MarkerFileName = 'network-configuration-snapshot.state'
