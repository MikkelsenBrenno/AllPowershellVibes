<#
.SYNOPSIS
    Discovers Network Version Snapshot compliance state.

.DESCRIPTION
    Discovers Network Version Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Network-Version-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Network Version Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$MarkerFileName = 'network-version-snapshot.state'
