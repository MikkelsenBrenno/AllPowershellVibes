<#
.SYNOPSIS
    Discovers Certificate Version Snapshot compliance state.

.DESCRIPTION
    Discovers Certificate Version Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Certificate-Version-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Certificate Version Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$MarkerFileName = 'certificate-version-snapshot.state'
