<#
.SYNOPSIS
    Discovers Network Policy Snapshot compliance state.

.DESCRIPTION
    Discovers Network Policy Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Network-Policy-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Network Policy Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$MarkerFileName = 'network-policy-snapshot.state'
