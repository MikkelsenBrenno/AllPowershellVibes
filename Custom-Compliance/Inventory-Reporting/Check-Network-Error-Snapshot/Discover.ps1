<#
.SYNOPSIS
    Discovers Network Error Snapshot compliance state.

.DESCRIPTION
    Discovers Network Error Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Network-Error-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Network Error Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$MarkerFileName = 'network-error-snapshot.state'
