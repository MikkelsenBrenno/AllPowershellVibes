<#
.SYNOPSIS
    Discovers Network Log Snapshot compliance state.

.DESCRIPTION
    Discovers Network Log Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Network-Log-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Network Log Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Inventory-Reporting'
$MarkerFileName = 'network-log-snapshot.state'
