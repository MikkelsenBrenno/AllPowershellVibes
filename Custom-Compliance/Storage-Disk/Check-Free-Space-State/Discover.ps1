<#
.SYNOPSIS
    Discovers Free Space compliance state.

.DESCRIPTION
    Discovers Free Space state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Free-Space-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-free-space-state.state'
