<#
.SYNOPSIS
    Discovers Disk Cleanup compliance state.

.DESCRIPTION
    Discovers Disk Cleanup state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Disk-Cleanup-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-disk-cleanup-state.state'
