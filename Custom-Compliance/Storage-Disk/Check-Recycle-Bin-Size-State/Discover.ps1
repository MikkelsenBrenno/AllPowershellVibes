<#
.SYNOPSIS
    Discovers Recycle Bin Size compliance state.

.DESCRIPTION
    Discovers Recycle Bin Size state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Recycle-Bin-Size-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-recycle-bin-size-state.state'
