<#
.SYNOPSIS
    Discovers Disk Health compliance state.

.DESCRIPTION
    Discovers Disk Health state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Disk-Health-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-disk-health-state.state'
