<#
.SYNOPSIS
    Discovers User Profile Size compliance state.

.DESCRIPTION
    Discovers User Profile Size state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-User-Profile-Size-State'
$ScriptName = 'Discover'

$ManagedItemName = 'User Profile Size'
$PurposeCategory = 'Storage-Disk'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Storage-Disk'
$MarkerFileName = 'check-user-profile-size-state.state'
