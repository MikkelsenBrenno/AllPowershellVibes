<#
.SYNOPSIS
    Discovers Volume Errors compliance state.

.DESCRIPTION
    Discovers Volume Errors state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Volume-Errors-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-volume-errors-state.state'
