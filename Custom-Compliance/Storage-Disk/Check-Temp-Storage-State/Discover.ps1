<#
.SYNOPSIS
    Discovers Temp Storage compliance state.

.DESCRIPTION
    Discovers Temp Storage state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Temp-Storage-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-temp-storage-state.state'
