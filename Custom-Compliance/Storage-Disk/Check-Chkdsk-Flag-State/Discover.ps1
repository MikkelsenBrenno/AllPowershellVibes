<#
.SYNOPSIS
    Discovers Chkdsk Flag compliance state.

.DESCRIPTION
    Discovers Chkdsk Flag state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Chkdsk-Flag-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-chkdsk-flag-state.state'
