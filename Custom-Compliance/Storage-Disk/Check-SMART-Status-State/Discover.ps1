<#
.SYNOPSIS
    Discovers SMART Status compliance state.

.DESCRIPTION
    Discovers SMART Status state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-SMART-Status-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-smart-status-state.state'
