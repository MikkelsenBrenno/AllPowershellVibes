<#
.SYNOPSIS
    Discovers BitLocker Volume compliance state.

.DESCRIPTION
    Discovers BitLocker Volume state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-BitLocker-Volume-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-bitlocker-volume-state.state'
