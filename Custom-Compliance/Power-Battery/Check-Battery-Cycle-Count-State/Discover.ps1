<#
.SYNOPSIS
    Discovers Battery Cycle Count compliance state.

.DESCRIPTION
    Discovers Battery Cycle Count state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Battery-Cycle-Count-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-battery-cycle-count-state.state'
