<#
.SYNOPSIS
    Discovers Power Plan compliance state.

.DESCRIPTION
    Discovers Power Plan state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Power-Plan-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-power-plan-state.state'
