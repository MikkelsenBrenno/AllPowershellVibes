<#
.SYNOPSIS
    Discovers DC Power Policy compliance state.

.DESCRIPTION
    Discovers DC Power Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-DC-Power-Policy-State'
$ScriptName = 'Discover'

$ManagedItemName = 'DC Power Policy'
$PurposeCategory = 'Power-Battery'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Power-Battery'
$MarkerFileName = 'check-dc-power-policy-state.state'
