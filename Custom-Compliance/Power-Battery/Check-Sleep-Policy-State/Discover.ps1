<#
.SYNOPSIS
    Discovers Sleep Policy compliance state.

.DESCRIPTION
    Discovers Sleep Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Sleep-Policy-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-sleep-policy-state.state'
