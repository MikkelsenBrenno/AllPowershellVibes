<#
.SYNOPSIS
    Discovers Lid Action compliance state.

.DESCRIPTION
    Discovers Lid Action state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Lid-Action-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-lid-action-state.state'
