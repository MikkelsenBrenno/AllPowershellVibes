<#
.SYNOPSIS
    Discovers Modern Standby compliance state.

.DESCRIPTION
    Discovers Modern Standby state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Modern-Standby-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-modern-standby-state.state'
