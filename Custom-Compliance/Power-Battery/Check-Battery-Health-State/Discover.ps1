<#
.SYNOPSIS
    Discovers Battery Health compliance state.

.DESCRIPTION
    Discovers Battery Health state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Battery-Health-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-battery-health-state.state'
