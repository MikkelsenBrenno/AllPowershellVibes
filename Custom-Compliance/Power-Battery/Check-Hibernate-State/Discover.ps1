<#
.SYNOPSIS
    Discovers Hibernate State compliance state.

.DESCRIPTION
    Discovers Hibernate State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Hibernate-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-hibernate-state.state'
