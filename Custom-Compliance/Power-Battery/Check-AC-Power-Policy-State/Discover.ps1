<#
.SYNOPSIS
    Discovers AC Power Policy compliance state.

.DESCRIPTION
    Discovers AC Power Policy state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-AC-Power-Policy-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-ac-power-policy-state.state'
