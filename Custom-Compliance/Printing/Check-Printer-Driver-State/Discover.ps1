<#
.SYNOPSIS
    Discovers Printer Driver compliance state.

.DESCRIPTION
    Discovers Printer Driver state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Printer-Driver-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-printer-driver-state.state'
