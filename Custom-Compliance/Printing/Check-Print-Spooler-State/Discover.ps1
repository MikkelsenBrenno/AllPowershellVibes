<#
.SYNOPSIS
    Discovers Print Spooler compliance state.

.DESCRIPTION
    Discovers Print Spooler state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Print-Spooler-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-print-spooler-state.state'
