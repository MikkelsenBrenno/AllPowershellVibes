<#
.SYNOPSIS
    Discovers Universal Print compliance state.

.DESCRIPTION
    Discovers Universal Print state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Universal-Print-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-universal-print-state.state'
