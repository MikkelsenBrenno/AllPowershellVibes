<#
.SYNOPSIS
    Discovers Cloud Printer compliance state.

.DESCRIPTION
    Discovers Cloud Printer state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Cloud-Printer-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-cloud-printer-state.state'
