<#
.SYNOPSIS
    Discovers Print Processor compliance state.

.DESCRIPTION
    Discovers Print Processor state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Print-Processor-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Print Processor'
$PurposeCategory = 'Printing'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Printing'
$MarkerFileName = 'check-print-processor-state.state'
