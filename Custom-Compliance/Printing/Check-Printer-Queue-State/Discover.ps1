<#
.SYNOPSIS
    Discovers Printer Queue compliance state.

.DESCRIPTION
    Discovers Printer Queue state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Printer-Queue-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-printer-queue-state.state'
