<#
.SYNOPSIS
    Discovers Stale Printers compliance state.

.DESCRIPTION
    Discovers Stale Printers state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Stale-Printers-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-stale-printers-state.state'
