<#
.SYNOPSIS
    Discovers Default Printer compliance state.

.DESCRIPTION
    Discovers Default Printer state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Default-Printer-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-default-printer-state.state'
