<#
.SYNOPSIS
    Discovers Print Port compliance state.

.DESCRIPTION
    Discovers Print Port state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Print-Port-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-print-port-state.state'
