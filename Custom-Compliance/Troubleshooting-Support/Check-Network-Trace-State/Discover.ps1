<#
.SYNOPSIS
    Discovers Network Trace compliance state.

.DESCRIPTION
    Discovers Network Trace state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Network-Trace-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-network-trace-state.state'
