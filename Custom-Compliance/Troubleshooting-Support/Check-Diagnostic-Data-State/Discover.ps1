<#
.SYNOPSIS
    Discovers Diagnostic Data compliance state.

.DESCRIPTION
    Discovers Diagnostic Data state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Diagnostic-Data-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-diagnostic-data-state.state'
