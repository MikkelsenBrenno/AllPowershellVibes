<#
.SYNOPSIS
    Discovers Crash Dumps compliance state.

.DESCRIPTION
    Discovers Crash Dumps state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Crash-Dumps-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-crash-dumps-state.state'
