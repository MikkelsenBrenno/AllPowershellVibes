<#
.SYNOPSIS
    Discovers Support Bundle compliance state.

.DESCRIPTION
    Discovers Support Bundle state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Support-Bundle-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-support-bundle-state.state'
