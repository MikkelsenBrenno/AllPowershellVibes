<#
.SYNOPSIS
    Discovers IME Log Collector compliance state.

.DESCRIPTION
    Discovers IME Log Collector state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-IME-Log-Collector-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-ime-log-collector-state.state'
