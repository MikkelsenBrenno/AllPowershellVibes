<#
.SYNOPSIS
    Discovers Reliability History compliance state.

.DESCRIPTION
    Discovers Reliability History state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Reliability-History-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-reliability-history-state.state'
