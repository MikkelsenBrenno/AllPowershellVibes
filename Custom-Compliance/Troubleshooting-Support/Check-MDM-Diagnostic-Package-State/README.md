# Check-MDM-Diagnostic-Package-State

## Summary

Discovers MDM Diagnostic Package state for Intune custom compliance evaluation in the Troubleshooting-Support category.
