<#
.SYNOPSIS
    Discovers MDM Diagnostic Package compliance state.

.DESCRIPTION
    Discovers MDM Diagnostic Package state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-MDM-Diagnostic-Package-State'
$ScriptName = 'Discover'

$ManagedItemName = 'MDM Diagnostic Package'
$PurposeCategory = 'Troubleshooting-Support'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Troubleshooting-Support'
$MarkerFileName = 'check-mdm-diagnostic-package-state.state'
