<#
.SYNOPSIS
    Discovers Event Error Snapshot compliance state.

.DESCRIPTION
    Discovers Event Error Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Event-Error-Snapshot-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-event-error-snapshot-state.state'
