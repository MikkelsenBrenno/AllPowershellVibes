<#
.SYNOPSIS
    Discovers Problem Reports compliance state.

.DESCRIPTION
    Discovers Problem Reports state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Problem-Reports-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-problem-reports-state.state'
