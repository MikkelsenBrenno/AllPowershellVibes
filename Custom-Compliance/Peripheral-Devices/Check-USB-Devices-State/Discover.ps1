<#
.SYNOPSIS
    Discovers USB Devices compliance state.

.DESCRIPTION
    Discovers USB Devices state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-USB-Devices-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-usb-devices-state.state'
