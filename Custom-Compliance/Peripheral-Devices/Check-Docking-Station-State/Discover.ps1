<#
.SYNOPSIS
    Discovers Docking Station compliance state.

.DESCRIPTION
    Discovers Docking Station state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Docking-Station-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-docking-station-state.state'
