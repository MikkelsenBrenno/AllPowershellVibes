<#
.SYNOPSIS
    Discovers Audio Device compliance state.

.DESCRIPTION
    Discovers Audio Device state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Audio-Device-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-audio-device-state.state'
