<#
.SYNOPSIS
    Discovers Camera Device compliance state.

.DESCRIPTION
    Discovers Camera Device state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Camera-Device-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-camera-device-state.state'
