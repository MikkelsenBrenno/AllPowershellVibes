<#
.SYNOPSIS
    Discovers External Monitor compliance state.

.DESCRIPTION
    Discovers External Monitor state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-External-Monitor-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-external-monitor-state.state'
