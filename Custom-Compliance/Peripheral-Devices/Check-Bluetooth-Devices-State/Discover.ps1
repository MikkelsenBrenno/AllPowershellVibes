<#
.SYNOPSIS
    Discovers Bluetooth Devices compliance state.

.DESCRIPTION
    Discovers Bluetooth Devices state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Bluetooth-Devices-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Bluetooth Devices'
$PurposeCategory = 'Peripheral-Devices'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Peripheral-Devices'
$MarkerFileName = 'check-bluetooth-devices-state.state'
