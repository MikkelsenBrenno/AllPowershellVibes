<#
.SYNOPSIS
    Discovers WiFi Cache Health compliance state.

.DESCRIPTION
    Discovers WiFi Cache Health state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-WiFi-Cache-Health'
$ScriptName = 'Discover'

$ManagedItemName = 'WiFi Cache Health'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'wifi-cache-health.state'
