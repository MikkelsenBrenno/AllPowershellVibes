<#
.SYNOPSIS
    Discovers Teams Recovery Marker compliance state.

.DESCRIPTION
    Discovers Teams Recovery Marker state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Teams-Recovery-Marker'
$ScriptName = 'Discover'

$ManagedItemName = 'Teams Recovery Marker'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'teams-recovery-marker.state'
