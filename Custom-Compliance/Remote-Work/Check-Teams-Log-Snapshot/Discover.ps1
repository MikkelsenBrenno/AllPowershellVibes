<#
.SYNOPSIS
    Discovers Teams Log Snapshot compliance state.

.DESCRIPTION
    Discovers Teams Log Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Teams-Log-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Teams Log Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'teams-log-snapshot.state'
