<#
.SYNOPSIS
    Discovers WiFi Certificate Readiness compliance state.

.DESCRIPTION
    Discovers WiFi Certificate Readiness state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-WiFi-Certificate-Readiness'
$ScriptName = 'Discover'

$ManagedItemName = 'WiFi Certificate Readiness'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'wifi-certificate-readiness.state'
