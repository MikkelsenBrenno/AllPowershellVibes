<#
.SYNOPSIS
    Discovers Teams Service State compliance state.

.DESCRIPTION
    Discovers Teams Service State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Teams-Service-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Teams Service State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'teams-service-state.state'
