<#
.SYNOPSIS
    Discovers Teams Policy State compliance state.

.DESCRIPTION
    Discovers Teams Policy State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Teams-Policy-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Teams Policy State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'teams-policy-state.state'
