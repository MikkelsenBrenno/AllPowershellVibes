<#
.SYNOPSIS
    Discovers WiFi SignIn Readiness compliance state.

.DESCRIPTION
    Discovers WiFi SignIn Readiness state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-WiFi-SignIn-Readiness'
$ScriptName = 'Discover'

$ManagedItemName = 'WiFi SignIn Readiness'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'wifi-signin-readiness.state'
