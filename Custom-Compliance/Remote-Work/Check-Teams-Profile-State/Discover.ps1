<#
.SYNOPSIS
    Discovers Teams Profile State compliance state.

.DESCRIPTION
    Discovers Teams Profile State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Teams-Profile-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Teams Profile State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'teams-profile-state.state'
