<#
.SYNOPSIS
    Discovers Teams SignIn Readiness compliance state.

.DESCRIPTION
    Discovers Teams SignIn Readiness state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Teams-SignIn-Readiness'
$ScriptName = 'Discover'

$ManagedItemName = 'Teams SignIn Readiness'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'teams-signin-readiness.state'
