<#
.SYNOPSIS
    Discovers WiFi Log Snapshot compliance state.

.DESCRIPTION
    Discovers WiFi Log Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-WiFi-Log-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'WiFi Log Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'wifi-log-snapshot.state'
