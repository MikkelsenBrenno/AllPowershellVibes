<#
.SYNOPSIS
    Discovers Teams Certificate Readiness compliance state.

.DESCRIPTION
    Discovers Teams Certificate Readiness state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Teams-Certificate-Readiness'
$ScriptName = 'Discover'

$ManagedItemName = 'Teams Certificate Readiness'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'teams-certificate-readiness.state'
