<#
.SYNOPSIS
    Discovers WiFi Shortcut State compliance state.

.DESCRIPTION
    Discovers WiFi Shortcut State state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-WiFi-Shortcut-State'
$ScriptName = 'Discover'

$ManagedItemName = 'WiFi Shortcut State'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'wifi-shortcut-state.state'
