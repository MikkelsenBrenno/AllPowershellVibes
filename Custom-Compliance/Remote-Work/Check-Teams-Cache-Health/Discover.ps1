<#
.SYNOPSIS
    Discovers Teams Cache Health compliance state.

.DESCRIPTION
    Discovers Teams Cache Health state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Teams-Cache-Health'
$ScriptName = 'Discover'

$ManagedItemName = 'Teams Cache Health'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'teams-cache-health.state'
