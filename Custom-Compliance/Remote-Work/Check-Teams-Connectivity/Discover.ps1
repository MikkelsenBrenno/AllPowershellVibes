<#
.SYNOPSIS
    Discovers Teams Connectivity compliance state.

.DESCRIPTION
    Discovers Teams Connectivity state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Teams-Connectivity'
$ScriptName = 'Discover'

$ManagedItemName = 'Teams Connectivity'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Remote-Work'
$MarkerFileName = 'teams-connectivity.state'
