<#
.SYNOPSIS
    Discovers User Root Certificate compliance state.

.DESCRIPTION
    Discovers User Root Certificate state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-User-Root-Certificate-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-user-root-certificate-state.state'
