<#
.SYNOPSIS
    Discovers SCEP Certificate compliance state.

.DESCRIPTION
    Discovers SCEP Certificate state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-SCEP-Certificate-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-scep-certificate-state.state'
