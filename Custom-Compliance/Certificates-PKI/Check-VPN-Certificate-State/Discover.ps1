<#
.SYNOPSIS
    Discovers VPN Certificate compliance state.

.DESCRIPTION
    Discovers VPN Certificate state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-VPN-Certificate-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-vpn-certificate-state.state'
