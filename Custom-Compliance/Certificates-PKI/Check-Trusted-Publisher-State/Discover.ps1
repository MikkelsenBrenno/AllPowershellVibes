<#
.SYNOPSIS
    Discovers Trusted Publisher compliance state.

.DESCRIPTION
    Discovers Trusted Publisher state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Trusted-Publisher-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-trusted-publisher-state.state'
