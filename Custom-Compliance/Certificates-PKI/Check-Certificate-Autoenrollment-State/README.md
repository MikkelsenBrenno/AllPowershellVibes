# Check-Certificate-Autoenrollment-State

## Summary

Discovers Certificate Autoenrollment state for Intune custom compliance evaluation in the Certificates-PKI category.
