<#
.SYNOPSIS
    Discovers Certificate Autoenrollment compliance state.

.DESCRIPTION
    Discovers Certificate Autoenrollment state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Certificate-Autoenrollment-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Certificate Autoenrollment'
$PurposeCategory = 'Certificates-PKI'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Certificates-PKI'
$MarkerFileName = 'check-certificate-autoenrollment-state.state'
