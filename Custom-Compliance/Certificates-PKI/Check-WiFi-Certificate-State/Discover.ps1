<#
.SYNOPSIS
    Discovers WiFi Certificate compliance state.

.DESCRIPTION
    Discovers WiFi Certificate state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-WiFi-Certificate-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-wifi-certificate-state.state'
