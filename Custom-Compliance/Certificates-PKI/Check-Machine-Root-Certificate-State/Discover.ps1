<#
.SYNOPSIS
    Discovers Machine Root Certificate compliance state.

.DESCRIPTION
    Discovers Machine Root Certificate state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Machine-Root-Certificate-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-machine-root-certificate-state.state'
