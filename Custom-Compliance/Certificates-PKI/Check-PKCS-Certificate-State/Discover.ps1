<#
.SYNOPSIS
    Discovers PKCS Certificate compliance state.

.DESCRIPTION
    Discovers PKCS Certificate state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-PKCS-Certificate-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-pkcs-certificate-state.state'
