<#
.SYNOPSIS
    Discovers Intermediate CA compliance state.

.DESCRIPTION
    Discovers Intermediate CA state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Intermediate-CA-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-intermediate-ca-state.state'
