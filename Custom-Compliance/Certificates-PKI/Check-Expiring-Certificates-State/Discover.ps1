<#
.SYNOPSIS
    Discovers Expiring Certificates compliance state.

.DESCRIPTION
    Discovers Expiring Certificates state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Expiring-Certificates-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-expiring-certificates-state.state'
