<#
.SYNOPSIS
    Discovers IME Service compliance state.

.DESCRIPTION
    Discovers IME Service state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-IME-Service-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-ime-service-state.state'
