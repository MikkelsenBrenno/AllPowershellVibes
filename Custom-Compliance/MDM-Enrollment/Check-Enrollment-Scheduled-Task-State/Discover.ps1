<#
.SYNOPSIS
    Discovers Enrollment Scheduled Task compliance state.

.DESCRIPTION
    Discovers Enrollment Scheduled Task state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Enrollment-Scheduled-Task-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-enrollment-scheduled-task-state.state'
