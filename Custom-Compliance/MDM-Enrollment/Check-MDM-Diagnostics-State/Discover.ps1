<#
.SYNOPSIS
    Discovers MDM Diagnostics compliance state.

.DESCRIPTION
    Discovers MDM Diagnostics state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-MDM-Diagnostics-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-mdm-diagnostics-state.state'
