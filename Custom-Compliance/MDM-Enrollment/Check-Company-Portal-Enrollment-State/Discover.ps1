<#
.SYNOPSIS
    Discovers Company Portal Enrollment compliance state.

.DESCRIPTION
    Discovers Company Portal Enrollment state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Company-Portal-Enrollment-State'
$ScriptName = 'Discover'

$ManagedItemName = 'Company Portal Enrollment'
$PurposeCategory = 'MDM-Enrollment'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\MDM-Enrollment'
$MarkerFileName = 'check-company-portal-enrollment-state.state'
