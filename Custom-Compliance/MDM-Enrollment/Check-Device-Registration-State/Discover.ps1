<#
.SYNOPSIS
    Discovers Device Registration compliance state.

.DESCRIPTION
    Discovers Device Registration state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Device-Registration-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-device-registration-state.state'
