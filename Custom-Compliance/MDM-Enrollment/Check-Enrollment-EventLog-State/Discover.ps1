<#
.SYNOPSIS
    Discovers Enrollment EventLog compliance state.

.DESCRIPTION
    Discovers Enrollment EventLog state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Enrollment-EventLog-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-enrollment-eventlog-state.state'
