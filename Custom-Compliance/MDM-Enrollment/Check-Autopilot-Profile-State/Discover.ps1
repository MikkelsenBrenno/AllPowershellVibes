<#
.SYNOPSIS
    Discovers Autopilot Profile compliance state.

.DESCRIPTION
    Discovers Autopilot Profile state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Autopilot-Profile-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-autopilot-profile-state.state'
