<#
.SYNOPSIS
    Discovers AAD Device Token compliance state.

.DESCRIPTION
    Discovers AAD Device Token state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-AAD-Device-Token-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-aad-device-token-state.state'
