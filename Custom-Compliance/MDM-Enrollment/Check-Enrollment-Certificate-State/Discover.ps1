<#
.SYNOPSIS
    Discovers Enrollment Certificate compliance state.

.DESCRIPTION
    Discovers Enrollment Certificate state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Enrollment-Certificate-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-enrollment-certificate-state.state'
