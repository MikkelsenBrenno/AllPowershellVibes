<#
.SYNOPSIS
    Discovers Policy Sync compliance state.

.DESCRIPTION
    Discovers Policy Sync state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Policy-Sync-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-policy-sync-state.state'
