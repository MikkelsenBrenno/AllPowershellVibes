<#
.SYNOPSIS
    Discovers DMClient Service compliance state.

.DESCRIPTION
    Discovers DMClient Service state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-DMClient-Service-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-dmclient-service-state.state'
