<#
.SYNOPSIS
    Discovers Disk Recovery Marker compliance state.

.DESCRIPTION
    Discovers Disk Recovery Marker state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Disk-Recovery-Marker'
$ScriptName = 'Discover'

$ManagedItemName = 'Disk Recovery Marker'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Endpoint-Health'
$MarkerFileName = 'disk-recovery-marker.state'
