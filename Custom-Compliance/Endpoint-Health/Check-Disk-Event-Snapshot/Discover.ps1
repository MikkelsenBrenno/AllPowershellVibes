<#
.SYNOPSIS
    Discovers Disk Event Snapshot compliance state.

.DESCRIPTION
    Discovers Disk Event Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Disk-Event-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Disk Event Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Endpoint-Health'
$MarkerFileName = 'disk-event-snapshot.state'
