<#
.SYNOPSIS
    Discovers Battery Recovery Marker compliance state.

.DESCRIPTION
    Discovers Battery Recovery Marker state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Battery-Recovery-Marker'
$ScriptName = 'Discover'

$ManagedItemName = 'Battery Recovery Marker'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Endpoint-Health'
$MarkerFileName = 'battery-recovery-marker.state'
