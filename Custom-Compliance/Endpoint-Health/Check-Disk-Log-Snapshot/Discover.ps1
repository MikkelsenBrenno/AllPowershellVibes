<#
.SYNOPSIS
    Discovers Disk Log Snapshot compliance state.

.DESCRIPTION
    Discovers Disk Log Snapshot state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Disk-Log-Snapshot'
$ScriptName = 'Discover'

$ManagedItemName = 'Disk Log Snapshot'
$MarkerRoot = Join-Path -Path $env:ProgramData -ChildPath 'IntuneScriptLibrary\ManagedState\Endpoint-Health'
$MarkerFileName = 'disk-log-snapshot.state'
