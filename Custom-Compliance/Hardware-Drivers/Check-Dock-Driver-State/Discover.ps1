<#
.SYNOPSIS
    Discovers Dock Driver compliance state.

.DESCRIPTION
    Discovers Dock Driver state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Dock-Driver-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-dock-driver-state.state'
