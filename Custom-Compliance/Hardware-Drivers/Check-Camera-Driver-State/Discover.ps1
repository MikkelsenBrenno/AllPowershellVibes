<#
.SYNOPSIS
    Discovers Camera Driver compliance state.

.DESCRIPTION
    Discovers Camera Driver state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Camera-Driver-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-camera-driver-state.state'
