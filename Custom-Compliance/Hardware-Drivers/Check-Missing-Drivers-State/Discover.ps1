<#
.SYNOPSIS
    Discovers Missing Drivers compliance state.

.DESCRIPTION
    Discovers Missing Drivers state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Missing-Drivers-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-missing-drivers-state.state'
