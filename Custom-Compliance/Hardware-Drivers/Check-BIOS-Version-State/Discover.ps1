<#
.SYNOPSIS
    Discovers BIOS Version compliance state.

.DESCRIPTION
    Discovers BIOS Version state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-BIOS-Version-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-bios-version-state.state'
