<#
.SYNOPSIS
    Discovers Network Driver compliance state.

.DESCRIPTION
    Discovers Network Driver state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Network-Driver-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-network-driver-state.state'
