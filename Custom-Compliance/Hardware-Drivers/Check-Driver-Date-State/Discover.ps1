<#
.SYNOPSIS
    Discovers Driver Date compliance state.

.DESCRIPTION
    Discovers Driver Date state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Driver-Date-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-driver-date-state.state'
