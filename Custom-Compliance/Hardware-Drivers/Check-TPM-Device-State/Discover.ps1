<#
.SYNOPSIS
    Discovers TPM Device compliance state.

.DESCRIPTION
    Discovers TPM Device state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-TPM-Device-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-tpm-device-state.state'
