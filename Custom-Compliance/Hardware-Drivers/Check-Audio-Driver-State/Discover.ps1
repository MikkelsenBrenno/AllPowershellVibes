<#
.SYNOPSIS
    Discovers Audio Driver compliance state.

.DESCRIPTION
    Discovers Audio Driver state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Audio-Driver-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-audio-driver-state.state'
