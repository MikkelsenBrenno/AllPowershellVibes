<#
.SYNOPSIS
    Discovers Display Driver compliance state.

.DESCRIPTION
    Discovers Display Driver state for Intune custom compliance evaluation.
...
$ScriptPackageName = 'Check-Display-Driver-State'
$ScriptName = 'Discover'
...
$MarkerFileName = 'check-display-driver-state.state'
